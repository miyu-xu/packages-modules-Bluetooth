...
class MetricsTest : BaseHostJUnit4Test() {
    ...
    fun aclMetricTest() {
        ...
        val atom = data.get(0).getAtom().getBluetoothAclConnectionStateChanged()
        assertThat(atom.getState())
                .isEqualTo(ConnectionStateEnum.CONNECTION_STATE_CONNECTED)
        assertThat(atom.getTransport())
                .isEqualTo(TransportTypeEnum.TRANSPORT_TYPE_BREDR)
    }
