...
public class PairingTest {
    ...
    private static final long TIMEOUT_BONDED = 5;
    ...
    public void classicPairing() throws Exception {
        ...
        Connection conn = createConnectionFuture.get(TIMEOUT_CONNECT, TimeUnit.SECONDS);
        BluetoothDevice dev = waitConnectionFuture.get(TIMEOUT_WAIT_CONNECTION, TimeUnit.SECONDS);
        ...
        PairingEvent mPairingEvent = waitPairingEventFuture.get(
            TIMEOUT_WAIT_PAIRING_EVENT, TimeUnit.SECONDS);
        ...
        secureConnectionFuture.get(TIMEOUT_SECURE, TimeUnit.SECONDS);
        answerObserver.onCompleted();

        // Wait bonding
        waitBondedFuture.get(TIMEOUT_BONDED, TimeUnit.SECONDS);
        ...
        // Wait disconnection
        waitDisconnectionFuture.get(TIMEOUT_DISCONNECTION, TimeUnit.SECONDS);
    }
