...
import pandora.HFProto.HfConnectRequest;
import pandora.HFProto.HfDisconnectRequest;
...
public class HfpTest {
    ...
    public void HfpConnectionDisconnectionTestFromAG() {
        ...
        registerIntentActions(BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED);
        ...
        unregisterIntentActions(BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED);
    }
    ...
    public void HfpConnectionDisconnectionFromHF() {
        ...
        mHfBlockingStub.connect(
                HfConnectRequest.newBuilder().setAddress(sAdapter.getAddress()).build());
        ...
        mHfBlockingStub.disconnect(
                HfDisconnectRequest.newBuilder().setAddress(sAdapter.getAddress()).build());
