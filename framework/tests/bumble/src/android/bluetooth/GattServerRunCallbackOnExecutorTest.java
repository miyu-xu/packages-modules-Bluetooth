...
public class GattServerRunCallbackOnExecutorTest {
    ...
    @Test
    public void callbackRunsOnBinderThread_whenNoExecutorIsProvided() throws Exception {
        ...
        BluetoothGattServer gattServer =
                mBluetoothManager.openGattServer(mContext, gattServerCallback);
        ...
        try {
            ...
            assertThat(callbackThread.getName()).contains("binder");
        } finally {
            gattServer.close();
        }
    }
    ...
    public void callbackRunsOnMainExecutor_whenMainExecutorIsProvided() throws Exception {
        CompletableFuture<Thread> callbackThreadFuture = new CompletableFuture<>();
        BluetoothGattServerCallback gattServerCallback =
                new BluetoothGattServerCallback() {
                    @Override
