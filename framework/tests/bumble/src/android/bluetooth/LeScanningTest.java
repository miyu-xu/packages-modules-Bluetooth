...
public class LeScanningTest {
    ...
    private static final String TEST_UUID_STRING2 = "00001800-0000-1000-8000-00805f9b34fb";
    ...
    public void startBleScan_withServiceData() {
        ...
        List<ScanResult> results =
                startScanning(scanFilter, ScanSettings.CALLBACK_TYPE_ALL_MATCHES, false);
    ...
    public void startBleScan_withServiceData_uuidDoesntMatch() {
        ...
        ScanFilter scanFilter =
                new ScanFilter.Builder()
                        .setServiceUuid(ParcelUuid.fromString(TEST_UUID_STRING))
                        .setServiceData(ParcelUuid.fromString(TEST_UUID_STRING2), TEST_SERVICE_DATA)
                        .build();
    ...
    private List<ScanResult> startScanning(ScanFilter scanFilter, int callbackType) {
        return startScanning(scanFilter, callbackType, true);
    }
