...
import static android.bluetooth.Utils.hexStringToByteArray;
...
public class LeScanningTest {
        ...
        ScanFilter scanFilter =
                new ScanFilter.Builder()
                        .setDeviceAddress(
                                ...
                                hexStringToByteArray(Utils.BUMBLE_IRK))
                        .build();
    ...
    /**
     * 1.1 Scan with Identity Address & IRK
     *
     * <p>https://docs.google.com/document/d/1oQOpgI83HSJBdr5mBU00za_6XrDGo2KDGnCcX-hXPHk/edit?pli=1&tab=t.0#heading=h.yl9o93gnbyuy
     */
    @Test
