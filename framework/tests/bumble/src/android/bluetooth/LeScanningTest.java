...
public class LeScanningTest {
    ...
    private final String TEST_UUID_STRING_16BIT = "1805";
    private final String TEST_UUID_STRING_128BIT = "00001805-0000-1000-8000-00805f9b34fb";
    ...
    public void startBleScan_withCallbackTypeAllMatches() {
        advertiseWithBumble(TEST_UUID_STRING_16BIT);

        List<ScanResult> results = startScanning(TEST_UUID_STRING_128BIT).join();

        assertThat(results.get(0).getScanRecord().getServiceUuids().get(0)).isEqualTo(
                ParcelUuid.fromString(TEST_UUID_STRING_128BIT));
    ...
    private void advertiseWithBumble(String serviceUuid16Bit) {
        HostProto.DataTypes dataType = HostProto.DataTypes.newBuilder()
                .addCompleteServiceClassUuids16(serviceUuid16Bit)
                .build();
