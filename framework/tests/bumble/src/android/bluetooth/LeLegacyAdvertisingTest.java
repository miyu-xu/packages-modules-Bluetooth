...
public class LeLegacyAdvertisingTest {
    ...
    public void setAdvertisingDataOver31Bytes() throws Exception {
        ...
        final CountDownLatch dataTooLargetLatch = new CountDownLatch(1);
        ...
        AdvertisingSetCallback callback =
                new AdvertisingSetCallback() {
                    ...
                    public void onAdvertisingSetStarted(
                        ...
                        int advertisingDataLengthWhichExccedsLimit = 50;
                        advertisingSet.setAdvertisingData(
                                createAdvertiseData(advertisingDataLengthWhichExccedsLimit));
                    }
                    ...
                    public void onAdvertisingDataSet(AdvertisingSet advertisingSet, int status) {
                        if (status == ADVERTISE_FAILED_DATA_TOO_LARGE) {
                            ...
                            dataTooLargetLatch.countDown();
                        }
                    }
                };

        advertiser.startAdvertisingSet(params, advertiseData, null, null, null, callback);
        assertThat(dataTooLargetLatch.await(TIMEOUT_MS, TimeUnit.MILLISECONDS)).isTrue();
    }
