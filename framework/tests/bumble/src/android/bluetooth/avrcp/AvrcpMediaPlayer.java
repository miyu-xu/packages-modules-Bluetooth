...
public class AvrcpMediaPlayer extends MediaBrowserService {
    ...
    private static final String DEFAULT_TITLE = "BumbleTestTitle";
    private static final String DEFAULT_ARTIST = "BumbleTestArtist";
    private static final String DEFAULT_ALBUM = "BumbleTestAlbum";
    private static final long DEFAULT_NUM_TRACKS = 900913;
    private static final long DEFAULT_TRACK_NUM = 900913;
    private static final String DEFAULT_GENRE = "BumbleTestGenre";
    private static final long DEFAULT_DURATION = 900913;
