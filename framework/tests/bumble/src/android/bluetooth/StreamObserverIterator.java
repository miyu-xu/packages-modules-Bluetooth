...
public class StreamObserverIterator<T> implements Iterator<T>, StreamObserver<T> {
    ...
    private static final Object sCompletedIndicator = new Object();
    ...
    public void onCompleted() {
        mCompleted = true;
        mQueue.add(sCompletedIndicator);
    }
    ...
    public T next() {
        try {
            ...
            if (item == sCompletedIndicator) {
                throw new RuntimeException(new NoSuchElementException("Iterator completed"));
            }
