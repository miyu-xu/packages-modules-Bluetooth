...
public class PairingTest {
    ...
    public void setUp() throws Exception {
        ...
        sAdapter.getProfileProxy(
                sTargetContext, mBluetoothProfileServiceListener, BluetoothProfile.HID_HOST);
        sAdapter.getProfileProxy(
                sTargetContext, mBluetoothProfileServiceListener, BluetoothProfile.A2DP);
        sAdapter.getProfileProxy(
                sTargetContext, mBluetoothProfileServiceListener, BluetoothProfile.HEADSET);
