...
public class PairingTest {
    ...
    public void testBondLe_identityAddressWithType(@TestParameter boolean isRandom) {
        BluetoothDevice device = mBumbleDevice;
        OwnAddressType ownAddressType = OwnAddressType.PUBLIC;
        String expectedAddress = mBumbleDevice.getAddress();
        int expectedAddressType = BluetoothDevice.ADDRESS_TYPE_PUBLIC;
        if (isRandom) {
            device = mRemoteLeDevice;
            ownAddressType = OwnAddressType.RANDOM;
            expectedAddress = Utils.BUMBLE_RANDOM_ADDRESS;
            expectedAddressType = BluetoothDevice.ADDRESS_TYPE_RANDOM;
        }
        ...
        assertThat(identityAddress.getAddress()).isEqualTo(expectedAddress);
        assertThat(identityAddress.getAddressType()).isEqualTo(expectedAddressType);
    }
