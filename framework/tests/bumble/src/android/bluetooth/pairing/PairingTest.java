...
public class PairingTest {
     ...
     *  helper -> IntentReceiver.helper_updateNewIntentActionsInParentReceiver() which either modifies the
    ...
    private void testStep_BondBredr(IntentReceiver parentIntentReceiver) {
        IntentReceiver intentReceiver =
            IntentReceiver.helper_updateNewIntentActionsInParentReceiver(
