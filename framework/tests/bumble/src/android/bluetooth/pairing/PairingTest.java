...
public class PairingTest {
    ...
    public void testBondBredr_RemoteInitiatedBonding() {
        ...
        Log.d(TAG, "testBondBredr_RemoteInitiatedBonding startDiscovery:");
        // Start Discovery
        ...
        if (mBumbleDevice == null) {
            Log.d(TAG, "testBondBredr_RemoteInitiatedBonding Discovery done:mBumbleDevice is null:");
        }
        else {
            Log.d(TAG, "testBondBredr_RemoteInitiatedBonding Discovery done:mBumbleDevice is not null:");
        }
