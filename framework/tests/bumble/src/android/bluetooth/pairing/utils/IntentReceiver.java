...
public class IntentReceiver {
    ...
    private IntentReceiver(Builder builder) {
        ...
        mDqIntentFilter.addFirst(helper_PrepareIntentFilter(mIntentStrings));
     ...
     *  instance.
     *
     * @param intentReceiver IntentReceiver instance from the parent test caller
     ...
     *  function always.
     */
    public static IntentReceiver helper_updateNewIntentActionsInParentReceiver(
    ...
    private void helper_RegisterReceiver() {
        Log.d(TAG, "helper_RegisterReceiver(): Registering for intents: " +
            helper_getActionsFromIntentFilter(mDqIntentFilter.peekFirst()));
     ...
     */
    private String helper_getActionsFromIntentFilter(
