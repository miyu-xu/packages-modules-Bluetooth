...
public class IntentReceiver {
    ...
    private IntentFilter helper_PrepareIntentFilter(String... intentStrings) {
        ...
        for (String intentString : mIntentStrings) intentFilter.addAction(intentString);
    ...
    private void helper_RegisterReceiver() {
        Log.d(TAG, "helper_RegisterReceiver(): Registering for intents: " + Arrays.toString(mIntentStrings));
