...
import pandora.SecurityProto.PairingHashResponse;
...
public class OobPairingTest {
    ...
    public void createBondWithRemoteOob() throws Exception {
        ...
        PairingHashResponse c =
                mBumble.securityBlocking().getPairingHash(Empty.getDefaultInstance());
        byte[] confirmationHash =
                c.getC().substring(HASH_START_POSITION, HASH_END_POSITION).toByteArray();
        byte[] randomHash =
                c.getC()
