...
public class GattServerTest {
    ...
    @Test
    public void serverConnectToPublicAddress() throws Exception {
        ScanningResponse response =
                startAdvertising(AdvertisingSetParameters.ADDRESS_TYPE_PUBLIC)
        ...
        BluetoothDevice device =
                sBluetoothAdapter.getRemoteLeDevice(
                        Utils.addressStringFromByteString(response.getPublic()),
    ...
    public void serverConnectToRandomAddress() throws Exception {
        ScanningResponse response =
                startAdvertising(AdvertisingSetParameters.ADDRESS_TYPE_RANDOM)
                        .thenCompose(advAddressPair -> scanWithBumble(advAddressPair))
                        .join();
        ...
        BluetoothDevice device =
                sBluetoothAdapter.getRemoteLeDevice(
                        Utils.addressStringFromByteString(response.getRandom()),
                        BluetoothDevice.ADDRESS_TYPE_PUBLIC);
        assertThat(device).isNotNull();
    ...
    private CompletableFuture<Pair<String, Integer>> startAdvertising(
        ...
        // Start advertising
        BluetoothLeAdvertiser leAdvertiser = sBluetoothAdapter.getBluetoothLeAdvertiser();
