...
import android.bluetooth.test_utils.DeviceBasedBroadcastReceiver;
...
public class PairingTest {
    ...
    private DeviceBasedBroadcastReceiver mReceiver;
    ...
    public void setUp() throws Exception {
        ...
        mReceiver = new DeviceBasedBroadcastReceiver();
    ...
    public void testBrEdrPairing_phoneInitiatedBrEdrInquiryOnlyJustWorks() {
        ...
        Intent bondingIntent =
                TestUtils.waitForItem(BOND_INTENT_TIMEOUT, mReceiver.getQueue(mBumbleDevice));
        ...
        PairingEvent pairingEvent = TestUtils.waitForItem(BOND_INTENT_TIMEOUT, pairingEvents);
