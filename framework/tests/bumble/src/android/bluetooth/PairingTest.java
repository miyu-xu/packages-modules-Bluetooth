<<<<<<< PATCH SET (dfdac9 Test parallel service discovery with pairing cancelation)
/*
...
public class PairingTest {
    ...
    private static final String TEST_UUID_1 = "12345678-0000-1000-8000-00805f9b34fb";
    ...
    private void helper_OutgoingGattServiceDiscoveryWithIncomingLePairing() {
        ...
        mBumble.gattBlocking()
                .registerService(
                        GattProto.RegisterServiceRequest.newBuilder()
                                .setService(
                                        GattProto.GattServiceParams.newBuilder()
                                                .setUuid(BluetoothUuid.BATTERY.toString())
                                                .build())
                                .build());
        ...
        verifyIntentReceived(
                ...
                hasExtra(
                        ...
                        Matchers.arrayContainingInAnyOrder(BluetoothUuid.BATTERY)));
...
=======
>>>>>>> BASE      (6141fe Merge changes Idcf3502b,I9e4cb5b8,I50024e85 into main)
