<<<<<<< PATCH SET (d03d0e Test parallel service discovery with pairing cancelation)
/*
...
public class PairingTest {
    ...
    private void testStep_OutgoingGattServiceDiscoveryWithIncomingLePairing() {
        ...
        // Todo: (b/316971017) Add minimal interesting GATT services on Bumble,
...
=======
>>>>>>> BASE      (0e6aa8 Merge "Flag for prevent pairing state reset due to unrelated)
