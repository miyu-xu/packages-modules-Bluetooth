...
class RfcommTest {
    ...
    private suspend fun bondDevice(remoteDevice: BluetoothDevice) {
        ...
        /* TODO: Remove this workaround - the real solution would be either to
         * 1. Obtain previously bonded devices from Bumble
         * 2. Disable HFP on the Bumble side
         */
