...
public class GattClientTest {
    ...
    public void directConnectGattAfterClose() throws Exception {
        ...
        BluetoothDevice device = getBumbleDevice();
    ...
    private BluetoothDevice getBumbleDevice() {
        android.content.Context context = ApplicationProvider.getApplicationContext();
        BluetoothManager bluetoothManager = context.getSystemService(BluetoothManager.class);
        BluetoothAdapter bluetoothAdapter = bluetoothManager.getAdapter();
        return bluetoothAdapter.getRemoteLeDevice(BUMBLE_RPA, BluetoothDevice.ADDRESS_TYPE_RANDOM);
    }
