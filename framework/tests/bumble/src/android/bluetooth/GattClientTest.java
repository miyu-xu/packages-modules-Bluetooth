...
public class GattClientTest {
    ...
    @Test
    public void clientGattReceiveNotificationOnCharacteristic() throws Exception {
        performNotificationIndicationTest(false);
    }

    @Test
    public void clientGattReceiveIndicationOnCharacteristic() throws Exception {
        performNotificationIndicationTest(true);
    }
    ...
    private void performNotificationIndicationTest(boolean isIndicate) {
