...
public class ServiceDiscoveryTest {
    ...
    public void testServiceDiscoveryUuids_LE_BREDR() {
        ...
        registerIntentActions(BluetoothDevice.ACTION_PAIRING_REQUEST);
        ...
        Log.d(
                TAG,
                "UUIDs retrieved from mBumbleDevice.getUuids(), UUID ="
                        + Arrays.toString(uuidsRaw));
        ...
        unregisterIntentActions(BluetoothDevice.ACTION_PAIRING_REQUEST);
