...
public void testServiceDiscoveryUuids_LE_BREDR()
{
	...
	// Setup intent filters
        ...
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.HOGP))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.BATTERY))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.HFP))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.A2DP_SOURCE))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.A2DP_SINK))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.AVRCP))).isTrue();
        ...
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.HOGP))).isTrue();  // should not match when flag disabled
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.BATTERY))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.HFP))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.A2DP_SOURCE))).isTrue();
        assertThat(Arrays.stream(uuidsRaw).anyMatch(item -> item.equals(BluetoothUuid.A2DP_SINK))).isTrue();
