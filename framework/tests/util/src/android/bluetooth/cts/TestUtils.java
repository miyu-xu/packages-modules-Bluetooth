    ...
    public static boolean isProfileEnabled(int profile) {
        switch (profile) {
            ...
            case BluetoothProfile.LE_AUDIO_BROADCAST -> {
                return leaudioBroadcastFeatureSupport() && BluetoothProperties.isProfileBapBroadcastSourceEnabled().orElse(false);
            }
            case BluetoothProfile.LE_AUDIO_BROADCAST_ASSISTANT -> {
                return leaudioBroadcastFeatureSupport() && BluetoothProperties.isProfileBapBroadcastAssistEnabled().orElse(false);
            }
                // Hidden profile
