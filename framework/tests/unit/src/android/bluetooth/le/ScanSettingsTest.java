...
import static com.android.bluetooth.ChangeIds.CHANGE_DEFAULT_TRACKABLE_ADV_NUMBER;
...
public class ScanSettingsTest {
    ...
    @Test
    @CoreCompatChangeRule.DisableCompatChanges(CHANGE_DEFAULT_TRACKABLE_ADV_NUMBER)
    @RequiresFlagsEnabled(Flags.FLAG_CHANGE_DEFAULT_TRACKABLE_ADV_NUMBER)
