...
<<<<<<< PATCH SET (7dd0ab Unhide and Flag Connection Subrate API and callback)
...
>>>>>>> BASE      (d44464 Update of Connection Subrate API and callback refactor)
                                ...
                                public void run() {
                                    ...
                                    if (callback != null) {
                                        callback.onSubrateChange(
                                                BluetoothGatt.this, subrateMode, status);
                                    }
                                }
                            });
                }
