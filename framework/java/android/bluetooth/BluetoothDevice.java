...
public final class BluetoothDevice implements Parcelable, Attributable {
     ...
     *
     * <p>This API only sets a preference. The caller is responsible for changing the audio input
     * routing to reflect the preference.
     *
     ...
     *
     * <p>This method returns the configured preference for whether this device should be the
     * preferred microphone for calls. It does not reflect the current audio routing.
     *
