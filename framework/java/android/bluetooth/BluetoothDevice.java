...
public final class BluetoothDevice implements Parcelable, Attributable {
     ...
     *
     * <p>Always contains the extra field {@link #EXTRA_SECURE_CONNECTIONS}
     *
     ...
     * keys used to enable encryption are from "Secure Connections" mode
     */
    @FlaggedApi(Flags.FLAG_ENCRYPTION_CHANGE_BROADCAST)
    @SuppressLint("ActionValue")
    public static final String EXTRA_SECURE_CONNECTIONS =
            "android.bluetooth.device.extra.SECURE_CONNECTIONS";
