...
public final class BluetoothDevice implements Parcelable, Attributable {
     ...
     *
     * <p>The Bundle can contain the following key-value pairs:
     *
     * <ul>
     *   <li>{@link #IDENTITY_ADDRESS}: The identity address (e.g., "00:11:22:AA:BB:CC").
     *   <li>{@link #IDENTITY_ADDRESS_TYPE}: The identity address type, which is one of:
     *       <ul>
     *         <li>{@link #ADDRESS_TYPE_PUBLIC}
     *         <li>{@link #ADDRESS_TYPE_RANDOM}
     *         <li>{@link #ADDRESS_TYPE_UNKNOWN}
     *       </ul>
     * </ul>
     *
