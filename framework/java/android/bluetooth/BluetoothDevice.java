...
public final class BluetoothDevice implements Parcelable, Attributable {
    ...
    */
     ...
     * Indicates that an ASHA device should be hidden from users because
     * for backward compatibility, ASHA requires each hearing aid to advertise as discoverable,
     * but CSIP requires follower devices of a set to advertise as non-discoverable.
     * This field helps ASHA and CSIP both supported devices to show up properly in pairing.
     * See Bluetooth CSIP specification for more details.
     *
     * @hide
     */
