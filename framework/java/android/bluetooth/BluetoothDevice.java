...
public final class BluetoothDevice implements Parcelable, Attributable {
     ...
     * for encryption.
     *
     * <p>Possible values are: {@link #ENCRPTION_ALGORITHM_NONE}, {@link #ENCRPTION_ALGORITHM_E0},
     * {@link #ENCRPTION_ALGORITHM_AES}.
     */
    @FlaggedApi(Flags.FLAG_ENCRYPTION_CHANGE_BROADCAST)
    @SuppressLint("ActionValue")ACTION_ENCRYPTION_CHANGE
    ...
    @FlaggedApi(Flags.FLAG_ENCRYPTION_CHANGE_BROADCAST)
    public static final int ENCRPTION_ALGORITHM_NONE = 0;

    /** Indicates link was encrypted using E0 algorithm */
    @FlaggedApi(Flags.FLAG_ENCRYPTION_CHANGE_BROADCAST)
    public static final int ENCRPTION_ALGORITHM_E0 = 1;

    /** Indicates link was encrypted using AES algorithm */
    @FlaggedApi(Flags.FLAG_ENCRYPTION_CHANGE_BROADCAST)
    public static final int ENCRPTION_ALGORITHM_AES = 2;
    ...
    /**
     * Used as an boolean extra field in {@link #ACTION_ENCRYPTION_CHANGE} intent. false mean
