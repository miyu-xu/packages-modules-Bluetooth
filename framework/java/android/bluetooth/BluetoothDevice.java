    ...
    */
    ...
    public BluetoothGatt connectGatt(Context context, boolean autoConnect,
        ...
        return connectGatt(context, autoConnect, transport, phy,
                BluetoothGatt.CONNECTION_PRIORITY_BALANCED, handler, callback);
    }
    ...
    public BluetoothGatt connectGatt(@NonNull Context context, boolean autoConnect,
            int transport, int phy, int connectionPriority, @Nullable Handler handler,
    ...
    public BluetoothGatt connectGatt(Context context, boolean autoConnect,
            BluetoothGattCallback callback, int transport,
            boolean opportunistic, int phy, int connectionPriority, Handler handler) {
        if (callback == null) {
