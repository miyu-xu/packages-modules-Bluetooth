...
public final class BluetoothDevice implements Parcelable, Attributable {
     ...
     * If The request is to create BluetoothSocket#TYPE_RFCOMM, It is must to provice the uuid
     * using BluetoothSocketSettings#setUuid().
     * If the request is to create BluetoothSocket#TYPE_L2CAP_LE, It is must to proide channel (psm)
     * value using BluetoothSocketSettings#setChannel().
    ...
    public @NonNull BluetoothSocket createClientSocket(@NonNull BluetoothSocketSettings settings)
        ...
        if (settings.getSocketType() == BluetoothSocket.TYPE_RFCOMM) {
            if (settings.getUuid() == null) {
                Log.e(TAG, "createClientSocket: Invalid Uuid");
            ...
            if (settings.getChannel() < 0) {
                Log.e(TAG, "createClientSocket: Invalid PSM");
        ...
        return new BluetoothSocket(
                ...
                this,
                psm,
                (uuid == null) ? null : new ParcelUuid(uuid));
    }
