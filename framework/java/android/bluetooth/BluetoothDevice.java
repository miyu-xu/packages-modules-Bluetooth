    ...
    */
    ...
    @IntDef(
        ...
        value = {
            ...
            BluetoothAudioPolicy.REMOTE_STATUS_UNKNOWN,
            /** Remote support status of audio policy feature is supported **/
            BluetoothAudioPolicy.REMOTE_STATUS_SUPPORTED,
            /** Remote support status of audio policy feature is not supported **/
            BluetoothAudioPolicy.REMOTE_STATUS_NOT_SUPPORTED,
        }
    )
     ...
     * {@link BluetoothAudioPolicy#REMOTE_STATUS_UNKNOWN} to indicate the remote
     * device has not yet relayed this information. After the internal configuration,
     * the support status will be set to either
     * {@link BluetoothAudioPolicy#REMOTE_STATUS_NOT_SUPPORTED} or
     * {@link BluetoothAudioPolicy#REMOTE_STATUS_SUPPORTED}.
     ...
     * {@link BluetoothAudioPolicy#REMOTE_STATUS_SUPPORTED} response from this API.
     *
    ...
    public @AudioPolicyRemoteSupport int getAudioPolicyRemoteSupported() {
        ...
        final IBluetooth service = getService();
        final int defaultValue = BluetoothAudioPolicy.REMOTE_STATUS_UNKNOWN;
        if (service == null || !isBluetoothEnabled()) {
