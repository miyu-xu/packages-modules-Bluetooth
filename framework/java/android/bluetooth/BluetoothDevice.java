...
public final class BluetoothDevice implements Parcelable, Attributable {
    ...
    */
    ...
    static final long CHANGE_TO_STRING_REDACTED = 265103382L;
     ...
     * <p> Currently this returns the MAC address of the device redacted by
     * replacing the hexadecimal digits of leftmost 4 bytes with "XX", e.g.,
     * "XX:XX:XX:XX:12:34".
     * Before {@link android.os.Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
     * the MAC address was returned as it is (without redaction).
     *
     * Warning: The return value of {@link #toString()} may change in
     * the future. It is intended to be used in logging statements.
     * Thus apps should never rely on the return value of {@link #toString()}
     * in their logic, always use other appropriate APIs instead. E.g.,
     * if the MAC address is needed, {@link #getAddress()} should be used.
     *
