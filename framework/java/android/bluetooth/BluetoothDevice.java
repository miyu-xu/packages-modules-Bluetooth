...
public final class BluetoothDevice implements Parcelable, Attributable {
    ...
    @Retention(RetentionPolicy.SOURCE)
    public @interface SetMicrophoneForCallEnabledReturnValues {}
     ...
     * @return whether microphone for call enable status was set properly
    ...
    @RequiresBluetoothConnectPermission
    @RequiresPermission(allOf = {BLUETOOTH_CONNECT, BLUETOOTH_PRIVILEGED})
    public @setMicrophoneForCallEnabledReturnValues int setMicrophoneForCallEnabled(
            boolean enabled) {
    ...
    public boolean isMicrophoneForCallEnabled() {
        ...
        if (service == null || !isBluetoothEnabled()) {
            ...
            try {
                return service.isMicrophoneForCallEnabled(this, mAttributionSource);
            } catch (RemoteException e) {
                Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
            }
        }
