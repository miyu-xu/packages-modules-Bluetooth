...
public final class BluetoothLeBroadcastMetadata implements Parcelable {
    ...
    @SystemApi
    @NonNull
    public static final Parcelable.Creator<BluetoothLeBroadcastMetadata> CREATOR =
            new Parcelable.Creator<BluetoothLeBroadcastMetadata>() {
                @NonNull
                public BluetoothLeBroadcastMetadata createFromParcel(@NonNull Parcel in) {
    ...
    public static final class Builder {
        ...
        @SystemApi
        @NonNull
        public Builder setSourceDevice(@Nullable BluetoothDevice sourceDevice,
        ...
        @SystemApi
        @NonNull
        public Builder addSubgroup(@NonNull BluetoothLeBroadcastSubgroup subgroup) {
