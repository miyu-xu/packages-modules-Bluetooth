...
public final class BluetoothLeAudioContentMetadata implements Parcelable {
    ...
    @SystemApi
    @NonNull
    public static final Parcelable.Creator<BluetoothLeAudioContentMetadata> CREATOR =
            new Parcelable.Creator<BluetoothLeAudioContentMetadata>() {
                @NonNull
                public BluetoothLeAudioContentMetadata createFromParcel(@NonNull Parcel in) {
    ...
    @SystemApi
    @NonNull
    public static BluetoothLeAudioContentMetadata fromRawBytes(@NonNull byte[] rawBytes) {
        if (rawBytes == null) {
    ...
    public static final class Builder {
         ...
         * Get the title and/or summary of Audio Stream content in UTF-8 format
         *
         * @return title and/or summary of Audio Stream content in UTF-8 format, null if this
         * metadata does not exist
         * @hide
         */
        @SystemApi
        @NonNull
        public Builder setProgramInfo(@Nullable String programInfo) {
            mProgramInfo = programInfo;
            return this;
        }
