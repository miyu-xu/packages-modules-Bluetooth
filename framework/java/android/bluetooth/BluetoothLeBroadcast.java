...
public final class BluetoothLeBroadcast implements BluetoothProfile {
    ...
    public interface Callback {
         ...
         */
        @SystemApi
        int REASON_LOCAL_STACK_REQUEST = 2;
         ...
         */
        @SystemApi
        int REASON_NO_MORE_BROADCAST_SLOT = 5;
         ...
         */
        @SystemApi
        int REASON_UPDATED_METADATA_IS_THE_SAME = 10;
         ...
         */
        @SystemApi
        int REASON_INVALID_BROADCAST_ID = 11;
         ...
         */
        @SystemApi
        int REASON_BAD_PARAMETER_OTHER = 12;
