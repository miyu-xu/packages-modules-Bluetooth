...
public final class BluetoothLeBroadcast implements AutoCloseable, BluetoothProfile {
    ...
    public void startBroadcast(@NonNull BluetoothLeAudioContentMetadata contentMetadata,
        ...
        if (service == null) {
            ...
            try {
                service.startBroadcast(convertMetadataToSettings(contentMetadata, broadcastCode),
                        mAttributionSource);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        ...
        if (service == null) {
            ...
            try {
                service.updateBroadcast(broadcastId,
                        convertMetadataToSettings(contentMetadata, null),
                        mAttributionSource);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
    ...
    private BluetoothLeBroadcastSettings convertMetadataToSettings(
