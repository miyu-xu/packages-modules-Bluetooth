...
public final class BluetoothAudioPolicy implements Parcelable {
    ...
    */
    ...
    @AudioPolicyValues private final int mInBandRingPolicy;

    /**
     * @hide
     */
    public BluetoothAudioPolicy(int callEstablishPolicy,
            int connectDuringCallPolicy, int inBandRingPolicy) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mCallEstablishPolicy, mConnectDuringCallPolicy, mInBandRingPolicy);
    }
    ...
    public static final class Builder {
        ...
        private int mInBandRingPolicy = POLICY_DEFAULT;
        ...
        private Builder(BluetoothAudioPolicy policies) {
            ...
            mInBandRingPolicy = policies.mInBandRingPolicy;
        }
         ...
         */
        public @NonNull Builder setCallEstablishPolicy(int callEstablishPolicy) {
            mCallEstablishPolicy = callEstablishPolicy;
            return this;
        }
         ...
         * @return reference to the current object
         */
        public @NonNull Builder setConnectDuringCallPolicy(int connectDuringCallPolicy) {
            mConnectDuringCallPolicy = connectDuringCallPolicy;
            return this;
        }
         ...
         *
         */
        public @NonNull Builder setInBandRingPolicy(int inBandRingPolicy) {
            mInBandRingPolicy = inBandRingPolicy;
            return this;
        }
        ...
        public @NonNull BluetoothAudioPolicy build() {
            return new BluetoothAudioPolicy(
                    mCallEstablishPolicy, mConnectDuringCallPolicy, mInBandRingPolicy);
        }
    }
}
