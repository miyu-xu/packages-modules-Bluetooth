...
public final class BluetoothAudioPolicy implements Parcelable {
    ...
    */
    ...
    /**
     * Hfp audio behavior not configured for the policy.
     *
    ...
    /**
     * Hfp audio is preferred by HF device for the policy.
     *
     ...
     * policy is set with this value, then the HF will prefer the Hfp audio
    ...
    /**
     * Hfp audio is not preferred by HF device for the policy.
     *
     *
     * If a policy is set with this value, then the HF device will not prefer the
     * audio for the policy use case. For example, if the Call Establish audio
     * policy is set with this value, then the HF will not prefer the Hfp audio
     * during making or picking up a call.
     * @hide
     */
    @SystemApi
    ...
    public static final class Builder {
         ...
         * makes or answers a call, is the audio prefered by HF should be decided
         * by this policy.
         *
