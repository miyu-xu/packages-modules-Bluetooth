...
public final class BluetoothAudioPolicy implements Parcelable {
    ...
    */
    ...
    @AudioPolicyValues private int mCallEstablishPolicy;
    ...
    public BluetoothAudioPolicy() {
        mCallEstablishPolicy = POLICY_DEFAULT;
     ...
     *
     */
    public @NonNull BluetoothAudioPolicy setCallEstablishPolicy(int callEstablishPolicy) {
        mCallEstablishPolicy = callEstablishPolicy;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mCallEstablishPolicy, mConnectingPolicy, mInBandRingPolicy);
    }
}
