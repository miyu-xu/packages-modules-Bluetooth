...
public final class BluetoothAudioPolicy implements Parcelable {
    ...
    */
    ...
    @AudioPolicyValues private final int mConnectDuringCallPolicy;
    ...
    public BluetoothAudioPolicy(int callEstablishPolicy,
            int connectDuringCallPolicy, int inBandRingtonePolicy) {
     ...
     *
     */
    public @AudioPolicyValues int getConnectDuringCallPolicy() {
        return mConnectDuringCallPolicy;
    }
    ...
    public String toString() {
        ...
        builder.append(mCallEstablishPolicy);
        builder.append(", mConnectDuringCallPolicy: ");
        builder.append(mConnectDuringCallPolicy);
    ...
    public void writeToParcel(@NonNull Parcel out, int flags) {
        ...
        out.writeInt(mConnectDuringCallPolicy);
    ...
    public boolean equals(@Nullable Object o) {
        if (o instanceof BluetoothAudioPolicy) {
            ...
            return (other.mCallEstablishPolicy == mCallEstablishPolicy
                    && other.mConnectDuringCallPolicy == mConnectDuringCallPolicy
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mCallEstablishPolicy, mConnectDuringCallPolicy, mInBandRingtonePolicy);
    }

    /**
     * Returns a builder initialized with the current contents of this object.
     *
     */
     ...
     * {@link BluetoothAudioPolicy#POLICY_DEFAULT}.
     */
    public static final class Builder {
        private int mCallEstablishPolicy = POLICY_DEFAULT;
        private int mConnectDuringCallPolicy = POLICY_DEFAULT;
        private int mInBandRingtonePolicy = POLICY_DEFAULT;

        public Builder() {

        }

        private Builder(BluetoothAudioPolicy policies) {
            mCallEstablishPolicy = policies.mCallEstablishPolicy;
            mConnectDuringCallPolicy = policies.mConnectDuringCallPolicy;
         ...
         * HF device when it makes or answers a call. That is, if this device
         * makes or answers a call, does it prefer the call audio to be routed
         * to it immediately.
         *
         ...
         * <p>This policy is used to determine the audio preference when the
         * HF device connects with the AG device during a call. That is, if the
         * HF device gets connected in the middle of a call, does it prefer
         * the call audio to be routed to it immediately.
         *
         * @return reference to the current object
         */
        public @NonNull Builder setConnectDuringCallPolicy(
                @AudioPolicyValues int connectDuringCallPolicy) {
            mConnectDuringCallPolicy = connectDuringCallPolicy;
            return this;
        }
         ...
         * in band ringtone. That is, if there is an incoming call, does it
         * prefer an in band ringtone routed to it.
         *
         * @return reference to the current object
         *
         */
        ...
        public @NonNull BluetoothAudioPolicy build() {
            return new BluetoothAudioPolicy(
                    mCallEstablishPolicy, mConnectDuringCallPolicy, mInBandRingtonePolicy);
        }
    }
}
