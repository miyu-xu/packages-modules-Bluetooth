...
public final class BluetoothLeBroadcastSettings implements Parcelable {
    ...
    public static final class Builder {
         ...
         * @throws IllegalArgumentException if name length is non-null and less than 4 characters
         * or greater than 32 characters
         * @return this builder
         * @hide
         */
        @SystemApi
         ...
         * @throws IllegalArgumentException if code length is non-null and less than 4 characters
