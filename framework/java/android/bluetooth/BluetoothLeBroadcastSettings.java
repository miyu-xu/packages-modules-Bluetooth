...
public final class BluetoothLeBroadcastSettings implements Parcelable {
    ...
    /**
     * Return the broadcast code for this broadcast source
     *
     * @hide
     */
    @SystemApi
    ...
    /**
     * Get available subgroup settings in the broadcast device.
     *
     * @return list of subgroup settings in the broadcast device
     * @hide
     */
    @SystemApi
    ...
    public static final class Builder {
        ...
        /**
         * Add a subgroup settings to the broadcast source.
         *
         * @param subgroupSettings {@link BluetoothLeBroadcastSubgroupSettings} that contains a
         *     subgroup's setting data
         * @return this builder
         * @hide
         */
        @SystemApi
        ...
        public Builder addSubgroupSettings(
            ...
            mSubgroups.add(subgroupSettings);
            return this;
        }
