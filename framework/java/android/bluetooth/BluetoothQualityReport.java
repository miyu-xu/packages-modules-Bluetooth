...
public final class BluetoothQualityReport implements Parcelable {
    ...
    public static final class BqrRfStats implements Parcelable {
        ...
        /**
         * Get the Packet counter of RSSI chain larger then -50 dBm
         *
         * @return the packet counter of RSSI chain larger then -50 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -50 dBm to -55 dBm
         *
         * @return the packet counter of RSSI chain between -50 dBm to -55 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -55 dBm to -60 dBm
         *
         * @return the packet counter of RSSI chain between -55 dBm to -60 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -60 dBm to -65 dBm
         *
         * @return the packet counter of RSSI chain between -60 dBm to -65 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -65 dBm to -70 dBm
         *
         * @return the packet counter of RSSI chain between -65 dBm to -70 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -70 dBm to -75 dBm
         *
         * @return the packet counter of RSSI chain between -70 dBm to -75 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -75 dBm to -80 dBm
         *
         * @return the packet counter of RSSI chain between -75 dBm to -80 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -80 dBm to -85 dBm
         *
         * @return the packet counter of RSSI chain between -80 dBm to -85 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -85 dBm to -90 dBm
         *
         * @return the packet counter of RSSI chain between -85 dBm to -90 dBm
         * @hide
         */
        @SystemApi
