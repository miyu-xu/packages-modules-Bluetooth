...
public final class BluetoothQualityReport implements Parcelable {
    ...
    public static final class BqrCommon implements Parcelable {
        ...
        /**
         * Get the number of CIS Data PDUs transmitted by the Link Layer in the last subevent of a
         * CIS event.
         *
         * @return the number of CIS Data PDUs transmitted in the last subevent subevent
         * @hide
         */
        @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
        @SystemApi
        ...
        /**
         * Get the number of received packets with CRC error since the last event.
         *
         * @return the number of received packets with CRC error since the last event
         * @hide
         */
        @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
        @SystemApi
        ...
        /**
         * Get the number of duplicate (retransmission) packets received since the last event.
         * event.
         *
         * @return the number of duplicate (retransmission) packets received
         * @hide
         */
        @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
        @SystemApi
        ...
        /**
         * Get the number of unreceived packets. This value corresponds to the parameter of the LE
         ...
         *
         * @return the Coex Information Mask value
         * @hide
         */
        @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
        @SystemApi
    ...
    public static final class BqrEnergyMonitor implements Parcelable {
         ...
         *
         * @return the total time in the active state (milliseconds)
         * @hide
         */
        @SystemApi
    ...
    public static final class BqrRfStats implements Parcelable {
        ...
        /**
         * Get the Packet counter of RSSI chain larger than -50 dBm
         *
         * @return the packet counter of RSSI chain larger than -50 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -50 dBm and -55 dBm
         *
         * @return the packet counter of RSSI chain between -50 dBm and -55 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -55 dBm and -60 dBm
         *
         * @return the packet counter of RSSI chain between -55 dBm and -60 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -60 dBm and -65 dBm
         *
         * @return the packet counter of RSSI chain between -60 dBm and -65 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -65 dBm and -70 dBm
         *
         * @return the packet counter of RSSI chain between -65 dBm and -70 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -70 dBm and -75 dBm
         *
         * @return the packet counter of RSSI chain between -70 dBm and -75 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -75 dBm and -80 dBm
         *
         * @return the packet counter of RSSI chain between -75 dBm and -80 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -80 dBm and -85 dBm
         *
         * @return the packet counter of RSSI chain between -80 dBm and -85 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI chain between -85 dBm and -90 dBm
         *
         * @return the packet counter of RSSI chain between -85 dBm and -90 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of the RSSI chain are smaller than -90 dBm
         *
         * @return the packet counter of RSSI chain are smaller than -90 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI delta are smaller than 2 dBm
         *
         * @return the packet counter of RSSI delta are smaller than 2 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI delta between 2 dBm and 5 dBm
         *
         * @return the packet counter of RSSI delta between 2 dBm and 5 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI delta between 5 dBm and 8 dBm
         *
         * @return the packet counter of RSSI delta between 5 dBm and 8 dBm
         * @hide
         */
        @SystemApi
        ...
        /**
         * Get the Packet counter of RSSI delta between 8 dBm and 11 dBm
         *
         * @return the packet counter of RSSI delta between 8 dBm and 11 dBm
         * @hide
         */
        @SystemApi
