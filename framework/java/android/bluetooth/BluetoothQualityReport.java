 ...
 *   <li>For Energy monitor event, you can call call {@link #getBqrEvent} to get a {@link
 *       BluetoothQualityReport.BqrEnergyMonitor} object.
 *   <li>For RF stats event, you can call call {@link #getBqrEvent} to get a {@link
...
public final class BluetoothQualityReport implements Parcelable {
    ...
    public static final class BqrCommon implements Parcelable {
        ...
        private BqrCommon(byte[] rawData, int offset) {
            ...
            int id = rawData[0] & 0xFF;
            if ((id == QUALITY_REPORT_ID_ENERGY_MONITOR) || (id == QUALITY_REPORT_ID_RF_STATS)) {
                mQualityReportId = id;
                return;
            }
