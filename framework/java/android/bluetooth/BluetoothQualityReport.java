...
public final class BluetoothQualityReport implements Parcelable {
     ...
     *
     * @return One of possible objects:
     * {@link BluetoothQualityReport.BqrCommon} object or null if report id is not
     *     {@link #QUALITY_REPORT_ID_MONITOR}.
     * {@link BluetoothQualityReport.BqrVsLsto} object or null if report id is not
     *     {@link #QUALITY_REPORT_ID_APPROACH_LSTO}.
     * {@link BluetoothQualityReport.BqrVsA2dpChoppy} object or null if report id is not
     *     {@link #QUALITY_REPORT_ID_A2DP_CHOPPY}.
     * {@link BluetoothQualityReport.BqrVsScoChoppy} object or null if report id is not
     *     {@link #QUALITY_REPORT_ID_SCO_CHOPPY}.
     * {@link BluetoothQualityReport.BqrConnectFail} object or null if report id is not
