...
/**
 * This class provides the public APIs to access the data of BQR event reported from firmware side.
 ...
 *       BluetoothQualityReport.BqrCommon} object, and call {@link #getBqrVsCommon} to get a {@link
 *       BluetoothQualityReport.BqrVsCommon} object, and call {@link #getBqrVsConnectFail} to get a
 *       {@link BluetoothQualityReport.BqrVsConnectFail} object.
 * </ul>
 *
 */
public final class BluetoothQualityReport implements Parcelable {
     ...
     *
     * @return the id, is one of {@link #QUALITY_REPORT_ID_MONITOR}, {@link
     *     #QUALITY_REPORT_ID_APPROACH_LSTO}, {@link #QUALITY_REPORT_ID_A2DP_CHOPPY}, {@link
     *     #QUALITY_REPORT_ID_SCO_CHOPPY}, {@link #QUALITY_REPORT_ID_CONN_FAIL}.
     */
     ...
     */
    public @NonNull String getQualityReportIdStr() {
        int id = mBqrCommon.getQualityReportId();
        switch (id) {
     ...
     *
     * @return the {@link BluetoothQualityReport.BqrVsConnectFail} object or null if report id is
     *     not {@link #QUALITY_REPORT_ID_CONN_FAIL}.
     */
    public @Nullable BqrVsConnectFail getBqrVsConnectFail() {
        return mBqrVsConnectFail;
    }

    public static final @NonNull Parcelable.Creator<BluetoothQualityReport>
            CREATOR = new Parcelable.Creator<BluetoothQualityReport>() {
    ...
    public String toString() {
        ...
        str =
                "BQR: {\n"
                        ...
                        + mName
                        + ", mBluetoothClass: "
                        + String.format("0x%X", mBluetoothClass)
                        + ",\n"
                        + mBqrCommon
                        + "\n"
                        + mBqrVsCommon
    ...
    public static final class BqrCommon implements Parcelable {
         ...
         */
        public @Nullable String getPacketTypeStr() {
        ...
        public static final @NonNull Parcelable.Creator<BqrCommon>
                CREATOR = new Parcelable.Creator<BqrCommon>() {
    ...
    /**
     * This class provides the public APIs to access the vendor specific common part of BQR event.
     */
    public static final class BqrVsCommon implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<BqrVsCommon>
                CREATOR = new Parcelable.Creator<BqrVsCommon>() {
    ...
    /**
     * This class provides the public APIs to access the vendor specific part of Approaching LSTO
     * event.
     */
    public static final class BqrVsLsto implements Parcelable {
         ...
         */
        public @Nullable String getConnStateStr() {
        ...
        public static final @NonNull Parcelable.Creator<BqrVsLsto>
                CREATOR = new Parcelable.Creator<BqrVsLsto>() {
    ...
    /**
     * This class provides the public APIs to access the vendor specific part of A2dp choppy event.
     */
    public static final class BqrVsA2dpChoppy implements Parcelable {
         ...
         */
        public @Nullable String getLinkQualityStr() {
        ...
        public static final @NonNull Parcelable.Creator<BqrVsA2dpChoppy>
                CREATOR = new Parcelable.Creator<BqrVsA2dpChoppy>() {
    ...
    /**
     * This class provides the public APIs to access the vendor specific part of SCO choppy event.
     */
    public static final class BqrVsScoChoppy implements Parcelable {
         ...
         */
        public @Nullable String getAirFormatStr() {
        ...
        public static final @NonNull Parcelable.Creator<BqrVsScoChoppy>
                CREATOR = new Parcelable.Creator<BqrVsScoChoppy>() {
    ...
    /**
     * This class provides the public APIs to access the vendor specific part of Connect fail event.
     */
    public static final class BqrVsConnectFail implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<BqrVsConnectFail>
                CREATOR = new Parcelable.Creator<BqrVsConnectFail>() {
                        public BqrVsConnectFail createFromParcel(Parcel in) {
                                return new BqrVsConnectFail(in);
                        }

                        public BqrVsConnectFail[] newArray(int size) {
                                return new BqrVsConnectFail[size];
                        }
                };
        ...
        * @return the string of the id.
        */
        public @NonNull String getConnectFailIdStr(int id) {
            switch (id) {
        ...
        public String toString() {
            ...
            str =
                    "  BqrVsConnectFail: {\n"
                            + "    mFailReason: "
                            + getConnectFailIdStr(mFailReason)
                            + " ("
