...
public final class BluetoothQualityReport implements Parcelable {
    ...
    /**
     * This class provides the System APIs to access the Energy Monitoring event.
     *
     * @hide
     */
    @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
    ...
    public static final class BqrEnergyMonitor implements Parcelable {
         ...
         * microamps.
         *
         * @return average current consumption in microamps
         * @hide
         */
        @SystemApi
    ...
    /**
     * This class provides the System APIs to access the RF Stats event.
     *
     * @hide
     */
    @FlaggedApi(Flags.FLAG_SUPPORT_BLUETOOTH_QUALITY_REPORT_V6)
    ...
    public static final class BqrRfStats implements Parcelable {
        ...
        /**
         * Gets the time period over which performance information has been collected in
         * milliseconds.
         *
         * @return the time period for performance data collection in milliseconds
         * @hide
         */
        @SystemApi
