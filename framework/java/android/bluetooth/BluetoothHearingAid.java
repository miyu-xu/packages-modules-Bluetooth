...
public final class BluetoothHearingAid implements BluetoothProfile {
    ...
    /**
     * Check whether the device has ASHA advertisement service data .
     *
    ...
    public boolean hasAshaAdvertisementServiceData(@NonNull BluetoothDevice device) {
        return getAshaCapability(device) != 0;
    }

    /**
     * Get ASHA device's capability from its advertisement service data.
     * Value 0 means there is no capability data.
     *
     * @param device discovered Bluetooth device
     * @return ASHA device's capability
     * @hide
    ...
    /**
     * Get ASHA device's truncated HiSyncID if {@link #hasAshaServiceData} is true.
     *
     * @param device discovered Bluetooth device
