...
public class BluetoothSocketException extends IOException {
    ...
    private static final String UNSPECIFIED_MSG = "A Bluetooth Socket failure occured";
    ...
    /**
     * Create a {@link BluetoothSocketException} with a {@link Code} and custom error message.
     *
     * @param code : Error code representing the reason for failure.
     * @param msg : Custom error message associated to the failure.
     */
    public BluetoothSocketException(@BluetoothSocketExceptionCode int code, String msg) {
        super(msg);
        this.mCode = code;
    }

    /**
     * Create a {@link BluetoothSocketException} with an error {@link Code}. A generic error message
     * is generated based on the {@code code} provided.
     *
     * @param code : Error code representing the reason for failure.
     */
