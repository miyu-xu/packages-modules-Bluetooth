...
public class BluetoothLeAudioCodecConfigMetadata implements Parcelable {
     ...
     *
     * @return raw bytes of stream metadata in Bluetooth LTV format, null if this metadata does not
     * exist
     */
    @SystemApi
    @Nullable
     ...
     */
    @SystemApi
    public static final Parcelable.Creator<BluetoothLeAudioCodecConfigMetadata> CREATOR =
