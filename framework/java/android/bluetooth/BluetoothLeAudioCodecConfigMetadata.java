...
public final class BluetoothLeAudioCodecConfigMetadata implements Parcelable {
    ...
    private final @BluetoothLeAudioCodecConfig.SampleRate int mSampleRate;
    private final @BluetoothLeAudioCodecConfig.FrameDuration int mFrameDuration;
    ...
    private BluetoothLeAudioCodecConfigMetadata(long audioLocation,
            @BluetoothLeAudioCodecConfig.SampleRate int sampleRate,
            @BluetoothLeAudioCodecConfig.FrameDuration int frameDuration,
     ...
     */
    @SystemApi
    public @BluetoothLeAudioCodecConfig.SampleRate int getSampleRate() {
        return mSampleRate;
    }
     ...
     */
    @SystemApi
    public @BluetoothLeAudioCodecConfig.FrameDuration int getFrameDuration() {
    ...
    public static final class Builder {
        ...
        @SystemApi
        @NonNull
        public Builder setSampleRate(@BluetoothLeAudioCodecConfig.SampleRate int sampleRate) {
            if (sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_NONE
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_8000
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_16000
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_24000
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_32000
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_44100
                    && sampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_48000) {
        ...
        @SystemApi
        @NonNull
        public Builder setFrameDuration(@BluetoothLeAudioCodecConfig.FrameDuration
                int frameDuration) {
            if (frameDuration != BluetoothLeAudioCodecConfig.FRAME_DURATION_NONE
        ...
        public @NonNull BluetoothLeAudioCodecConfigMetadata build() {
            ...
            if (mSampleRate != BluetoothLeAudioCodecConfig.SAMPLE_RATE_NONE) {
            ...
            if (mFrameDuration != BluetoothLeAudioCodecConfig.FRAME_DURATION_NONE) {
