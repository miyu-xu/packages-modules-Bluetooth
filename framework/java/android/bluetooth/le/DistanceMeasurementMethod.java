...
import android.bluetooth.le.DistanceMeasurementParams.DistanceMeasurementMethodId;
...
public final class DistanceMeasurementMethod implements Parcelable {
    ...
    public static final class Builder {
         ...
         *
         * @param supported if azimuth angle supported or not
         *
         * @hide
         */
        @SystemApi
         ...
         *
         * @param supported if altitude angle supported or not
         *
         * @hide
         */
        @SystemApi
