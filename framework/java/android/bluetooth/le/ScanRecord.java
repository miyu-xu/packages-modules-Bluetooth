...
public final class ScanRecord {
                ...
                switch (fieldType) {
                    ...
                    case DATA_TYPE_TRANSPORT_DISCOVERY_DATA:
                        ...
                        byte[] transportDiscoveryDataBytes =
                                new byte[transportBlockBytes.length + 1];
                        transportDiscoveryDataBytes[0] = (byte) DATA_TYPE_TRANSPORT_DISCOVERY_DATA;
                        System.arraycopy(transportBlockBytes, 0, transportDiscoveryDataBytes, 1,
                                transportBlockBytes.length);
    ...
    public String toString() {
        return "ScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
                ...
                + BluetoothLeUtils.toString(mTransportDiscoveryData.toByteArray()) + "]";
    }
