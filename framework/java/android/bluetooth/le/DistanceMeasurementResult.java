...
public final class DistanceMeasurementResult implements Parcelable {
    ...
    /**
     * Get time of arrival of first channel sounding event , represented in mirco seconds
     *
     *
            ...
            new Parcelable.Creator<DistanceMeasurementResult>() {
                ...
                public @NonNull DistanceMeasurementResult createFromParcel(@NonNull Parcel in) {
                    return new Builder(in.readDouble(), in.readDouble())
                            ...
                            .setTimeInMicroSecond(in.readDouble())
                            .build();
                }
    ...
    public static final class Builder {
         ...
         * Valid range is -127 to +20
         *
         * @param mInitRSSI estimated rssi of the initiator device
         * @hide
         */
        @FlaggedApi(Flags.FLAG_CHANNEL_SOUNDING)
        @SystemApi
        @NonNull
        public Builder setInitiatorRSSI(double initRSSI) {
            mInitRSSI = initRSSI;
            return this;
        }
         ...
         * Valid range is -127 to +20
         *
         * @param mReflRSSI estimated rssi of the reflector device
         * @hide
         */
        @FlaggedApi(Flags.FLAG_CHANNEL_SOUNDING)
        @SystemApi
        @NonNull
        public Builder setReflectorRSSI(double reflRSSI) {
            mReflRSSI = reflRSSI;
            return this;
        }

        /**
         * set time of arrival of first channel sounding event , represented in mirco seconds
         *
         * @param mTimeUs estimated time
         * @hide
         */
        @FlaggedApi(Flags.FLAG_CHANNEL_SOUNDING)
        @SystemApi
        @NonNull
        public Builder setTimeInMicroSecond(double timeUs) {
            mTimeUs = timeUs;
            return this;
        }
