...
public final class ScanFilter implements Parcelable {
    ...
    public static final class Builder {
         ...
         * <p>
         * The {@code adDataMask} must have the same length of {@code adData}.
         *
         * @throws IllegalArgumentException If the {@code adType} is invalid, or {@code
         * adData} is null while {@code adDataMask} is not, or {@code
         * adData} and {@code adDataMask} have different length.
         */
        @NonNull
