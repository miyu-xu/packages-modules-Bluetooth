...
public final class ScanFilter implements Parcelable {
    ...
    */
    ...
    public static final class Builder {
         ...
         * @param wifiNanHash must be null for non WIFI_ALLIANCE_ORG_ID
         *  & must be 8 Octets for WIFI_ALLIANCE_ORG_ID
         *
        ...
        public @NonNull Builder setTransportDiscoveryData(int orgId, int tdsFlags,
            ...
            if ((orgId != WIFI_ALLIANCE_ORG_ID) && (wifiNanHash != null)) {
                throw new IllegalArgumentException(
                    "Wifi NAN Hash is not null for non-Wifi Org Id");
            }
            if ((orgId == WIFI_ALLIANCE_ORG_ID)
                && (wifiNanHash == null
                || (wifiNanHash != null
                && wifiNanHash.length != 8))) {
                throw new IllegalArgumentException(
                    "Wifi NAN Hash is null or length is not 8 octets for Wifi Org Id");
            }
            mOrgId = orgId;
            mTdsFlags = tdsFlags;
            mTdsFlagsMask = tdsFlagsMask;
