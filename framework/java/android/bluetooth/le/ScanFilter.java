...
public final class ScanFilter implements Parcelable {
    ...
    */
    ...
    public static final class Builder {
         ...
         * for WIFI_ALLIANCE_NAN_ORG_ID. {@code transportData} can be valid value OR {@code null}
         * for non WIFI_ALLIANCE_NAN_ORG_ID.
         * @param {@code transportDataMask} must be {@code null} for WIFI_ALLIANCE_NAN_ORG_ID.
         ...
         * @throws IllegalArgumentException, if {@code transportDataMask} is not {@code null} for
         ...
         * not equal to {@code transportDataMask} length for non WIFI_ALLIANCE_NAN_ORG_ID.
         *
         * @hide
         */
        @SystemApi
