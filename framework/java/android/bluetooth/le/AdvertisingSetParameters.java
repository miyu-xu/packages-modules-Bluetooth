...
public final class AdvertisingSetParameters implements Parcelable {
    ...
    /**
     * @return Advertising type for directed advertising
     * @hide
     */
    @FlaggedApi(Flags.FLAG_DIRECTED_ADVERTISING)
    @SystemApi
    ...
    public static final class Builder {
        ...
        private int mPeerAddressType;
        private int mDirectedAdvertisingType;
        ...
        @FlaggedApi(Flags.FLAG_DIRECTED_ADVERTISING)
        @SystemApi
        public @NonNull Builder setPeerAddressType(@PeerAddressType int peerAddressType) {
        ...
        /**
         * Set advertising type for directed advertising.
         *
         * @param directedAdvertisingType advertising type for the directed advertising
         * @throws IllegalArgumentException if {@code directedAdvertisingType} is invalid
         * @hide
         */
        @FlaggedApi(Flags.FLAG_DIRECTED_ADVERTISING)
        @SystemApi
        public @NonNull Builder setDirectedAdvertisingType(
