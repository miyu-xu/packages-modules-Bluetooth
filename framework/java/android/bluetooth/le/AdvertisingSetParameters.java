...
public final class AdvertisingSetParameters implements Parcelable {
     ...
     * @hide This API is intended for internal use only and is not yet ready for public release. It
    ...
    public static final class Builder {
         ...
         * @hide This API is intended for internal use only and is not yet ready for public release.
            ...
            if (mIsLegacy) {
                ...
                if (mIsDirected && !mConnectable) {
                    throw new IllegalStateException(
                            "Legacy directed advertising shall be connectable");
                }
