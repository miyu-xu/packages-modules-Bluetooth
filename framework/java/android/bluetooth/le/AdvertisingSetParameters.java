...
public final class AdvertisingSetParameters implements Parcelable {
    ...
    private AdvertisingSetParameters(boolean connectable, boolean discoverable, boolean scannable,
            boolean isLegacy, boolean isAnonymous, boolean includeTxPower, int primaryPhy,
            int secondaryPhy, int interval, int txPowerLevel,
     ...
     */
    public boolean isDiscoverable() { return mDiscoverable; }
    ...
    public String toString() {
        return "AdvertisingSetParameters [connectable=" + mConnectable + ", discoverable="
                + mDiscoverable + ", isLegacy=" + mIsLegacy + ", isAnonymous=" + mIsAnonymous
                + ", includeTxPower=" + mIncludeTxPower + ", primaryPhy=" + mPrimaryPhy
                + ", secondaryPhy=" + mSecondaryPhy + ", interval=" + mInterval
                + ", txPowerLevel=" + mTxPowerLevel + ", ownAddressType=" + mOwnAddressType + "]";
    }
    ...
    public static final class Builder {
         ...
         * By default, advertisements will be discoverable. Devices connecting to non-discoverable
        ...
        public AdvertisingSetParameters build() {
            ...
            return new AdvertisingSetParameters(mConnectable, mDiscoverable, mScannable, mIsLegacy,
                    mIsAnonymous, mIncludeTxPower, mPrimaryPhy, mSecondaryPhy, mInterval,
                    mTxPowerLevel, mOwnAddressType);
        }
    }
}
