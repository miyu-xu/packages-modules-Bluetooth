...
public final class AdvertiseData implements Parcelable {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(mServiceUuids, other.mServiceUuids)
                ...
                && java.util.Arrays.equals(
                        mEncryptedKeyMaterialValue, other.mEncryptedKeyMaterialValue);
    }
                ...
                public AdvertiseData createFromParcel(Parcel in) {
                    ...
                    for (int i = 0; i < manufacturerSize; ++i) {
                        ...
                        builder.addManufacturerData(
                                manufacturerId, manufacturerData, manufacturerDataEnc);
                    }
                    ...
                    builder.setIncludePublicBroadcastDeviceName(
                            (in.readByte() == 1), (in.readByte() == 1));
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder addServiceSolicitationUuid(
                @NonNull ParcelUuid serviceSolicitationUuid, boolean needEncryption) {
            if (serviceSolicitationUuid == null) {
                throw new IllegalArgumentException("serviceSolicitationUuid is null");
            }
        ...
        public Builder addServiceData(
                ParcelUuid serviceDataUuid, byte[] serviceData, boolean needEncryption) {
            if (serviceDataUuid == null || serviceData == null) {
                throw new IllegalArgumentException("serviceDataUuid or serviceDataUuid is null");
            }
        ...
        public Builder addManufacturerData(
                int manufacturerId, byte[] manufacturerSpecificData, boolean needEncryption) {
            if (manufacturerId < 0) {
                throw new IllegalArgumentException("invalid manufacturerId - " + manufacturerId);
            }
            if (manufacturerSpecificData == null) {
         ...
         */
        @NonNull
        public Builder setIncludePublicBroadcastDeviceName(
                boolean includeDeviceName, boolean needEncryption) {
        ...
        public Builder setEncryptedKeyMaterialValue(byte[] value) {
            if (value == null) {
                throw new IllegalArgumentException(" Encrypted Data Key Material value is null");
            }
