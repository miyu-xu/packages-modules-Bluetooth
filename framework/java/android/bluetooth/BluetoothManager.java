...
public final class BluetoothManager {
    ...
    public BluetoothGattServer openGattServer(
        ...
        if (Flags.gattServerAddHandlerToRunCallbacksOn()) {
            return openGattServer(context, BluetoothDevice.TRANSPORT_AUTO, false, null, callback);
        } else {
            Executor directExecutor = Runnable::run;
            return openGattServer(
                    context, BluetoothDevice.TRANSPORT_AUTO, false, directExecutor, callback);
        }
    }
    ...
    public BluetoothGattServer openGattServer(
        ...
        if (executor == null) {
            Log.d(TAG, "Null executor is passed. Using main executor.");
