...
public final class BluetoothLeBroadcastAssistant implements BluetoothProfile, AutoCloseable {
    ...
    public interface Callback {
         ...
         * client can know that the source notified by
         * {@link Callback#onSourceFound(BluetoothLeBroadcastMetadata)} before is not available any more
         * after this callback.
         *
         * @param broadcastId broadcast ID as defined in the BASS specification
         * @hide
         */
        @FlaggedApi("com.android.bluetooth.flags.lea_broadcast_monitor_source_sync_status")
        @SystemApi
