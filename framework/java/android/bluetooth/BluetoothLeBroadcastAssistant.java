...
public final class BluetoothLeBroadcastAssistant implements BluetoothProfile {
    ...
    interface Callback {
        ...
        @IntDef(prefix = "REASON_",
                value = {
                        ...
                        REASON_DUPLICATE_ADDITION,
                        REASON_BAD_PARAMETERS,
                        REASON_BASS_LINK_ERROR,
                        REASON_NO_EMPTY_SLOT,
                        REASON_INVALID_SOURCE_ID,
                        REASON_OPERATION_REJECTED,
                        REASON_SEARCH_ALREADY_STARTED,
                        REASON_SEARCH_ALREADY_STOPPED
        })
        @interface Reason {}
         ...
         * management policy, permissions, and more.
         * @hide
         */
        @SystemApi
         ...
         */
        @SystemApi
        int REASON_DUPLICATE_ADDITION = 4;

        /**
         * Indicates that bad parameters was given to the Broadcast Assistant apis
         * @hide
         */
        @SystemApi
        int REASON_BAD_PARAMETERS = 5;

        /**
         * Indicates that there is an underlying link error between the Broadcast Assistant
         * and Broadcast Sink. Maybe try again later or disconnect and retry.
         * @hide
         */
        @SystemApi
        int REASON_BASS_LINK_ERROR = 6;

        /**
         * Indicates that too many sources was added to Broadcast sink
         *
         * Check the capacity of Broadcast sink via
         ...
         * in {@link #onSourceAdded(BluetoothDevice, int, int)} callback, but will be updated via
         * {@link #onReceiveStateChanged(BluetoothDevice, int, BluetoothLeBroadcastReceiveState)}
         * @hide
         */
        @SystemApi
        int REASON_NO_EMPTY_SLOT = 7;

        /**
         * Indicates that the source ID is invalid for the given Broadcast sink device
         *
         * In the removal case, the source ID could have already been removed earlier
         *
         * @hide
         */
        @SystemApi
        int REASON_INVALID_SOURCE_ID = 8;

        /**
         * Indicates that Broadcast Sink rejected this operation for reasons not covered above
         * @hide
         */
        @SystemApi
        int REASON_OPERATION_REJECTED = 9;

        /**
         * Indicates that this update is initiated by the Broadcast Sink for reasons not transparent
         * to this Broadcast Assistant
         * @hide
         */
        @SystemApi
        int REASON_REMOTE_REQUEST = 10;

        /**
         * Indicate that search for nearby Broadcast Sources has already started
         * @hide
         */
        @SystemApi
        int REASON_SEARCH_ALREADY_STARTED = 11;

        /**
         * Indicate that search for nearby Broadcast Sources has already stopped
         * @hide
         */
        @SystemApi
        int REASON_SEARCH_ALREADY_STOPPED = 12;
         ...
         */
        @SystemApi
        void onSourceAddFailed(BluetoothDevice sink, BluetoothLeBroadcastMetadata source,
                @Reason int reason);
     ...
     * {@link BluetoothProfile#CONNECTION_POLICY_FORBIDDEN} if you do not want the Broadcas Sink
     ...
     * {@link Callback#REASON_LOCAL_APP_REQUEST}. However, this callback only indicates that the
     * Broadcast Sink has allocated resource to receive audio from the Broadcast Source, and audio
     * stream may not have started. The caller should then wait for
     * {@link Callback#onReceiveStateChanged(BluetoothDevice, int,
     * BluetoothLeBroadcastReceiveState)}
     ...
     * removed from the <var>sink</var> by any Broadcast role (could be another remote deivce).
     *
     ...
     * with reason code {@link Callback#REASON_LOCAL_APP_REQUEST}.
     *
