...
public final class BluetoothHapClient implements BluetoothProfile, AutoCloseable {
    ...
    public void registerCallback(@NonNull @CallbackExecutor Executor executor,
        ...
        IBluetoothHapClientCallback delegate =
                new BluetoothHapClientCallbackDelegate(executor, callback);
        try {
            service.registerCallback(delegate, mAttributionSource);
    ...
    public void unregisterCallback(@NonNull Callback callback) {
        ...
        try {
            service.unregisterCallback(mAttributionSource);
        } catch (RemoteException e) {
            Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
        }
    }
