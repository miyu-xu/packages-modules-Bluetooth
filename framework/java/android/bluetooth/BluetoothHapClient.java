...
public final class BluetoothHapClient implements BluetoothProfile, AutoCloseable {
    ...
    public interface Callback {
        ...
        @IntDef(value = {
                ...
                BluetoothStatusCodes.ERROR_HAP_SET_NAME_NOT_ALLOWED,
                BluetoothStatusCodes.ERROR_HAP_OPERATION_NOT_SUPPORTED,
                BluetoothStatusCodes.ERROR_HAP_OPERATION_NOT_POSSIBLE,
                BluetoothStatusCodes.ERROR_HAP_INVALID_PRESET_NAME_LENGTH,
                BluetoothStatusCodes.ERROR_HAP_GROUP_OPERATION_NOT_SUPPORTED,
                BluetoothStatusCodes.ERROR_HAP_PROCEDURE_ALREADY_IN_PROGRESS,
         ...
         *  {@link #PRESET_INFO_REASON_PRESET_AVAILABILITY_CHANGED}.
         *
         * @hide
         */
        @SystemApi
    ...
    /**
     * Get the currently active preset info
     *
     * @param device is the device for which we want to get the preset name
     * @return currently active preset info if available
     * @hide
     */
    @SystemApi
    @RequiresBluetoothConnectPermission
     ...
     *
     * On success, {@link Callback#onPresetInfo(BluetoothDevice, List<BluetoothHapPresetInfo>, int)}
     * with a new name will be called.
     ...
     *
     * On success, {@link Callback#onPresetInfo(BluetoothDevice, List<BluetoothHapPresetInfo>, int)}
     * with a new name will be called for each device within the group.
     * On failure, {@link Callback#onSetPresetNameFailed(BluetoothDevice, int)} will be called
     * for each device within the group.
