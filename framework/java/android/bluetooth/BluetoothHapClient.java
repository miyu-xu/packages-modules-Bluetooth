...
public final class BluetoothHapClient implements BluetoothProfile, AutoCloseable {
    ...
    public BluetoothHapPresetInfo getPresetInfo(@NonNull BluetoothDevice device, int presetIndex) {
        ...
        return callService(
                s -> s.getPresetInfo(device, presetIndex, mAttributionSource), defaultValue);
    }
    ...
    private <R> R callService(
            RemoteExceptionFunction<IBluetoothHapClient, R> function, R defaultValue) {
