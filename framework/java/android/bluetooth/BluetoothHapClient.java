...
public final class BluetoothHapClient implements BluetoothProfile, AutoCloseable {
    ...
    /**
     * Hearing aid type value which is used in {@link #FEATURE_MASK_HEARING_AID_TYPE}. Indicates
     * this Bluetooth device is belongs to a binaural hearing aid set. A binaural hearing aid set is
     * two hearing aids that form a Coordinated Set, one for the right ear and one for the left ear
     * of the user. Typically used by a user with bilateral hearing loss.
     * @hide
     */
    @SystemApi
    ...
    /**
     * Hearing aid type value which is used in {@link #FEATURE_MASK_HEARING_AID_TYPE}. Indicates
     * this Bluetooth device is a single hearing aid for the left or the right ear. Typically used
     * by a user with unilateral hearing loss.
     * @hide
     */
    @SystemApi
    ...
    /**
     * Hearing aid type value which is used in {@link #FEATURE_MASK_HEARING_AID_TYPE}. Indicates
     * this Bluetooth device is two hearing aids with a connection to one another that expose a
     * single Bluetooth radio interface.
     * @hide
     */
    @SystemApi
    ...
    /**
     * Hearing aid type value which is used in {@link #FEATURE_MASK_HEARING_AID_TYPE}. This value
