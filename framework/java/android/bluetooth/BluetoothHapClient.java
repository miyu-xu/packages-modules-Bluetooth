...
public final class BluetoothHapClient implements BluetoothProfile, AutoCloseable {
    ...
    public interface Callback {
         ...
         * @param reasonCode reason for the selected preset change
         *
         * @hide
         */
        @SystemApi
     ...
     * On failure, {@link Callback#onPresetSelectionForGroupFailed(BluetoothDevice, int)} will be
     * called for each device within the group.
     *
