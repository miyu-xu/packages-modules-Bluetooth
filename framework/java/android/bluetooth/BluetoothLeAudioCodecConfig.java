...
public final class BluetoothLeAudioCodecConfig implements Parcelable {
     ...
     * Codec sample rate 48000 Hz.
     */
    public static final int SAMPLE_RATE_96000 = 0x01 << 8;
     ...
     */
    public static final int FRAME_DURATION_15000 = 0x01 << 2;
    ...
    public String toString() {
        return "{codecName:" + getCodecName() + ",mCodecType:" + mCodecType
                ...
                + ",mMaxOctetsPerFrame:" + mMaxOctetsPerFrame + ",mCodecSpecific1:" + mCodecSpecific1
                + ",mCodecSpecific2:" + mCodecSpecific2 + ",mCodecSpecific3:" + mCodecSpecific3
    ...
    public static final class Builder {
        ...
        private final long mCodecSpecific1 = 0;
        private final long mCodecSpecific2 = 0;
        private final long mCodecSpecific3 = 0;
        private final long mCodecSpecific4 = 0;
