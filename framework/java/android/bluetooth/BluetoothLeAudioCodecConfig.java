...
public final class BluetoothLeAudioCodecConfig implements Parcelable {
     ...
     */
    public @BitsPerSample int getBitsPerSample() { return mBitsPerSample; }

    /**
     * Returns the codec channel mode.
     */
    public @ChannelMode int getChannelMode() { return mChannelMode; }

    /**
     * Returns the frame duration.
     */
    public @ChannelMode int getFrameDuration() { return mFrameDuration; }
    ...
    /**
     * Creates and returns a new {@link Builder} initialized with this BluetoothLeAudioCodecConfig's data
     */
    @NonNull
