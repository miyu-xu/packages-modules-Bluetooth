...
public final class BluetoothLeAudioCodecConfig implements Parcelable {
    ...
    private BluetoothLeAudioCodecConfig(@SourceCodecType int codecType,
            ...
            @ChannelCount int channelCount, @FrameDuration int frameDuration,
            int octetsPerFrame, int minOctetsPerFrame, int maxOctetsPerFrame) {
    ...
    public String toString() {
        return "{codecName:" + getCodecName() + ",mCodecType:" + mCodecType
                ...
                + ",mChannelCount:" + mChannelCount + ",mFrameDuration:" + mFrameDuration
                + ",mOctetsPerFrame:" + mOctetsPerFrame + ",mMinOctetsPerFrame:"
                + mMinOctetsPerFrame + ",mMaxOctetsPerFrame:" + mMaxOctetsPerFrame + "}";
    }
    ...
    public static final class Builder {
        ...
        public @NonNull Builder setMaxOctetsPerFrame(int maxOctetsPerFrame) {
            mOctetsPerFrame = maxOctetsPerFrame;
            return this;
        }
        ...
        public @NonNull BluetoothLeAudioCodecConfig build() {
            return new BluetoothLeAudioCodecConfig(mCodecType, mCodecPriority, mSampleRate,
                    mChannelCount, mFrameDuration, mOctetsPerFrame, mMinOctetsPerFrame,
                    mMaxOctetsPerFrame);
        }
    }
}
