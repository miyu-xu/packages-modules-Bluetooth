 ...
 * {@hide}
 */
public final class BluetoothAvrcpControllerPlayerSettings implements Parcelable {
    public static final String TAG = "BluetoothAvrcpControllerPlayerSettings";
    ...
    public static final @NonNull Creator<BluetoothAvrcpControllerPlayerSettings> CREATOR =
            new Creator<>() {
        public BluetoothAvrcpControllerPlayerSettings createFromParcel(Parcel in) {
            return new BluetoothAvrcpControllerPlayerSettings(in);
        }

        public BluetoothAvrcpControllerPlayerSettings[] newArray(int size) {
            return new BluetoothAvrcpControllerPlayerSettings[size];
        }
    };

    private BluetoothAvrcpControllerPlayerSettings(Parcel in) {
     ...
     */
    public BluetoothAvrcpControllerPlayerSettings(int settings) {
        mSettings = settings;
    }
