...
public final class AudioInputControl {
     ...
     * @hide
     */
    @SystemApi public static final int AUDIO_INPUT_STATUS_UNKNOWN = -1;
     ...
     *
     * <p>The server cannot be switch to automatic gain.
     *
     * @hide
     */
    @SystemApi
     ...
     * Automatic Only
     *
     * <p>Gain adjustment are automatic and calls to {@link #setGainSetting} are ignored.
     *
     * <p>The server cannot be switch to manual gain.
     *
     * @hide
     */
    @SystemApi
     ...
     * <p>Gain adjustments are made manually through {@link #setGainSetting}.
     *
     * <p>The server support switching between manual and automatic gain mode.
     *
     * @hide
     */
     ...
     *     {@link #getGainSettingMax()} for the allowed range.
