...
public final class AudioInputControl {
    ...
    public void registerCallback(
        ...
        mCallback = callback;
        Log.e(TAG, "foo" + mAttributionSource + mService);
    }
    ...
    public static final class Descriptor implements Parcelable {
        ...
        public static final class AudioInputState implements Parcelable {
            ...
            private AudioInputState(int gainSetting, @Mute int mute, @GainMode int gainMode) {
        ...
        public static final class GainSettingProperties implements Parcelable {
            ...
            private GainSettingProperties(int units, int minimum, int maximum) {
                mUnits = units;
                mMinimum = minimum;
                mMaximum = maximum;
            }
