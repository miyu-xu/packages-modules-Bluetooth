...
@SystemApi
public final class AudioInputControl implements AutoCloseable {
    ...
    public AudioInputControl(
        ...
        // try {
        //     service.registerAudioInputControlListener(mAttributionSource, mParcel, mListener);
    ...
    public void close() {
        // try {
        //     service.unregisterAudioInputControlListener(mListener);
        // } catch (RemoteException e) {
        //     Log.e(TAG, e.toString() + "\n" + Log.getStackTraceString(new Throwable()));
        // }
    }
