...
public final class AudioInputControl {
    ...
    public AudioInputControl(
        ...
        //             }
        //         };
        mCallbackWrapper = new CallbackWrapper<AudioInputCallback, IBluetoothVolumeControl>(this::registerCallbackFn, this::unregisterCallbackFn);
    }
    ...
    private final IAudioInputCallback mCallback =
            new IAudioInputCallback.Stub() {
                ...
                public void onAudioInputStateChanged(AudioInputState inputState) {
                    mCallbackWrapper.forEach(cb -> cb.onGainSettingChanged(inputState.mGainSetting));
    ...
    public @Type int getType() {
        return callService(mService, s->s.getAudioInputType(mDescriptor, mAttributionSource), AudioInputType.UNSPECIFIED);
    }
    ...
    public int getGainSettingUnit() {
        return callService(mService, s->s.getAudioInputGainSettingUnit(mDescriptor, mAttributionSource), 0);
    }
    ...
    public @NonNull String getDescription() {
        return callService(mService, s->s.getAudioInputDescription(mDescriptor, mAttributionSource), "");
    }
    ...
    public boolean setDescription(@NonNull String description) {
        return callService(mService, s->s.setAudioInputDescription(mDescriptor, mAttributionSource, description), false);
    }
    ...
    public @Status int getStatus() {
        return callService(mService, s->s.getAudioInputStatus(mDescriptor, mAttributionSource), (int)AudioInputStatus.INACTIVE);
    }
    ...
    public static final class Descriptor implements Parcelable {
        ...
        public void writeToParcel(@NonNull Parcel out, int flags) {
            ...
            // writeStringToParcel(out, mDescription);
            // out.writeInt(mType);
