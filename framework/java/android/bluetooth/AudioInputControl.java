...
public final class AudioInputControl {
    ...
    public static final class Descriptor implements Parcelable {
        ...
        public Descriptor(@NonNull BluetoothDevice device, int instanceId, @Type int type, @Status int status, AudioInputState, audioInputState, GainSettingProperties gainSettingProperties) {
