 ...
 * BluetoothCodecConfig#getSupportedCodecTypes}.
 */
public final class BluetoothCodecType implements Parcelable {
     ...
     * @hide
     */
    public static @Nullable BluetoothCodecType createFromType(@SourceCodecType int codecType) {
...
public final class BluetoothCodecConfig implements Parcelable {
     ...
     *     BluetoothCodeConfig#getSupportedCodecTypes} instead.
     */
     ...
     *     BluetoothCodeConfig#getSupportedCodecTypes} instead.
     */
    @Deprecated private static final int SOURCE_CODEC_TYPE_MAX = 7;
    ...
    public String toString() {
        ...
        return "{codecName:"
                + mCodecType.getCodecName()
                + ",mCodecType:"
                + mCodecType.getNativeCodecType()
                + ",mCodecPriority:"
                + mCodecPriority
                + ",mSampleRate:"
                + String.format("0x%x", mSampleRate)
                + "("
                + sampleRateStr
                + ")"
                + ",mBitsPerSample:"
