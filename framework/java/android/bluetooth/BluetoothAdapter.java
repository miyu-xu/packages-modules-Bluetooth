...
public final class BluetoothAdapter {
    ...
    /**
     * Creates a listening server channel for Bluetooth connections with the given socket settings
     * {@link BluetoothSocketSettings}.
     *
     * <p>Use {@link BluetoothServerSocket#accept} to retrieve incoming connections from a listening
     * {@link BluetoothServerSocket}.
     *
     * <p>This API supports BluetoothSocket#TYPE_RFCOMM and BluetoothSocket#TYPE_LE only, which can
     * be set using {@link BluetoothSocketSettings#setSocketType()}.
     *
     * <p>For `BluetoothSocket#TYPE_RFCOMM`, you must provide a UUID using {@link
     * BluetoothSocketSettings#setUuid()}.
     *
     * <p>For `BluetoothSocket#TYPE_LE`, the system assigns a dynamic PSM value. You can read this
     * value using {@link BluetoothServerSocket#getPsm()}. This value is released when the server
     * socket is closed, Bluetooth is turned off, or the application exits unexpectedly. You are
     * responsible for communicating this PSM value to the client device.
     *
     * <p>The mechanism of disclosing the assigned dynamic PSM value to the initiating peer is
     * defined and performed by the application.
     *
     * <p>Use {@link BluetoothDevice#createUsingSocketSettings(BluetoothSocketSettings)} to connect
     * to this server socket from another Android device using the given the PSM value or the
     * service UUID.
     *
