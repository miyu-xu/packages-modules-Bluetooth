...
public final class BluetoothAdapter {
    ...
    @IntDef(prefix = {"RFCOMM_LISTENER_"},
        value = {RFCOMM_LISTENER_SUCCESS, RFCOMM_LISTENER_START_FAILED_UUID_IN_USE,
            ...
            RFCOMM_LISTENER_FAILED_TO_CREATE_SERVER_SOCKET, RFCOMM_LISTENER_NO_SOCKET_AVAILABLE})
    @Retention(RetentionPolicy.SOURCE)
    ...
    public void listenUsingRfcommWithServiceRecord(@NonNull String name, @NonNull UUID uuid,
    ...
    @RequiresPermission(Manifest.permission.BLUETOOTH_CONNECT)
    @NonNull
    public BluetoothSocket retrieveSocketForServiceId(@NonNull UUID uuid) throws IOException {
