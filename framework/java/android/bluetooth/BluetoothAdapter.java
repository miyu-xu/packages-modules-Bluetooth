...
public final class BluetoothAdapter {
     ...
     * <p> If the request is to create socket of type BluetoothSocket#TYPE_RFCOMM, It is must to
     * to provide the uuid using BluetoothScoketSettings#setUuid()
     *
    ...
    public @NonNull BluetoothServerSocket createListeningChannel(
        ...
        if (type == BluetoothSocket.TYPE_RFCOMM) {
            ...
            Log.e(TAG, "Invalid Socket type: " + type);
