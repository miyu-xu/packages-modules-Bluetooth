...
public final class BluetoothAdapter {
     ...
     *
     * <p>
     * If socket is of BluetoothSocket#TYPE_L2CAP
     ...
     * defined and performed by the application.
     *
     * <p>Use {@link BluetoothDevice#createClientConnection(BluetoothSocketSettings)} to connect to this server socket from
     * another Android device that is given the PSM value.
     *
     * @return an BluetoothServerSocket
     * @throws IOException on error, for example Bluetooth not available, or insufficient
     *     permissions, or unable to start this CoC
     */
    @RequiresLegacyBluetoothPermission
