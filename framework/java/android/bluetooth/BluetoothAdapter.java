...
public final class BluetoothAdapter {
    ...
    private void registerOrUnregisterAdapterLocked() {
        ...
        if (wantRegistered) {
            if (sAdapterState == BluetoothAdapter.STATE_OFF && sAdapterStateFuture == null) {
                sAdapterStateFuture = new CompletableFuture<>();
            }
            CompletableFuture<Void> futureState = new CompletableFuture<>();
            sAdapterStateFuture = futureState;
            try {
                sService =
