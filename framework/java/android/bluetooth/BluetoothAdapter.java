...
public final class BluetoothAdapter {
    ...
    public BluetoothLeScanner getBluetoothLeScanner() {
     ...
     /**
     * Returns a {@link DistanceMeasurementManager} object for distance measurement operations.
     * Will return null if Bluetooth is turned off or if distance measurement is not supported on
     * this device.
     * <p>
    ...
    /**
     * Returns {@link BluetoothStatusCodes#FEATURE_SUPPORTED} if the distance measurement feature
     * is supported, {@link BluetoothStatusCodes#FEATURE_NOT_SUPPORTED} if the feature is not
     * supported, or an error code.
     *
    ...
    public @LeFeatureReturnValues int isDistanceMeasurementSupported() {
        ...
        try {
            ...
            if (mService != null) {
                final SynchronousResultReceiver<Integer> recv = SynchronousResultReceiver.get();
                mService.isDistanceMeasurementSupported(recv);
                return recv.awaitResultNoInterrupt(getSyncTimeout())
                    .getValue(BluetoothStatusCodes.ERROR_UNKNOWN);
            } else {
                throw new IllegalStateException(
