...
public final class BluetoothAvrcpPlayerSettings implements Parcelable {
    ...
    /**
     * Default state off, as defined in Bluetooth.
     */
    ...
    public static boolean isValidPlayerValue(int value) {
        if (value >= STATE_SHUFFLE_OFF && value <= STATE_REPEAT_GROUP) {
            return true;
        }
        return false;
    }
    ...
    /**
     * @return the map of values and text equivalent.
     */
    public @NonNull Map<Integer, String> getPlayerValueTexts() {
        return mValuesText;
    }
