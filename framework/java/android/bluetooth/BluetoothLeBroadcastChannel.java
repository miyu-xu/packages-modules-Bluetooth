 ...
 * @hide
 */
public class BluetoothLeBroadcastChannel implements Parcelable {
    ...
    public BluetoothLeBroadcastChannel(boolean isSelected, int channelIndex,
     ...
     * @hide
     */
    public static final Parcelable.Creator<BluetoothLeBroadcastChannel> CREATOR =
            new Parcelable.Creator<BluetoothLeBroadcastChannel>() {
                @NonNull
                public BluetoothLeBroadcastChannel createFromParcel(@NonNull Parcel in) {
    ...
    public static class Builder {
         ...
         * @throws BluetoothLeBroadcastChannel if the object cannot be built
         * @hide
         */
        @SystemApi
