...
public final class BluetoothSocketSettings {
    ...
    // Flag to indicate if switching data path to end point when connection is completed.
    ...
    */
    ...
    /**
     * Check if the auto data path switch flag is enabled.
     *
     * @hide
     */
    @SystemApi
