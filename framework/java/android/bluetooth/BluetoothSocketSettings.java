...
public final class BluetoothSocketSettings {
    ...
    /** Returns L2CAP psm on which socket will be created, this is valid
      * for the socket of type BluetoothSocket#TYPE_L2CAP_LE */
    @RequiresNoPermission
    ...
    private BluetoothSocketSettings(
            int socketType, int channel, boolean encryption, boolean authentication,
    ...
    public static final class Builder {
        ...
        /**
         * Set the channel for Bluetooth connection. This can serve as L2CAP PSM.
         * This is used only for the sockets of type BluetoothSocket#TYPE_L2CAP_LE.
         *
         ...
         *
         * @param encryptionEnabled true if encryption is needed for this socket
         *                   false otherwise
         ...
         *
         * @param authenticationEnabled true if authentication is needed for this socket
         *                       false otherwise
         * @return BluetoothSocketSettings.Builder object
         */
        @NonNull
        ...
        public BluetoothSocketSettings build() {
            return new BluetoothSocketSettings(
                    mSocketType, mChannel, mEncryptionEnabled,
                    mAuthenticationEnabled, mServiceName, mUuid);
        }
    }
}
