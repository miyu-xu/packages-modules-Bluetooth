...
public final class BluetoothSocketSettings {
    ...
    public static final class Builder {
        ...
        /**
         * Set Encryption requirement for for Bluetoth connection.
         *
        ...
        /**
         * Set Authentication requirement for for Bluetoth connection.
         *
        ...
        public BluetoothSocketSettings build() {
            ...
            return new BluetoothSocketSettings(
                    mSocketType, mChannel, mEncryptionEnabled, mAuthenticationEnabled, mServiceName, mUuid);
        }
    }
}
