...
public final class BluetoothVolumeControl implements BluetoothProfile, AutoCloseable {
    ...
    /**
     * Tells remote device to set a volume offset to the absolute volume.
     *
     * @param volumeOffset Volume offset to be set on remote device.
     *               Minimum value is -255 and maximum value is 255
     * @hide
     */
    @SystemApi
    @RequiresBluetoothConnectPermission
