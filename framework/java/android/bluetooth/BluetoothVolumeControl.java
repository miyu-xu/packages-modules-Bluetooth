...
public final class BluetoothVolumeControl implements BluetoothProfile, AutoCloseable {
    ...
    /**
     * @deprecated see {@link MyAwesomeCallback2}
     * @hide
     */
    @Deprecated
    @SystemApi
    ...
    /**
     * This class provides a callback that is invoked when volume changes on the remote device.
     *
    ...
    public interface MyAwesomeCallback2 { // TODO put a better name Ah ah ah ah
        /**
    ...
    /**
     * @deprecated use {@link #registerCallback(Executor, MyAwesomeCallback2)}
     * @hide
     */
    @SystemApi
    @Deprecated
    ...
    /**
     * @deprecated use {@link #unregisterCallback(Executor, MyAwesomeCallback2)}
     * @hide
     */
    @SystemApi
    @Deprecated
