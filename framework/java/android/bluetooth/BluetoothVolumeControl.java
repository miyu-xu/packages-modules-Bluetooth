...
public final class BluetoothVolumeControl implements BluetoothProfile, AutoCloseable {
    ...
    public List<BluetoothDevice> getDevicesMatchingConnectionStates(int[] states) {
        Log.d("getDevicesMatchingStates()");
        final IBluetoothVolumeControl service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            Log.d(Log.getStackTraceString(new Throwable()));
    ...
    public int getConnectionState(BluetoothDevice device) {
        Log.d("getConnectionState(" + device + ")");
        final IBluetoothVolumeControl service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            Log.d(Log.getStackTraceString(new Throwable()));
    ...
    public boolean isVolumeOffsetAvailable(@NonNull BluetoothDevice device) {
        Log.d("isVolumeOffsetAvailable(" + device + ")");
        final IBluetoothVolumeControl service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            Log.d(Log.getStackTraceString(new Throwable()));
    ...
    public int getNumberOfVolumeOffsetInstances(@NonNull BluetoothDevice device) {
        Log.d("getNumberOfVolumeOffsetInstances(" + device + ")");
        final IBluetoothVolumeControl service = getService();
    ...
    public boolean setConnectionPolicy(
        ...
        Log.d("setConnectionPolicy(" + device + ", " + connectionPolicy + ")");
        final IBluetoothVolumeControl service = getService();
        if (service == null) {
            Log.w(TAG, "Proxy not attached to service");
            Log.d(Log.getStackTraceString(new Throwable()));
