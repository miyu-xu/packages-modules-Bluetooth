...
public final class BluetoothVolumeControl implements BluetoothProfile, AutoCloseable {
     ...
     * the remote device.
     *
     * <p> In order to balance volume on the group of Le Audio devices, Volume Offset Control Service (VOCS)
     * shall be used. User can verify if the remote device supports VOCS by calling
     * {@link #isVolumeOffsetAvailable(device)}.
     *
     * @hide
     */
    @SystemApi
    public interface Callback {
         ...
         */
        @SystemApi
        void onVolumeOffsetChanged(int volumeOffset);
    }
    ...
    public boolean isVolumeOffsetAvailable(@Nullable BluetoothDevice device) {
