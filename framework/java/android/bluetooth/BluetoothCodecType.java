...
public final class BluetoothCodecType implements Parcelable {
     ...
     */
    @SystemApi
    public BluetoothCodecType(int codecType, long codecId, String codecName) {
        mNativeCodecType = codecType;
        mCodecId = codecId;
