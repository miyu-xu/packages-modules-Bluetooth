            ...
            new IBluetoothGattServerCallback.Stub() {
                ...
                public void onServiceAdded(int status, BluetoothGattService service) {
                    ...
                    if (executor != null && callback != null) {
                        ...
                        try {
                            executor.execute(() -> callback.onServiceAdded(status, tmp));
                        } finally {
                            if (Flags.gattServerAddHandlerToRunCallbacksOn()) {
                                Binder.restoreCallingIdentity(token);
                            }
                ...
                public void onNotificationSent(String address, int status) {
                    ...
                    if (executor != null && callback != null) {
                        ...
                        try {
                            executor.execute(() -> callback.onNotificationSent(device, status));
                        } finally {
                            if (Flags.gattServerAddHandlerToRunCallbacksOn()) {
                                Binder.restoreCallingIdentity(token);
                            }
                ...
                public void onMtuChanged(String address, int mtu) {
                    ...
                    if (executor != null && callback != null) {
                        ...
                        try {
                            executor.execute(() -> callback.onMtuChanged(device, mtu));
                        } finally {
                            if (Flags.gattServerAddHandlerToRunCallbacksOn()) {
                                Binder.restoreCallingIdentity(token);
                            }
