    ...
    private final IBluetoothGattServerCallback mBluetoothGattServerCallback =
            new IBluetoothGattServerCallback.Stub() {
                ...
                public void onServiceAdded(int status, BluetoothGattService service) {
                    ...
                    runCallbackOnExecutor(executor, () -> callback.onServiceAdded(status, tmp));
                }
                ...
                public void onExecuteWrite(String address, int transId, boolean execWrite) {
                    ...
                    runCallbackOnExecutor(
                            executor, () -> callback.onExecuteWrite(device, transId, execWrite));
                }
                ...
                public void onNotificationSent(String address, int status) {
                    ...
                    runCallbackOnExecutor(
                            executor, () -> callback.onNotificationSent(device, status));
                }
                ...
                public void onMtuChanged(String address, int mtu) {
                    ...
                    runCallbackOnExecutor(executor, () -> callback.onMtuChanged(device, mtu));
                }
                ...
                public void onPhyUpdate(String address, int txPhy, int rxPhy, int status) {
                    ...
                    runCallbackOnExecutor(
                            executor, () -> callback.onPhyUpdate(device, txPhy, rxPhy, status));
                }
                ...
                public void onPhyRead(String address, int txPhy, int rxPhy, int status) {
                    ...
                    runCallbackOnExecutor(
                            executor, () -> callback.onPhyRead(device, txPhy, rxPhy, status));
                }
