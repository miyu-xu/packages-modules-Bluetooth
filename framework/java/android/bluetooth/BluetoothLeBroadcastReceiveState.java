...
public final class BluetoothLeBroadcastReceiveState implements Parcelable {
    ...
    public BluetoothLeBroadcastReceiveState(
        ...
        requireNonNull(sourceDevice, "sourceDevice cannot be null");
        ...
        requireNonNull(bisSyncState, "bisSyncState cannot be null");
        ...
        requireNonNull(subgroupMetadata, "subgroupMetadata cannot be null");
