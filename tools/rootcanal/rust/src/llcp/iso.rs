...
impl IsoManager {
    ...
    fn new_cis_connection_handle(&mut self) -> u16 {
        todo!()
    }
    ...
    fn sendl_llcp_packet<P: Into<llcp::PacketPacket>>(
        &self,
        acl_connection_handle: u16,
        packet: P,
    ) {
    ...
    fn get_cis_connection_handle<F>(&self, predicate: F) -> Option<u16>
    where
        F: Fn(&Cis) -> bool,
    {
    ...
    pub fn hci_le_set_cig_parameters(&mut self, packet: hci::LeSetCigParametersPacket) {
        ...
        let sdu_interval_c_to_p: u32 = packet.get_sdu_interval_m_to_s();
        let sdu_interval_p_to_c: u32 = packet.get_sdu_interval_s_to_m();
        let framed: bool = packet.get_framing() == hci::Enable::Enabled;
        let max_transport_latency_c_to_p: u16 = packet.get_max_transport_latency_m_to_s();
        let max_transport_latency_p_to_c: u16 = packet.get_max_transport_latency_s_to_m();
        ...
        for cis in cis_config {
            ...
            if (cis.phy_m_to_s & !self.supported_phys()) != 0
                || (cis.phy_s_to_m & !self.supported_phys()) != 0
            {
                println!(
                    "CIS ({}) configures unsupported PHYs ({:x}, {:x})",
                    cis.cis_id, cis.phy_m_to_s, cis.phy_s_to_m
                );
        ...
        for cis_config in cis_config {
            ...
            cis.max_sdu_c_to_p = cis_config.max_sdu_m_to_s;
            cis.max_sdu_p_to_c = cis_config.max_sdu_s_to_m;
            cis.phy_c_to_p = cis_config.phy_m_to_s;
            cis.phy_p_to_c = cis_config.phy_s_to_m;
            cis.parameters = CisParameters::Short {
                rtn_c_to_p: cis_config.rtn_m_to_s,
                rtn_p_to_c: cis_config.rtn_s_to_m,
            };
        }
    ...
    pub fn hci_le_set_cig_parameters_test(&mut self, packet: hci::LeSetCigParametersTestPacket) {
        ...
        let sdu_interval_c_to_p: u32 = packet.get_sdu_interval_m_to_s();
        let sdu_interval_p_to_c: u32 = packet.get_sdu_interval_s_to_m();
        let ft_c_to_p: u8 = packet.get_ft_m_to_s();
        let ft_p_to_c: u8 = packet.get_ft_s_to_m();
        ...
        for cis_config in cis_config {
            ...
            cis.parameters = CisParameters::Full {
                nse: cis_config.nse,
                bn_c_to_p: cis_config.bn_m_to_s,
                bn_p_to_c: cis_config.bn_s_to_m,
                max_pdu_c_to_p: cis_config.max_pdu_s_to_m,
                max_pdu_p_to_c: cis_config.max_pdu_m_to_s,
            };
        }
    ...
    pub fn hci_le_create_cis(&mut self, packet: hci::LeCreateCisPacket) {
        let cis_config: &[hci::CreateCisConfig] = packet.get_cis_config();
        let mut requested_cis = HashSet::new();
        ...
        for cis_config in cis_config {
            ...
            if !requested_cis.insert(cis_config.cis_connection_handle) {
                println!(
    ...
    pub fn hci_le_reject_cis_request(&mut self, packet: hci::LeRejectCisRequestPacket) {
        ...
        self.sendl_llcp_packet(
            ...
            llcp::RejectExtIndBuilder {
                ...
                error_code: hci::ErrorCode::RemoteUserTerminatedConnection as u8,
            },
        );
    ...
    pub fn hci_le_setup_iso_data_path(&mut self, _packet: hci::LeSetupIsoDataPathPacket) {
        todo!()
    }
    ...
    pub fn ll_cis_req(&mut self, acl_connection_handle: u16, packet: llcp::CisReqPacket) {
    ...
    pub fn ll_cis_rsp(&mut self, acl_connection_handle: u16, _packet: llcp::CisRspPacket) {
        ...
        if let Some(cis_connection_handle) = cis_connection_handle {
            ...
            self.send_hci_event(hci::LeCisEstablishedBuilder {
                ...
                cig_sync_delay: cis.cig_sync_delay,
                cis_sync_delay: cis.cis_sync_delay,
                transport_latency_m_to_s: 0, // TODO
                transport_latency_s_to_m: 0, // TODO
                phy_m_to_s: hci::SecondaryPhyType::from_u8(cis.phy_c_to_p as u8).unwrap(),
                phy_s_to_m: hci::SecondaryPhyType::from_u8(cis.phy_p_to_c as u8).unwrap(),
                nse: cis.nse,
                bn_s_to_m: cis.bn_c_to_p,
                bn_m_to_s: cis.bn_p_to_c,
                ft_s_to_m: cis.ft_c_to_p,
                ft_m_to_s: cis.ft_p_to_c,
                max_pdu_s_to_m: cis.max_pdu_c_to_p as u8,
                max_pdu_m_to_s: cis.max_pdu_p_to_c as u8,
    ...
    pub fn ll_reject_ext_ind(
        &mut self,
        acl_connection_handle: u16,
        packet: llcp::RejectExtIndPacket,
    ) {
        ...
        if let Some(cis_connection_handle) = cis_connection_handle {
            ...
            self.send_hci_event(hci::LeCisEstablishedBuilder {
                ...
                cig_sync_delay: 0,
                cis_sync_delay: 0,
                transport_latency_m_to_s: 0,
                transport_latency_s_to_m: 0,
                phy_m_to_s: hci::SecondaryPhyType::NoPackets,
                phy_s_to_m: hci::SecondaryPhyType::NoPackets,
                nse: 0,
                bn_s_to_m: 0,
                bn_m_to_s: 0,
                ft_s_to_m: 0,
    ...
    pub fn ll_cis_ind(&mut self, acl_connection_handle: u16, packet: llcp::CisIndPacket) {
        let cis_connection_handle = self.get_cis_connection_handle(|cis| {
            cis.acl_connection_handle == acl_connection_handle
    ...
    pub fn ll_cis_terminate_ind(
        &mut self,
        acl_connection_handle: u16,
        packet: llcp::CisTerminateIndPacket,
    ) {
        let cis_connection_handle = self.get_cis_connection_handle(|cis| {
            cis.acl_connection_handle == acl_connection_handle
