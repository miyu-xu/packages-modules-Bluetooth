...
PhyLayer::PhyLayer(Identifier id, Phy::Type type)
    : id(id), type(type), phy_devices_() {}
...
uint8_t PhyLayer::ComputeRssi(PhyDevice::Identifier sender_id,
...
void PhyLayer::Send(std::vector<uint8_t> const& packet, uint8_t /*tx_power*/,
