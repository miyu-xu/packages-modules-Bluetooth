...
ErrorCode ApcfScanner::UpdateFilterList(std::vector<GapDataFilter>& filter_list,
  ...
  if (!HasFilterIndex(filter_index)) {
  ...
  switch (action) {
    case ApcfAction::ADD: {
      ...
      filter_list.push_back(rootcanal::apcf::GapDataFilter{
    ...
    case ApcfAction::DELETE: {
      ...
      std::remove_if(
          std::begin(filter_list), std::end(filter_list), [&](auto it) {
            return it.filter_index == filter_index && it.gap_data == gap_data &&
...
ErrorCode LinkLayerController::LeApcfServiceUuid(
  ...
  ErrorCode status = apcf_scanner_.UpdateFilterList(
      ...
      apcf_filter_index, uuid_data, uuid_data_mask);
...
ErrorCode LinkLayerController::LeApcfServiceSolicitationUuid(
  ...
  ErrorCode status = apcf_scanner_.UpdateFilterList(
      ...
      apcf_action, apcf_filter_index, uuid_data, uuid_data_mask);
...
ErrorCode LinkLayerController::LeApcfLocalName(
  ...
  ErrorCode status = apcf_scanner_.UpdateFilterList(
      ...
      apcf_filter_index, local_name, local_name_mask);
...
ErrorCode LinkLayerController::LeApcfManufacturerData(
  ...
  ErrorCode status = apcf_scanner_.UpdateFilterList(
      ...
      apcf_filter_index, manufacturer_data, manufacturer_data_mask);
...
ErrorCode LinkLayerController::LeApcfServiceData(
  ...
  ErrorCode status = apcf_scanner_.UpdateFilterList(
      ...
      apcf_filter_index, service_data, service_data_mask);
