...
void DualModeController::ReadFailedContactCounter(CommandView command) {
  ...
  ErrorCode status = link_layer_controller_.HasAclConnection(connection_handle) ? ErrorCode::SUCCESS : ErrorCode::UNKNOWN_CONNECTION;

  send_event_(bluetooth::hci::ReadFailedContactCounterBuilder::Create(
