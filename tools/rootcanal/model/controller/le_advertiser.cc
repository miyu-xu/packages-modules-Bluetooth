...
ErrorCode LinkLayerController::LeSetAdvertisingSetRandomAddress(
  ...
  auto advertiser_handle = extended_advertisers_.find(advertising_handle);
  if (advertiser_handle == extended_advertisers_.end()) {
  ...
  ExtendedAdvertiser& advertiser = advertiser_handle->second;
...
ErrorCode LinkLayerController::LeSetExtendedAdvertisingParameters(
  ...
  if (advertiser_handle == extended_advertisers_.end()) {
    ...
    advertiser = advertiser_handle->second;
  }
  ...
  // Note: not explicitely specified in the specification but makes sense
