...
bool ControllerProperties::CheckSupportedFeatures() const {
  ...
  uint64_t lmp_page_0_reserved_bits[] = {
      UINT64_C(0x7fffe7e407000000),  // v1.0B (withdrawn)
      UINT64_C(0x7fffe7e407000000),  // v1.1 (withdrawn)
      UINT64_C(0x7fffe7e407000000),  // v1.2 (withdrawn)
      UINT64_C(0x7fff066401000000),  // v2.0 (withdrawn)
      UINT64_C(0x7c86006401000000),  // v2.1 (withdrawn)
      UINT64_C(0x7886006401000000),  // v3.0 (withdrawn)
      UINT64_C(0x7884000401000000),  // v4.0 (withdrawn)
      UINT64_C(0x7884000401000000),  // v4.1
      UINT64_C(0x7884000401000000),  // v4.2
      UINT64_C(0x7884000401000100),  // v5.0
      UINT64_C(0x7884000401000100),  // v5.1
      UINT64_C(0x7884000401000100),  // v5.2
      UINT64_C(0x7884000401000100),  // v5.3
  };

  uint64_t lmp_page_2_reserved_bits[] = {
      UINT64_C(0xffffffffffffffff),  // v1.0B (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v1.1 (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v1.2 (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v2.0 (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v2.1 (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v3.0 (withdrawn)
      UINT64_C(0xffffffffffffffff),  // v4.0 (withdrawn)
      UINT64_C(0xfffffffffffff480),  // v4.1
      UINT64_C(0xfffffffffffff480),  // v4.2
      UINT64_C(0xfffffffffffff480),  // v5.0
      UINT64_C(0xfffffffffffff080),  // v5.1
      UINT64_C(0xfffffffffffff080),  // v5.2
      UINT64_C(0xfffffffffffff080),  // v5.3
  };

  unsigned lmp_version = static_cast<unsigned>(this->lmp_version);
  if ((lmp_page_0_reserved_bits[lmp_version] & lmp_features[0]) != 0) {
    LOG_INFO("The page 0 feature bits 0x%016" PRIx64
             " are reserved in the "
             "specification %s",
             lmp_page_0_reserved_bits[lmp_version] & lmp_features[0],
             LmpVersionText(this->lmp_version).c_str());
    return false;
  }

  if ((lmp_page_2_reserved_bits[lmp_version] & lmp_features[2]) != 0) {
    LOG_INFO("The page 2 feature bits 0x%016" PRIx64
             " are reserved in the "
             "specification %s",
             lmp_page_2_reserved_bits[lmp_version] & lmp_features[2],
             LmpVersionText(this->lmp_version).c_str());
    return false;
  }
