...
class LinkLayerController {
 ...
 public:
  ...
  ErrorCode LeApcfSetFilteringParameters(
      bluetooth::hci::ApcfAction apcf_action,
      uint8_t apcf_filter_index,
      uint16_t apcf_feature_selection,
      uint16_t apcf_list_logic_type,
      uint8_t apcf_filter_logic_type,
  ...
  ErrorCode LeApcfBroadcastAddress(
      bluetooth::hci::ApcfAction apcf_action,
      uint8_t apcf_filter_index,
  ...
  ErrorCode LeApcfLocalName(
      bluetooth::hci::ApcfAction apcf_action,
      uint8_t apcf_filter_index,
      std::vector<uint8_t> apcf_local_name,
      uint8_t *apcf_available_spaces);

  ErrorCode LeApcfManufacturerData(
      bluetooth::hci::ApcfAction apcf_action,
      uint8_t apcf_filter_index,
      std::vector<uint8_t> apcf_manufacturer_data,
      uint8_t *apcf_available_spaces);

  ErrorCode LeApcfAdTypeFilter(
      bluetooth::hci::ApcfAction apcf_action,
      uint8_t apcf_filter_index,
      uint8_t ad_type,
