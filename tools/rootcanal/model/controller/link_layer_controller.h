...
class LinkLayerController {
 ...
 public:
  ...
  const Address& GetRandomAddress() const { return random_address_; }
  const Address& GetPublicAddress() const { return address_; }
 ...
 private:
  ...
  std::map<uint8_t, ExtendedAdvertiser> extended_advertisers_{};
