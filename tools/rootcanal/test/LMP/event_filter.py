...
class Test(ControllerTest):
    ...
    async def test_inquiry_result_all_devices(self):
        ...
        await self.expect_ll(
            ll.Inquiry(source_address=controller.address, destination_address=Address(),
                inquiry_mode=hci.InquiryMode.STANDARD, lap=0))

        controller.send_ll(
            ll.InquiryResponse(
                source_address=inquiry_address_1,
                destination_address=controller.address,
                page_scan_repetition_mode=1,
                class_of_device=inquiry_class_of_device_1,
                clock_offset=0))

        controller.send_ll(
            ll.InquiryResponse(
                source_address=inquiry_address_2,
                destination_address=controller.address,
                page_scan_repetition_mode=1,
                class_of_device=inquiry_class_of_device_2,
                clock_offset=0))
    ...
    async def test_inquiry_result_class_of_device(self):
        ...
        controller.send_cmd(hci.SetEventFilterInquiryResultClassOfDevice(
            class_of_device=0xaaaa02,
            class_of_device_mask=0xffffff))
        ...
        controller.send_cmd(hci.SetEventFilterInquiryResultClassOfDevice(
            class_of_device=0xaaaa00,
            class_of_device_mask=0xffff00))
    ...
    async def test_inquiry_result_address(self):
        ...
        controller.send_cmd(hci.SetEventFilterInquiryResultAddress(
            address=inquiry_address_2))
