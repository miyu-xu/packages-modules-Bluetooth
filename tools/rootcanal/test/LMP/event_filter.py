...
class Test(ControllerTest):
    ...
    async def test_inquiry_result_all_devices(self):
        ...
        controller.send_ll(
            ll.InquiryResponse(source_address=inquiry_address_1,
        ...
        controller.send_ll(
            ll.InquiryResponse(source_address=inquiry_address_2,
                               destination_address=controller.address,
                               page_scan_repetition_mode=1,
        ...
        await self.expect_evt(
            hci.InquiryResult(responses=[
                hci.InquiryResponse(bd_addr=inquiry_address_1,
        ...
        await self.expect_evt(
            hci.InquiryResult(responses=[
                hci.InquiryResponse(bd_addr=inquiry_address_2,
                                    page_scan_repetition_mode=hci.PageScanRepetitionMode.R1,
                                    class_of_device=inquiry_class_of_device_2,
                                    clock_offset=0)
            ]))
    ...
    async def test_inquiry_result_address(self):
        ...
        controller.send_cmd(hci.SetEventFilterInquiryResultAddress(address=inquiry_address_2))
