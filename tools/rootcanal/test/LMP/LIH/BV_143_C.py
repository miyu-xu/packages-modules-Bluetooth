...
class Test(ControllerTest):
    ...
    async def test(self):
        ...
        controller.send_ll(ll.Page(source_address=peer_address,
        ...
        await self.expect_evt(hci.RoleChange(status=ErrorCode.ROLE_CHANGE_NOT_ALLLOWED, bd_addr=peer_address, role=hci.Role.PERIPHERAL))
        ...
        await self.expect_evt(hci.RoleChange(status=ErrorCode.ROLE_SWITCH_FAILED, bd_addr=peer_address, role=hci.Role.PERIPHERAL))
