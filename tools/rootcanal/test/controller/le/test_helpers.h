...
[[maybe_unused]] static bluetooth::hci::ScanningPhyParameters
MakeScanningPhyParameters(bluetooth::hci::LeScanType scan_type,
                          uint16_t scan_interval, uint16_t scan_window) {
  bluetooth::hci::ScanningPhyParameters parameters;
