...
TEST_F(LeSetPeriodicAdvertisingParametersTest, Success) {
  ASSERT_EQ(controller_.LeSetExtendedAdvertisingParameters(
                0, MakeAdvertisingEventProperties(), 0x0800, 0x0800,
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                0, 0x6, 0xffff, false), ErrorCode::SUCCESS);
}
...
TEST_F(LeSetPeriodicAdvertisingParametersTest, InvalidAdvertisingInterval) {
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                0, 0x0, 0xffff, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);

  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                0, 0xffff, 0x6, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);
}
...
TEST_F(LeSetPeriodicAdvertisingParametersTest, InvalidAdvertisingEventProperties) {
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                0, 0x6, 0xffff, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                1, 0x6, 0xffff, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                2, 0x6, 0xffff, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);

  ASSERT_EQ(controller_.LeSetExtendedAdvertisingParameters(
                3, MakeAdvertisingEventProperties(LEGACY), 0x0800, 0x0800,
                0x7, OwnAddressType::PUBLIC_DEVICE_ADDRESS,
                PeerAddressType::PUBLIC_DEVICE_OR_IDENTITY_ADDRESS,
                Address::kEmpty, AdvertisingFilterPolicy::ALL_DEVICES, 0x70,
                PrimaryPhyType::LE_1M, 0, SecondaryPhyType::LE_2M, 0x0, false),
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                3, 0x6, 0xffff, false), ErrorCode::INVALID_HCI_COMMAND_PARAMETERS);
}
...
TEST_F(LeSetPeriodicAdvertisingParametersTest, PeriodicAdvertisingEnabled) {
  ...
  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingEnable(
                0, true, false), ErrorCode::SUCCESS);

  ASSERT_EQ(controller_.LeSetPeriodicAdvertisingParameters(
                0, 0x6, 0xffff, false), ErrorCode::COMMAND_DISALLOWED);
}
