...
class Test(ControllerTest):
    ...
    async def test(self):
        ...
        # response.
        controller.send_cmd(hci.LeSetPhy(
            connection_handle=acl_connection_handle,
        ...
        await self.expect_evt(hci.LeSetPhyStatus(
            status=ErrorCode.SUCCESS, num_hci_command_packets=1))

        await.self.expect_ll(ll.LlPhyReq(
            source_address=controller.address,
            destination_address=peer_address,
            tx_phys=0x7,
            rx_phys=0x7))

        controller.send_ll(ll.LlPhyUpdateInd(
        ...
        await self.expect_evt(hci.LePhyUpdateComplete(
...
0x05 0x01 0x01 0x01
0x04 0x04 0x04 0x04
0x05 0x07 0x04 0x02, 0x04
0x05 0x05 0x04 0x01
0x04 0x02 0x04 0x02
0x03 0x07 0x01 0x04, 0x01
0x06 0x06 0x02 0x04
0x03 0x02 0x02 0x02
0x01 0x06 0x01 0x04
0x05 0x06 0x01 0x04
...
0x03 0x05 0x02 0x01
0x06 0x04 0x02 0x04
0x02 0x07 0x02 0x01, 0x02
0x06 0x01 0x02 0x01
0x02 0x02 0x02 0x02
0x03 0x04 0x01 0x04
0x07 0x03 0x04, 0x01 0x01
0x02 0x01 0x02 0x01
0x03 0x03 0x01 0x01
0x02 0x03 0x02 0x01
0x04 0x07 0x04 0x02, 0x04
0x07 0x04 0x01, 0x04 0x04
0x07 0x01 0x04, 0x02 0x01
0x06 0x05 0x04 0x01
0x02 0x06 0x02 0x04
0x07 0x07 0x01, 0x02 0x01, 0x04
0x04 0x06 0x04 0x02
0x02 0x05 0x02 0x01
0x06 0x02 0x04 0x02
0x07 0x02 0x01, 0x02 0x02
0x07 0x06 0x04, 0x01 0x04
0x06 0x07 0x02 0x02, 0x01
0x06 0x03 0x02 0x02
0x05 0x04 0x04 0x04
0x07 0x05 0x04, 0x02 0x01
0x01 0x07 0x01 0x04, 0x02
        ]
    ...
    async def steps_4_11(self, peer_address: Address, connection_handle: int, phy_c_to_p: int, phy_p_to_c: int,
                        req_all_phys: int, req_tx_phys: int, req_rx_phys: int,
        ...
        next_phy_c_to_p = req_tx_phys & rsp_rx_phys
        next_phy_p_to_c = req_rx_phys & rsp_tx_phys
        ...
        # TODO: the event is always being sent.
        await self.expect_evt(
