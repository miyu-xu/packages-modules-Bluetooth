...
class Test(ControllerTest):
    ...
    async def steps_3_7(self, advertising_data: List[int]):
        ...
        controller.send_cmd(hci.LeSetExtendedAdvertisingDataRaw(
            advertising_handle=0,
            operation=hci.Operation.COMPLETE_ADVERTISEMENT,
            advertising_data=advertising_data))

        await self.expect_evt(hci.LeSetExtendedAdvertisingDataComplete(status=ErrorCode.SUCCESS, num_hci_command_packets=1))
