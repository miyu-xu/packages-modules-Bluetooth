    ...
    async def test(self):
        ...
        controller.send_cmd(
            hci.LeSetAdvertisingParameters(advertising_interval_min=0x200,
                                           ...
                                           advertising_type=hci.AdvertisingType.ADV_DIRECT_IND,
        ...
        # advertising channel.
        direct_ind = await self.expect_ll(ll.LeLegacyAdvertisingPdu(source_address=self.Any,
        ...
        controller.send_cmd(hci.Disconnect(
