...
mod tests {
    ...
    fn p192() {
        ...
        assert_eq!(
            pub_a.x,
            BigInt::parse_bytes(b"15207009984421a6586f9fc3fe7e4329d2809ea51125f8ed", 16).unwrap()
        );
        // assert_eq!(
        //     pub_a.y,
        //     BigInt::parse_bytes(b"b09d42b81bc5bd009f79e4b59dbbaa857fca856fb9f7ea25", 16).unwrap()
        // );
        let shared = group.shared_secret(priv_b, pub_a);
        assert_eq!(
            shared.x,
            BigInt::parse_bytes(b"fb3ba2012c7e62466e486e229290175b4afebc13fdccee46", 16).unwrap()
        );
    }
