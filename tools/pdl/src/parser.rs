...
pub mod ast {
    ...
    pub type Decl = crate::ast::Decl<(), ()>;
    pub type File = crate::ast::File<(), ()>;
}
    ...
    Ok(crate::ast::Field {
        ...
        desc: match rule {
            ...
            Rule::fixed_field => match children.next() {
                ...
                Some(n) if n.as_rule() == Rule::string => {
                    let tag_id = n.as_string();
                    let enum_id = parse_string(&mut children)?;
    ...
    for node in root.children() {
        ...
        match rule {
            ...
            Rule::checksum_declaration => {
                ...
                file.declarations.push(crate::ast::Decl::checksum(loc, id, function, width))
            }
            Rule::custom_field_declaration => {
                ...
                let function = parse_string(&mut children)?;
                file.declarations.push(crate::ast::Decl::custom_field(loc, id, function, width))
            }
            Rule::enum_declaration => {
                ...
                file.declarations.push(crate::ast::Decl::enum_(loc, id, width, tags))
            }
            Rule::packet_declaration => {
                ...
                file.declarations.push(crate::ast::Decl::packet(
                    loc,
                    id,
                    parent_id,
                    constraints,
            ...
            Rule::struct_declaration => {
                ...
                let constraints = parse_constraint_list_opt(&mut children, context)?;
                let fields = parse_field_list_opt(&mut children, context)?;
                file.declarations.push(crate::ast::Decl::struct_(
                    loc,
                    id,
                    parent_id,
                    constraints,
            ...
            Rule::group_declaration => {
                ...
                file.declarations.push(crate::ast::Decl::group(loc, id, fields))
            }
