...
pub mod ast {
    ...
    #[allow(unused)]
    pub type Field = crate::ast::Field<Size>;
    #[allow(unused)]
    pub type Decl = crate::ast::Decl<Size, Size>;
    #[allow(unused)]
    pub type File = crate::ast::File<Size, Size>;
}
...
impl<'d> PacketScope<'d> {
    ...
    fn insert(&mut self, field: &'d parser::ast::Field, result: &mut LintDiagnostics) {
        match &field.desc {
            ...
            FieldDesc::Padding { .. } | FieldDesc::Reserved { .. } | FieldDesc::Fixed { .. } => {
                None
            }
