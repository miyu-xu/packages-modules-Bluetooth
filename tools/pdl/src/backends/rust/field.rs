...
use crate::backends::rust::Context;
...
impl Tag {
    fn new(id: &str, value: usize) -> Tag {
        Tag { id: String::from(id), value }
    }
}
...
impl Field {
    pub fn from_ast(ctx: &Context<'_>, field: &ast::Field) -> Field {
        match field {
    ...
    pub fn get_width(&self) -> usize {
        match self {
            ...
            Field::Enum(field) => field.get_width(),
        }
    }
