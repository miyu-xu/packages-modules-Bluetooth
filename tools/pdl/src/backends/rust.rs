...
fn generate_enum_decl(id: &str, tags: &[ast::Tag]) -> String {
    ...
    let code = quote! {
        ...
        // TODO(mgeisler): should we include a #[repr(u64)] like
        // bluetooth_packetgen?
        pub enum #name {
            #(#variants),*
        }
    ...
    // TODO(mgeisler): bluetooth_packetgen includes an Display impl,
    // but I think the Debug impl is good enough.
...
mod tests {
    ...
    /// Create a test case for given PDL `code`.
    ///
    ...
    /// Create a test cases for given PDL `code`.
    ///
