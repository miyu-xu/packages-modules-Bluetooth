...
impl ParentData {
    ...
    fn parse_inner(mut bytes: &mut Cell<&[u8]>) -> Result<Self> {
        ...
        let foo: Enum16 = (bytes.get_mut().get_u16()).into();
        if bytes.get().remaining() < 2 {
            return Err(Error::InvalidLengthError {
                obj: "Parent".to_string(),
                wanted: 2,
        ...
        let bar: Enum16 = (bytes.get_mut().get_u16()).into();
        if bytes.get().remaining() < 2 {
            return Err(Error::InvalidLengthError {
                obj: "Parent".to_string(),
                wanted: 2,
        ...
        let baz: Enum16 = (bytes.get_mut().get_u16()).into();
...
impl ChildData {
    ...
    fn parse_inner(mut bytes: &mut Cell<&[u8]>, bar: Enum16, baz: Enum16) -> Result<Self> {
        ...
        let quux: Enum16 = (bytes.get_mut().get_u16()).into();
