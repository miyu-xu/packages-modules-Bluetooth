...
# le_pdl_test is the name of the module generated from the canonical
# little endian test grammar. The purpose of this module is to validate the
# generated parser against the set of pre-generated test vectors
# in canonical/le_test_vectors.json.
import le_pdl_test
...
class PacketParserTest(unittest.TestCase):
    """Validate the generated parser against pre-generated test
       vectors in canonical/le_test_vectors.json"""
