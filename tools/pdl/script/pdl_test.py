...
"""Test if pdl.py output the same json minus some keys than the rust pdl implementation"""
...
def simplify_ast(obj):
    """
    Remove keys that are not emited by pypdl in ast
    """
    ...
    def test_output_valid(self):
        for filename in FILES_TO_TEST:
            with self.subTest(filename):
                ...
                self.maxDiff = None
                self.assertDictEqual(pdl_ast, pypdl_ast)
