""
    ...
    from __future__ import absolute_import from __future__ import division from __future__ import
        print_function
            ...
            from mobly.controllers
                .android_device import AndroidDevice
    ...
    : self._ad = ad if not isinstance(self._ad, AndroidDevice)
    : raise TypeError('Must apply AndroidBluetoothClientTestDecorator to an ' 'AndroidDevice')
