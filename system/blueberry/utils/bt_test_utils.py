...
def get_mac_address_of_generic_advertisement(scan_device, adv_device, adv_addr_type=-1):
    ...
    Args:
        ...
        adv_addr_type: The address type for the advertiser (AUTO by default)
    ...
    if adv_addr_type >= 0 and adv_addr_type <= 2:
