...
class GattBondedConnectTest(sl4a_sl4a_base_test.Sl4aSl4aBaseTestClass):
    ...
    def test_scan_connect_unbonded_device_public_address_with_irk(self):
        ...
        # Stop cert advertising; new address will be advertised for OOB pairing flow
        ...
        # TODO: Disconnect GATT

        # TODO: Scan for device

        # TODO: Connect GATT again
...
#     def test_scan_connect_unbonded_device_public_address_with_irk_bond_le_connect_gatt(self):
#         # Set up SL4A cert side to advertise
#         logging.info("Starting advertising")
#         self.cert.sl4a.bleSetAdvertiseSettingsIsConnectable(True)
#         self.cert.sl4a.bleSetAdvertiseDataIncludeDeviceName(True)
...
#         assertThat(self._wait_for_event(expected_event_name, self.dut)).isTrue()
#
#         # TODO: Bond - sl4a bluetoothLeBond with random address
#         self.cert.sl4a.bluetoothStartPairingHelper(True)
#         #self.dut.sl4a.bluetoothLeBond(advertising_address)
#
#         try:
#             bond_state = self.dut.ed.pop_event(self.SL4A_EVENT_BONDED, self.default_timeout)
#         except queue.Empty() as error:
...
#         logging.info("Bonded: %s", bond_state["data"]["bonded_state"])
#
#         # TODO: DO I start and stop advertising or just keep advertising?
#
#         # TODO: Disconnect GATT - is it after or before bond?
#
#         # TODO: Scan for device
#
#         # TODO: Connect GATT again
...
#         # Test over
#         self.cert.sl4a.bleStopBleAdvertising(advertise_callback)
#         self.dut.dl4a.bluetoothUnbond(advertising_address)
