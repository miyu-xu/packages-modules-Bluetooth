...
class Sl4aSl4aBaseTestClass(BaseTestClass):
    ...
    def setup_class(self):
        ...
        self.cert.services.register('sl4a', Sl4aService, start_service=False)
        ...
        try:
            self.cert.sl4a.start()
        except AppRestoreConnectionError:
            pass
        try:
            self.cert.sl4a.clear_host_port()
        except AdbError:
            pass
        sl4a_client._APP_START_WAIT_TIME = 2 * 60
        self.cert.sl4a.restore_app_connection(port=forwarded_port)
    ...
    def setup_test(self):
        ...
        self.cert.ed.clear_all_events()
        self.cert.sl4a.setScreenTimeout(500)
        self.cert.sl4a.wakeUpNow()
