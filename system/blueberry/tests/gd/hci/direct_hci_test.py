...
import blueberry.utils.bluetooth
...
class DirectHciTest(gd_base_test.GdBaseTestClass):
    ...
    def test_le_ad_scan_cert_advertises(self):
        self.dut_hci.register_for_le_events(hci.SubeventCode.EXTENDED_ADVERTISING_REPORT, hci.SubeventCode.ADVERTISING_REPORT)
        ...
        self.dut_hci.send_command(
            hci.LeSetExtendedScanParameters(
                ...
                scanning_phys=1, parameters=[
                hci.PhyScanParameters(
        ...
        self.cert_hal.send_hci_command(hci.LeSetAdvertisingSetRandomAddress(
            advertising_handle=advertising_handle,
        ...
        self.dut_hci.send_command(hci.LeSetExtendedScanEnable(enable=Enable.DISABLED))
    ...
    def _create_phy_scan_params():
        return hci.LeCreateConnPhyScanParameters(
            scan_interval = 0x60,
            scan_window = 0x30,
    ...
    def test_le_connection_dut_advertises(self):
        self.dut_hci.register_for_le_events(hci.SubeventCode.CONNECTION_COMPLETE, hci.SubeventCode.ADVERTISING_SET_TERMINATED,
                                            hci.SubeventCode.READ_REMOTE_FEATURES_COMPLETE)
        # Cert Connects
        self.cert_hal.unmask_event(hci.EventCode.LE_META_EVENT)
        self.cert_hal.send_hci_command(
            hci.LeSetRandomAddress(random_address=bluetooth.Address('0C:05:04:03:02:01')))
        self.cert_hal.send_hci_command(
        ...
        assertThat(self.dut_hci.get_le_event_stream()).emits(
            lambda packet: packet.payload[0] == int(hci.EventCode.LE_META_EVENT) and packet.payload[2] == int(hci.SubeventCode.READ_REMOTE_FEATURES_COMPLETE)
        )
    ...
    def test_le_filter_accept_list_connection_cert_advertises(self):
        # DUT Connects
        self.dut_hci.send_command(
            hci.LeSetRandomAddress(random_address=bluetooth.Address('0D:05:04:03:02:01')))
        self.dut_hci.send_command(
        ...
        self.dut_hci.send_command(
            hci.LeExtendedCreateConnection(
                initiator_filter_policy=hci.InitiatorFilterPolicy.USE_FILTER_ACCEPT_LIST,
                own_address_type=hci.OwnAddressType.RANDOM_DEVICE_ADDRESS,
                initiating_phys=1,
                phy_scan_parameters=[self._create_phy_scan_params()]))
    ...
    def test_connection_cert_connects(self):
        self.cert_hal.send_command(hci.WritePageTimeout(page_timeout=0x4000))
