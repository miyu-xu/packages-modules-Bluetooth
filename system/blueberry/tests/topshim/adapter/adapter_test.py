...
from blueberry.tests.topshim.lib.automation_helper import AdapterAutomationHelper
...
class AdapterTest(TopshimBaseTest):
    ...
    async def _test_verify_adapter_started(self):
        ...
        self.dut_adapter.fetch_events(asyncio.get_running_loop())
        self.dut_adapter.pending_future = \
