...
inline tBLE_ADDR_TYPE to_identity_ble_addr_type(tBLE_ADDR_TYPE type) {
  switch (type) {
    case BLE_ADDR_PUBLIC:
    case BLE_ADDR_PUBLIC_ID:
    ...
    case BLE_ADDR_ANONYMOUS:
    default:
      return BLE_ADDR_ANONYMOUS;
  }
}

inline tBLE_ADDR_TYPE from_identity_ble_addr_type(tBLE_ADDR_TYPE type) {
  switch (type) {
    case BLE_ADDR_PUBLIC:
    case BLE_ADDR_PUBLIC_ID:
