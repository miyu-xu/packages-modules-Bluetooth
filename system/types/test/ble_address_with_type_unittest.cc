...
TEST(BleAddressWithTypeTest, to_identity_ble_addr_type) {
  ASSERT_TRUE(to_identity_ble_addr_type(BLE_ADDR_PUBLIC) == BLE_ADDR_PUBLIC_ID);
  ASSERT_TRUE(to_identity_ble_addr_type(BLE_ADDR_PUBLIC_ID) ==
              BLE_ADDR_PUBLIC_ID);
  ASSERT_TRUE(to_identity_ble_addr_type(BLE_ADDR_RANDOM) == BLE_ADDR_RANDOM_ID);
  ASSERT_TRUE(to_identity_ble_addr_type(BLE_ADDR_RANDOM_ID) ==
              BLE_ADDR_RANDOM_ID);
}

TEST(BleAddressWithTypeTest, from_identity_ble_addr_type) {
  ASSERT_TRUE(from_identity_ble_addr_type(BLE_ADDR_PUBLIC) == BLE_ADDR_PUBLIC);
  ASSERT_TRUE(from_identity_ble_addr_type(BLE_ADDR_PUBLIC_ID) ==
              BLE_ADDR_PUBLIC);
  ASSERT_TRUE(from_identity_ble_addr_type(BLE_ADDR_RANDOM) == BLE_ADDR_RANDOM);
  ASSERT_TRUE(from_identity_ble_addr_type(BLE_ADDR_RANDOM_ID) ==
              BLE_ADDR_RANDOM);
}
