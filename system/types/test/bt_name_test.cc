...
TEST(BtNameTest, new_name) {
  BD_NAME bd_name1 = {};
  bd_name_new(bd_name1, "ATestName");

  BD_NAME bd_name2 = {};
  bd_name_new(bd_name2, "ATestName");

  BD_NAME bd_name3 = {};
  bd_name_new(bd_name3, "ADifferentTestName");
...
TEST(BtNameTest, new_name_nullptr) {
  BD_NAME bd_name1 = {0};
  bd_name_new(bd_name1, nullptr);
  ASSERT_TRUE(bd_name_is_empty(bd_name1));

  BD_NAME bd_name2 = {};
  bd_name_new(bd_name2, "ARealTestName");
  bd_name_new(bd_name2, nullptr);
  ASSERT_FALSE(bd_name_is_empty(bd_name2));
}

TEST(BtNameTest, clear) {
  BD_NAME bd_name = {};
  bd_name_new(bd_name, "ATestName");
