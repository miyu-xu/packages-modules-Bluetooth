...
typedef enum {
  ...
  OI_HANDSFREE_SERVICE_NOT_STARTED = 1803,      /**< HANDSFREE: Cannot connect to
                                                   ...
                                                   not started */
  OI_HANDSFREE_AG_SERVICE_NOT_STARTED = 1804,   /**< HANDSFREE: Cannot connect to handsfree device
                                                   if handsfree AG   service not started */
  ...
  OI_AVRCP_RESPONSE_INTERNAL_ERROR = 3308,      /**< AVRCP: Command rejected: target detected other
                                                   error conditions. */
