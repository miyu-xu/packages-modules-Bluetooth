...
HACK_ProfileInterface mock_HACK_profile_interface = {
    .btif_hh_connect = [](const tTypedAddressTransport& dev_add /* dev_addr */)
        -> bt_status_t { return BT_STATUS_SUCCESS; },
    .btif_hh_virtual_unplug =
        [](const tTypedAddressTransport& dev_add /* bd_addr */) -> bt_status_t {
      return BT_STATUS_SUCCESS;
    },
    .bta_hh_read_ssr_param = [](const tTypedAddressTransport& /* bd_addr */,
                                uint16_t* /* p_max_ssr_lat */,
                                uint16_t* /* p_min_ssr_tout */)
        -> tBTA_HH_STATUS { return BTA_HH_OK; },
