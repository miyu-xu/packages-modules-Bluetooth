...
EventCallbacks mock_event_callbacks = {
  ...
  .invoke_ssp_request_cb = [](RawAddress /* bd_addr */, bt_ssp_variant_t /* pairing_variant */,
                              uint32_t /* pass_key */) {},
  ...
  .invoke_link_quality_report_cb = [](uint64_t /* timestamp */, int /* report_id */, int /* rssi */,
...
HACK_ProfileInterface mock_HACK_profile_interface = {
  ...
  .bta_hh_read_ssr_param = [](const tAclLinkSpec& /* link_spec */, uint16_t* /* p_max_ssr_lat */,
