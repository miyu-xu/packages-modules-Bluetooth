...
class BtaAvCo {
 public:
   ...
   */
  bool SetActivePeer(const RawAddress& peer_address, const uint16_t profile);
 ...
 private:
   ...
   */
  BtaAvCoState* getRelevantState(const BtaAvCoPeer* p_peer);
  ...
  BtaAvCoState bta_av_source_state_;
  BtaAvCoState bta_av_sink_state_;
};
