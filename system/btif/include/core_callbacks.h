...
// These callbacks are non-profile specific (e.g. connection complete, bond
...
struct CodecInterface {
  virtual void initializeCodecs();
  virtual void cleanupCodecs();
...
struct CoreInterface {
  ...
  CodecInterface* codecs;
  HACK_ProfileInterface* profileSpecific_HACK;

  virtual void toggleProfile(tBTA_SERVICE_ID service_id, bool enable);
