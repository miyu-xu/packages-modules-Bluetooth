...
struct HACK_ProfileInterface {
  // HID hacks
  bt_status_t (*btif_hh_connect)(const tTypedAddressTransport* bd_addr);
  bt_status_t (*btif_hh_virtual_unplug)(const tTypedAddressTransport* bd_addr);
  tBTA_HH_STATUS (*bta_hh_read_ssr_param)(const tTypedAddressTransport& bd_addr,
