...
typedef struct {
  ...
  alarm_t* ready_timer;    // to delay marking a device as ready, to give input chance to listen.
  alarm_t* disconn_timer;  // to disconnect device if still not ready after some time.
} btif_hh_uhid_t;
