...
typedef struct {
  ...
  tTypedAddressTransport pending_conn_address;
} btif_hh_cb_t;
...
void btif_hh_remove_device(const tTypedAddressTransport& addr_transport);
bool btif_hh_add_added_dev(const tTypedAddressTransport& addr_transport,
                           tBTA_HH_ATTR_MASK attr_mask);
