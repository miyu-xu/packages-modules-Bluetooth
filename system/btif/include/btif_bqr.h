...
// have equal size.
static_assert(sizeof(BqrEnergyMonitorEvent) == sizeof(BqrEnergyMonitorEvent),
              "BqrEnergyMonitorEvent Size is not correct");
...
// Ensure the internal device class implementation and public one
// have equal size.
static_assert(sizeof(BqrRFStatsEvent) == sizeof(BqrRFStatsEvent),
              "BqrRFStatsEvent Size is not correct");
