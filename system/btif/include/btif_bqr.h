...
// Total length of all parameters of the Energy monitor event
static constexpr uint8_t kEnergyMonitorParamTotalLen = 81;
// Total length of all parameters of the RF Stats event
static constexpr uint8_t kRFStatsParamTotalLen = 82;
...
public:
  ...
  // @param length Total length of all parameters contained in the sub-event.
  // @param p_param_buf A pointer to the parameters contained in the sub-event.
  void ParseBqrEnergyMonitorEvt(uint8_t length, const uint8_t* p_param_buf);
  // Parse the RF Stats BQR event.
  //
  // @param length Total length of all parameters contained in the sub-event.
  // @param p_param_buf A pointer to the parameters contained in the sub-event.
  void ParseBqrRFStatsEvt(uint8_t length, const uint8_t* p_param_buf);
