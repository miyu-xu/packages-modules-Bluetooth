 ...
 public:
  ...
  void ListPlayerSettings(ListPlayerSettingsCallback cb) override {
    auto cb_lambda = [](ListPlayerSettingsCallback cb,
      ...
      do_in_main_thread(FROM_HERE, base::Bind(cb, attributes));
    };
  ...
  void ListPlayerSettingValues(PlayerAttribute setting,
    ...
    auto cb_lambda = [](ListPlayerSettingValuesCallback cb,
      ...
      do_in_main_thread(FROM_HERE, base::Bind(cb, setting, values));
    };
  ...
  void SetPlayerSettings(std::vector<PlayerAttribute> attributes,
    ...
    do_in_avrcp_jni(base::Bind(&PlayerSettingsInterface::SetPlayerSettings,
                               base::Unretained(wrapped_), attributes, values,
                               bound_cb));
  }
