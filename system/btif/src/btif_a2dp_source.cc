...
bool btif_a2dp_source_init(
  ...
  local_thread()->DoInThread(base::BindOnce(&btif_a2dp_source_init_delayed, offload_enabled,
...
static bool btif_a2dp_source_startup(
  ...
  local_thread()->DoInThread(base::BindOnce(&btif_a2dp_source_startup_delayed, offload_enabled,
                                            std::move(provider_info)));
