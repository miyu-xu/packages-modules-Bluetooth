...
void btif_av_update_source_metadata(btav_a2dp_codec_audio_context_t audio_context) {
  bool is_gaming_mode = (audio_context == BTAV_A2DP_CODEC_AUDIO_CONTEXT_GAME);
  log::info("active_peer={}, is_gaming={}",btif_av_source_active_peer(), is_gaming_mode);

  btif_av_set_latency_req_t set_latency_req;
  set_latency_req.is_low_latency = false;
  set_latency_req.is_gaming_enabled = is_gaming_mode;
