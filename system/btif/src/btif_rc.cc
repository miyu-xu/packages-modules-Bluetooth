...
static void btif_rc_upstreams_evt(uint16_t event, tAVRC_COMMAND* pavrc_cmd,
  ...
  switch (event) {
    ...
    case AVRC_PDU_LIST_PLAYER_APP_ATTR: {
        ...
        HAL_CBACK(bt_rc_callbacks, list_player_app_attr_cb, p_dev->rc_addr);
    } break;
    ...
    case AVRC_PDU_GET_CUR_PLAYER_APP_VALUE: {
        ...
        HAL_CBACK(bt_rc_callbacks, get_player_app_value_cb ,
                pavrc_cmd->get_cur_app_val.num_attr, player_attr, p_dev->rc_addr);
    } break;
    case AVRC_PDU_SET_PLAYER_APP_VALUE: {
        ...
        else
        {
            ...
            HAL_CBACK(bt_rc_callbacks, set_player_app_value_cb, &attr, p_dev->rc_addr);
        }
    } break;
    case AVRC_PDU_GET_PLAYER_APP_ATTR_TEXT: {
        ...
        else
        {
            ...
            HAL_CBACK(bt_rc_callbacks, get_player_app_attrs_text_cb,
                        pavrc_cmd->get_app_attr_txt.num_attr, player_attr_txt, p_dev->rc_addr);
        }
    } break;
    case AVRC_PDU_GET_PLAYER_APP_VALUE_TEXT: {
        ...
        else
        {
            ...
            HAL_CBACK(bt_rc_callbacks, get_player_app_values_text_cb,
                      ...
                      pavrc_cmd->get_app_val_txt.vals, p_dev->rc_addr);
        }
    } break;
...
**
****************************************************************************/
static bt_status_t  list_player_app_attr_rsp(const RawAddress& bd_addr, int num_attr, btrc_player_attr_t *p_attrs)
{
    tAVRC_RESPONSE avrc_rsp;
    int i;
    btif_rc_device_cb_t* p_dev = btif_rc_get_device_by_bda(bd_addr);
...
************************************************************************/
static bt_status_t  list_player_app_value_rsp(const RawAddress& bd_addr, int num_val, uint8_t *value)
{
    tAVRC_RESPONSE avrc_rsp;
    int i;
    btif_rc_device_cb_t* p_dev = btif_rc_get_device_by_bda(bd_addr);
...
**
***********************************************************************/
static bt_status_t get_player_app_value_rsp(const RawAddress& bd_addr, btrc_player_settings_t *p_vals)
{
    tAVRC_RESPONSE avrc_rsp;
    uint32_t i;
    btif_rc_device_cb_t* p_dev = btif_rc_get_device_by_bda(bd_addr);
...
**
*******************************************************************/
static bt_status_t set_player_app_value_rsp (const RawAddress& bd_addr, btrc_status_t rsp_status)
{
    tAVRC_RESPONSE avrc_rsp;
    btif_rc_device_cb_t* p_dev = btif_rc_get_device_by_bda(bd_addr);
    CHECK_RC_CONNECTED(p_dev);
...
**
*******************************************************************/
static bt_status_t get_player_app_attr_text_rsp(const RawAddress& bd_addr, int num_attr,
...
**
*******************************************************************/
static bt_status_t get_player_app_value_text_rsp(const RawAddress& bd_addr, int num_attr, btrc_player_setting_text_t *p_attrs)
{
    tAVRC_RESPONSE avrc_rsp;
    tAVRC_APP_SETTING_TEXT attr_txt[AVRC_MAX_APP_ATTR_SIZE];
    int i;
