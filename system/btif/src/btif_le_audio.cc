...
class LeAudioClientInterfaceImpl : public LeAudioClientInterface, public LeAudioClientCallbacks {
  ...
  void SetEnableState(const RawAddress& address, bool enabled) override {
    ...
    do_in_main_thread(FROM_HERE,
                      Bind(&LeAudioClient::SetEnableState, Unretained(LeAudioClient::Get()),
                           address, enabled));
  }
  ...
  void GroupAddNode(const int group_id, const RawAddress& address) override {
    ...
    do_in_main_thread(FROM_HERE,
                      Bind(&LeAudioClient::GroupAddNode, Unretained(LeAudioClient::Get()), group_id,
                           address));
  }
  ...
  void GroupRemoveNode(const int group_id, const RawAddress& address) override {
    ...
    do_in_main_thread(FROM_HERE,
                      Bind(&LeAudioClient::GroupRemoveNode, Unretained(LeAudioClient::Get()),
                           group_id, address));
  }
  ...
  void SetCodecConfigPreference(int group_id, btle_audio_codec_config_t input_codec_config,
    ...
    do_in_main_thread(
            FROM_HERE,
            Bind(&LeAudioClient::SetCodecConfigPreference, Unretained(LeAudioClient::Get()),
  ...
  void SetCcidInformation(int ccid, int context_type) {
    ...
    do_in_main_thread(FROM_HERE,
                      Bind(&LeAudioClient::SetCcidInformation, Unretained(LeAudioClient::Get()),
                           ccid, context_type));
  }
  ...
  void SetUnicastMonitorMode(uint8_t direction, bool enable) {
    ...
    do_in_main_thread(FROM_HERE,
                      Bind(&LeAudioClient::SetUnicastMonitorMode, Unretained(LeAudioClient::Get()),
                           direction, enable));
  }
  ...
  void SetGroupAllowedContextMask(int group_id, int sink_context_types, int source_context_types) {
    ...
    do_in_main_thread(
            FROM_HERE,
            Bind(&LeAudioClient::SetGroupAllowedContextMask, Unretained(LeAudioClient::Get()),
