...
#include "bta/le_audio/le_audio_set_configurations.h"
...
class LeAudioClientInterfaceImpl : public LeAudioClientInterface,
  ...
  void Initialize(LeAudioClientCallbacks* callbacks,
    ...
    le_audio::set_configurations::AudioSetConfigurationProvider::Initialize();
    do_in_main_thread(
  ...
  void Cleanup(void) override {
    ...
    do_in_main_thread(
        ...
        Bind(&LeAudioClient::Cleanup,
             jni_thread_wrapper(
                 FROM_HERE, Bind(&le_audio::set_configurations::
