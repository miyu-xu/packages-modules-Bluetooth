 ...
 * @param p_search_data {@code tBTA_DM_SEARCH} search data
 * @param asha_capability value will be updated if this field is found
 * @param asha_truncated_hi_sync_id value will be updated if this field is found
 */
static void get_asha_service_data(tBTA_DM_SEARCH* p_search_data,
  ...
  switch (event) {
    ...
    case BTA_DM_INQ_RES_EVT: {
...

      {
        ...
        // A non-negative value represents SHA capability information is valid.
        ...
        get_asha_service_data(p_search_data, asha_capability,
