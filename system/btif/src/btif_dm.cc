...
static void btif_stats_add_bond_event(bt_status_t status, const RawAddress& bd_addr,
                                      bt_bond_function_t function, bt_bond_state_t state,
                                      tHCI_ERROR_CODE fail_reason);
...
static void bond_state_changed(bt_status_t status, const RawAddress& bd_addr,
                               bt_bond_state_t state) {
  btif_stats_add_bond_event(status, bd_addr, BTIF_DM_FUNC_BOND_STATE_CHANGED, state,
...
void btif_dm_create_bond(const RawAddress bd_addr, tBT_TRANSPORT transport) {
  ...
  btif_stats_add_bond_event(BT_STATUS_NA, bd_addr, BTIF_DM_FUNC_CREATE_BOND, pairing_cb.state,
                            (tHCI_ERROR_CODE)pairing_cb.fail_reason);
...
void btif_dm_cancel_bond(const RawAddress bd_addr) {
  ...
  btif_stats_add_bond_event(BT_STATUS_NA, bd_addr, BTIF_DM_FUNC_CANCEL_BOND, pairing_cb.state,
                            (tHCI_ERROR_CODE)pairing_cb.fail_reason);
...
void btif_dm_remove_bond(const RawAddress bd_addr) {
  ...
  btif_stats_add_bond_event(BT_STATUS_NA, bd_addr, BTIF_DM_FUNC_REMOVE_BOND, pairing_cb.state,
                            (tHCI_ERROR_CODE)pairing_cb.fail_reason);
