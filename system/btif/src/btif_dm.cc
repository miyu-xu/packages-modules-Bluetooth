...
bt_status_t btif_in_execute_service_request(tBTA_SERVICE_ID service_id,
  ...
  switch (service_id) {
    ...
    case BTA_MN_SERVICE_ID: {
      /**
       * Do nothing; these services were started elsewhere. However, we need to
       * flow through this codepath in order to properly report back the local
       * UUIDs back to adapter properties in Java. To achieve this, we need to
       * catch these service IDs in order for {@link
