...
<<<<<<< PATCH SET (ec24ce add implementation for detecting REMOTE_IS_ASHA_FOLLOWER)
        ...
        if (p_search_data->inq_res.p_eir) {
          // based on ASHA advertising service data to decide whether it is
          // hidden
          ...
          while ((p_service_data = AdvertiseDataParser::GetFieldByType(
            ...
            if (uuid == 0xfdf0 /* ASHA service*/) {
              ...
              if (service_data_len < 8) {
                ...
                // Get ASHA capability byte and retrieve 2nd bit value
                ...
                if (is_ASHA_follower) {
                  BTIF_STORAGE_FILL_PROPERTY(
                      ...
                      BT_PROPERTY_REMOTE_IS_ASHA_FOLLOWER, sizeof(bool),
                      &is_ASHA_follower);
                }
              }
              break;
...
=======
>>>>>>> BASE      (80150f Merge "Reduce excessive l2cap traffic logging")
