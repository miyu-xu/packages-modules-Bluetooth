...
void btif_enable_bluetooth_evt() {
  ...
  if (!btif_config_get_str(BTIF_STORAGE_SECTION_ADAPTER , BTIF_STORAGE_KEY_ADDRESS , val, &val_size) ||
    ...
    LOG_INFO("Storing '%s' into the config file", ADDRESS_TO_LOGGABLE_CSTR(local_bd_addr));
