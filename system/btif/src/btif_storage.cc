...
bt_status_t btif_storage_load_bonded_devices(void) {
...

  {
    for (i = 0; i < bonded_devices.num_devices; i++) {
      ...
      btif_storage_get_remote_prop(p_remote_addr, BT_PROPERTY_UUIDS, remote_uuids_le,
                                   sizeof(remote_uuids_le), &remote_properties[num_props]);
      num_props++;

      btif_storage_get_remote_prop(p_remote_addr, BT_PROPERTY_UUIDS, remote_uuids_bredr,
