...
const std::unordered_set<std::string> kLinkKeyTypes = {
    BTIF_STORAGE_KEY_LINK_KEY ,      BTIF_STORAGE_KEY_LE_KEY_PENC , BTIF_STORAGE_KEY_LE_KEY_PID ,
    BTIF_STORAGE_KEY_LE_KEY_PCSRK , BTIF_STORAGE_KEY_LE_KEY_LENC , BTIF_STORAGE_KEY_LE_KEY_LCSRK };
