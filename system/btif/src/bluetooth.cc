...
static int create_bond_out_of_band(const RawAddress* bd_addr, int transport,
  ...
  do_in_main_thread(FROM_HERE,
                    base::BindOnce(btif_dm_create_bond_out_of_band, *bd_addr, transport, *p192_data,
                                   *p256_data));
  return BT_STATUS_SUCCESS;
}
...
EXPORT_SYMBOL bt_interface_t bluetoothInterface = {
  ...
  .set_event_filter_connection_setup_all_devices = set_event_filter_connection_setup_all_devices,
