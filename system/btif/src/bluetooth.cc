...
static bluetooth::core::CoreInterface* CreateInterfaceToProfiles() {
  ...
  if (!eventCallbacks_initialized) {
    eventCallbacks.invoke_adapter_state_changed_cb = invoke_adapter_state_changed_cb;
    eventCallbacks.invoke_adapter_properties_cb = invoke_adapter_properties_cb;
    eventCallbacks.invoke_remote_device_properties_cb = invoke_remote_device_properties_cb;
    eventCallbacks.invoke_device_found_cb = invoke_device_found_cb;
    eventCallbacks.invoke_discovery_state_changed_cb = invoke_discovery_state_changed_cb;
    ...
    eventCallbacks.invoke_address_consolidate_cb = invoke_address_consolidate_cb;
    eventCallbacks.invoke_le_address_associate_cb = invoke_le_address_associate_cb;
    ...
    eventCallbacks.invoke_link_quality_report_cb = invoke_link_quality_report_cb;
  ...
  if (!profileInterface_initialized) {
    ...
    // LE Audio
    profileInterface.IsLeAudioClientRunning = LeAudioClient::IsLeAudioClientRunning;
