 ...
 *                  and key.
 *
 *                  section : The section name (i.e
 *BTIF_STORAGE_SECTION_ADAPTER) key : The key name (i.e
 *BTIF_STORAGE_KEY_ADDRESS) value : A pointer to a buffer where we will store
 *the value size_bytes : The size of the buffer we have available to write the
 *value into. Will be updated upon returning to contain the number of bytes
 *                               written.
 *
