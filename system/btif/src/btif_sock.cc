  ...
  *sock_fd = INVALID_FD;
  ...
  if (status != BT_STATUS_SUCCESS) {
    log::info("address={}, state={}, role={}, server_name={}, channel={}",
              ...
              SOCKET_CONNECTION_STATE_DISCONNECTED, SOCKET_ROLE_LISTEN,
...
static bt_status_t btsock_connect(const RawAddress* bd_addr, btsock_type_t type,
  ...
  *sock_fd = INVALID_FD;
  ...
  log::info("address={}, state={}, role={}, server_name={}, channel={}",
            ...
            SOCKET_CONNECTION_STATE_CONNECTING, SOCKET_ROLE_CONNECTION,
            uuid->ToString().c_str(), channel);
  ...
  if (status != BT_STATUS_SUCCESS) {
    log::info("address={}, state={}, role={}, server_name={}, channel={}",
              ADDRESS_TO_LOGGABLE_CSTR(*bd_addr),
              SOCKET_CONNECTION_STATE_DISCONNECTED, SOCKET_ROLE_CONNECTION,
              uuid->ToString().c_str(), channel);
    btif_sock_connection_logger(SOCKET_CONNECTION_STATE_DISCONNECTED,
                                SOCKET_ROLE_CONNECTION, *bd_addr, channel,
                                uuid->ToString().c_str());
