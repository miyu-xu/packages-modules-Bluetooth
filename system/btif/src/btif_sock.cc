...
static bt_status_t btsock_listen(btsock_type_t type, const char* service_name, const Uuid* uuid,
                                 int channel, int* sock_fd, int flags, int app_uid, int data_path,
                                 const char* socket_name, long hub_id, long endpoint_id,
                                 bool auto_switch);
...
static bt_status_t btsock_listen(btsock_type_t type, const char* service_name,
                                 ...
                                 int app_uid, int data_path, const char* socket_name, long hub_id,
                                 long endpoint_id, bool auto_switch) {
  ...
  *sock_fd = INVALID_FD;
  ...
  log::info(
          ...
          "channel: {}, app_uid: {}, data_path: {}, hub_id: {}, endpoint_id: {}, auto_switch: {}",
          RawAddress::kEmpty, type, channel, app_uid, data_path, hub_id, endpoint_id, auto_switch);
...
static bt_status_t btsock_connect(const RawAddress* bd_addr, btsock_type_t type, const Uuid* uuid,
  ...
  log::info(
          ...
          "app_uid: {}, data_path: {}, hub_id: {}, endpoint_id: {}, auto_switch: {}",
          *bd_addr, type, channel, app_uid, data_path, hub_id, endpoint_id, auto_switch);
