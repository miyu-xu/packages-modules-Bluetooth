...
static bt_status_t btsock_get_l2cap_local_cid(uint32_t id, uint16_t* cid);
static bt_status_t btsock_get_l2cap_remote_cid(uint32_t id, uint16_t* cid);
...
static bt_status_t btsock_get_l2cap_local_cid(uint32_t id, uint16_t* cid) {
  return btsock_l2cap_get_l2cap_local_cid(id, cid);
}

static bt_status_t btsock_get_l2cap_remote_cid(uint32_t id, uint16_t* cid) {
  return btsock_l2cap_get_l2cap_remote_cid(id, cid);
}