...
static bt_status_t btsock_listen(btsock_type_t type, const char* service_name, const Uuid* uuid,
                                 int channel, int* sock_fd, int flags, int app_uid, int data_mode,
                                 const char* socket_name, int hub_id, int endpoint_id,
                                 bool auto_switch);
...
static bt_status_t btsock_listen(btsock_type_t type, const char* service_name,
  ...
  *sock_fd = INVALID_FD;
  ...
  log::info(
          ...
          "channel: {}, app_uid: {}, data_mode: {}, hub_id: {}, endpoint_id: {}, auto_switch: {}",
          RawAddress::kEmpty, type, channel, app_uid, data_mode, hub_id, endpoint_id, auto_switch);
  ...
  switch (type) {
    case BTSOCK_RFCOMM:
      ...
      break;
    case BTSOCK_L2CAP:
      status = btsock_l2cap_listen(service_name, channel, sock_fd, flags, app_uid, data_mode,
    ...
    case BTSOCK_L2CAP_LE:
      status = btsock_l2cap_listen(service_name, channel, sock_fd, flags | BTSOCK_FLAG_LE_COC,
                                   app_uid, data_mode, socket_name, hub_id, endpoint_id,
                                   auto_switch);
      break;
    case BTSOCK_SCO:
...
static bt_status_t btsock_connect(const RawAddress* bd_addr, btsock_type_t type, const Uuid* uuid,
  ...
  log::info(
          ...
          "app_uid: {}, data_mode: {}, hub_id: {}, endpoint_id: {}, auto_switch: {}",
          *bd_addr, type, channel, app_uid, data_mode, hub_id, endpoint_id, auto_switch);
  ...
  *sock_fd = INVALID_FD;
  ...
  switch (type) {
    ...
    case BTSOCK_L2CAP:
      status = btsock_l2cap_connect(bd_addr, channel, sock_fd, flags, app_uid, data_mode,
                                    socket_name, hub_id, endpoint_id, auto_switch);
      break;
    case BTSOCK_L2CAP_LE:
      status =
