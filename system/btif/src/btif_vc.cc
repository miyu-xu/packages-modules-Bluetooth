...
class VolumeControlInterfaceImpl : public VolumeControlInterface, public VolumeControlCallbacks {
  ...
  void OnExtAudioInGainSettingsPropertiesChanged(const RawAddress& address, uint8_t ext_input_id,
                                                 uint8_t unit, int8_t min, int8_t max) override {
    do_in_jni_thread(Bind(&VolumeControlCallbacks::OnExtAudioInGainSettingsPropertiesChanged,
