...
const BtaAvCoSep* BtaAvCo::SelectSourceCodec(BtaAvCoPeer* p_peer) {
  ...
  log::info("{}: prefer software_codec {}  offload_codec {}", __func__,
...
bool BtaAvCo::UpdateSelectableSourceCodec(const A2dpCodecConfig& codec_config,
  ...
  if (p_sink == nullptr) {
    ...
    log::verbose("{}: peer {} does not support codec {}", __func__,
  ...
  log::verbose("{}: successfully set codec {} of sink peer {}", __func__,
