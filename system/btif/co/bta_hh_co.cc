...
#define BTA_HH_UHID_READY_TIMEOUT_MS 10000
#define BTA_HH_UHID_READY_SHORT_TIMEOUT_MS 2000
    ...
    case UHID_CLOSE:
      ...
      if (com::android::bluetooth::flags::hid_report_queuing()) {
        ...
        if (com::android::bluetooth::flags::close_hid_if_uhid_ready_too_slow()) {
          ...
          if (!alarm_is_scheduled(p_uhid->ready_disconn_timer)) {
            alarm_set_on_mloop(p_uhid->ready_disconn_timer, BTA_HH_UHID_READY_SHORT_TIMEOUT_MS,
...
static void* btif_hh_poll_event_thread(void* arg) {
  ...
  if (com::android::bluetooth::flags::hid_report_queuing()) {
    ...
    if (com::android::bluetooth::flags::close_hid_if_uhid_ready_too_slow()) {
      alarm_set_on_mloop(p_uhid->ready_disconn_timer, BTA_HH_UHID_READY_TIMEOUT_MS,
                         uhid_ready_disconn_timeout, INT_TO_PTR(p_uhid->dev_handle));
    }
