...
static btrc_ctrl_callbacks_t default_btrc_ctrl_callbacks = {
    ...
    .passthrough_rsp_cb = [](const RawAddress& /* bd_addr */, int /* id */,
                             int /* key_state */) { ASSERT_TRUE(false); },
    .groupnavigation_rsp_cb = [](int /* id */,
                                 int /* key_state */) { ASSERT_TRUE(false); },
    .connection_state_cb =
        [](bool /* rc_connect */, bool /* bt_connect */,
           const RawAddress& /* bd_addr */) { ASSERT_TRUE(false); },
    .getrcfeatures_cb = [](const RawAddress& /* bd_addr */,
                           int /* features */) { ASSERT_TRUE(false); },
    .setplayerappsetting_rsp_cb =
    ...
    .playerapplicationsetting_cb =
        [](const RawAddress& /* bd_addr */, uint8_t /* num_attr */,
           ...
           btrc_player_app_ext_attr_t* /* ext_attrs */) { ASSERT_TRUE(false); },
    .playerapplicationsetting_changed_cb =
        [](const RawAddress& /* bd_addr */,
           const btrc_player_settings_t& /* vals */) { ASSERT_TRUE(false); },
    .setabsvol_cmd_cb = [](const RawAddress& /* bd_addr */,
                           uint8_t /* abs_vol */,
                           uint8_t /* label */) { ASSERT_TRUE(false); },
    ...
    .get_cover_art_psm_cb =
        [](const RawAddress& /* bd_addr */, const uint16_t /* psm */) {
          ASSERT_TRUE(false);
        },
};
