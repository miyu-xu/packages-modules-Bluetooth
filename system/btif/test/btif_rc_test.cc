...
int osi_property_get(char const*, char*, char const*){return 0;}
void osi_free_and_reset(void**){}
void* osi_malloc(size_t size){return nullptr;}
void* osi_calloc(size_t size){return nullptr;}

void list_clear(list_t*){}
list_node_t*  list_foreach(list_t const*, bool (*)(void*, void*), void*){return nullptr;}
list_node_t*  list_begin(list_t const*){return nullptr;}
void*  list_node(list_node_t const*){return nullptr;}
list_node_t*   list_next(list_node_t const*){return nullptr;}
list_t* list_new(list_free_cb callback){return nullptr;}
bool  list_remove(list_t*, void*){return true;}
bool  list_append(list_t*, void*){return true;}
bool  list_is_empty(list_t const*){return true;}
void*  list_front(list_t const*){return nullptr;}

bool alarm_is_scheduled(alarm_t const*){return true;}
uint64_t alarm_get_remaining_ms(alarm_t const*){return 0;}
void  alarm_free(alarm_t*){}
alarm_t*  alarm_new(char const*){return nullptr;}
...
void AvrcpService::ServiceInterfaceImpl::SetBipClientStatus(const RawAddress& bdaddr, bool connected) {};
