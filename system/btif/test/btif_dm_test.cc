...
TEST_F(BtifDmTest, bta_energy_info_cb__with_no_uuid) {
  bluetooth::core::testing::mock_event_callbacks.invoke_energy_info_cb =
      [](bt_activity_energy_info /* energy_info */,
         bt_uid_traffic_t* /* uid_data */) { LOG_INFO("CMM no uuid hit"); };
...
TEST_F(BtifDmWithUidTest, bta_energy_info_cb__with_uuid) {
  bluetooth::core::testing::mock_event_callbacks.invoke_energy_info_cb =
      [](bt_activity_energy_info /* energy_info */,
         bt_uid_traffic_t* /* uid_data */) { LOG_INFO("CMM with uuid hit"); };
  bluetooth::legacy::testing::bta_energy_info_cb(
      tx_time, rx_time, idle_time, energy_used, BTM_CONTRL_UNKNOWN,
      BTA_SUCCESS);
}
