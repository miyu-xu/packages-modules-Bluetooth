...
public:
   ...
   */
  virtual bool RegisterSocketHalCallbacks(hal::SocketHalCallback* callbacks) = 0;

  /**
   * Retrieves the supported offload features available from LPP offload HALs.
   *
   * @return Supported LPP offload features
   */
  virtual LppOffloadFeatures GetOffloadFeaturesSupported() const = 0;
