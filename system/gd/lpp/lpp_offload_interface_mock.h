...
public:
  MOCK_METHOD(bool, RegisterSocketHalCallbacks, (hal::SocketHalCallback*), (override));
  MOCK_METHOD(LppOffloadFeatures, GetOffloadFeaturesSupported, (), (override));
  MOCK_METHOD(hal::SocketCapabilities, GetSocketCapabilities, (), (override));
