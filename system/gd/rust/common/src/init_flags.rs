     ...
     dependencies: { $($parent:ident => $child:ident),* }) => {
        ...
        impl $name {
            ...
            fn dump(&self) -> String {
                ...
                $(
                    out.push_str(stringify!($flag));
                    out.push_str(": ");
                    out.push_str(&format!("{}", self.$flag));
                    out.push_str("\n");
                )*
                $(
                    out.push_str(stringify!($dy_flag));
                    out.push_str(": ");
                    out.push_str(&format!("{}", self.$dy_flag));
                    out.push_str("\n");
                )*
                $(
                    out.push_str(stringify!($extra_field));
                    out.push_str(": ");
                    out.push_str(&format!("{}", self.$extra_field));
                    out.push_str("\n");
                )*
                out
            }
...
/// Dumps all the flags in a format suitable for the dumpsys
pub fn dump() -> String {
