...
impl Default for ParameterProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ParameterProvider {
    ...
    pub fn new() -> Self {
        Self {
            configuration_file_path: "/data/misc/bluedroid/bt_config.conf".to_string(),
            btsnoop_log_file_path: "/data/misc/bluetooth/logs/btsnoop_hci.log".to_string(),
            btsnooz_log_file_path: "/data/misc/bluetooth/logs/btsnooz_hci.log".to_string(),
...
mod tests {
    ...
    async fn test_config_file_path() {
        let param_provider = Arc::new(Mutex::new(ParameterProvider::new()));
