    ...
    command_options.insert(
        ...
        CommandOption {
            rules: vec![
                ...
                String::from("advertise set-data <type> <payload> <adv_id>"),
            ],
    ...
    fn cmd_advertise(&mut self, args: &Vec<String>) -> CommandResult {
        ...
        match &command[..] {
            ...
            "set-data" => {
                ...
                let adv_id = String::from(get_arg(args, 3)?)
                    .parse::<i32>()
                ...
                context.gatt_dbus.as_mut().unwrap().set_raw_data(adv_id, ad_type, ad_payload);
            }
            _ => return Err(CommandError::InvalidArgs),
        }
