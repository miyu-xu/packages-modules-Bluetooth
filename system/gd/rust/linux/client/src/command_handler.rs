    ...
    command_options.insert(
        ...
        CommandOption {
            rules: vec![
                ...
                String::from("socket listen-rfcomm <csn>"),
                String::from("socket send-msc <dlci> <addr>"),
                String::from(
        ...
        match &command[..] {
            ...
            "send-msc" => {
                ...
                self.context
                    ...
                    .as_mut()
                    .unwrap()
                    .rfcomm_start_control_request(dlci, addr);
            }
            "listen-rfcomm" => {
                let csn = String::from(get_arg(args, 1)?)
                    .parse::<i32>()
                ...
                let SocketResult { status, id } = self
                    ...
                    .as_mut()
                    .unwrap()
                    .listen_using_rfcomm(callback_id, Some(csn), None, None, None);
