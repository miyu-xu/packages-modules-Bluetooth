...
impl IAdvertisingSetCallback for AdvertisingSetCallback {
    fn on_advertising_set_started(&self, advertiser_id: i32, tx_power: i32, status: i32) {
        print_info!("on_advertising_set_started: advertiser_id = {}, tx_power = {}, status = {}", advertiser_id, tx_power, status);
    }

    fn on_own_address_read(&self, advertiser_id: i32, address_type: i32, address: String) {
        print_info!("on_own_address_read: advertiser_id = {}, address_type = {}, address = {}", advertiser_id, address_type, address);
    }
    ...
    fn on_advertising_enabled(&self, advertiser_id: i32, enable: bool, status: i32) {
        print_info!("on_advertising_enabled: advertiser_id = {}, enable = {}, status = {}", advertiser_id, enable, status);
    }

    fn on_advertising_data_set(&self, advertiser_id: i32, status: i32) {
        print_info!("on_advertising_data_set: advertiser_id = {}, status = {}", advertiser_id, status);
    }

    fn on_scan_response_data_set(&self, advertiser_id: i32, status: i32) {
        print_info!("on_scan_response_data_set: advertiser_id = {}, status = {}", advertiser_id, status);
    }

    fn on_advertising_parameters_updated(&self, advertiser_id: i32, tx_power: i32, status: i32) {
        print_info!("on_advertising_parameters_updated: advertiser_id = {}, tx_power: {}, status = {}", advertiser_id, tx_power, status);
    }

    fn on_periodic_advertising_parameters_updated(&self, advertiser_id: i32, status: i32) {
        print_info!("on_periodic_advertising_parameters_updated: advertiser_id = {}, status = {}", advertiser_id, status);
    }

    fn on_periodic_advertising_data_set(&self, advertiser_id: i32, status: i32) {
        print_info!("on_periodic_advertising_data_set: advertiser_id = {}, status = {}", advertiser_id, status);
    }

    fn on_periodic_advertising_enabled(&self, advertiser_id: i32, enable: bool, status: i32) {
        print_info!("on_periodic_advertising_enabled: advertiser_id = {}, enable = {}, status = {}", advertiser_id, enable, status);
    }
}
