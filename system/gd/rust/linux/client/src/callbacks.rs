...
impl IBluetoothMediaCallback for MediaCallback {
    fn on_ble_bluetooth_audio_device_added(&mut self, _device: BluetoothAudioDevice) {}
    fn on_ble_bluetooth_audio_device_removed(&mut self, _addr: String) {}
    fn on_ble_group_status(&mut self, _group_id: i32, _status: BtLeAudioGroupStatus) {}
    ...
    fn on_ble_group_stream_status(&mut self, _group_id: i32, _status: BtLeAudioGroupStreamStatus) {}
