...
// Iterates over Advertising Data's elements having the given AD type. `next()` returns the next slice of the advertising data element excluding the length and type.
