...
impl ISuspend for Suspend {
    ...
    fn suspend(&self, suspend_type: SuspendType) -> u32 {
        let suspend_id = 1;
        match suspend_type {
            // TODO(231437552): Rename Connected to Connected since it isn't only for HID
            ...
            // TODO(231437552): Rename Disconnected to Disconnected since it isn't only for HID
