...
pub enum Message {
    ...
    // Sends (bonded_device_list, found_device_list) whenever lists
    // are updated for use by internal systems.
    UpdatedDeviceLists(Vec<String>, Vec<String>),
    ...
    pub async fn dispatch(
        ...
        loop {
            ...
            match m.unwrap() {
                ...
                // Any service needing an updated list of devices can
                // have an update method triggered from here rather
                // than needing a reference to Bluetooth.
                Message::UpdatedDeviceLists(bonded_device_list, found_device_list) => {
                    battery_service
                        .lock()
                        .unwrap()
                        .update_device_list(bonded_device_list, found_device_list);
                }
