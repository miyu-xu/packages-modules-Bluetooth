...
impl AdvertisingSetParameters {
    /// Creates an advertising parameter from the AdvertisingSetParameters.
    pub fn make(&self) -> bt_topshim::profiles::gatt::AdvertiseParameters {
        let mut props: u16 = 0;
        if self.connectable {
            props |= 0x01;
        }
...
impl PeriodicAdvertisingParameters {
    /// Creates default periodic advertising paramers.
    pub fn make_default() -> bt_topshim::profiles::gatt::PeriodicAdvertisingParameters {
    ...
    /// Creates periodic advertising paramers from the PeriodicAdvertisingParameters.
    pub fn make(&self) -> bt_topshim::profiles::gatt::PeriodicAdvertisingParameters {
        let mut p = PeriodicAdvertisingParameters::make_default();
