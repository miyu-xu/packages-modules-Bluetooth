...
pub trait IBluetoothGatt {
    ...
    // Advertising (Moving out. See documents in bluetooth_adv::IBluetoothAdvertiseManager)
    // TODO(b/242083290): Split out AdvertiseManager interface in DBus layer and remove these.
