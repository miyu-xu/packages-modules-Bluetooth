...
pub trait IBluetoothGatt {
    ...
    /// Register callbacks for BLE advertising.
    fn register_advertiser_callback(&mut self, callback: Box<dyn IAdvertisingSetCallback + Send>);

    /// Unregister callbacks for BLE advertising.
    fn unregister_advertiser_callback(&mut self, callback: Box<dyn IAdvertisingSetCallback + Send>);

    /// Create a new BLE advertising set and start advertising.
    ///
    /// Returns the reg_id for the advertising set.
    ///
    ...
    /// Update advertisement data of the advertising set.
    fn set_advertising_data(&mut self, advertiser_id: i32, data: AdvertiseData);

    /// Update scan response of the advertising set.
    fn set_scan_response_data(&mut self, advertiser_id: i32, data: AdvertiseData);

    /// Update advertising parameters of the advertising set.
    ...
    /// Update periodic advertising parameters of the advertising set.
    ...
    /// Update periodic advertisement data of the advertising set.
...
impl IBluetoothGatt for BluetoothGatt {
    ...
    fn register_advertiser_callback(&mut self, _callback: Box<dyn IAdvertisingSetCallback + Send>) {
        // TODO(b/233128394)
    }

    fn unregister_advertiser_callback(
        &mut self,
