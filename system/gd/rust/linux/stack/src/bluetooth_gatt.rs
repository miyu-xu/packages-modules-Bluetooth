    ...
    fn on_scan_result(
        ...
        self.scanner_callbacks.for_all_callbacks(|callback| {
            callback.on_scan_result(ScanResult {
                name: extract_name(adv_data.as_slice()),
                ...
                rssi,
                periodic_adv_int,
                flags: extract_flags(adv_data.as_slice()),
                service_uuids: extract_service_uuids(adv_data.as_slice()),
                service_data: extract_service_data(adv_data.as_slice()),
                manufacturer_data: extract_manufacturer_data(adv_data.as_slice()),
