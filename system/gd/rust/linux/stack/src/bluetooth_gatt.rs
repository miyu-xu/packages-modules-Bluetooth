...
use crate::bluetooth_adv::{
    AdvertiseData, Advertiser, AdvertisingSetParameters, BtifGattAdvCallbacks,
    IAdvertisingSetCallback, IBluetoothAdvertiser, PeriodicAdvertisingParameters,
};
...
pub trait IBluetoothGatt {
    ...
    // Advertising (Moving out. See documents in bluetooth_adv::IBluetoothAdvertiser)
    // TODO(b/242083290): Split out Advertiser interface in DBus layer and remove these.
...
impl BluetoothGatt {
    ...
    pub fn new(intf: Arc<Mutex<BluetoothInterface>>, tx: Sender<Message>) -> BluetoothGatt {
        ...
        BluetoothGatt {
            ...
            advertiser: Advertiser::new(tx.clone()),
    ...
    pub fn init_profiles(
        ...
        self.advertiser.initialize(self.gatt.clone(), Some(adapter));
    ...
    pub fn remove_adv_callback(&mut self, callback_id: u32) -> bool {
        self.advertiser.unregister_callback(callback_id)
    }
...
impl IBluetoothGatt for BluetoothGatt {
    ...
    fn register_advertiser_callback(
        ...
        self.advertiser.register_callback(callback)
    }
    ...
    fn start_advertising_set(
        ...
        self.advertiser.start_advertising_set(
            parameters,
            advertise_data,
            scan_response,
            periodic_parameters,
    ...
    fn stop_advertising_set(&mut self, advertiser_id: i32) {
        self.advertiser.stop_advertising_set(advertiser_id)
    }

    fn get_own_address(&mut self, advertiser_id: i32) {
        self.advertiser.get_own_address(advertiser_id);
    }
    ...
    fn enable_advertising_set(
        ...
        self.advertiser.enable_advertising_set(advertiser_id, enable, duration, max_ext_adv_events);
    }

    fn set_advertising_data(&mut self, advertiser_id: i32, data: AdvertiseData) {
        self.advertiser.set_advertising_data(advertiser_id, data);
    }

    fn set_raw_adv_data(&mut self, advertiser_id: i32, data: Vec<u8>) {
        self.advertiser.set_raw_adv_data(advertiser_id, data);
    }

    fn set_scan_response_data(&mut self, advertiser_id: i32, data: AdvertiseData) {
        self.advertiser.set_scan_response_data(advertiser_id, data);
    }
    ...
    fn set_advertising_parameters(
        ...
        self.advertiser.set_advertising_parameters(advertiser_id, parameters);
    }
    ...
    fn set_periodic_advertising_parameters(
        ...
        self.advertiser.set_periodic_advertising_parameters(advertiser_id, parameters);
    }

    fn set_periodic_advertising_data(&mut self, advertiser_id: i32, data: AdvertiseData) {
        self.advertiser.set_periodic_advertising_data(advertiser_id, data);
    }
    ...
    fn set_periodic_advertising_enable(
        ...
        self.advertiser.set_periodic_advertising_enable(advertiser_id, enable, include_adi);
    }
...
impl BtifGattAdvCallbacks for BluetoothGatt {
    fn on_advertising_set_started(
        ...
        self.advertiser.on_advertising_set_started(reg_id, advertiser_id, tx_power, status);
    }

    fn on_advertising_enabled(&mut self, adv_id: u8, enabled: bool, status: AdvertisingStatus) {
        self.advertiser.on_advertising_enabled(adv_id, enabled, status);
    }

    fn on_advertising_data_set(&mut self, adv_id: u8, status: AdvertisingStatus) {
        self.advertiser.on_advertising_data_set(adv_id, status);
    }

    fn on_scan_response_data_set(&mut self, adv_id: u8, status: AdvertisingStatus) {
        self.advertiser.on_scan_response_data_set(adv_id, status);
    }
    ...
    fn on_advertising_parameters_updated(
        ...
        self.advertiser.on_advertising_parameters_updated(adv_id, tx_power, status);
    }
    ...
    fn on_periodic_advertising_parameters_updated(
        ...
        self.advertiser.on_periodic_advertising_parameters_updated(adv_id, status);
    }

    fn on_periodic_advertising_data_set(&mut self, adv_id: u8, status: AdvertisingStatus) {
        self.advertiser.on_periodic_advertising_data_set(adv_id, status);
    }
    ...
    fn on_periodic_advertising_enabled(
        ...
        self.advertiser.on_periodic_advertising_enabled(adv_id, enabled, status);
    }

    fn on_own_address_read(&mut self, adv_id: u8, addr_type: u8, address: RawAddress) {
        self.advertiser.on_own_address_read(adv_id, addr_type, address);
    }
}
