...
pub struct Bluetooth {
    ...
    scan_mode_suspend_mode: SuspendMode,
    is_discovering: bool,
...
impl Bluetooth {
    ...
    pub fn new(
        ...
        Bluetooth {
            ...
            scan_mode_suspend_mode: SuspendMode::Normal,
    ...
    fn trigger_update_connectable_mode(&self) {
        if self.get_scan_mode_suspend_mode() != SuspendMode::Normal {
            return;
        }
    ...
    pub(crate) fn set_scan_mode_suspend_mode(&mut self, suspend_mode: SuspendMode) {
        if suspend_mode != self.scan_mode_suspend_mode {
            self.scan_mode_suspend_mode = suspend_mode;
        }
    }

    /// Gets current suspend mode for scan mode (connectable/discoverable mode).
    pub(crate) fn get_scan_mode_suspend_mode(&self) -> SuspendMode {
        self.scan_mode_suspend_mode.clone()
    }
    ...
    pub(crate) fn scan_mode_enter_suspend(&mut self) -> BtStatus {
        ...
        self.set_scan_mode_suspend_mode(SuspendMode::Suspending);
        ...
        self.set_scan_mode_suspend_mode(SuspendMode::Suspended);
    ...
    pub(crate) fn scan_mode_exit_suspend(&mut self) -> BtStatus {
        if self.get_scan_mode_suspend_mode() != SuspendMode::Suspended {
            return BtStatus::Busy;
        }
        self.set_scan_mode_suspend_mode(SuspendMode::Resuming);
        ...
        self.set_scan_mode_suspend_mode(SuspendMode::Normal);
