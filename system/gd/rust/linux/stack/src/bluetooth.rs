...
impl Bluetooth {
    ...
    fn send_metrics_remote_device_info(device: &BluetoothDeviceContext) {
        ...
        let mut vpi = BtVendorProductInfo { vendor_id_src: 0, vendor_id: 0, product_id: 0, version: 0 };
        ...
        metrics::device_info_report(addr, device_type, class_of_device,
                                    appearance, vpi.vendor_id,
                                    vpi.vendor_id_src, vpi.product_id,
                                    vpi.version);
    }
}
