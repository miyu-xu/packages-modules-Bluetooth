...
impl BluetoothMedia {
    ...
    fn should_insert_call_when_sco_start(&mut self) -> bool {
        return !self.mps_qualification_enabled;
    }
    ...
    // default values.
    //
    // If there is an active HFP audio connection, the function places an active call.
