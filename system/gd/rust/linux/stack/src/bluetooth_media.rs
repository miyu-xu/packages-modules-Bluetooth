            ...
            HfpCallbacks::VendorSpecificAtCommand(at_string, addr) => {
                ...
                match command {
                    ...
                    "+IPHONEACCEV" => {
                        ...
                        // Battery level has IndicatorType of 1, with single digit number in IndicatorValue repesenting level/10
                        match args.next() {
                            Some(num_indicators) => {
                    ...
                    "+XEVENT" => {
                        // Format: AT+XEVENT=BATTERY,[Level],[NumberOfLevel],[MinutesOfTalk],[IsCharging]
