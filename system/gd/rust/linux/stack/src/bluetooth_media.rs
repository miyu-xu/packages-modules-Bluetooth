...
impl BluetoothMedia {
    ...
    fn rm_connected_profile(
        ...
        if is_profile_critical {
            // Per MPS v1.0, the disconnection of profiles should not affect each other.
            // Prevent disconnection during tests.
            ...
            A2dpCallbacks::ConnectionState(addr, state, error) => {
                ...
                match state {
                    ...
                    BtavConnectionState::Disconnected => {
                        ...
                        // Per MPS v1.0, the disconnection of profiles should not affect each other.
                        // Prevent disconnecting other profiles during tests.
                        if !self.phone_ops_enabled {
    ...
    fn notify_media_capability_updated(&mut self, addr: RawAddress) {
        ...
        let phone_ops_enabled = self.phone_ops_enabled;
...
impl IBluetoothMedia for BluetoothMedia {
    ...
    fn set_active_device(&mut self, address: String) {
        ...
        if self.phone_ops_enabled && address == String::from("00:00:00:00:00:00") {
            return;
        }
