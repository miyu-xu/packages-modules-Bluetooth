...
impl DBusArg for BtSdpRecord {
    ...
    fn from_dbus(
        ...
        let variant_type = match data.get("type") {
        ...
        let variant_type = <u32 as RefArgToRust>::ref_arg_to_rust(
            variant_type.as_static_inner(0).unwrap(),
            format!("u32"),
        )?;
        let record = match variant_type {
            0 => {
    ...
    fn to_dbus(record: BtSdpRecord) -> Result<dbus::arg::PropMap, Box<dyn std::error::Error>> {
        ...
        match record {
            BtSdpRecord::HeaderOverlay(header) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(0 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::MapMas(mas_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(1 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::MapMns(mns_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(2 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::PbapPse(pse_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(3 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::PbapPce(pce_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(4 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::OppServer(ops_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(5 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::SapServer(sap_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(6 as u32)?)),
                );
                map.insert(
                    String::from("0"),
            ...
            BtSdpRecord::Dip(dip_record) => {
                map.insert(
                    String::from("type"),
                    dbus::arg::Variant(Box::new(DBusArg::to_dbus(7 as u32)?)),
                );
                map.insert(
                    String::from("0"),
