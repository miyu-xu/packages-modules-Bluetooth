    ...
    loop {
        ...
        match m.unwrap() {
            ...
            Message::AdapterStateChange(adapter_action) => {
                    ...
                    AdapterStateActions::BluetoothStarted(pid, i) => {
                        ...
                        if context.state_machine.has_queued_present(hci) {
                            ...
                            bluetooth_manager
                                .lock()
                                .unwrap()
                                .callback_hci_device_change(hci.to_i32(), true);
                        }
                    }
                ...
                if state_to_enabled(next_state) != state_to_enabled(prev_state) {
                    bluetooth_manager
                        .lock()
                        .unwrap()
                        .callback_hci_enabled_change(hci.to_i32(), state_to_enabled(next_state));
                }
            }
