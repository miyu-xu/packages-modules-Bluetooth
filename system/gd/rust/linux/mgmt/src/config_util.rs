...
/// File to store LL privacy status to bluez
const BLUEZ_LL_PRIVACY_CONF: &str = "/var/lib/bluetooth/bluetooth-llprivacy.experimental";
...
pub fn write_bluez_ll_privacy_enabled(enabled: bool) -> bool {
    std::fs::write(
        BLUEZ_LL_PRIVACY_CONF,
        match enabled {
            true => "enable\n",
            _ => "disable\n",
        },
