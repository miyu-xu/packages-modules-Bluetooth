...
pub mod hci {
    ...
    impl_command_expectations!(ReadLocalVersionInformationBuilder, ReadLocalVersionInformationComplete);
    impl_command_expectations!(ReadLocalSupportedCommandsBuilder, ReadLocalSupportedCommandsComplete);
    ...
    impl_command_expectations!(ReadLocalSupportedFeaturesBuilder, ReadLocalSupportedFeaturesComplete);
    impl_command_expectations!(LeReadLocalSupportedFeaturesBuilder, LeReadLocalSupportedFeaturesComplete);
    impl_command_expectations!(LeReadSupportedStatesBuilder, LeReadSupportedStatesComplete);
    impl_command_expectations!(LeReadFilterAcceptListSizeBuilder, LeReadFilterAcceptListSizeComplete);
    ...
    impl_command_expectations!(LeReadSuggestedDefaultDataLengthBuilder, LeReadSuggestedDefaultDataLengthComplete);
    impl_command_expectations!(LeReadMaximumAdvertisingDataLengthBuilder, LeReadMaximumAdvertisingDataLengthComplete);
    impl_command_expectations!(LeReadNumberOfSupportedAdvertisingSetsBuilder, LeReadNumberOfSupportedAdvertisingSetsComplete);
    impl_command_expectations!(LeReadPeriodicAdvertiserListSizeBuilder, LeReadPeriodicAdvertiserListSizeComplete);
...
impl TryFrom<OpCode> for OpCodeIndex {
    ...
    fn try_from(value: OpCode) -> std::result::Result<Self, Self::Error> {
        match value {
            ...
            OpCode::ReadRemoteVersionInformation => Ok(OpCodeIndex::ReadRemoteVersionInformation),
            ...
            OpCode::ReadDefaultLinkPolicySettings => Ok(OpCodeIndex::ReadDefaultLinkPolicySettings),
            ...
            OpCode::WriteConnectionAcceptTimeout => Ok(OpCodeIndex::WriteConnectionAcceptTimeout),
            ...
            OpCode::WriteNumBroadcastRetransmits => Ok(OpCodeIndex::WriteNumBroadcastRetransmits),
            ...
            OpCode::HostNumberOfCompletedPackets => Ok(OpCodeIndex::HostNumberOfCompletedPackets),
            ...
            OpCode::ReadAfhChannelAssessmentMode => Ok(OpCodeIndex::ReadAfhChannelAssessmentMode),
            OpCode::WriteAfhChannelAssessmentMode => Ok(OpCodeIndex::WriteAfhChannelAssessmentMode),
            ...
            OpCode::WriteExtendedInquiryResponse => Ok(OpCodeIndex::WriteExtendedInquiryResponse),
            ...
            OpCode::UserConfirmationRequestReply => Ok(OpCodeIndex::UserConfirmationRequestReply),
            ...
            OpCode::LeReadLocalSupportedFeatures => Ok(OpCodeIndex::LeReadLocalSupportedFeatures),
            ...
            OpCode::LeAddDeviceToFilterAcceptList => Ok(OpCodeIndex::LeAddDeviceToFilterAcceptList),
            ...
            OpCode::SetExternalFrameConfiguration => Ok(OpCodeIndex::SetExternalFrameConfiguration),
            ...
            OpCode::LeReadLocalResolvableAddress => Ok(OpCodeIndex::LeReadLocalResolvableAddress),
            OpCode::LeSetAddressResolutionEnable => Ok(OpCodeIndex::LeSetAddressResolutionEnable),
            ...
            OpCode::LeSetExtendedAdvertisingData => Ok(OpCodeIndex::LeSetExtendedAdvertisingData),
            OpCode::LeSetExtendedScanResponseData => Ok(OpCodeIndex::LeSetExtendedScanResponseData),
            ...
            OpCode::LeSetPeriodicAdvertisingParameters => Ok(OpCodeIndex::LeSetPeriodicAdvertisingParameters),
            OpCode::LeSetPeriodicAdvertisingData => Ok(OpCodeIndex::LeSetPeriodicAdvertisingData),
            ...
            OpCode::LeReadRfPathCompensationPower => Ok(OpCodeIndex::LeReadRfPathCompensationPower),
            ...
            OpCode::LeConnectionCteRequestEnable => Ok(OpCodeIndex::LeConnectionCteRequestEnable),
            OpCode::LeConnectionCteResponseEnable => Ok(OpCodeIndex::LeConnectionCteResponseEnable),
            ...
            OpCode::ReadLocalSimplePairingOptions => Ok(OpCodeIndex::ReadLocalSimplePairingOptions),
            ...
            OpCode::LeSetPathLossReportingEnable => Ok(OpCodeIndex::LeSetPathLossReportingEnable),
