...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn ll_privacy_state_changed(llp_state: u32, rpa_state: u32);
    }
}
...
pub fn ll_privacy_state_changed(llp_state: u32, rpa_state: u32) {
    ffi::ll_privacy_state_changed(llp_state, rpa_state);
}
