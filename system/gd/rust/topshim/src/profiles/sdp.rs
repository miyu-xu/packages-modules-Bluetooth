...
pub struct BtSdpMpsRecord {
    pub hdr: BtSdpHeaderOverlay,
    pub supported_scenarios_mpsd: u64, // LibBluetooth expects big endian data
    pub supported_scenarios_mpmd: u64, // LibBluetooth expects big endian data
    pub supported_dependencies: u16,   // LibBluetooth expects big endian data
}
...
impl BtSdpMpsRecord {
    pub fn default() -> Self {
        ...
        BtSdpMpsRecord {
            ...
            supported_scenarios_mpsd: 0b1_0101_0101_0101_u64.to_be(),
            supported_scenarios_mpmd: 0,
            // LibBluetooth accepts big endian data. CrOS supports:
            // - 1 Sniff Mode During Streaming
            // - 3 (Dis-)Connection Order / Behavior
            supported_dependencies: 0b1010_u16.to_be(),
        }
    }
}
