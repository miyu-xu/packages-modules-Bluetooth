...
pub struct BtSdpMpsRecord {
    pub hdr: BtSdpHeaderOverlay,
    pub supported_scenarios_mpsd: u64,
    pub supported_scenarios_mpmd: u64,
    pub supported_dependencies: u16,
}
