...
pub mod ffi {
    ...
    extern "Rust" {
        ...
        unsafe fn gdscan_on_set_scanner_paramter_complete(scannerId: u8, status: u8);
...
cb_variant!(
    GDScannerCb,
    gdscan_on_set_scanner_paramter_complete -> GattScannerCallbacks::OnSetScannerParameterComplete,
    u8, u8
);
