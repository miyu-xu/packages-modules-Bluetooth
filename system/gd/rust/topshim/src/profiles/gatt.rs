...
impl GattServer {
    ...
    pub fn send_response(
        ...
        // SAFETY: Access to union field is unsafe, because the fields may be
        // uninitialized and cause undefined behavior. However, all calls to
        // `send_response` in `/system/gd/rust/linux` initialize the required
        // fields.
        unsafe {
            log::debug!("topshim out: send_response: \"{}\", \"{}\", \"{}\", \"BtGattResponse {{ handle: {}, \
