...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn set_codec_config_preference(self: Pin<&mut LeAudioClientIntf>, group_id: i32,
        ...
        fn send_audio_profile_preferences(self: Pin<&mut LeAudioClientIntf>, group_id: i32,
    ...
    extern "Rust" {
        ...
        fn le_audio_group_node_status_callback(
            bd_addr: RawAddress, group_id: i32, node_status: BtLeAudioGroupNodeStatus);
        fn le_audio_audio_conf_callback(
            direction: u8, group_id: i32,
            snk_audio_location: u32, src_audio_location: u32, avail_cont: u16);
        fn le_audio_sink_audio_location_available_callback(
            addr: RawAddress, snk_audio_locations: u32);
...
pub enum LeAudioClientCallbacks {
    ...
    AudioGroupCodecConf(i32, ffi::BtLeAudioCodecConfig, ffi::BtLeAudioCodecConfig,
...
impl LeAudioClient {
    ...
    #[profile_enabled_or]
    fn set_codec_config_preference(&mut self, group_id: i32,
    ...
    #[profile_enabled_or]
    fn send_audio_profile_preferences(&mut self, group_id: i32,
                                      is_output_preference_le_audio: bool,
                                      is_duplex_preference_le_audio: bool) {
