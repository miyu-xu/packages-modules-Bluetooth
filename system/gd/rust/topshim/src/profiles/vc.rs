...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        // fn set_volume(self: Pin<&mut VolumeControlIntf>, addr: RawAddress, volume: u8);
        ...
        // fn set_ext_audio_out_description(self: Pin<&mut VolumeControlIntf>, addr: RawAddress, ext_output_id: u8, descr: String);
    }
...
impl VolumeControl {
    pub fn new(intf: &BluetoothInterface) -> VolumeControl {
        ...
        unsafe {
            vc_if = ffi::GetVolumeControlProfile(intf.as_raw_ptr());
        }

        VolumeControl { internal: vc_if, _is_init: false, _is_enabled: false }
    }
    ...
    // #[profile_enabled_or]
    // pub fn set_volume(&mut self, addr: RawAddress, volume: u8) {
    ...
    // #[profile_enabled_or]
    // pub fn set_ext_audio_out_description(&mut self, addr: RawAddress, ext_output_id: u8, descr: String) {
    //     self.internal.pin_mut().set_ext_audio_out_description(addr, ext_output_id, descr.into());
    // }
}
