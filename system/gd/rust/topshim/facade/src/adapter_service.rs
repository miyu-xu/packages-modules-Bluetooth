...
use bt_topshim_facade_protobuf::facade::{
    ...
    SetDiscoveryModeRequest, SetDiscoveryModeResponse, SetLocalIoCapsRequest, ToggleStackRequest,
    ToggleStackResponse,
};
...
impl AdapterService for AdapterServiceImpl {
    ...
    fn set_local_io_caps(
        ...
        self.btif_intf.lock().unwrap().set_adapter_property(btif::BluetoothProperty::LocalIoCaps(
