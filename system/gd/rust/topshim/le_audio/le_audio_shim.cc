...
class DBusLeAudioClientCallbacks : public le_audio::LeAudioClientCallbacks {
 public:
  ...
  void OnGroupNodeStatus(
      const RawAddress& bd_addr, int group_id, le_audio::GroupNodeStatus node_status) {
    log::info("bd_addr={}, group_id={}, node_status={}",
        ADDRESS_TO_LOGGABLE_CSTR(bd_addr), group_id, static_cast<int>(node_status));
  ...
  void OnAudioConf(
      ...
      uint32_t src_audio_location,
      uint16_t avail_cont) {
    log::info("direction={}, group_id={}, snk_audio_location={}, src_audio_location={}, avail_cont={}",
        direction,
        group_id,
        snk_audio_location,
        src_audio_location,
  ...
  void OnSinkAudioLocationAvailable(const RawAddress& address, uint32_t snk_audio_locations) {
    log::info("address={}, snk_audio_locations={}", ADDRESS_TO_LOGGABLE_CSTR(address), snk_audio_locations);
  ...
  void OnHealthBasedRecommendationAction(
    ...
    log::info("address={}, action={}",
        ADDRESS_TO_LOGGABLE_CSTR(address), static_cast<int>(action));
  }
        ...
        .base =
            {
                ...
                .gain = static_cast<float>(m.gain),
                .dest_device = AUDIO_DEVICE_DEFAULT,
