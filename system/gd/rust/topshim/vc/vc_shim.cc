...
class DBusVolumeControlCallbacks : public vc::VolumeControlCallbacks {
 public:
  ...
  void OnVolumeStateChanged(
    ...
    log::info("address={}, volume={}, mute={}, is_autonomous={}",
        ADDRESS_TO_LOGGABLE_CSTR(address), volume, mute, is_autonomous);
  ...
  void OnGroupVolumeStateChanged(
    ...
    log::info("group_id={}, volume={}, mute={}, is_autonomous={}",
  ...
  void OnExtAudioOutVolumeOffsetChanged(
    ...
    log::info("address={}, ext_output_id={}, offset={}",
        ADDRESS_TO_LOGGABLE_CSTR(address), ext_output_id, offset);
  ...
  void OnExtAudioOutLocationChanged(
    ...
    log::info("address={}, ext_output_id, location={}",
        ADDRESS_TO_LOGGABLE_CSTR(address), ext_output_id, location);
  ...
  void OnExtAudioOutDescriptionChanged(
    ...
    log::info("address={}, ext_output_id={}, descr={}",
        ADDRESS_TO_LOGGABLE_CSTR(address), ext_output_id, descr.c_str());
...
void VolumeControlIntf::set_ext_audio_out_description(RawAddress addr, uint8_t ext_output_id, const char* descr) {
