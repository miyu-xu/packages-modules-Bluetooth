...
#if 0
  log::verbose("U={}, V={}, X={}, Z={:x}", HexEncode(u, kOctet32Length), HexEncode(v, kOctet32Length), HexEncode(x.data(), x.size()), z);
#endif
...
void f5(
    ...
    Octet16* ltk) {
#if 0
 log::verbose("W={}, N1={}, N2={}, A1={}, A2={}", HexEncode(w, kOctet32Length), HexEncode(n1.data(), n1.size()), HexEncode(n2.data(), n2.size()), HexEncode(a1, 7), HexEncode(a2, 7));
#endif
...
f6(const Octet16& w, const Octet16& n1, const Octet16& n2, const Octet16& r, uint8_t* iocap, uint8_t* a1, uint8_t* a2) {
  const uint8_t msg_len = kOctet16Length /* N1 size */ + kOctet16Length /* N2 size */ +
                          ...
                          7 /* A2 size*/;
#if 0
  log::verbose("W={}, N1={}, N2={}, R={}, IOcap={}, A1={}, A2={}", HexEncode(w.data(), w.size()), HexEncode(n1.data(), n1.size()), HexEncode(n2.data(), n2.size()), HexEncode(r.data(),
  r.size()), HexEncode(iocap, 3), HexEncode(a1, 7), HexEncode(a2, 7));
#endif
...
#if 0
  log::verbose("U={}, V={}, X={}, Y={}", HexEncode(u, kOctet32Length), HexEncode(v,
  kOctet32Length), HexEncode(x.data(), x.size()), HexEncode(y.data(), y.size()));
#endif
