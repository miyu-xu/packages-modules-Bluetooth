...
void LinkManager::OnConnectRequest(hci::Address, hci::ClassOfDevice) {
...
void LinkManager::HACK_OnEscoConnectRequest(hci::Address, hci::ClassOfDevice) {
  LOG_ERROR("Remote ESCO connect request unimplemented");
}

void LinkManager::HACK_OnScoConnectRequest(hci::Address, hci::ClassOfDevice) {
