...
void LinkManager::OnConnectRequest(
    [[maybe_unused]] hci::Address device, [[maybe_unused]] hci::ClassOfDevice cod) {
  LOG_ERROR("Remote connect request unimplemented");
}

void LinkManager::OnConnectFail(
    hci::Address device, hci::ErrorCode reason, [[maybe_unused]] bool locally_initiated) {
