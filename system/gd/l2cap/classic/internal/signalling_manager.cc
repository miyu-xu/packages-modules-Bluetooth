...
void ClassicSignallingManager::SendEchoRequest(std::unique_ptr<packet::RawBuilder>) {
...
void ClassicSignallingManager::OnDisconnectionResponse(SignalId signal_id, Cid, Cid cid) {
  if (command_just_sent_.signal_id_ != signal_id ||
...
void ClassicSignallingManager::OnEchoResponse(
    SignalId signal_id, const PacketView<kLittleEndian>&) {
