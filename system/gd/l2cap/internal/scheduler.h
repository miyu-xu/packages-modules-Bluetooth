...
class Scheduler {
 public:
   ...
   */
  virtual void OnPacketsReady([[maybe_unused]] Cid cid, [[maybe_unused]] int number_packets) {}

  /**
   * Let the scheduler send the specified cid first.
   * Used by A2dp software encoding.
   */
  virtual void SetChannelTxPriority([[maybe_unused]] Cid cid, [[maybe_unused]] bool high_priority) {
  }
   ...
   * should be dropped
   */
  virtual void RemoveChannel([[maybe_unused]] Cid cid) {}
