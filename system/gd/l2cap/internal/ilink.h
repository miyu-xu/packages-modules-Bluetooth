...
class ILink {
 public:
  ...
  virtual void OnPendingPacketChange(
      [[maybe_unused]] Cid local_cid, [[maybe_unused]] bool has_packet) {}

  // To be used by LE credit based channel data controller over LE link
  virtual void SendLeCredit([[maybe_unused]] Cid local_cid, [[maybe_unused]] uint16_t credit) {}

  // Used by A2dp software encoding
  virtual void SetChannelTxPriority(
      [[maybe_unused]] Cid local_cid, [[maybe_unused]] bool high_priority) {}
};
}  // namespace internal
}  // namespace l2cap
}  // namespace bluetooth
