...
class Link : public l2cap::internal::ILink,
  ...
  // Invoked by signalling manager to indicate an outgoing connection request failed and link
  // shall free resources
  ...
  // Received connection update complete from ACL manager. SignalId is bound to a valid number
  // when we need to send a response to remote. If SignalId is bound to an invalid number, we
  // don't send a response to remote, because the connection update request is not from remote LL
  // peripheral.
