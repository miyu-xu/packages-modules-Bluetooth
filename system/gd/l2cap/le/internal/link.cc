...
Link::Link(
    ...
    [[maybe_unused]] FixedChannelServiceManagerImpl* fixed_service_manager,
...
void Link::OnLeReadRemoteFeaturesComplete(
    [[maybe_unused]] hci::ErrorCode hci_status, [[maybe_unused]] uint64_t features) {}
...
std::shared_ptr<FixedChannelImpl> Link::AllocateFixedChannel(
    Cid cid, [[maybe_unused]] SecurityPolicy security_policy) {
...
void Link::OnPendingPacketChange([[maybe_unused]] Cid local_cid, bool has_packet) {
  if (has_packet) {
