...
void LeSignallingManager::SendEnhancedConnectionRequest(Psm, std::vector<Cid>, Mtu) {}

void LeSignallingManager::SendEnhancedReconfigureRequest(std::vector<Cid>, Mtu mtu) {}
