...
void LogAclAfterRemoteNameRequest(const hci::Address& address, tBTM_STATUS status) {
  ...
  switch(status) {
    ...
    case BTM_NO_RESOURCES:
      bluetooth::os::LogMetricBluetoothEvent(address, EvenType::ACL_CONNECTION_INITIATOR,
