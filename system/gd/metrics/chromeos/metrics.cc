...
static const uint32_t DEVICE_MAJOR_CLASS_MASK = 0x1F00;
static const uint32_t DEVICE_MAJOR_CLASS_BIT_OFFSET = 8;
static const uint32_t DEVICE_CATEGORY_MASK = 0xFFC0;
static const uint32_t DEVICE_CATEGORY_BIT_OFFSET = 6;
