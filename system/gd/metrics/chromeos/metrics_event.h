...
// ENUM definition for profile connection state that in sync with ChromeOS structured metrics ProfileConnectionState and
// BlueZ's metrics_profile_conn_state.
...
// ProfileConnectionState and BlueZ's metrics_profile_disconn_state.
enum class ProfileDisconnectionState : int64_t {
  // Common states for connecting and disconnecting a profile
  PROFILE_CONN_STATE_STARTING = 0,
  PROFILE_CONN_STATE_SUCCEED = 1,
  PROFILE_CONN_STATE_ALREADY_CONNECTED = 2,
