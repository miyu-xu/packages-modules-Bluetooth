...
struct HciLayer::impl {
  ...
  void register_vs_event(VseSubeventCode event, ContextualCallback<void(VendorSpecificEventView)> handler) {
    log::assert_that(
  ...
  void unregister_le_event(VseSubeventCode event) {
  ...
  void on_le_meta_event(EventView event) {
    ...
    le_event_handlers_[subevent_code].Invoke(meta_event_view);
  }
  ...
  void on_vs_event(EventView event) {
    ...
    vs_event_handlers_[subevent_code].Invoke(vs_event_view);
  }
...
void HciLayer::RegisterVendorSpecificEventHandler(VseSubeventCode event, ContextualCallback<void(VendorSpecificEventView)> handler) {
