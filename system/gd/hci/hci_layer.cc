...
struct HciLayer::impl {
  ...
  void register_vs_event_default(ContextualCallback<void(VendorSpecificEventView)> handler) {
    vs_event_default_handler_ = handler;
  }
  ...
  void on_vs_event(EventView event) {
    ...
    } else if (vs_event_default_handler_) {
...
void HciLayer::RegisterVendorSpecificEventDefaultHandler(
        ContextualCallback<void(VendorSpecificEventView)> handler) {
  CallOn(impl_, &impl::register_vs_event_default, handler);
}

void HciLayer::UnregisterVendorSpecificEventDefaultHandler() {
