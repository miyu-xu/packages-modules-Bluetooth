...
public:
  ...
  virtual void GetSocketCapabilities(SocketCapabilities* socketCapabilities) override;

  virtual bool SocketOpened(const SocketContext& context) override;

  virtual void SocketClosed(uint64_t socketId) override;
