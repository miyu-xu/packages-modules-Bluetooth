...
public:
  ...
  virtual bool SetAclCredits(int linkType, int credit) override;
  virtual bool NotifyAclConnectionStateChange(int aclHandle, int linkType, int state) override;
  virtual bool NotifyAclLeDataLengthChange(int aclHandle, int txDataLen, int rxDataLen) override;
  virtual bool NotifyAclPowerModeChange(int aclHandle, int powerMode, int interval) override;
