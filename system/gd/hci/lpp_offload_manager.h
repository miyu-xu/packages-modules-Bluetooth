...
public:
  ...
  virtual bool SetAclCredits(int link, int credit) override;
  virtual bool NotifyAclConnectionStateChange(int handle, int link, int state) override;
  virtual bool NotifyAclLeDataLengthChange(int handle, int txDataLen, int rxDataLen) override;
  virtual bool NotifyAclPowerModeChange(int handle, int mode, int interval) override;
