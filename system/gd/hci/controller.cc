...
static const std::string kPropertyRemoveSniffSubratingEventMaskEnabled =
    "bluetooth.gd.hci.remove_sniff_sub_event_mask.enabled";
...
struct Controller::impl {
  ...
  void Start(hci::HciLayer* hci) {
    ...
    if (os::GetSystemPropertyBool(kPropertyRemoveSniffSubratingEventMaskEnabled, false)) {
      event_mask = RemoveSniffSubratingEventMask(event_mask);
    }
...
uint64_t Controller::RemoveSniffSubratingEventMask(uint64_t event_mask) {
