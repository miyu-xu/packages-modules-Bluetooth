...
struct Controller::impl {
  ...
  void read_local_version_information_complete_handler(CommandCompleteView view) {
    ...
    LOG_WARN("aaaaaaaaaaa %hhu", local_version_information_.lmp_version_);
    LOG_WARN("aaaaaaaaaab %d", local_version_information_.lmp_subversion_);
    LOG_WARN("aaaaaaaaaac %hhu", local_version_information_.hci_version_);
    LOG_WARN("aaaaaaaaaad %d", local_version_information_.hci_revision_);
