...
std::optional<std::vector<uint8_t>> LeScanningReassembler::ProcessAdvertisingReport(
  ...
  AdvertisingInfo info(address, DirectAdvertisingAddressType(address_type), advertising_sid);
  ...
  std::vector<uint8_t> complete_advertising_data;
  complete_advertising_data.swap(advertising_fragment->data);
...
LeScanningReassembler::AdvertisingInfo::AdvertisingInfo(
