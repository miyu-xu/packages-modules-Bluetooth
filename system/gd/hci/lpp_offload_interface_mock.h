...
public:
  ...
  MOCK_METHOD(void, onReceiveSocketCloseRequest, (bluetooth::Uuid, RequestReason), (override));
};
...
public:
  ...
  MOCK_METHOD(bool, SetAclCreditsForSockets, (AclLinkType, int));
  MOCK_METHOD(bool, NotifyAclConnectionStateChange, (int, AclLinkType, ConnectionState));
  MOCK_METHOD(bool, NotifyAclLeDataLengthChange, (int, int, int));
  MOCK_METHOD(bool, NotifyAclPowerModeChange, (int, AclPowerMode, int));
  MOCK_METHOD(bool, NotifySocketConnectionStateChange, (const SocketContext&));
};
