...
class LeScanningReassembler {
 public:
  ...
  /// events.
  /// Returns the completed advertising data if the event was complete, or
  /// the completion of a fragmented advertising event. If a fragmented
  /// advertising event is completed, the extended_event_type will be from
  /// the first fragment.
