...
class TestLeConnectionManagementCallbacks
  ...
  virtual void OnDataLengthChange(uint16_t /* tx_octets */, uint16_t /* tx_time */,
                                  uint16_t /* rx_octets */, uint16_t /* rx_time */) override {}
  ...
  virtual void OnLeReadRemoteFeaturesComplete(hci::ErrorCode /* hci_status */,
                                              uint64_t /* features */) override {}
  virtual void OnPhyUpdate(hci::ErrorCode /* hci_status */, uint8_t /* tx_phy */,
