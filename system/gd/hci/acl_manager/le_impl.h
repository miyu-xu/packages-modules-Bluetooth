...
struct le_impl : public bluetooth::hci::LeAddressManagerCallback {
 ...
 public:
  ...
  void on_le_connection_cannceled_on_pause() {
    ASSERT_LOG(pause_connection, "Connection must be paused when informing le address manager");
