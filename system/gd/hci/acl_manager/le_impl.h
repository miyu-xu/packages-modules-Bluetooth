...
struct le_impl : public bluetooth::hci::LeAddressManagerCallback {
 ...
 public:
  ...
  void arm_connectability() {
    ...
    uint16_t le_scan_interval = osi_property_get_int32(PROPERTY_CONN_SCAN_INTERVAL_SLOW, kScanIntervalSlow);
    uint16_t le_scan_window = osi_property_get_int32(PROPERTY_CONN_SCAN_WINDOW_SLOW, kScanWindowSlow);
    ...
    if (!direct_connections_.empty()) {
      le_scan_interval = osi_property_get_int32(PROPERTY_CONN_SCAN_INTERVAL_FAST, kScanIntervalFast);
      le_scan_window = osi_property_get_int32(PROPERTY_CONN_SCAN_WINDOW_FAST, kScanWindowFast);
      le_scan_window_2m = osi_property_get_int32(PROPERTY_CONN_SCAN_WINDOW_2M_FAST, kScanWindow2mFast);
      le_scan_window_coded = osi_property_get_int32(PROPERTY_CONN_SCAN_WINDOW_CODED_FAST, kScanWindowCodedFast);
    }
    ...
    uint16_t conn_interval_min = osi_property_get_int32(PROPERTY_MIN_CONN_INTERVAL, 0x0018);
    uint16_t conn_interval_max = osi_property_get_int32(PROPERTY_MAX_CONN_INTERVAL, 0x0028);
    uint16_t conn_latency = osi_property_get_int32(PROPERTY_CONN_LATENCY, 0x0000);
    uint16_t supervision_timeout = osi_property_get_int32(PROPERTY_CONN_SUPERVISION_TIMEOUT, 0x001f4);
      ...
      if (is_direct) {
        ...
        if (create_connection_timeout_alarms_.find(address_with_type) == create_connection_timeout_alarms_.end()) {
          ...
          uint32_t connection_timeout =
              osi_property_get_int32(PROPERTY_DIRECT_CONN_TIMEOUT, kCreateConnectionTimeoutMs);
