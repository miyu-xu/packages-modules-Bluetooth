...
protected:
  ...
  LeExtendedCreateConnectionView get_extended_create_connection_view(
...
TEST_F(LeImplTest, aggressive_connection_mode_selected_when_no_ongoing_connections_exist) {
  ...
  LeExtendedCreateConnectionView view = get_extended_create_connection_view("D0:05:04:03:02:01");

  ASSERT_TRUE(view.IsValid());
  ASSERT_EQ(view.GetPhyScanParameters()[0].conn_interval_min_, kConnIntervalAggressiveMin);
  ASSERT_EQ(view.GetPhyScanParameters()[0].conn_interval_max_, kConnIntervalAggressiveMax);
}
...
TEST_F(LeImplTest, aggressive_connection_mode_selected_when_one_ongoing_connection_exists) {
  ...
  LeExtendedCreateConnectionView view = get_extended_create_connection_view("F0:05:04:03:02:01");
...
TEST_F(LeImplTest, relaxed_connection_mode_selected_when_two_ongoing_connections_exist) {
  ...
  ASSERT_TRUE(view.IsValid());
  ASSERT_EQ(view.GetPhyScanParameters()[0].conn_interval_min_, kConnIntervalRelaxedMin);
  ASSERT_EQ(view.GetPhyScanParameters()[0].conn_interval_max_, kConnIntervalRelaxedMax);
}
