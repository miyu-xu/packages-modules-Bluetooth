...
class ConnectionManagementCallbacks {
  ...
  // Invoked when controller sends Change Connection Link Key Complete event with Success error
  // code
  ...
  // Invoked when controller sends Command Complete event for Read Link Policy Settings command
  ...
  // Invoked when controller sends Command Complete event for Read Transmit Power Level command
  // with Success error code
  virtual void OnReadTransmitPowerLevelComplete(uint8_t transmit_power_level) = 0;
  // Invoked when controller sends Command Complete event for Read Link Supervision Time out
  // command with Success error code
  ...
  // Invoked when controller sends Command Complete event for Read Link Quality command with
  // Success error code
  ...
  // Invoked when controller sends Command Complete event for Read Clock command with Success
  // error code
