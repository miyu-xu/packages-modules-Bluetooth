    ...
    for (const auto& socket_prop : socket_props_) {
      switch (static_cast<int>(socket_prop.dataPath)) {
        case SocketDataPath::OFFLOAD_SOFTWARE:
          ...
          features_.max_le_coc_sw_socket_num = socket_prop.numOfLeCocSocketSupported_;
          features_.max_rfcomm_sw_socket_num = socket_prop.numOfRfcommSocketSupported_;
        ...
        case SocketDataPath::OFFLOAD_HARDWARE:
          features_.socket_hw_offload_supported = (socket_prop.numOfLeCocSocketSupported_ > 0 ||
                                                   socket_prop.numOfRfcommSocketSupported_ > 0);
          features_.max_le_coc_hw_socket_num = socket_prop.numOfLeCocSocketSupported_;
          features_.max_rfcomm_hw_socket_num = socket_prop.numOfRfcommSocketSupported_;
