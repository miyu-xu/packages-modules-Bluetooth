    ...
    switch (command.GetOpCode()) {
      ...
      case (OpCode::DYNAMIC_AUDIO_BUFFER): {
        ...
        if (dab_command->GetDabCommand() == DabCommand::GET_AUDIO_BUFFER_TIME_CAPABILITY) {
          ...
          capabilities[0] = DynamicAudioBufferCodecCapability(0x123, 0x103,
                                                              0x1234); // sbc_capabilities
          capabilities[1] = DynamicAudioBufferCodecCapability(0x223, 0x123,
                                                              0x2340); // aac_capabilities
          capabilities[4] = DynamicAudioBufferCodecCapability(0x323, 0x223,
                                                              0x3456); // ldac_capabilities
