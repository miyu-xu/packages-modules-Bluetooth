...
public:
  ...
  virtual void OnDistanceMeasurementResult(
          ...
          uint64_t elapsed_realtime_nanos, int init_RSSI, int refl_RSSI, int8_t confidence_level,
          double delayed_spread_meters, DistanceMeasurementDetectedAttackLevel detected_attack_level,
