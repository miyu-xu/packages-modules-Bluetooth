...
static const Uuid ONES = Uuid::From128BitBE(Uuid::UUID128Bit{
        { 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
         0x11 }
});

static const Uuid SEQUENTIAL = Uuid::From128BitBE(Uuid::UUID128Bit{
        { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67,
         0x89 }
});

static const Uuid kBase = Uuid::From128BitBE(Uuid::UUID128Bit{
