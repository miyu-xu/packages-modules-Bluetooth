...
void AclManager::AddDeviceToDefaultConnectionIntervalList(const Address address) {
  CallOn(pimpl_->le_impl_, &le_impl::add_device_to_default_connection_interval_list, address);
}
