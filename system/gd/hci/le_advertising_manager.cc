...
<<<<<<< PATCH SET (901909 Fix Advertising_instance address when multi-adv device is co)
...
=======
>>>>>>> BASE      (5540d6 Merge "classic_acl_connection_test: Add unit tests")
  ...
  void multi_advertising_state_change(hci::VendorSpecificEventView event) {
    ...
    ASSERT(view.IsValid());
    LOG_INFO("Instance: 0x%x StateChangeReason: 0x%x Handle: 0x%x Address: %s", view.GetAdvertisingInstance(),
