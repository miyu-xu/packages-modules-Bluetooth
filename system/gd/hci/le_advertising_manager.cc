...
constexpr int kIdLocal = 0xff;  // Id Advertiser not register from Java layer
...
struct LeAdvertisingManager::impl : public bluetooth::hci::LeAddressManagerCallback {
  ...
  void handle_set_terminated(LeAdvertisingSetTerminatedView event_view) {
    ...
    LOG_INFO(
        "CYDBG Received LE Advertising Set Terminated with status %s", ErrorCodeText(event_view.GetStatus()).c_str());
