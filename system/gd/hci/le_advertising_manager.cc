 ...
 * (1) if the host only supports the public/static address policy, all connectable advertisements
 *     will be public and all non-connectable advertisements will never user RPA
