...
struct LeAdvertisingManager::impl : public bluetooth::hci::LeAddressManagerCallback {
  ...
  void set_encrypted_advertiser_data(AdvertiserId advertiser_id) {
    ...
    if (!adv_inst->advertisement_enc.empty()) {
      ...
      impl::set_enc_data(advertiser_id, false, adv_inst->advertisement, adv_inst->advertisement_enc);
...
void LeAdvertisingManager::SetData(AdvertiserId advertiser_id,
...
void LeAdvertisingManager::SetPeriodicData(AdvertiserId advertiser_id,
    std:: vector<GapData> data) {
