...
struct DistanceMeasurementManager::impl : bluetooth::hal::RangingHalCallback {
  ...
  void handle_ras_server_getting_request(const Address& identity_address,
...
void DistanceMeasurementManager::HandleRasServerGettingRequest(
        const bluetooth::hci::Address& identity_address, uint16_t connection_handle,
        hci::Role local_hci_role) {
  CallOn(pimpl_.get(), &impl::handle_ras_server_getting_request, identity_address,
