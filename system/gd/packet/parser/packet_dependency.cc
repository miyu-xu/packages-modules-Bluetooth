...
std::vector<std::string>& PacketDependency::GetMyDependencies(const std::string& packet_name) {
  return parse_and_match_fields[packet_name + "--parse-params"];
}

std::vector<std::string>& PacketDependency::GetChildrenDependencies(const std::string& packet_name) {
