...
PacketDependencyTree::PacketDependencyTree(const ParentDef* root) {
...
std::vector<std::string>& PacketDependencyTree::GetMyDependencies(const std::string& packet_name) {
  return parse_and_match_fields[packet_name + "--parse-params"];
}

std::vector<std::string>& PacketDependencyTree::GetChildrenDependencies(const std::string& packet_name) {
  return parse_and_match_fields[packet_name + "--match-variables"];
}

std::set<std::string> PacketDependencyTree::CollectInitialParseAndMatchFields(
...
void PacketDependencyTree::FinalizeParseAndMatchFields(
