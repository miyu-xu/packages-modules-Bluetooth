...
struct ModuleUnitTestDataBuilder {
  ...
  explicit ModuleUnitTestDataBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<ModuleUnitTestData> CreateModuleUnitTestDataDirect(
  ...
  return bluetooth::CreateModuleUnitTestData(
      _fbb,
      title__);
}
...
inline bool VerifyModuleUnitTestDataBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<bluetooth::ModuleUnitTestData>(nullptr);
}

inline bool VerifySizePrefixedModuleUnitTestDataBuffer(
    ::flatbuffers::Verifier &verifier) {
