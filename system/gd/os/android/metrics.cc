...
void LogMetricA2dpSessionMetricsEvent(
  ...
  switch (codec_index) {
    case BTAV_A2DP_CODEC_INDEX_SOURCE_SBC:
      metric_id = "tex_test.bluetooth.value_sbc_codec_usage_over_a2dp";
      break;
    case BTAV_A2DP_CODEC_INDEX_SOURCE_AAC:
      metric_id = "tex_test.bluetooth.value_aac_codec_usage_over_a2dp";
      break;
    case BTAV_A2DP_CODEC_INDEX_SOURCE_APTX:
      metric_id = "tex_test.bluetooth.value_aptx_codec_usage_over_a2dp";
      break;
    case BTAV_A2DP_CODEC_INDEX_SOURCE_APTX_HD:
      metric_id = "tex_test.bluetooth.value_aptx_hd_codec_usage_over_a2dp";
      break;
    case BTAV_A2DP_CODEC_INDEX_SOURCE_LDAC:
      metric_id = "tex_test.bluetooth.value_ldac_codec_usage_over_a2dp";
      break;
    case BTAV_A2DP_CODEC_INDEX_SOURCE_OPUS:
      metric_id = "tex_test.bluetooth.value_opus_codec_usage_over_a2dp";
      break;
    default:
      return;
  }
