...
struct ReactorEventWithTokio : public ReactorEventApi {
  ReactorEventWithTokio() {}
  ~ReactorEventWithTokio() {}
  bool Read() override {
    return false;
  }
...
ReactorEventApi* NewReactorEventWithTokio() {
  return new ReactorEventWithTokio();
}
...
Reactor::Reactable* RustReactor::Register(int fd, common::Closure on_read_ready, common::Closure on_write_ready) {
  LOG_ERROR("UNIMPLEMENTED");
...
void RustReactor::ModifyRegistration(
