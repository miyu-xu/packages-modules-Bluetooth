...
class ReactorApi {
 public:
  ...
  virtual void Run() = 0;
  virtual void Stop() = 0;
  virtual Reactor::Reactable* Register(int fd, common::Closure on_read_ready, common::Closure on_write_ready) = 0;
  ...
  virtual void ModifyRegistration(
      Reactor::Reactable* reactable, common::Closure on_read_ready, common::Closure on_write_ready) = 0;
