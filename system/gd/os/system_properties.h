...
/* System Property to indicate if BCC event should not open SCO. */
static const std::string kIsBccOpenScoDisallowed = "persist.bluetooth.is_bcc_open_sco_disallowed";
