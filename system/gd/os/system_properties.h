...
// Get |property| keyed system property as uint64_t from supported platform, return |default_value|
...
uint64_t GetSystemPropertyUint64Base(
    const std::string& property, uint64_t default_value, int base = 0);
