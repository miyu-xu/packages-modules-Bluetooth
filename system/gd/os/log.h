...
#define LOG_INFO_INT(fmt, ...) _LOGWRAPPER(ALOGI, fmt, ##__VA_ARGS__)
#define LOG_WARN_INT(fmt, ...) _LOGWRAPPER(ALOGW, fmt, ##__VA_ARGS__)
...
#define LOG_INFO_INT(fmt, ...)                                                \
  _LOGWRAPPER(LOG_TAG_INFO, fmt, ##__VA_ARGS__)

#define LOG_WARN_INT(fmt, ...)                                                \
  _LOGWRAPPER(LOG_TAG_WARN, fmt, ##__VA_ARGS__)
