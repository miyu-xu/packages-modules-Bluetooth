...
// need to abort on this statement
// to catch the bug
#define LOG_ALWAYS_FATAL_INT(...) do {  \
    abort();                            \
  } while (false)

#else /* end of FUZZ_TARGET */
...
#define LOG_VERBOSE(fmt, args...)                                             \
  LOG_VERBOSE_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)

#define LOG_DEBUG(fmt, args...)                                               \
  LOG_DEBUG_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)

#define LOG_INFO(fmt, args...)                                                \
  LOG_INFO_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)

#define LOG_WARN(fmt, args...)                                                \
  LOG_WARN_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)

#define LOG_ERROR(fmt, args...)                                               \
  LOG_ERROR_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)

#ifndef LOG_ALWAYS_FATAL
#define LOG_ALWAYS_FATAL(fmt, args...)                                        \
  LOG_ALWAYS_FATAL_INT(SRC_FMT_STR fmt, __FILE__, __LINE__, __func__, ##args)
#endif
