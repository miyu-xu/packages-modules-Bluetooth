...
class TestEnqueueEnd {
  ...
  void handle_register_enqueue() {
    queue_->RegisterEnqueue(
            handler_,
            common::Bind(&TestEnqueueEnd::EnqueueCallbackForTest, common::Unretained(this)));
  }
...
class TestDequeueEnd {
  ...
  void handle_register_dequeue() {
    queue_->RegisterDequeue(
            handler_,
            common::Bind(&TestDequeueEnd::DequeueCallbackForTest, common::Unretained(this)));
  }
