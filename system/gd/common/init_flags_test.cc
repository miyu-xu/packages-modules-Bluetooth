...
TEST(InitFlagsTest, test_leaudio_targeted_annoucement_reconnection_mode) {
  const char* input[] = {"INIT_leaudio_targeted_annoucement_reconnection_mode=true", nullptr};
  InitFlags::Load(input);
