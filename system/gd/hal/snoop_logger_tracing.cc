...
void SnoopLoggerTracing::TracePacket(const BundleKey& key, const BundleDetails& details) {
  SnoopLoggerTracing::Trace([&key, &details](SnoopLoggerTracing::TraceContext ctx) {
