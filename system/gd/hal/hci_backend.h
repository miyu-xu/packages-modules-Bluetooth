...
class HciBackend {
 public:
  static std::unique_ptr<HciBackend> CreateAidl(std::shared_ptr<HciBackendCallbacks>, const char*);

  static std::unique_ptr<HciBackend> CreateHidl(
      std::shared_ptr<HciBackendCallbacks>, ::bluetooth::os::Handler*);
