...
TEST_F(SnoopLoggerSocketModuleTest, socket_start_no_stop_test) {
  {
    auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
    sls.Start();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_stop_no_start_test) {
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Stop();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_start_stop_test) {
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_repeated_start_stop_test) {
  int repeat = 10;
  {
    auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
...
TEST_F(SnoopLoggerSocketModuleTest, socket_connect_test) {
  int ret = 0;
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_connect_disconnect_test) {
  int ret = 0;
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_send_no_start_test) {
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
...
TEST_F(SnoopLoggerSocketModuleTest, socket_send_before_connect_test) {
  int ret = 0;
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
  ...
  int bytes_read = recv(socket_fd, recv_buf, sizeof(SnoopLoggerCommon::FileHeaderType), MSG_DONTWAIT);
  ASSERT_EQ(bytes_read, -1);
}

TEST_F(SnoopLoggerSocketModuleTest, socket_recv_file_header_test) {
  int ret = 0;
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
...
TEST_F(SnoopLoggerSocketModuleTest, socket_send_recv_test) {
  int ret = 0;
  auto sls = SnoopLoggerSocket(SnoopLoggerSocket::DEFAULT_LOCALHOST_, SnoopLoggerSocket::DEFAULT_LISTEN_PORT_);
  sls.Start();
