...
protected:
  ...
  hal::SocketCapabilities GetSocketCapabilities() override { return kEmptySocketCapabilities; }
  ...
  bool Opened(const hal::SocketContext& /*context*/) override { return false; }
