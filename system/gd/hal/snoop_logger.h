...
class ProfilesFilter {
 public:
  ...
  void ProfileL2capOpen(profile_type_t profile, uint16_t lcid, uint16_t rcid, uint16_t psm, bool flow_ext);

  void ProfileL2capClose(profile_type_t profile);

  void ProfileRfcommOpen(profile_type_t profile, uint16_t lcid, uint8_t dlci, uint16_t uuid, bool flow_ext);
...
class SnoopLogger : public ::bluetooth::Module {
 public:
  ...
  static const std::string kBtSnoopLogFilterProfilesProperty;
  ...
  static const std::string kBtSnoopLogFilterProfileModeNone;
  ...
  std::unordered_map<std::string, std::string> kBtSnoopLogFilterProfiles = {
      {kBtSnoopLogFilterProfilePbap, kBtSnoopLogFilterProfileModeNone},
      {kBtSnoopLogFilterProfileMap, kBtSnoopLogFilterProfileModeNone}};
  ...
  void SetRfcommPortOpen(uint16_t conn_handle, uint16_t local_cid, uint8_t dlci, uint16_t uuid, bool flow);
  ...
  void SetL2capChannelOpen(uint16_t handle, uint16_t local_cid, uint16_t remote_cid, uint16_t psm, bool flow);
 ...
 protected:
  ...
  uint32_t PayloadStrip(profile_type_t current_profile, uint8_t* packet, uint32_t hdr_len, uint32_t pl_len);
