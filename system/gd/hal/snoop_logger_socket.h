...
#include "hal/socket_interface.h"
...
class SnoopLoggerSocket {
 public:
  ...
  SnoopLoggerSocket(SocketInterface* socket, int address = DEFAULT_LOCALHOST_, int port = DEFAULT_LISTEN_PORT_);
  ...
  SocketInterface* GetSocketInterface() const;
