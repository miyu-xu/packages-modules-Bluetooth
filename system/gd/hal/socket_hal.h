...
public:
   ...
   */
  virtual bluetooth::hci::SocketProperties GetSocketProperties() = 0;
   ...
   */
  virtual bool NotifyAclConnectionStateChange(int aclHandle, bluetooth::hci::AclLinkType linkType,
                                              bluetooth::hci::ConnectionState state) = 0;
   ...
   * @return true if successfully notified to the offload end point
   */
  virtual bool NotifyAclPowerModeChange(int aclHandle, bluetooth::hci::AclPowerMode powerMode,
                                        int interval) = 0;
