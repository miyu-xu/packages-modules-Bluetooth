...
struct SocketContext {
  ...
  union ChannelInfo {
    ...
    RfcommChannelInfo rfcomm_channel_info;
  };
...
public:
   ...
   */
  virtual void SocketOpenedComplete(uint64_t socket_id, SocketStatus status) = 0;
   ...
   * @param socket_id Identifier assigned to the socket by the host stack
   */
  virtual void SocketClose(uint64_t socket_id) = 0;
};
