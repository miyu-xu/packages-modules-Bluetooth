...
public:
  ...
  virtual bool SetAclCredits(int link, int credit) = 0;
  virtual bool NotifyAclConnectionStateChange(int handle, int link, int state) = 0;
  virtual bool NotifyAclLeDataLengthChange(int handle, int txDataLen, int rxDataLen) = 0;
  virtual bool NotifyAclPowerModeChange(int handle, int mode, int interval) = 0;
  virtual bool NotifySocketConnectionStateChange(SocketContext& context) = 0;
};
