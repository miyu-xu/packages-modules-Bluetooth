...
struct TestTableString FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyString(test_string()) &&
           verifier.EndTable();
  }
};
...
struct TestTableStringBuilder {
  ...
  explicit TestTableStringBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<TestTableString> CreateTestTableString(
    ...
    ::flatbuffers::Offset<::flatbuffers::String> test_string = 0) {
...
inline ::flatbuffers::Offset<TestTableString> CreateTestTableStringDirect(
  ...
  return testing::CreateTestTableString(
      _fbb,
      test_string__);
}
...
inline bool VerifyTestTableStringBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<testing::TestTableString>(nullptr);
}

inline bool VerifySizePrefixedTestTableStringBuffer(
    ::flatbuffers::Verifier &verifier) {
...
inline void FinishTestTableStringBuffer(
    ...
    ::flatbuffers::Offset<testing::TestTableString> root) {
  fbb.Finish(root);
}
