...
struct TestTableFloat FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<float>(verifier, VT_TEST_FLOAT, 4) &&
           verifier.EndTable();
  }
};
...
struct TestTableFloatBuilder {
  ...
  explicit TestTableFloatBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline bool VerifyTestTableFloatBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<testing::TestTableFloat>(nullptr);
}

inline bool VerifySizePrefixedTestTableFloatBuffer(
    ::flatbuffers::Verifier &verifier) {
...
inline void FinishTestTableFloatBuffer(
    ...
    ::flatbuffers::Offset<testing::TestTableFloat> root) {
  fbb.Finish(root);
}
