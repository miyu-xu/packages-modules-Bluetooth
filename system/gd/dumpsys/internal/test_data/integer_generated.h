...
struct TestTableIntegerBuilder {
  ...
  explicit TestTableIntegerBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline bool VerifyTestTableIntegerBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<testing::TestTableInteger>(nullptr);
}

inline bool VerifySizePrefixedTestTableIntegerBuffer(
    flatbuffers::Verifier &verifier) {
...
inline void FinishTestTableIntegerBuffer(
    ...
    flatbuffers::Offset<testing::TestTableInteger> root) {
  fbb.Finish(root);
}
