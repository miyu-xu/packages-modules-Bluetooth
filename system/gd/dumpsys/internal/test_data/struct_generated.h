...
struct TestSubTable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_PLACEHOLDER, 4) &&
           verifier.EndTable();
  }
};
...
struct TestSubTableBuilder {
  ...
  explicit TestSubTableBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
struct TestTableStruct FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_SUB_TABLE) &&
           verifier.VerifyTable(sub_table()) &&
           verifier.EndTable();
  }
};
...
struct TestTableStructBuilder {
  ...
  explicit TestTableStructBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<TestTableStruct> CreateTestTableStruct(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<testing::TestSubTable> sub_table = 0) {
...
inline bool VerifyTestTableStructBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<testing::TestTableStruct>(nullptr);
}

inline bool VerifySizePrefixedTestTableStructBuffer(
    flatbuffers::Verifier &verifier) {
...
inline void FinishTestTableStructBuffer(
    ...
    flatbuffers::Offset<testing::TestTableStruct> root) {
  fbb.Finish(root);
}
