...
void OnAttRegistrationCompleteLe(
    [[maybe_unused]] l2cap::le::FixedChannelManager::RegistrationResult result,
    [[maybe_unused]] std::unique_ptr<l2cap::le::FixedChannelService> le_smp_service) {
  LOG_INFO("ATT channel registration complete");
}

void OnAttConnectionOpenLe([[maybe_unused]] std::unique_ptr<l2cap::le::FixedChannel> channel) {
