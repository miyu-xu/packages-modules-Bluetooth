...
use bluetooth_core::{
    ...
    packets::{
        ...
        AttFindByTypeValueRequestBuilder, AttFindByTypeValueResponseView,
        AttFindInformationRequestBuilder, AttFindInformationResponseChild,
        ...
        AttWriteRequestBuilder, AttWriteResponseBuilder, GattCharacteristicDeclarationValueBuilder,
    ...
    utils::packet::{build_att_data, build_att_view_or_crash, build_view_or_crash},
};
