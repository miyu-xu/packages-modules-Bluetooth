...
use bluetooth_core::{
    gatt::{
        ...
        server::{
            gatt_database::{
                AttPermissions, GattCharacteristicWithHandle, GattServiceWithHandle, Uuid,
            },
            GattModule,
        },
    },
    packets::{
        ...
        AttReadResponseBuilder, AttWriteRequestBuilder, AttWriteResponseBuilder,
        GattServiceDeclarationValueBuilder, Serializable,
    },
...
const UUID_1: Uuid = Uuid::new([1, 2, 0, 0]);
const UUID_2: Uuid = Uuid::new([1, 3, 0, 0]);
