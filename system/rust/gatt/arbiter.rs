...
use crate::packets::{AttOpcode, OwnedAttView, OwnedPacket};

use super::ids::{AdvertiserId, ConnectionId, ServerId, TransportIndex};
...
impl Arbiter {
    ...
    pub fn on_le_connect(
        ...
        info!("processing incoming connection on transport {tcb_idx:?} to advertiser {advertiser:?}");
