...
pub trait GattCallbacks {
    /// Invoked when a client tries to read a characteristic/descriptor. Expects a response
    ...
    /// Invoked when a client tries to write a characteristic/descriptor. Expects a
