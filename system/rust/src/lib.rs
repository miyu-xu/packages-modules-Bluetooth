...
use connection::hci_operations::HciConnectProxy;
use connection::{AddressManager};
...
pub struct ModuleViews<'a> {
    ...
    pub connection_manager: &'a mut connection::ConnectionManager,
}
...
impl GlobalModuleRegistry {
    ...
    pub fn start(
        ...
        hci_connect_proxy: Rc<dyn HciConnectProxy>,
        ...
        local.block_on(&rt, async {
            ...
            let connection_manager =
                &mut connection::ConnectionManager::new(hci_connect_proxy, address_manager);
