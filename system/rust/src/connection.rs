...
impl ConnectionManager {
  pub async fn connect(&self, client: ConnectionManagerClient, address: AddressWithType, params: ConnectionParameters) -> Result<(), ConnectionFailure> {
    todo!()
  }

  pub fn cancel_connect(&self, client: ConnectionManagerClient, address: AddressWithType) -> Result<(), CancelConnectFailure> {
    todo!()
  }
}
