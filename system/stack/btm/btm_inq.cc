 ...
 *
 ******************************************************************************/
void BTM_ReadRemoteDeviceName(const RawAddress& remote_bda, tBTM_CMPL_CB* p_cb,
  ...
  btm_cb.btm_inq_vars.remote_name_scheduler.InitiateRemoteNameRequest(
...
tBTM_STATUS BTM_CancelRemoteDeviceName(tBTM_PENDING_REMNAME_HANDLE handle) {
  btm_cb.btm_inq_vars.remote_name_scheduler.CancelRemoteNameRequest(handle);
}
