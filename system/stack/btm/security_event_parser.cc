...
namespace {
static void log_address_and_status(Address bda, EventCode event_code,
...
static void log_address(Address bda, EventCode event_code) {
  uint32_t cmd = android::bluetooth::hci::CMD_UNKNOWN;
...
static void parse_encryption_change(EventView event) {
  ...
  // btm_encryption_change(status, handle, encr_enable);
...
static void parse_change_connection_link_key_complete(EventView event) {
  auto complete_opt =
...
static void parse_central_link_key_complete(EventView event) {
...
static void parse_return_link_keys(EventView event) {
...
static void parse_pin_code_request(EventView event) {
...
static void parse_link_key_request(EventView event) {
...
static void parse_link_key_notification(EventView event) {
...
static void parse_encryption_key_refresh_complete(EventView event) {
...
static void parse_io_capabilities_req(EventView event) {
...
static void parse_io_capabilities_rsp(EventView event) {
...
static void parse_remote_oob_data_request(EventView event) {
...
static void parse_simple_pairing_complete(EventView event) {
...
static void parse_user_passkey_notification(EventView event) {
...
static void parse_keypress_notification(EventView event) {
...
static void parse_user_confirmation_request(EventView event) {
...
static void parse_user_passkey_request(EventView event) {
