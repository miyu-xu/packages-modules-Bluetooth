...
// Pairing parameteres defined in Vol 3, Part H, Chapter 3.5.1 - 3.5.2
// All present in the exact demical values, not hex
...
uint8_t btm_ble_br_keys_req(tBTM_SEC_DEV_REC* p_dev_rec,
  ...
  p_data->max_key_size =
      osi_property_get_int32(kPropertyCtkdMaxKeySize, SMP_BR_SEC_DEFAULT_KEY);
