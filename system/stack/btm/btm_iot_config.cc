...
void btm_iot_save_remote_versions(tACL_CONN* p_acl_cb) {
  device_iot_config_addr_set_int(p_acl_cb->remote_addr,
          IOT_CONF_KEY_MANUFACTURER, p_acl_cb->remote_version_info.manufacturer);
  device_iot_config_addr_set_int(p_acl_cb->remote_addr,
          IOT_CONF_KEY_LMPVER, p_acl_cb->remote_version_info.lmp_version);
  device_iot_config_addr_set_int(p_acl_cb->remote_addr,
          IOT_CONF_KEY_LMPSUBVER, p_acl_cb->remote_version_info.lmp_subversion);
}
