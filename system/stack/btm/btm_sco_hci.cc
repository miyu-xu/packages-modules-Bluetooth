...
static const uint8_t
    btm_msbc_zero_packet[] = {0x01, 0x08, /* Mock H2 header */
                              ...
                              0x6c, 0x00 /* A padding byte defined by mSBC */};
...
struct tBTM_MSBC_PLC {
 ...
 public:
  ...
  void handle_bad_frames(const uint8_t** output) {
    ...
    hfp_msbc_decoder_decode_packet(btm_msbc_zero_packet, decoded_buffer,
