 ...
 *
 * Description      Delete old record when pairing with already paired device
 *                  which advertising with new random address, using new IRK but
 *                  same old static address.
 *
 * Returns          true if a duplicate device was deleted
 *
 ******************************************************************************/
