...
public:
  ...
  bool is_datalen_set_by_prevclient() const { return is_datalen_set_by_prevclient; }

  void set_is_datalen_set_by_prevclient(bool value) { is_datalen_set_by_prevclient = value; }
