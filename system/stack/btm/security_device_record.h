...
public:
  ...
  bool is_security_state_idle() const { return sec_state == BTM_SEC_STATE_IDLE; }
  bool is_security_state_authenticating() const {
    return sec_state == BTM_SEC_STATE_AUTHENTICATING;
  }
  bool is_security_state_bredr_encrypting() const { return sec_state == BTM_SEC_STATE_ENCRYPTING; }
  bool is_security_state_le_encrypting() const { return sec_state == BTM_SEC_STATE_LE_ENCRYPTING; }
  bool is_security_state_encrypting() const {
    return is_security_state_bredr_encrypting() || is_security_state_le_encrypting();
  }
  bool is_security_state_getting_name() const { return sec_state == BTM_SEC_STATE_GETTING_NAME; }
  bool is_security_state_authorizing() const { return sec_state == BTM_SEC_STATE_AUTHORIZING; }
  bool is_security_state_switching_role() const {
    return sec_state == BTM_SEC_STATE_SWITCHING_ROLE;
  }
  bool is_security_state_disconnecting() const { return sec_state == BTM_SEC_STATE_DISCONNECTING; }
