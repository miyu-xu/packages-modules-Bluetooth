...
/* Try to encode PCM data into SCO packets and buffer them.
 * Args:
 *    data - Pointer to input PCM bytes for the encoder to encode.
 *    len - Length of the input data.
 *    output - Pointer to output mSBC packets encoded by the encoder.
 * Returns:
 *    The length of encoded data. 0 if failed.
 */
