  ...
  if (p_dev_rec != nullptr) {
    switch (event) {
      ...
      case SMP_SEC_REQUEST_EVT:
        btm_ble_sec_req(p_dev_rec, (tBTM_LE_EVT_DATA*)p_data);
        break;

      case SMP_CONSENT_REQ_EVT:
        btm_ble_consent_req(p_dev_rec, (tBTM_LE_EVT_DATA*)p_data);
        break;

      case SMP_COMPLT_EVT:
        btm_ble_complete_evt(p_dev_rec, (tBTM_LE_EVT_DATA*)p_data);
        break;
