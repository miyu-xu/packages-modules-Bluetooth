  ...
  switch (sec_act) {
    ...
    case BTM_BLE_SEC_ENCRYPT_MITM:
      ...
      if (SMP_Pair(bd_addr) == SMP_STARTED) {
        cmd = BTM_CMD_STARTED;
        p_rec->sec_rec.le_link = tSECURITY_STATE::BTM_SEC_STATE_AUTHENTICATING;
      }
      break;
...
tBTM_STATUS btm_ble_start_encrypt(const RawAddress& bda, bool use_stk,
  ...
  if (p_rec->sec_rec.le_link == tSECURITY_STATE::BTM_SEC_STATE_IDLE) {
    p_rec->sec_rec.le_link = tSECURITY_STATE::BTM_SEC_STATE_ENCRYPTING;
  }
