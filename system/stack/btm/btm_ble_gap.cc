...
void btm_ble_init(void) {
...
#endif
  if (osi_property_get("persist.vendor.btstack.enable.enc_adv_data",enc_adv_data_enabled_prop, "true")
  ...
  if (osi_property_get("persist.vendor.btstack.enable.enc_adv_data_log", enc_adv_data_log_enabled_prop,
