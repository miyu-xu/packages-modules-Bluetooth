...
void btsnd_hcic_remove_iso_data_path(uint16_t iso_handle, uint8_t data_path_dir,
  ...
  btu_hcif_send_cmd_with_cb(HCI_LE_REMOVE_ISO_DATA_PATH, param, params_len,
                            std::move(cb));
}
...
void btsnd_hcic_read_iso_link_quality(uint16_t iso_handle,
  ...
  btu_hcif_send_cmd_with_cb(HCI_LE_READ_ISO_LINK_QUALITY, param, params_len,
                            std::move(cb));
}
...
void btsnd_hcic_ble_set_default_periodic_advertising_sync_transfer_params(
  ...
  btu_hcif_send_cmd_with_cb(
          HCI_LE_SET_DEFAULT_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAM, param,
