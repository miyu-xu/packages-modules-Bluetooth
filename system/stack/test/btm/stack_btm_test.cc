...
class StackBtmWithQueuesTest : public StackBtmTest {
  ...
  bluetooth::common::BidiQueue<bluetooth::hci::ScoView, bluetooth::hci::ScoBuilder> sco_queue_{
    10
  };
...
TEST_F(StackBtmWithInitFreeTest, Init) { ASSERT_FALSE(btm_cb.btm_inq_vars.remname_active); }
