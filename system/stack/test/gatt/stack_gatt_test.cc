...
const static std::map<uint8_t, uint16_t> gatt_min_value_cmd_size{
    ...
    {GATT_RSP_READ_BLOB, 1},     // op_code (1) + offset (2)
    {GATT_RSP_READ, 1},
...
TEST_F(StackGattTest, attp_build_value_cmd_test1) {
...
TEST_F(StackGattTest, attp_build_value_cmd_test2) {
  for (auto it = gatt_min_value_cmd_size.begin();
       it != gatt_min_value_cmd_size.end(); it++) {
...
TEST_F(StackGattTest, attp_build_value_cmd_test3) {
  for (auto it = gatt_min_value_cmd_size.begin();
       it != gatt_min_value_cmd_size.end(); it++) {
...
TEST_F(StackGattTest, attp_build_value_cmd_test4) {
  for (auto it = gatt_min_value_cmd_size.begin();
       it != gatt_min_value_cmd_size.end(); it++) {
...
/*
TEST_F(StackGattTest, attp_build_value_cmd_test) {
  attp_build_value_cmd_test_small_size();
  attp_build_value_cmd_read_by_type_test_long_data();
  attp_build_value_cmd_test1();
  attp_build_value_cmd_test2();
  attp_build_value_cmd_test3();
  attp_build_value_cmd_test4();
}
*/
