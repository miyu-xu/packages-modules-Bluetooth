...
TEST_F(StackL2capTest, l2cap_result_code_text) {
  std::vector<std::pair<tL2CAP_CONN, std::string>> results = {
          std::make_pair(L2CAP_CONN_OK, "L2CAP_CONN_OK(0x0000)"),
          std::make_pair(L2CAP_CONN_PENDING, "L2CAP_CONN_PENDING(0x0001)"),
          std::make_pair(L2CAP_CONN_NO_PSM, "L2CAP_CONN_NO_PSM(0x0002)"),
          std::make_pair(L2CAP_CONN_SECURITY_BLOCK, "L2CAP_CONN_SECURITY_BLOCK(0x0003)"),
          std::make_pair(L2CAP_CONN_NO_RESOURCES, "L2CAP_CONN_NO_RESOURCES(0x0004)"),
          std::make_pair(L2CAP_CONN_TIMEOUT, "L2CAP_CONN_TIMEOUT(0xEEEE)"),
          std::make_pair(L2CAP_CONN_OTHER_ERROR, "L2CAP_CONN_OTHER_ERROR(0xF000)"),
          ...
          std::make_pair(L2CAP_CONN_NO_LINK, "L2CAP_CONN_NO_LINK(0xF003)"),
          std::make_pair(L2CAP_CONN_CANCEL, "L2CAP_CONN_CANCEL(0xF004)"),
          ...
          std::make_pair(L2CAP_CONN_INSUFFICIENT_ENCRYP, "L2CAP_CONN_INSUFFICIENT_ENCRYP(0xFF08)"),
          std::make_pair(L2CAP_CONN_INVALID_SOURCE_CID, "L2CAP_CONN_INVALID_SOURCE_CID(0xFF09)"),
          ...
          std::make_pair(L2CAP_CONN_INVALID_PARAMETERS, "L2CAP_CONN_INVALID_PARAMETERS(0xFF0C)"),
  };
