...
class StackL2capChannelTest : public StackL2capTest {
 protected:
  void SetUp() override { StackL2capChannelTest::SetUp(); }

  void TearDown() override { StackL2capChannelTest::TearDown(); }
...
TEST_F(StackL2capChannelTest, l2c_link_init) {
  ...
  ASSERT_EQ(123, l2cb.num_lm_acl_bufs);
  ASSERT_EQ(123, l2cb.controller_xmit_window);
}
