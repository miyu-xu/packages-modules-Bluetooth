...
std::vector<std::function<void(FuzzedDataProvider*)>> a2dp_codec_operations = {
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      if (p_result_codec_config) {
        codecs->setCodecConfig(fdp->ConsumeBool(), peer_codec_info, fdp->ConsumeBool(),
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      std::unique_ptr<uint8_t, void (*)(void*)> p_result_codec_config(
          reinterpret_cast<uint8_t*>(calloc(500, sizeof(uint8_t))), free);
      if (p_result_codec_config) {
        codecs->setSinkCodecConfig(fdp->ConsumeBool(), peer_codec_info, fdp->ConsumeBool(),
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      codecs->setCodecUserConfig(fdp->ConsumeBool(), codec_user_config, &p_peer_params,
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      codecs->setCodecAudioConfig(
          fdp->ConsumeBool(), codec_audio_config, &p_peer_params, p_peer_sink_capabilities,
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      codecs->setCodecOtaConfig(fdp->ConsumeBool(), p_ota_codec_config, &p_peer_params,
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      codecs->setPeerSinkCodecCapabilities(fdp->ConsumeBool(), p_peer_codec_capabilities);
    },
    ...
    [](FuzzedDataProvider* fdp) -> void {
      ...
      codecs->setPeerSourceCodecCapabilities(fdp->ConsumeBool(), p_peer_codec_capabilities);
    },
