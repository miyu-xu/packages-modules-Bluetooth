...
std::vector<std::function<void(FuzzedDataProvider*, uint8_t*)>> a2dp_codec_info_operations = {
  ...
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_IsSourceCodecValid(codec_info); },

  // A2DP_IsSinkCodecValid
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_IsSinkCodecValid(codec_info); },
  ...
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_GetTrackSampleRate(codec_info); },
  ...
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_SourceCodecIndex(codec_info); },

  // A2DP_SinkCodecIndex
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_SinkCodecIndex(codec_info); },
  ...
  [](FuzzedDataProvider* fdp, uint8_t* codec_info) -> void { A2DP_CodecInfoString(codec_info); }
};
