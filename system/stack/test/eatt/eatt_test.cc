...
protected:
  ...
  void SetUp() override {
    ...
    ON_CALL(l2cap_interface_, L2CA_GetBleConnRole(_)).WillByDefault(DoAll(Return(hci_role_)));
  ...
  void TearDown() override {
    ...
    EXPECT_CALL(l2cap_interface_, L2CAP_DeregisterLECoc(BT_PSM_EATT)).Times(1);
