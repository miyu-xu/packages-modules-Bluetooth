...
TEST_F(StackSdpInitTest, sdp_state_text) {
  std::vector<std::pair<tSDP_STATE, std::string>> states = {
      std::make_pair(tSDP_STATE::IDLE, "tSDP_STATE::IDLE"),
      std::make_pair(tSDP_STATE::CONN_SETUP, "tSDP_STATE::CONN_SETUP"),
      std::make_pair(tSDP_STATE::CFG_SETUP, "tSDP_STATE::CFG_SETUP"),
      std::make_pair(tSDP_STATE::CONNECTED, "tSDP_STATE::CONNECTED"),
      std::make_pair(tSDP_STATE::CONN_PEND, "tSDP_STATE::CONN_PEND"),
  };
  for (const auto& state : states) {
