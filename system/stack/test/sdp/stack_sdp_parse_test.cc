...
TEST_F_WITH_FLAGS(StackSdpAsClientParseTest, sdp_disc_server_rsp_packets00,
  ...
  p_sdp_rec = p_db_->p_first_rec;
  ASSERT(get_legacy_stack_sdp_api()->record.SDP_FindServiceUUIDInRec_128bit(
  ...
  ASSERT(get_legacy_stack_sdp_api()->record.SDP_FindProtocolListElemInRec(
  ...
  // Browse Group List
  ASSERT(get_legacy_stack_sdp_api()->record.SDP_FindAttributeInRec(
