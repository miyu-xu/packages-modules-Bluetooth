...
struct lc3_decoder_size {
  ...
  std::function<unsigned(int dt_us, int sr_hz)> body{ [](int dt_us, int sr_hz) {
    return return_value;
  } };
...
struct lc3_delay_samples {
  static int return_value;
  std::function<int(int dt_us, int sr_hz)> body{ [](int dt_us, int sr_hz) {
    return return_value;
  } };
...
struct lc3_encode {
  ...
  std::function<int(struct lc3_encoder* encoder, enum lc3_pcm_format fmt, const void* pcm,
          ...
          body{ [](struct lc3_encoder* encoder, enum lc3_pcm_format fmt, const void* pcm,
                   int stride, int nbytes, void* out) { return return_value; } };
...
struct lc3_frame_bytes {
  static int return_value;
  std::function<int(int dt_us, int bitrate)> body{ [](int dt_us, int bitrate) {
    return return_value;
  } };
...
struct lc3_resolve_bitrate {
  static int return_value;
  std::function<int(int dt_us, int nbytes)> body{ [](int dt_us, int nbytes) {
    return return_value;
  } };
