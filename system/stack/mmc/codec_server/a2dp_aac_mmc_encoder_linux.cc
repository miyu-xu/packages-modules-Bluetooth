...
A2dpAacEncoderLinux::A2dpAacEncoderLinux() : avctx_(nullptr) {}

A2dpAacEncoderLinux::~A2dpAacEncoderLinux() { cleanup(); }

int A2dpAacEncoderLinux::init(ConfigParam config) {
...
void A2dpAacEncoderLinux::cleanup() {
  if (avctx_) {
...
int A2dpAacEncoderLinux::transcode(uint8_t* i_buf, int i_len, uint8_t* o_buf,
                                   int o_len) {
  int rc;
