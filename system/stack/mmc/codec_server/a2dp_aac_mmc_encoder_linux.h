...
// A2dpAacEncoderLinux wraps Ffmpeg encode libraries.
class A2dpAacEncoderLinux : public MmcInterface {
 public:
  explicit A2dpAacEncoderLinux();
  ~A2dpAacEncoderLinux();

  // A2dpAacEncoderLinux is neither copyable nor movable.
  A2dpAacEncoderLinux(const A2dpAacEncoderLinux&) = delete;
  A2dpAacEncoderLinux& operator=(const A2dpAacEncoderLinux&) = delete;
