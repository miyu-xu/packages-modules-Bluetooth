...
uint16_t AVDT_RemoveStream(uint8_t handle) {
  ...
  LOG_DEBUG("%s: avdt_handle=%d", __func__, handle);
...
uint16_t AVDT_DelayReport(uint8_t handle, uint8_t seid, uint16_t delay) {
  ...
  LOG_DEBUG("%s: avdt_handle=%d seid=%d delay=%d", __func__, handle, seid,
            delay);
...
uint16_t AVDT_OpenReq(uint8_t handle, const RawAddress& bd_addr,
  ...
  LOG_INFO("%s: address=%s avdt_handle=%d seid=%d", __func__,
...
uint16_t AVDT_ConfigRsp(uint8_t handle, uint8_t label, uint8_t error_code,
  ...
  LOG_DEBUG("%s: avdt_handle=%d label=%d error_code=0x%x category=%d", __func__,
...
uint16_t AVDT_StartReq(uint8_t* p_handles, uint8_t num_handles) {
  ...
  LOG_DEBUG("%s: num_handles=%d", __func__, num_handles);
...
uint16_t AVDT_CloseReq(uint8_t handle) {
  ...
  LOG_INFO("%s: avdt_handle=%d", __func__, handle);
...
uint16_t AVDT_SecurityReq(uint8_t handle, uint8_t* p_data, uint16_t len) {
  ...
  LOG_DEBUG("%s: avdt_handle=%d len=%d", __func__, handle, len);
...
uint16_t AVDT_SecurityRsp(uint8_t handle, uint8_t label, uint8_t error_code,
  ...
  LOG_DEBUG("%s: avdt_handle=%d label=%d error_code=0x%x len=%d", __func__,
...
uint16_t AVDT_WriteReqOpt(uint8_t handle, BT_HDR* p_pkt, uint32_t time_stamp,
  ...
  LOG_DEBUG("%s: avdt_handle=%d timestamp=%d m_pt=0x%x opt=0x%x", __func__,
  ...
  LOG_DEBUG("%s: result=%d avdt_handle=%d", __func__, result, handle);
  return result;
}
