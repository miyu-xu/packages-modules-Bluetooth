...
void avdt_ccb_event(AvdtpCcb* p_ccb, uint8_t event,
...
void avdt_scb_event(AvdtpScb* p_scb, uint8_t event,
...
void avdt_msg_send_cmd(AvdtpCcb* p_ccb, void* p_scb, uint8_t sig_id,
                              tAVDT_MSG* p_params);
void avdt_msg_send_rsp(AvdtpCcb* p_ccb, uint8_t sig_id,
                              tAVDT_MSG* p_params);
void avdt_msg_send_rej(AvdtpCcb* p_ccb, uint8_t sig_id,
                              tAVDT_MSG* p_params);
void avdt_msg_send_grej(AvdtpCcb* p_ccb, uint8_t sig_id,
                               tAVDT_MSG* p_params);
...
AvdtpTransportChannel* avdt_ad_tc_tbl_by_st(uint8_t type,
                                                   AvdtpCcb* p_ccb,
                                                   uint8_t state);
...
void avdt_ad_tc_cong_ind(AvdtpTransportChannel* p_tbl,
                                bool is_congested);
void avdt_ad_tc_data_ind(AvdtpTransportChannel* p_tbl, BT_HDR* p_buf);
AvdtpTransportChannel* avdt_ad_tc_tbl_by_type(uint8_t type,
                                                     AvdtpCcb* p_ccb,
                                                     AvdtpScb* p_scb);
