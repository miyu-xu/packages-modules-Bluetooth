...
static void l2cu_set_acl_priority_latency_syna(tL2C_LCB* p_lcb, tL2CAP_PRIORITY priority) {
  ...
  BTM_VendorSpecificCommand(HCI_SYNA_SET_ACL_PRIORITY, HCI_SYNA_ACL_PRIORITY_PARAM_SIZE, command,
                            NULL);
}
...
static void l2cu_set_acl_priority_unisoc(tL2C_LCB* p_lcb, tL2CAP_PRIORITY priority) {
  ...
  BTM_VendorSpecificCommand(HCI_UNISOC_SET_ACL_PRIORITY, HCI_UNISOC_ACL_PRIORITY_PARAM_SIZE,
                            command, NULL);
}
...
static void l2cu_set_acl_latency_mtk(tL2CAP_LATENCY latency) {
  ...
  BTM_VendorSpecificCommand(HCI_MTK_SET_ACL_PRIORITY, HCI_MTK_ACL_PRIORITY_PARAM_SIZE, command,
                            NULL);
}
