...
/* Callback function prototype to pass echo response  */
/* to the upper layer                                                   */
...
* Function         L2CA_Ping
*
* Description      Higher layers call this function to send an ping request.
*
* Returns          true if ping request sent, else false.
*
******************************************************************************/
