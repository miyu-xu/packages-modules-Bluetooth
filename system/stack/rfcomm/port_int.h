...
typedef struct {
  ...
  uint16_t cached_lcid;                    /* store LCID for retry of outgoing connection*/
  bool collided_then_received_conn_cnf;    /* true if peer responded to start_req after collision */
  ...
  // References to pending_ will be dead after rfcomm_mux_fix_collision_resolution() rolls out
