...
void RFCOMM_PortParameterNegotiationRequest(tRFC_MCB* p_mcb,
                                                   uint8_t dlci,
                                                   tPORT_STATE* p_pars);
void RFCOMM_PortParameterNegotiationResponse(tRFC_MCB* p_mcb,
                                                    uint8_t dlci,
                                                    tPORT_STATE* p_pars,
                                                    uint16_t param_mask);

void RFCOMM_ControlReq(tRFC_MCB* p_mcb, uint8_t dlci,
                              tPORT_CTRL* p_pars);
void RFCOMM_ControlRsp(tRFC_MCB* p_mcb, uint8_t dlci,
                              tPORT_CTRL* p_pars);

void RFCOMM_LineStatusReq(tRFC_MCB* p_mcb, uint8_t dlci,
                                 uint8_t line_status);
/*
...
void rfc_mx_sm_execute(tRFC_MCB* p_mcb, tRFC_MX_EVENT event,
                              void* p_data);

/*
 * Functions provided by the rfc_port_fsm.cc
*/
void rfc_port_sm_execute(tPORT* p_port, tRFC_PORT_EVENT event,
                                void* p_data);

void rfc_process_pn(tRFC_MCB* p_rfc_mcb, bool is_command,
                           MX_FRAME* p_frame);
void rfc_process_msc(tRFC_MCB* p_rfc_mcb, bool is_command,
                            MX_FRAME* p_frame);
void rfc_process_rpn(tRFC_MCB* p_rfc_mcb, bool is_command,
                            bool is_request, MX_FRAME* p_frame);
void rfc_process_rls(tRFC_MCB* p_rfc_mcb, bool is_command,
                            MX_FRAME* p_frame);
...
void rfc_send_pn(tRFC_MCB* p_mcb, uint8_t dlci, bool is_command,
...
void PORT_ParNegInd(tRFC_MCB* p_mcb, uint8_t dlci, uint16_t mtu,
                           uint8_t cl, uint8_t k);
void PORT_ParNegCnf(tRFC_MCB* p_mcb, uint8_t dlci, uint16_t mtu,
                           uint8_t cl, uint8_t k);
...
void PORT_LineStatusInd(tRFC_MCB* p_mcb, uint8_t dlci,
                               uint8_t line_status);
