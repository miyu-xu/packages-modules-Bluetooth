...
void rfc_send_rpn(tRFC_MCB* p_mcb, uint8_t dlci, bool is_command, tPORT_SETTINGS* p_settings,
                  uint16_t mask);
...
void PORT_PortNegInd(tRFC_MCB* p_mcb, uint8_t dlci, tPORT_SETTINGS* p_settings,
                     uint16_t param_mask);
void PORT_PortNegCnf(tRFC_MCB* p_mcb, uint8_t dlci, tPORT_SETTINGS* p_settings, uint16_t result);
