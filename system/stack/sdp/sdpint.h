...
extern uint16_t sdpu_set_avrc_target_version(const tSDP_ATTRIBUTE* p_attr,
                                         const RawAddress* bdaddr);
extern void sdpu_set_avrc_target_features(tSDP_ATTRIBUTE attr, const tSDP_ATTRIBUTE* p_attr,
                                         const RawAddress* bdaddr, uint16_t profile_version);
