...
void sdpu_set_avrc_target_version(const tSDP_ATTRIBUTE* p_attr,
  ...
  uint16_t dut_avrcp_version = (bluetooth::common::init_flags::dynamic_avrcp_version_enhancement_is_enabled())?
      GetInterfaceToProfiles()->profileSpecific_HACK->AVRC_GetProfileVersion() : avrcp_version;
