...
inline std::string l2cap_result_text(const tL2CAP_CONN& result) {
  switch (result) {
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_OK);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_PENDING);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_NO_PSM);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_SECURITY_BLOCK);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_NO_RESOURCES);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_TIMEOUT);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_OTHER_ERROR);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_ACL_CONNECTION_FAILED);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_CLIENT_SECURITY_CLEARANCE_FAILED);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_NO_LINK);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_CANCEL);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INSUFFICIENT_AUTHENTICATION);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INSUFFICIENT_AUTHORIZATION);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INSUFFICIENT_ENCRYP_KEY_SIZE);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INSUFFICIENT_ENCRYP);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INVALID_SOURCE_CID);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_SOURCE_CID_ALREADY_ALLOCATED);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_UNACCEPTABLE_PARAMETERS);
    CASE_RETURN_STRING_HEX04(L2CAP_CONN_INVALID_PARAMETERS);
  };
...
inline std::string l2cap_uint_result_text(uint16_t result) {
  return l2cap_result_text(to_l2cap_result_code(result));
}
