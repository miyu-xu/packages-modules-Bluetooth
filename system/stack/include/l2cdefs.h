...
typedef enum : uint16_t {
  ...
  L2CAP_CONN_ACL_CONNECTION_FAILED = 247,
  L2CAP_CONN_CLIENT_SECURITY_CLEARANCE_FAILED = 248,
  L2CAP_CONN_INSUFFICIENT_AUTHENTICATION = 249,
  L2CAP_CONN_INSUFFICIENT_AUTHORIZATION = 250,
  L2CAP_CONN_INSUFFICIENT_ENCRYP_KEY_SIZE = 251,
  L2CAP_CONN_INSUFFICIENT_ENCRYP = 252,
  L2CAP_CONN_INVALID_SOURCE_CID = 253,
  L2CAP_CONN_SOURCE_CID_ALREADY_ALLOCATED = 254,
