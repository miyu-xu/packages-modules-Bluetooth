...
inline std::string l2cap_cid_fixed_text(const tL2CAP_CID_FIXED& cid) {
  switch (cid) {
    CASE_RETURN_STRING04X(L2CAP_SIGNALLING_CID);
    CASE_RETURN_STRING04X(L2CAP_CONNECTIONLESS_CID);
    CASE_RETURN_STRING04X(L2CAP_AMP_CID);
    CASE_RETURN_STRING04X(L2CAP_ATT_CID);
    CASE_RETURN_STRING04X(L2CAP_BLE_SIGNALLING_CID);
    CASE_RETURN_STRING04X(L2CAP_SMP_CID);
    CASE_RETURN_STRING04X(L2CAP_SMP_BR_CID);
    CASE_RETURN_STRING04X(L2CAP_BASE_APPL_CID);
  };
