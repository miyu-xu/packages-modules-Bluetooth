...
public:
  ...
  static constexpr uint16_t kMinConnIntervalAggressive = 0x0006;  // 6, *1.25 becomes 7.5ms
  static constexpr uint16_t kMaxConnIntervalAggressive = 0x0008;  // 8, *1.25 becomes 10ms
