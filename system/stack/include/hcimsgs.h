...
void btsnd_hcic_reject_esco_conn(const RawAddress& bd_addr,
                                        uint8_t reason);
/* Hold Mode */
...
void btsnd_hcic_write_ext_inquiry_response(void* buffer,
                                                  uint8_t fec_req);
/* IO Capabilities Response */
void btsnd_hcic_io_cap_req_reply(const RawAddress& bd_addr,
...
void btsnd_hcic_user_passkey_reply(const RawAddress& bd_addr,
                                          uint32_t value);

void btsnd_hcic_user_passkey_neg_reply(const RawAddress& bd_addr);

/* Remote OOB Data Request Reply */
void btsnd_hcic_rem_oob_reply(const RawAddress& bd_addr,
...
void btsnd_hcic_write_voice_settings(
...
void btsnd_hcic_vendor_spec_cmd(void* buffer, uint16_t opcode,
...
void btsnd_hcic_ble_write_adv_params(
...
void btsnd_hcic_ble_set_scan_rsp_data(uint8_t data_len,
                                             uint8_t* p_scan_rsp);
...
void btsnd_hcic_ble_set_scan_enable(uint8_t scan_enable,
                                           uint8_t duplicate);
...
void btsnd_hcic_ble_upd_ll_conn_params(
...
void btsnd_hcic_ble_rc_param_req_reply(
    uint16_t handle, uint16_t conn_int_min, uint16_t conn_int_max,
    uint16_t conn_latency, uint16_t conn_timeout, uint16_t min_ce_len,
    uint16_t max_ce_len);

void btsnd_hcic_ble_rc_param_req_neg_reply(uint16_t handle,
                                                  uint8_t reason);

void btsnd_hcic_ble_set_data_length(uint16_t conn_handle,
                                           uint16_t tx_octets,
                                           uint16_t tx_time);
...
void btsnd_hcic_ble_read_resolvable_addr_local(
    uint8_t addr_type_peer, const RawAddress& bda_peer);
