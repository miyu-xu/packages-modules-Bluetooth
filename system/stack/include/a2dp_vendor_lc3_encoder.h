...
//
// Interface to the A2DP LC3 Encoder
//

#ifndef A2DP_VENDOR_LC3_ENCODER_H
#define A2DP_VENDOR_LC3_ENCODER_H

#include "a2dp_codec_api.h"

// Loads the A2DP LC3 encoder.
// Return true on success, otherwise false.
bool A2DP_VendorLoadEncoderLc3(void);

// Unloads the A2DP LC3 encoder.
void A2DP_VendorUnloadEncoderLc3(void);

// Initialize the A2DP LC3 encoder.
...
// Cleanup the A2DP LC3 encoder.
void a2dp_vendor_lc3_encoder_cleanup(void);

// Reset the feeding for the A2DP LC3 encoder.
void a2dp_vendor_lc3_feeding_reset(void);

// Flush the feeding for the A2DP LC3 encoder.
void a2dp_vendor_lc3_feeding_flush(void);

// Get the A2DP LC3 encoder interval (in milliseconds).
...
// Prepare and send A2DP LC3 encoded frames.
// |timestamp_us| is the current timestamp (in microseconds).
void a2dp_vendor_lc3_send_frames(uint64_t timestamp_us);

// Set transmit queue length for the A2DP LC3 (Dynamic Bit Rate) mechanism.
void a2dp_vendor_lc3_set_transmit_queue_length(size_t transmit_queue_length);

#endif  // A2DP_VENDOR_LC3_ENCODER_H
