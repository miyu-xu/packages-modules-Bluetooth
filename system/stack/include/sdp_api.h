...
struct tLegacyStackSdpApi {
  struct {
     ...
     *                  The difference between this API function and the
     *                  function SDP_ServiceSearchRequest is that this one does
     *a combined ServiceSearchAttributeRequest SDP function with the user data
     *piggyback
     *
     * Returns          true if discovery started, false if failed.
     *
  ...
  struct {
     ...
     *maintenance API. If the sequence already exists in the record, it is
     *                  replaced with the new sequence.
     *
     * Returns          true if added OK, else false
     *
     ...
     *                  record. This would be through the SDP database
     *maintenance API. If the service list already exists in the record, it is
     *replaced with the new list.
     *
     * Returns          true if added OK, else false
     *
