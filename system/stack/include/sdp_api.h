...
struct tSdpApi {
  struct {
     ...
     *the discovery database is managed. len         - (input) size (in bytes)
     *of the memory NOTE: This must be larger than sizeof(tSDP_DISCOVERY_DB)
     ...
     *applied p_attr_list - (input) list of attribute filters
     *
     ...
     *
     * Parameters:      p_db        - (input) address of an area of memory where
     *the discovery database is managed. p_cb        - (input) callback executed
     *when complete
     *
     ...
     * parameters:      bd_addr     - (input) device address for service search
     *                  p_db        - (input) address of an area of memory where
     *the discovery database is managed. p_cb2       - (input) callback executed
     *when complete p_data      - (input) user data
     *
     * Returns          true if discovery started, false if failed.
     *
     ******************************************************************************/
  ...
  struct {
     ...
     *
     * parameters:      p_db        - (input) address of an area of memory where
     *the discovery database is managed. uuid16      - (input) Uuid to search in
     *db disc_rec    - (output) Record found, null otherwise
     *
     ...
     *
     * parameters:      p_db        - (input) address of an area of memory where
     *the discovery database is managed. uuid        - (input) Uuid to search in
     *db disc_rec    - (input) Start record, null from beginning
     *
     * Returns          Pointer to record containing service class, or NULL
     *
     ******************************************************************************/
     ...
     *
     * parameters:      p_db        - (input) address of an area of memory where
     *the discovery database is managed. disc_rec    - (input) Start record,
     *null from beginning
     *
     * Returns          Pointer to record containing service class, or NULL
     *
