...
#define HCI_READ_LOCAL_SUPPORTED_CODECS_V2 \
  (0x000D | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_SUPPORTED_CODEC_CAPABILITIES \
  (0x000E | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_SUPPORTED_CONTROLLER_DELAY \
  (0x000F | HCI_GRP_INFORMATIONAL_PARAMS)
...
#define HCI_READ_LOCAL_SUPPORTED_CODECS_V2_SUPPORTED(x) ((x)[45] & 0x04)
#define HCI_READ_LOCAL_SUPPORTED_CODEC_CAPABILITIES_SUPPORTED(x) \
  ((x)[45] & 0x08)
#define HCI_READ_LOCAL_SUPPORTED_CONTROLLER_DELAY_SUPPORTED(x) ((x)[45] & 0x10)
