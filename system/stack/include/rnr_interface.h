...
public:
   ...
   *
   ******************************************************************************/
  virtual tBTM_STATUS BTM_ReadRemoteDeviceName(const RawAddress& remote_bda,
   ...
   *
   ******************************************************************************/
  virtual tBTM_STATUS BTM_CancelRemoteDeviceName(void) = 0;
   ...
   *
   ******************************************************************************/
  virtual void btm_process_remote_name(const RawAddress* bda, const BD_NAME bdn,
...
bluetooth::stack::rnr::Interface& get_rnr_interface();
