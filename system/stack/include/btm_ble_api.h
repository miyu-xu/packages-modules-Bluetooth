...
extern void btm_ble_periodic_adv_sync_established(uint8_t status, uint16_t sync_handle, uint8_t adv_sid,
        uint8_t address_type, const RawAddress& addr, uint8_t phy, uint16_t interval,
        uint8_t adv_clock_accuracy);
extern void btm_ble_periodic_adv_report(uint16_t sync_handle, uint8_t tx_power, int8_t rssi,
