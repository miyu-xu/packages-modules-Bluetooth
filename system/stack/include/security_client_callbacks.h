...
/* Request CSIS verification for found member. Parameters are
 *              BD Address of remote
 */
typedef uint8_t(tBTM_CSIS_VERIFICATION_CALLBACK)(const RawAddress& bd_addr);
...
struct tBTM_APPL_INFO {
  ...
  tBTM_CSIS_VERIFICATION_CALLBACK* p_csis_verification_callback{nullptr};
};
