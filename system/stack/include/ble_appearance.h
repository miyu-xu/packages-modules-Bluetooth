...
#define appearanceToCODForCategory0000(X) \
  X(BLE_APPEARANCE_UNKNOWN, 0x0000, COD_SERVICE_NA, COD_MAJOR_UNCLASSIFIED, \
...
#define appearanceToCODForCategory0002(X) \
  X(BLE_APPEARANCE_GENERIC_COMPUTER, 0x0080, COD_SERVICE_NA, \
    COD_MAJOR_COMPUTER, COD_MAJOR_COMPUTER_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x003 */
#define BLE_APPEARANCE_SMART_WATCH 0x00C2
#define appearanceToCODForCategory0003(X) \
  X(BLE_APPEARANCE_GENERIC_WATCH, 0x00C0, COD_SERVICE_NA, \
    COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_WRIST_WATCH) \
  X(BLE_APPEARANCE_SPORTS_WATCH, 0x00C1, COD_SERVICE_NA, \
    COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_WRIST_WATCH)
...
#define appearanceToCODForCategory0005(X) \
  X(BLE_APPEARANCE_GENERIC_DISPLAY, 0x0140, COD_SERVICE_NA, \
    COD_MAJOR_IMAGING, COD_MAJOR_IMAGING_MINOR_DISPLAY)

/* Category[15:6] 0x006 */
#define appearanceToCODForCategory0006(X) \
  X(BLE_APPEARANCE_GENERIC_REMOTE, 0x0180, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_REMOTE_CONTROL)

/* Category[15:6] 0x007 */
#define appearanceToCODForCategory0007(X) \
  X(BLE_APPEARANCE_GENERIC_EYEGLASSES, 0x01C0, COD_SERVICE_NA, \
    COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_GLASSES)
...
#define appearanceToCODForCategory000A(X) \
  X(BLE_APPEARANCE_GENERIC_MEDIA_PLAYER, 0x0280, COD_SERVICE_NA, \
    COD_MAJOR_AUDIO, COD_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x00B */
#define appearanceToCODForCategory000B(X) \
  X(BLE_APPEARANCE_GENERIC_BARCODE_SCANNER, 0x02C0, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x00C */
#define appearanceToCODForCategory000C(X) \
  X(BLE_APPEARANCE_GENERIC_THERMOMETER, 0x0300, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_THERMOMETER) \
  X(BLE_APPEARANCE_THERMOMETER_EAR, 0x0301, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_THERMOMETER)

/* Category[15:6] 0x00D */
#define appearanceToCODForCategory000D(X) \
  X(BLE_APPEARANCE_GENERIC_HEART_RATE, 0x0340, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_HEART_PULSE_MONITOR) \
  X(BLE_APPEARANCE_HEART_RATE_BELT, 0x0341, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_HEART_PULSE_MONITOR)

/* Category[15:6] 0x00E */
#define appearanceToCODForCategory000E(X) \
  X(BLE_APPEARANCE_GENERIC_BLOOD_PRESSURE, 0x0380, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR) \
  X(BLE_APPEARANCE_BLOOD_PRESSURE_ARM, 0x0381, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR) \
  X(BLE_APPEARANCE_BLOOD_PRESSURE_WRIST, 0x0382, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR)
...
#define appearanceToCODForCategory000F(X) \
  X(BLE_APPEARANCE_GENERIC_HID, 0x03C0, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_UNCATEGORIZED) \
  X(BLE_APPEARANCE_HID_KEYBOARD, 0x03C1, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_KEYBOARD) \
  X(BLE_APPEARANCE_HID_MOUSE, 0x03C2, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_POINTING) \
  X(BLE_APPEARANCE_HID_JOYSTICK, 0x03C3, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_JOYSTICK) \
  X(BLE_APPEARANCE_HID_GAMEPAD, 0x03C4, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_GAMEPAD) \
  X(BLE_APPEARANCE_HID_DIGITIZER_TABLET, 0x03C5, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_DIGITIZING_TABLET) \
  X(BLE_APPEARANCE_HID_CARD_READER, 0x03C6, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_CARD_READER) \
  X(BLE_APPEARANCE_HID_DIGITAL_PEN, 0x03C7, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_DIGITAL_PEN) \
  X(BLE_APPEARANCE_HID_BARCODE_SCANNER, 0x03C8, COD_SERVICE_NA, \
    COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x010 */
#define appearanceToCODForCategory0010(X) \
  X(BLE_APPEARANCE_GENERIC_GLUCOSE, 0x0400, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_GLUCOSE_METER)

/* Category[15:6] 0x011 */
#define appearanceToCODForCategory0011(X) \
  X(BLE_APPEARANCE_GENERIC_WALKING, 0x0440, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WALKING_IN_SHOE, 0x0441, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
...
#define appearanceToCODForCategory0025(X) \
  X(BLE_APPEARANCE_GENERIC_WEARABLE_AUDIO_DEVICE, 0x0940, \
    (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, \
    (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), \
...
#define appearanceToCODForCategory0031(X) \
  X(BLE_APPEARANCE_GENERIC_PULSE_OXIMETER, 0x0C40, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER) \
  X(BLE_APPEARANCE_PULSE_OXIMETER_FINGERTIP, 0x0C41, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER) \
  X(BLE_APPEARANCE_PULSE_OXIMETER_WRIST, 0x0C42, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER)

/* Category[15:6] 0x032 */
#define appearanceToCODForCategory0032(X) \
  X(BLE_APPEARANCE_GENERIC_WEIGHT, 0x0C80, COD_SERVICE_NA, \
    COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_WEIGHING_SCALE)
 ...
 *
 * TODO: Once all the categories are added, instead of listing all the
 *  categories, use recursive way to call them.
 */
