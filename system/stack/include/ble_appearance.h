 ...
 *  new macro to the appropriate appearanceToCODForCategoryXXXX macro, and then
 *  add this apearnceToCODForCategoryXXXX macro to the appearanceToCOD macro
 *  (if not already added).
 */

/* Category[15:6] 0x000 */
#define appearanceToCODForCategory0000(X) \
  X(BLE_APPEARANCE_UNKNOWN, 0x0000, COD_SERVICE_NA, COD_MAJOR_UNCLASSIFIED, COD_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x001 */
#define appearanceToCODForCategory0001(X) \
  X(BLE_APPEARANCE_GENERIC_PHONE, 0x0040, COD_SERVICE_NA, COD_MAJOR_PHONE, COD_MAJOR_PHONE_MINOR_UNCATEGORIZED)
...
#define appearanceToCODForCategory0002(X) \
  X(BLE_APPEARANCE_GENERIC_COMPUTER, 0x0080, COD_SERVICE_NA, COD_MAJOR_COMPUTER, COD_MAJOR_COMPUTER_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x003 */
#define BLE_APPEARANCE_SMART_WATCH 0x00C2
#define appearanceToCODForCategory0003(X) \
  X(BLE_APPEARANCE_GENERIC_WATCH, 0x00C0, COD_SERVICE_NA, COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_WRIST_WATCH) \
  X(BLE_APPEARANCE_SPORTS_WATCH, 0x00C1, COD_SERVICE_NA, COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_WRIST_WATCH)

/* Category[15:6] 0x004 */
#define BLE_APPEARANCE_GENERIC_CLOCK 0x0100

/* Category[15:6] 0x005 */
#define appearanceToCODForCategory0005(X) \
  X(BLE_APPEARANCE_GENERIC_DISPLAY, 0x0140, COD_SERVICE_NA, COD_MAJOR_IMAGING, COD_MAJOR_IMAGING_MINOR_DISPLAY)

/* Category[15:6] 0x006 */
#define appearanceToCODForCategory0006(X) \
  X(BLE_APPEARANCE_GENERIC_REMOTE, 0x0180, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_REMOTE_CONTROL)

/* Category[15:6] 0x007 */
#define appearanceToCODForCategory0007(X) \
  X(BLE_APPEARANCE_GENERIC_EYEGLASSES, 0x01C0, COD_SERVICE_NA, COD_MAJOR_WEARABLE, COD_MAJOR_WEARABLE_MINOR_GLASSES)
...
/* Category[15:6] 0x00A */
#define appearanceToCODForCategory000A(X) \
  X(BLE_APPEARANCE_GENERIC_MEDIA_PLAYER, 0x0280, COD_SERVICE_NA, COD_MAJOR_AUDIO, COD_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x00B */
#define appearanceToCODForCategory000B(X) \
  X(BLE_APPEARANCE_GENERIC_BARCODE_SCANNER, 0x02C0, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_UNCATEGORIZED)

/* Category[15:6] 0x00C */
#define appearanceToCODForCategory000C(X) \
  X(BLE_APPEARANCE_GENERIC_THERMOMETER, 0x0300, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_THERMOMETER) \
  X(BLE_APPEARANCE_THERMOMETER_EAR, 0x0301, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_THERMOMETER)

/* Category[15:6] 0x00D */
#define appearanceToCODForCategory000D(X) \
  X(BLE_APPEARANCE_GENERIC_HEART_RATE, 0x0340, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_HEART_PULSE_MONITOR) \
  X(BLE_APPEARANCE_HEART_RATE_BELT, 0x0341, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_HEART_PULSE_MONITOR)

/* Category[15:6] 0x00E */
#define appearanceToCODForCategory000E(X) \
  X(BLE_APPEARANCE_GENERIC_BLOOD_PRESSURE, 0x0380, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR) \
  X(BLE_APPEARANCE_BLOOD_PRESSURE_ARM, 0x0381, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR) \
  X(BLE_APPEARANCE_BLOOD_PRESSURE_WRIST, 0x0382, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_BLOOD_MONITOR)

/* Category[15:6] 0x00F */
#define BLE_APPEARANCE_HID_TOUCHPAD 0x03C9
#define BLE_APPEARANCE_HID_PRESENTATION_REMOTE 0x03CA
#define appearanceToCODForCategory000F(X) \
  X(BLE_APPEARANCE_GENERIC_HID, 0x03C0, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_UNCATEGORIZED) \
  X(BLE_APPEARANCE_HID_KEYBOARD, 0x03C1, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_KEYBOARD) \
  X(BLE_APPEARANCE_HID_MOUSE, 0x03C2, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_POINTING) \
  X(BLE_APPEARANCE_HID_JOYSTICK, 0x03C3, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_JOYSTICK) \
  X(BLE_APPEARANCE_HID_GAMEPAD, 0x03C4, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_GAMEPAD) \
  ...
  X(BLE_APPEARANCE_HID_CARD_READER, 0x03C6, COD_SERVICE_NA, COD_MAJOR_PERIPHERAL, COD_MAJOR_PERIPH_MINOR_CARD_READER) \
...
/* Category[15:6] 0x010 */
#define appearanceToCODForCategory0010(X) \
  X(BLE_APPEARANCE_GENERIC_GLUCOSE, 0x0400, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_GLUCOSE_METER)

/* Category[15:6] 0x011 */
#define appearanceToCODForCategory0011(X) \
  X(BLE_APPEARANCE_GENERIC_WALKING, 0x0440, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WALKING_IN_SHOE, 0x0441, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WALKING_ON_SHOE, 0x0442, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WALKING_ON_HIP, 0x0443, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_STEP_COUNTER)
...
/* Category[15:6] 0x025 */
#define appearanceToCODForCategory0025(X) \
  X(BLE_APPEARANCE_GENERIC_WEARABLE_AUDIO_DEVICE, 0x0940, (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WEARABLE_AUDIO_DEVICE_EARBUD, 0x0941, (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WEARABLE_AUDIO_DEVICE_HEADSET, 0x0942, (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WEARABLE_AUDIO_DEVICE_HEADPHONES, 0x0943, (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), COD_MAJOR_HEALTH_MINOR_STEP_COUNTER) \
  X(BLE_APPEARANCE_WEARABLE_AUDIO_DEVICE_NECK_BAND, 0x0944, (COD_SERVICE_AUDIO | COD_SERVICE_RENDERING) >> 8, (COD_MAJOR_AUDIO | COD_SERVICE_LE_AUDIO), COD_MAJOR_HEALTH_MINOR_STEP_COUNTER)
...
/* Category[15:6] 0x031 */
#define appearanceToCODForCategory0031(X) \
  X(BLE_APPEARANCE_GENERIC_PULSE_OXIMETER, 0x0C40, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER) \
  X(BLE_APPEARANCE_PULSE_OXIMETER_FINGERTIP, 0x0C41, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER) \
  X(BLE_APPEARANCE_PULSE_OXIMETER_WRIST, 0x0C42, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_PULSE_OXIMETER)

/* Category[15:6] 0x032 */
#define appearanceToCODForCategory0032(X) \
  X(BLE_APPEARANCE_GENERIC_WEIGHT, 0x0C80, COD_SERVICE_NA, COD_MAJOR_HEALTH, COD_MAJOR_HEALTH_MINOR_WEIGHING_SCALE)
 ...
 */
#define appearanceToCOD(X) \
  appearanceToCODForCategory0001(X) \
  appearanceToCODForCategory0002(X) \
  appearanceToCODForCategory0003(X) \
  appearanceToCODForCategory0005(X) \
  appearanceToCODForCategory0006(X) \
  appearanceToCODForCategory0007(X) \
  appearanceToCODForCategory000A(X) \
  appearanceToCODForCategory000B(X) \
  appearanceToCODForCategory000C(X) \
  appearanceToCODForCategory000D(X) \
  appearanceToCODForCategory000E(X) \
  appearanceToCODForCategory000F(X) \
  appearanceToCODForCategory0010(X) \
  appearanceToCODForCategory0011(X) \
  appearanceToCODForCategory0025(X) \
  appearanceToCODForCategory0031(X) \
  appearanceToCODForCategory0032(X)

// Generates the BLE appearance definitions for reference
#define generateBLEAppearanceDefinition(appearance, value, service, major, minor) \
  constexpr uint16_t appearance = value;

// Generate the actual definition for each appearance.
appearanceToCOD(generateBLEAppearanceDefinition)

#undef generateBLEAppearanceDefinition
