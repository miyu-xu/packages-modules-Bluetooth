 ...
 *                  specifications in the tPORT_SETTINGS structure.
 *
 * Parameters:      handle     - Handle returned in the RFCOMM_CreateConnection
 *                  p_settings - Pointer to a tPORT_SETTINGS structure containing
 *                               configuration information for the connection.
 *
 ******************************************************************************/
[[nodiscard]] int PORT_SetSettings(uint16_t handle, tPORT_SETTINGS* p_settings);

/*******************************************************************************
 *
 * Function         PORT_GetSettings
 *
 * Description      This function is called to fill tPORT_SETTINGS structure
 *                  with the current control settings for the port
 *
 * Parameters:      handle     - Handle returned in the RFCOMM_CreateConnection
 *                  p_settings - Pointer to a tPORT_SETTINGS structure in which
 *                               configuration information is returned.
 *
 ******************************************************************************/
[[nodiscard]] int PORT_GetSettings(uint16_t handle, tPORT_SETTINGS* p_settings);
