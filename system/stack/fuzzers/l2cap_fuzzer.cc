...
<<<<<<< PATCH SET (9d8122 Fix crash in l2cap-fuzzer)
  log::assert_that(
          L2CA_Register(BT_PSM_ATT, appl_info, false, nullptr, L2CAP_MTU_SIZE, 0, BTM_SEC_NONE),
...
=======
  ...
  log::assert_that(stack::l2cap::get_interface().L2CA_RegisterLECoc(BT_PSM_EATT, appl_info,
                                                                    BTM_SEC_NONE, {}),
>>>>>>> BASE      (5c547d Merge "SystemServer: check null when Bluetooth crash" into m)
