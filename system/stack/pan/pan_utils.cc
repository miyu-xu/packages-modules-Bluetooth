...
uint32_t pan_register_with_sdp(uint16_t uuid, const char* p_name,
  ...
  if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
    ...
    log::warn("Unable to add SDP PAN profile attribute");
  }
  ...
  if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
    ...
    log::warn("Unable to add SDP service name attribute");
  }
  ...
  if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
    ...
    log::warn("Unable to add SDP service description attribute");
  }
  ...
  if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
          ...
          (uint8_t*)&security)) {
    log::warn("Unable to add SDP security description attribute");
  }
  ...
  if (uuid == UUID_SERVCLASS_NAP) {
    ...
    if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
      ...
      log::warn("Unable to add SDP attribute net access type");
    }
    ...
    if (!get_legacy_stack_sdp_api()->handle.SDP_AddAttribute(
            ...
            array)) {
      log::warn("Unable to add SDP attribute net access rate");
    }
  }
