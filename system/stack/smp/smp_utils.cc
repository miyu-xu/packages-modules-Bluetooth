...
bool smp_send_msg_to_L2CAP(const RawAddress& rem_bda, BT_HDR* p_toL2CAP) {
  ...
  SMP_TRACE_EVENT("SMP Over BR: %d, Status: %d, State: %d, Failure: %d, Local IO Capability: %d, Peer IO Caps: %d, Is Pair Cancel: %d, TK: %d, Loc OOB Flag: %d, Peer OOB Flag: %d, Check CTKD: %d", 
    smp_cb.smp_over_br, 
    smp_cb.status, 
    smp_cb.state, 
    smp_cb.failure,
