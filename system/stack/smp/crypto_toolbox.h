...
Octet16 smp_calculate_f4(uint8_t* u, uint8_t* v, const Octet16& x,
                                uint8_t z);
...
void smp_calculate_f5(uint8_t* w, const Octet16& n1, const Octet16& n2,
                             ...
                             Octet16* ltk);
Octet16 smp_calculate_f6(const Octet16& w, const Octet16& n1,
...
Octet16 smp_calculate_link_key_to_ltk(const Octet16& link_key,
                                             bool use_h7);
