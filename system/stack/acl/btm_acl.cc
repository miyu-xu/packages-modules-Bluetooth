...
void BTM_ReadConnectionAddr(const RawAddress& remote_bda,
  ...
  bluetooth::shim::ACL_ReadConnectionAddress(
      p_sec_rec->hci_handle, local_conn_addr, p_addr_type, ota_address);
}
 ...
 *
 * Description    This function is read the remote device address used in
...
bool BTM_ReadRemoteConnectionAddr(const RawAddress& pseudo_addr,
  ...
  bluetooth::shim::ACL_ReadPeerConnectionAddress(
      p_sec_rec->hci_handle, conn_addr, p_addr_type, ota_address);
  return true;
}
