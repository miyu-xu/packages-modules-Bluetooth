...
std::map<::bt_property_type_t,
 ...
 return new headless::property::void_t(data, len, BT_PROPERTY_SERVICE_RECORD);
          ...
          {                BT_PROPERTY_ADAPTER_SCAN_MODE,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_ADAPTER_SCAN_MODE);
 } },
          {           BT_PROPERTY_ADAPTER_BONDED_DEVICES,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_ADAPTER_BONDED_DEVICES);
 } },
 ...
 BT_PROPERTY_ADAPTER_DISCOVERABLE_TIMEOUT);
          ...
          {             BT_PROPERTY_REMOTE_FRIENDLY_NAME,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_REMOTE_FRIENDLY_NAME);
 } },
 ...
 return new headless::property::void_t(data, len, BT_PROPERTY_REMOTE_RSSI);
          ...
          {              BT_PROPERTY_REMOTE_VERSION_INFO,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_REMOTE_VERSION_INFO);
 } },
 ...
 return new headless::property::void_t(data, len, BT_PROPERTY_LOCAL_LE_FEATURES);
          ...
          {             BT_PROPERTY_DYNAMIC_AUDIO_BUFFER,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_DYNAMIC_AUDIO_BUFFER);
 } },
 ...
 BT_PROPERTY_REMOTE_IS_COORDINATED_SET_MEMBER);
          ...
          {          BT_PROPERTY_REMOTE_DEVICE_TIMESTAMP,
           [](const uint8_t* data, const size_t len) -> headless::bt_property_t* {
 return new headless::property::void_t(data, len, BT_PROPERTY_REMOTE_DEVICE_TIMESTAMP);
 } },
};
