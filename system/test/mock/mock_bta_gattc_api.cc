...
void BTA_GATTC_Disable(void) { increment_mock_function_call_count(__func__); }
...
void BTA_GATTC_Close(uint16_t conn_id) { increment_mock_function_call_count(__func__); }
