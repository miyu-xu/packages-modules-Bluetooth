...
void BTA_AgAudioClose(uint16_t handle) { increment_mock_function_call_count(__func__); }
void BTA_AgAudioOpen(uint16_t handle, bool force_cvsd) {
  increment_mock_function_call_count(__func__);
}
void BTA_AgClose(uint16_t handle) { increment_mock_function_call_count(__func__); }
void BTA_AgDeregister(uint16_t handle) { increment_mock_function_call_count(__func__); }
void BTA_AgDisable() { increment_mock_function_call_count(__func__); }
...
void BTA_AgSetScoAllowed(bool value) { increment_mock_function_call_count(__func__); }
