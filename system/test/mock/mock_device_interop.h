...
struct interop_database_match_addr {
  ...
  std::function<bool(const interop_feature_t feature, const RawAddress* addr)> body{
    [](const interop_feature_t /* feature */, const RawAddress* /* addr */) { return return_value; }
  };
...
struct interop_database_match_manufacturer {
  ...
  std::function<bool(const interop_feature_t feature, uint16_t manufacturer)> body{
    [](const interop_feature_t /* feature */, uint16_t /* manufacturer */) { return return_value; }
  };
...
struct interop_database_match_name {
  ...
  std::function<bool(const interop_feature_t feature, const char* name)> body{
    [](const interop_feature_t /* feature */, const char* /* name */) { return return_value; }
  };
...
struct interop_database_match_version {
  ...
  std::function<bool(const interop_feature_t feature, uint16_t version)> body{
    [](const interop_feature_t /* feature */, uint16_t /* version */) { return return_value; }
  };
...
struct interop_feature_name_to_feature_id {
  ...
  std::function<int(const char* feature_name)> body{ [](const char* /* feature_name */) {
    return return_value;
  } };
...
struct token_to_ul {
  static bool return_value;
  std::function<bool(char* token, uint16_t* ul)> body{ [](char* /* token */, uint16_t* /* ul */) {
    return return_value;
  } };
