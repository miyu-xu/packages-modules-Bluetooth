...
struct LogMetricLeConnectionCompletion {
  std::function<void(bluetooth::hci::Address address, hci::ErrorCode reason,
                     bool is_locally_initiated)>
          body{[](bluetooth::hci::Address /* address */, hci::ErrorCode /* reason */,
                  bool /* is_locally_initiated */) {}};
  void operator()(bluetooth::hci::Address address, hci::ErrorCode reason,
                  bool is_locally_initiated) {
