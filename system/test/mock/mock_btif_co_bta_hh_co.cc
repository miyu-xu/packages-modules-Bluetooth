...
void bta_hh_co_destroy(int fd) { increment_mock_function_call_count(__func__); }
...
void uhid_set_non_blocking(int fd) { increment_mock_function_call_count(__func__); }
