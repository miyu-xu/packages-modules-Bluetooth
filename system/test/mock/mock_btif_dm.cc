...
void BTIF_dm_disable() { increment_mock_function_call_count(__func__); }
void BTIF_dm_enable() { increment_mock_function_call_count(__func__); }
void BTIF_dm_on_hw_error() { increment_mock_function_call_count(__func__); }
...
void btif_ble_test_end() { increment_mock_function_call_count(__func__); }
void btif_ble_transmitter_test(uint8_t tx_freq, uint8_t test_data_len,
                               uint8_t packet_payload) {
  increment_mock_function_call_count(__func__);
}
void btif_debug_bond_event_dump(int fd) { increment_mock_function_call_count(__func__); }
...
void btif_dm_cancel_discovery(void) { increment_mock_function_call_count(__func__); }
void btif_dm_cleanup(void) { increment_mock_function_call_count(__func__); }
...
void btif_dm_init(uid_set_t* set) { increment_mock_function_call_count(__func__); }
void btif_dm_get_local_class_of_device(DEV_CLASS device_class) {
  increment_mock_function_call_count(__func__);
}
void btif_dm_load_ble_local_keys(void) { increment_mock_function_call_count(__func__); }
void btif_dm_on_disable() { increment_mock_function_call_count(__func__); }
...
void btif_dm_read_energy_info() { increment_mock_function_call_count(__func__); }
...
void btif_dm_start_discovery(void) { increment_mock_function_call_count(__func__); }
