...
void l2c_link_adjust_allocation(void) { increment_mock_function_call_count(__func__); }
...
void l2c_link_timeout(tL2C_LCB* p_lcb) { increment_mock_function_call_count(__func__); }
