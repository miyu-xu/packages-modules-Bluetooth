...
void BTA_HfClientClose(uint16_t handle) { increment_mock_function_call_count(__func__); }
void BTA_HfClientDisable(void) { increment_mock_function_call_count(__func__); }
void BTA_HfClientDumpStatistics(int fd) { increment_mock_function_call_count(__func__); }
