...
void bluetooth::shim::LogMetricHfpAgVersion(hci::Address address, uint16_t version) {
  inc_func_call_count(__func__);
  test::mock::main_shim_metrics_api::LogMetricHfpAgVersion(address, version);
}

void bluetooth::shim::LogMetricHfpHfVersion(hci::Address address, uint16_t version) {
  inc_func_call_count(__func__);
  test::mock::main_shim_metrics_api::LogMetricHfpHfVersion(address, version);
}

void bluetooth::shim::LogMetricHfpRfcommChannelFail(hci::Address address) {
  inc_func_call_count(__func__);
  test::mock::main_shim_metrics_api::LogMetricHfpRfcommChannelFail(address);
}

void bluetooth::shim::LogMetricHfpRfcommCollisionFail(hci::Address address) {
  inc_func_call_count(__func__);
  test::mock::main_shim_metrics_api::LogMetricHfpRfcommCollisionFail(address);
}

void bluetooth::shim::LogMetricHfpRfcommAgOpenFail(hci::Address address) {
  inc_func_call_count(__func__);
  test::mock::main_shim_metrics_api::LogMetricHfpRfcommAgOpenFail(address);
}

void bluetooth::shim::LogMetricHfpSlcFail(hci::Address address) {
  inc_func_call_count(__func__);
