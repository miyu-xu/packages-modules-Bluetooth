...
struct BTM_AddEirService {
  std::function<void(uint32_t* p_eir_uuid, uint16_t uuid16)> body{ [](uint32_t* /* p_eir_uuid */,
                                                                      uint16_t /* uuid16 */) {} };
...
struct BTM_ClearInqDb {
  static tBTM_STATUS return_value;
  std::function<tBTM_STATUS(const RawAddress* p_bda)> body{ [](const RawAddress* /* p_bda */) {
    return return_value;
  } };
...
struct BTM_InqDbNext {
  static tBTM_INQ_INFO* return_value;
  std::function<tBTM_INQ_INFO*(tBTM_INQ_INFO* p_cur)> body{ [](tBTM_INQ_INFO* /* p_cur */) {
    return return_value;
  } };
...
struct BTM_InqDbRead {
  static tBTM_INQ_INFO* return_value;
  std::function<tBTM_INQ_INFO*(const RawAddress& p_bda)> body{ [](const RawAddress& /* p_bda */) {
    return return_value;
  } };
...
struct BTM_SetConnectability {
  static tBTM_STATUS return_value;
  std::function<tBTM_STATUS(uint16_t page_mode)> body{ [](uint16_t /* page_mode */) {
    return return_value;
  } };
...
struct BTM_SetDiscoverability {
  static tBTM_STATUS return_value;
  std::function<tBTM_STATUS(uint16_t inq_mode)> body{ [](uint16_t /* inq_mode */) {
    return return_value;
  } };
...
struct BTM_WriteEIR {
  static tBTM_STATUS return_value;
  std::function<tBTM_STATUS(BT_HDR* p_buff)> body{ [](BT_HDR* /* p_buff */) {
    return return_value;
  } };
...
struct btm_inq_db_find {
  ...
  std::function<tINQ_DB_ENT*(const RawAddress& p_bda)> body{ [](const RawAddress& /* p_bda */) {
    return return_value;
  } };
...
struct btm_inq_find_bdaddr {
  static bool return_value;
  std::function<bool(const RawAddress& p_bda)> body{ [](const RawAddress& /* p_bda */) {
    return return_value;
  } };
...
struct btm_process_inq_complete {
  std::function<void(tHCI_STATUS status, uint8_t mode)> body{ [](tHCI_STATUS /* status */,
                                                                 uint8_t /* mode */) {} };
