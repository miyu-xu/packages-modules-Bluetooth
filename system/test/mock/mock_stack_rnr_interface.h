...
public:
  ...
  MOCK_METHOD(tBTM_STATUS, BTM_ReadRemoteDeviceName,
              (const RawAddress& remote_bda, tBTM_NAME_CMPL_CB* p_cb, tBT_TRANSPORT transport));
  MOCK_METHOD(tBTM_STATUS, BTM_CancelRemoteDeviceName, ());
  MOCK_METHOD(void, btm_process_remote_name,
              (const RawAddress* bda, const BD_NAME bdn, uint16_t /* evt_len */,
...
namespace testing {
void reset_rnr_interface();
void set_rnr_interface(bluetooth::stack::rnr::Interface* interface_);
}  // namespace testing
