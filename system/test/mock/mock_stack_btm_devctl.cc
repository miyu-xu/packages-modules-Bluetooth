...
void BTM_db_reset(void) { increment_mock_function_call_count(__func__); }
void BTM_reset_complete() { increment_mock_function_call_count(__func__); }
void btm_delete_stored_link_key_complete(uint8_t* p) {
  increment_mock_function_call_count(__func__);
}
void btm_dev_free() { increment_mock_function_call_count(__func__); }
void btm_dev_init() { increment_mock_function_call_count(__func__); }
