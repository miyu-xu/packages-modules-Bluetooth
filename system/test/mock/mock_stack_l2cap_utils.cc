...
void l2cu_adj_id(tL2C_LCB* p_lcb) { increment_mock_function_call_count(__func__); }
...
void l2cu_dequeue_ccb(tL2C_CCB* p_ccb) { increment_mock_function_call_count(__func__); }
void l2cu_device_reset(void) { increment_mock_function_call_count(__func__); }
void l2cu_disconnect_chnl(tL2C_CCB* p_ccb) {
  increment_mock_function_call_count(__func__);
}
void l2cu_enqueue_ccb(tL2C_CCB* p_ccb) { increment_mock_function_call_count(__func__); }
...
void l2cu_release_ccb(tL2C_CCB* p_ccb) { increment_mock_function_call_count(__func__); }
void l2cu_release_lcb(tL2C_LCB* p_lcb) { increment_mock_function_call_count(__func__); }
void l2cu_release_rcb(tL2C_RCB* p_rcb) { increment_mock_function_call_count(__func__); }
