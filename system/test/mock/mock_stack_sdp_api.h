...
struct SDP_CancelServiceSearch {
  std::function<bool(const tSDP_DISCOVERY_DB* p_db)> body{ [](const tSDP_DISCOVERY_DB* /* p_db */) {
    return false;
  } };
...
struct SDP_FindProfileVersionInRec {
  std::function<bool(const tSDP_DISC_REC* p_rec, uint16_t profile_uuid, uint16_t* p_version)> body{
    [](const tSDP_DISC_REC* /* p_rec */, uint16_t /* profile_uuid */, uint16_t* /* p_version */) {
      return false;
    }
  };
...
struct SDP_FindServiceInDb_128bit {
  std::function<tSDP_DISC_REC*(const tSDP_DISCOVERY_DB* p_db, tSDP_DISC_REC* p_start_rec)> body{
    [](const tSDP_DISCOVERY_DB* /* p_db */, tSDP_DISC_REC* /* p_start_rec */) { return nullptr; }
  };
