...
void BluetoothMetricsLogger::Build() { increment_mock_function_call_count(__func__); }
...
void BluetoothMetricsLogger::Reset() { increment_mock_function_call_count(__func__); }
void BluetoothMetricsLogger::ResetLog() { increment_mock_function_call_count(__func__); }
