...
struct BTA_DmRemoveDevice {
  ...
  std::function<tBTA_STATUS(const RawAddress& bd_addr)> body{ [](const RawAddress& /* bd_addr */) {
    return return_value;
  } };
...
// Return: void
struct BTA_DmSearch {
  std::function<void(tBTA_DM_SEARCH_CBACK* p_cback)> body{ [](tBTA_DM_SEARCH_CBACK* /* p_cback */) {
  } };
...
struct BTA_DmSetDefaultEventMaskExcept {
  std::function<void(uint64_t mask, uint64_t le_mask)> body{ [](uint64_t /* mask */,
                                                                uint64_t /* le_mask */) {} };
...
struct BTA_DmSetLocalDiRecord {
  ...
  std::function<tBTA_STATUS(tSDP_DI_RECORD* p_device_info, uint32_t* p_handle)> body{
    [](tSDP_DI_RECORD* /* p_device_info */, uint32_t* /* p_handle */) { return return_value; }
  };
