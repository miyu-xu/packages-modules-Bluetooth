...
void btif_enable_bluetooth_evt() { increment_mock_function_call_count(__func__); }
void btif_enable_service(tBTA_SERVICE_ID service_id) {
  increment_mock_function_call_count(__func__);
}
void btif_get_adapter_properties(void) { increment_mock_function_call_count(__func__); }
...
void btif_init_ok() { increment_mock_function_call_count(__func__); }
