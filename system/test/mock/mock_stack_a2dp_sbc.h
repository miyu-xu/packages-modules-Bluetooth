...
struct A2DP_AdjustCodecSbc {
  ...
  std::function<bool(uint8_t* p_codec_info)> body{ [](uint8_t* /* p_codec_info */) {
    return return_value;
  } };
...
struct A2DP_BuildCodecHeaderSbc {
  ...
  std::function<bool(const uint8_t* p_codec_info, BT_HDR* p_buf, uint16_t frames_per_packet)> body{
    [](const uint8_t* /* p_codec_info */, BT_HDR* /* p_buf */, uint16_t /* frames_per_packet */) {
      return return_value;
    }
  };
...
struct A2DP_GetAllocationMethodCodeSbc {
  ...
  std::function<int(const uint8_t* p_codec_info)> body{ [](const uint8_t* /* p_codec_info */) {
    return return_value;
  } };
...
struct A2DP_InitCodecConfigSbc {
  static bool return_value;
  std::function<bool(AvdtpSepConfig* p_cfg)> body{ [](AvdtpSepConfig* /* p_cfg */) {
    return return_value;
  } };
...
struct A2DP_IsPeerSinkCodecValidSbc {
  static bool return_value;
  std::function<bool(const uint8_t* p_codec_info)> body{ [](const uint8_t* /* p_codec_info */) {
    return return_value;
  } };
