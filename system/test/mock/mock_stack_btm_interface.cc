...
struct btm_client_interface_t default_btm_client_interface = {
  ...
  .peer = {
            ...
            return hci_feature_bytes_per_page;
                ...
                .BTM_GetMaxPacketSize = [](const RawAddress& /* bd_addr */) -> uint16_t { return 0; },
                .BTM_ReadRemoteVersion = [](const RawAddress& /* addr */, uint8_t* /* lmp_version */,
  ...
  .link_policy = {
            ...
            return BTM_SUCCESS;
                ...
                .BTM_SwitchRoleToCentral = [](const RawAddress& /* remote_bd_addr */) -> tBTM_STATUS {
            return BTM_SUCCESS;
  ...
  .link_controller = {
                .BTM_GetLinkSuperTout = [](const RawAddress& /* remote_bda */, uint16_t* /* p_timeout */)
  ...
  .ble = {
                ...
                .BTM_SetBleDataLength = [](const RawAddress& /* bd_addr */, uint16_t /* tx_pdu_length */)
                  -> tBTM_STATUS { return BTM_SUCCESS; },
                .BTM_BleReadControllerFeatures = [](tBTM_BLE_CTRL_FEATURES_CBACK* /* p_vsc_cback */) {},
                .BTM_BleSetPhy = [](const RawAddress& /* bd_addr */, uint8_t /* tx_phys */,
                uint8_t /* rx_phys */, uint16_t /* phy_options */) {},
                .BTM_BleSetPrefConnParams = [](const RawAddress& /* bd_addr */,
  ...
  .sco = {
                ...
                tBTM_SCO_CB* /* p_disc_cb */) -> tBTM_STATUS { return BTM_SUCCESS; },
                .BTM_RegForEScoEvts = [](uint16_t /* sco_inx */, tBTM_ESCO_CBACK* /* p_esco_cback */)
                  -> tBTM_STATUS { return BTM_SUCCESS; },
  ...
  .local = {
            ...
            return BTM_SUCCESS;
                  ...
                  [](tBTM_CMPL_CB* /* p_rln_cmpl_cback */) -> tBTM_STATUS { return BTM_SUCCESS; },
  ...
  .db = {
                .BTM_InqDbRead = [](const RawAddress& /* p_bda */) -> tBTM_INQ_INFO* { return nullptr; },
                .BTM_InqDbFirst = []() -> tBTM_INQ_INFO* { return nullptr; },
                .BTM_InqDbNext = [](tBTM_INQ_INFO* /* p_cur */) -> tBTM_INQ_INFO* { return nullptr; },
