...
struct btsnd_hcic_hold_mode {
  std::function<void(uint16_t handle, uint16_t max_hold_period, uint16_t min_hold_period)> body{
    [](uint16_t /* handle */, uint16_t /* max_hold_period */, uint16_t /* min_hold_period */) {}
  };
...
struct btsnd_hcic_read_tx_power {
  std::function<void(uint16_t handle, uint8_t type)> body{ [](uint16_t /* handle */,
                                                              uint8_t /* type */) {} };
...
struct btsnd_hcic_reject_conn {
  std::function<void(const RawAddress& dest, uint8_t reason)> body{ [](const RawAddress& /* dest */,
                                                                       uint8_t /* reason */) {} };
...
struct btsnd_hcic_rmt_ext_features {
  std::function<void(uint16_t handle, uint8_t page_num)> body{ [](uint16_t /* handle */,
                                                                  uint8_t /* page_num */) {} };
...
struct btsnd_hcic_set_conn_encrypt {
  std::function<void(uint16_t handle, bool enable)> body{ [](uint16_t /* handle */,
                                                             bool /* enable */) {} };
...
struct btsnd_hcic_write_auto_flush_tout {
  std::function<void(uint16_t handle, uint16_t tout)> body{ [](uint16_t /* handle */,
                                                               uint16_t /* tout */) {} };
...
struct btsnd_hcic_write_ext_inquiry_response {
  std::function<void(void* buffer, uint8_t fec_req)> body{ [](void* /* buffer */,
                                                              uint8_t /* fec_req */) {} };
...
struct btsnd_hcic_write_inqscan_cfg {
  std::function<void(uint16_t interval, uint16_t window)> body{ [](uint16_t /* interval */,
                                                                   uint16_t /* window */) {} };
...
struct btsnd_hcic_write_link_super_tout {
  std::function<void(uint16_t handle, uint16_t timeout)> body{ [](uint16_t /* handle */,
                                                                  uint16_t /* timeout */) {} };
...
struct btsnd_hcic_write_policy_set {
  std::function<void(uint16_t handle, uint16_t settings)> body{ [](uint16_t /* handle */,
                                                                   uint16_t /* settings */) {} };
