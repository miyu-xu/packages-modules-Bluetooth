...
void btm_ble_dir_adv_tout(void) { increment_mock_function_call_count(__func__); }
void btm_ble_free() { increment_mock_function_call_count(__func__); }
void btm_ble_increment_link_topology_mask(uint8_t link_role) {
  increment_mock_function_call_count(__func__);
}
void btm_ble_init(void) { increment_mock_function_call_count(__func__); }
...
void btm_ble_start_scan() { increment_mock_function_call_count(__func__); }
void btm_ble_stop_inquiry(void) { increment_mock_function_call_count(__func__); }
void btm_ble_stop_scan(void) { increment_mock_function_call_count(__func__); }
