...
struct log_le_pairing_fail {
  std::function<void(const RawAddress& raw_address, uint8_t failure_reason, bool is_outgoing)>
      body{[](const RawAddress& /* address */, uint8_t /* failure reason */,
              bool is_outgoing) {}};
...
extern struct log_le_pairing_fail;
