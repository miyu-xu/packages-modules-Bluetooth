...
struct get_transparent_mode_supported get_transparent_mode_supported;
struct init init;
...
bool get_transparent_mode_supported::return_value = false;
...
bool get_transparent_mode_supported() {
  inc_func_call_count(__func__);
  return test::mock::stack_btm_sco_hfp_hal::get_transparent_mode_supported();
}
void init() {
  inc_func_call_count(__func__);
