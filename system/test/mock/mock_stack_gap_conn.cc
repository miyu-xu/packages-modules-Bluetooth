...
bool GAP_GetLeChannelInfo(uint16_t /* gap_handle */, uint16_t* /* local_mtu */,
                          uint16_t* /*remote_mtu */, uint16_t* /* local_mps */,
                          uint16_t* /* remote_mps */, uint16_t* /* local_credit */,
                          uint16_t* /* remote_credit */, uint16_t* /* local_cid */,
                          uint16_t* /* remote_cid */, uint16_t* /* acl_handle */) {
  inc_func_call_count(__func__);
  return false;
}
