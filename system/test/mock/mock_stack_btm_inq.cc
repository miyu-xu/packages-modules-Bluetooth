...
void BTM_CancelInquiry(void) { increment_mock_function_call_count(__func__); }
void BTM_EnableInterlacedInquiryScan() { increment_mock_function_call_count(__func__); }
void BTM_EnableInterlacedPageScan() { increment_mock_function_call_count(__func__); }
void btm_clr_inq_db(const RawAddress* p_bda) {
  increment_mock_function_call_count(__func__);
}
void btm_clr_inq_result_flt(void) { increment_mock_function_call_count(__func__); }
void btm_inq_clear_ssp(void) { increment_mock_function_call_count(__func__); }
void btm_inq_db_free(void) { increment_mock_function_call_count(__func__); }
void btm_inq_db_init(void) { increment_mock_function_call_count(__func__); }
void btm_inq_db_reset(void) { increment_mock_function_call_count(__func__); }
...
void btm_inq_stop_on_ssp(void) { increment_mock_function_call_count(__func__); }
...
void btm_sort_inq_result(void) { increment_mock_function_call_count(__func__); }
