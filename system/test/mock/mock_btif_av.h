...
// Params: const A2dpType a2dp_type.
// Return: void
struct btif_av_clear_remote_suspend_flag {
  std::function<void(const A2dpType a2dp_type)> body{
      [](const A2dpType a2dp_type) {}};
  void operator()(const A2dpType a2dp_type) { body(a2dp_type); };
};
...
struct btif_av_get_audio_delay {
  ...
  std::function<uint16_t(const A2dpType a2dp_type)> body{
      [](const A2dpType a2dp_type) { return return_value; }};
  uint16_t operator()(const A2dpType a2dp_type) { return body(a2dp_type); };
};
...
struct btif_av_get_peer_sep {
  ...
  std::function<uint8_t(const A2dpType a2dp_type)> body{
      [](const A2dpType a2dp_type) { return return_value; }};
  uint8_t operator()(const A2dpType a2dp_type) { return body(a2dp_type); };
};
...
struct btif_av_is_connected {
  static bool return_value;
  std::function<bool(const A2dpType a2dp_type)> body{
      [](const A2dpType a2dp_type) { return return_value; }};
  bool operator()(const A2dpType a2dp_type) { return body(a2dp_type); };
};
extern struct btif_av_is_connected btif_av_is_connected;

// Name: btif_av_is_connected_addr
// Params: const RawAddress& peer_address, const A2dpType a2dp_type
// Return: bool
struct btif_av_is_connected_addr {
  static bool return_value;
  std::function<bool(const RawAddress& peer_address, const A2dpType a2dp_type)>
      body{[](const RawAddress& /* peer_address */,
              const A2dpType /* a2dp_type */) { return return_value; }};
  bool operator()(const RawAddress& peer_address, const A2dpType a2dp_type) {
    return body(peer_address, a2dp_type);
  };
};
...
struct btif_av_set_audio_delay {
  ...
  void operator()(const RawAddress& peer_address, uint16_t delay,
                  const A2dpType a2dp_type) {
    body(peer_address, delay, a2dp_type);
  };
};
