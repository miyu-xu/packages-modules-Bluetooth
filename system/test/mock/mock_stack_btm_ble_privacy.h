...
struct btm_ble_clear_resolving_list_complete {
  std::function<void(uint8_t* p, uint16_t evt_len)> body{ [](uint8_t* /* p */,
                                                             uint16_t /* evt_len */) {} };
...
struct btm_ble_read_resolving_list_entry_complete {
  std::function<void(const uint8_t* p, uint16_t evt_len)> body{ [](const uint8_t* /* p */,
                                                                   uint16_t /* evt_len */) {} };
...
struct btm_ble_read_resolving_list_entry {
  std::function<bool(tBTM_SEC_DEV_REC* p_dev_rec)> body{ [](tBTM_SEC_DEV_REC* /* p_dev_rec */) {
    return false;
  } };
