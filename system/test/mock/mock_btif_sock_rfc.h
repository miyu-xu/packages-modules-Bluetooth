...
struct bta_co_rfc_data_incoming {
  ...
  std::function<int(uint32_t id, BT_HDR* p_buf)> body{ [](uint32_t /* id */, BT_HDR* /* p_buf */) {
    return return_value;
  } };
...
struct bta_co_rfc_data_outgoing_size {
  static int return_value;
  std::function<int(uint32_t id, int* size)> body{ [](uint32_t /* id */, int* /* size */) {
    return return_value;
  } };
...
struct btsock_rfc_disconnect {
  static bt_status_t return_value;
  std::function<bt_status_t(const RawAddress* bd_addr)> body{ [](const RawAddress* /* bd_addr */) {
    return return_value;
  } };
...
struct btsock_rfc_signaled {
  std::function<void(int fd, int flags, uint32_t id)> body{ [](int /* fd */, int /* flags */,
                                                               uint32_t /* id */) {} };
