...
void SMP_Init(void) { increment_mock_function_call_count(__func__); }
...
void SMP_CrLocScOobData() { increment_mock_function_call_count(__func__); }

void SMP_ClearLocScOobData() { increment_mock_function_call_count(__func__); }
