...
// Must be called on jni thread
void api_counter_metric_init() { mock_function_count_map[__func__]++; }
...
// Dump the counters in alphabetical order
...
// Dump the counters in alphabetical order
void api_counter_metric_dump(int fd) { mock_function_count_map[__func__]++; }
