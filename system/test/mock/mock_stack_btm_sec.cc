...
void BTM_ReadLocalOobData(void) { increment_mock_function_call_count(__func__); }
...
void btm_rem_oob_req(const uint8_t* p) { increment_mock_function_call_count(__func__); }
...
void btm_sec_check_pending_reqs(void) { increment_mock_function_call_count(__func__); }
...
void btm_sec_dev_reset(void) { increment_mock_function_call_count(__func__); }
