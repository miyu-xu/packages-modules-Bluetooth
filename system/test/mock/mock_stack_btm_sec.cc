...
struct btm_sec_find_dev_by_sec_state btm_sec_find_dev_by_sec_state;
...
tBTM_SEC_DEV_REC* btm_sec_find_dev_by_sec_state::return_value = nullptr;
...
tBTM_SEC_DEV_REC* btm_sec_find_dev_by_sec_state(uint8_t state) {
  mock_function_count_map[__func__]++;
  return test::mock::stack_btm_sec::btm_sec_find_dev_by_sec_state(state);
}
