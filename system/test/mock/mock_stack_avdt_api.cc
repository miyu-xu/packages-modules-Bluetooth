...
void AVDT_AbortReq(uint8_t handle) { increment_mock_function_call_count(__func__); }
void AVDT_Deregister(void) { increment_mock_function_call_count(__func__); }
...
void stack_debug_avdtp_api_dump(int fd) { increment_mock_function_call_count(__func__); }
