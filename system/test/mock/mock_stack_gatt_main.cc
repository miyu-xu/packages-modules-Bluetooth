...
void gatt_init(void) { increment_mock_function_call_count(__func__); }
...
void gatt_free(void) { increment_mock_function_call_count(__func__); }
void gatt_init_srv_chg(void) { increment_mock_function_call_count(__func__); }
...
void gatt_proc_srv_chg(void) { increment_mock_function_call_count(__func__); }
