...
void avrc_flush_cmd_q(uint8_t handle) { increment_mock_function_call_count(__func__); }
void avrc_process_timeout(void* data) { increment_mock_function_call_count(__func__); }
