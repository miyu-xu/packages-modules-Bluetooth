...
struct checksum_read {
  ...
  std::function<std::string(const char* filename)> body{ [this](const char* /* filename */) {
    return return_value;
  } };
...
struct config_has_section {
  ...
  std::function<bool(const config_t& /* config */, const std::string& /* section */)> body{
    [this](const config_t& /* config */, const std::string& /* section */) { return return_value; }
  };
...
struct config_new_empty {
  std::function<std::unique_ptr<config_t>(void)> body{ [](void) {
...
struct config_remove_key {
  ...
  std::function<bool(config_t* config, const std::string& section, const std::string& key)> body{
    [this](config_t* /* config */, const std::string& /* section */, const std::string& /* key */) {
      return return_value;
    }
  };
...
struct config_remove_section {
  ...
  std::function<bool(config_t* config, const std::string& section)> body{
    [this](config_t* /* config */, const std::string& /* section */) { return return_value; }
  };
...
struct config_save {
  ...
  std::function<bool(const config_t& config, const std::string& filename)> body{
    [this](const config_t& /* config */, const std::string& /* filename */) { return return_value; }
  };
...
struct config_t_Has {
  bool return_value{ false };
  std::function<bool(const std::string& key)> body{ [this](const std::string& /* key */) {
    return return_value;
  } };
...
struct section_t_Set {
  std::function<void(std::string key, std::string value)> body{ [](std::string /* key */,
                                                                   std::string /* value */) {} };
