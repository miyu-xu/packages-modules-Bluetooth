...
void BTA_AvClose(tBTA_AV_HNDL handle) { increment_mock_function_call_count(__func__); }
void BTA_AvCloseRc(uint8_t rc_handle) { increment_mock_function_call_count(__func__); }
void BTA_AvDeregister(tBTA_AV_HNDL hndl) {
  increment_mock_function_call_count(__func__);
}
void BTA_AvDisable(void) { increment_mock_function_call_count(__func__); }
...
void BTA_AvOpenRc(tBTA_AV_HNDL handle) { increment_mock_function_call_count(__func__); }
