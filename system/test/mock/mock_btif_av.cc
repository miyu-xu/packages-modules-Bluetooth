...
void btif_av_clear_remote_suspend_flag(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  test::mock::btif_av::btif_av_clear_remote_suspend_flag(a2dp_type);
}
...
uint16_t btif_av_get_audio_delay(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_get_audio_delay(a2dp_type);
}
uint8_t btif_av_get_peer_sep(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_get_peer_sep(a2dp_type);
}
...
bool btif_av_is_connected(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_is_connected(a2dp_type);
}
...
bool btif_av_is_peer_edr(const RawAddress& peer_address,
                         const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_is_peer_edr(peer_address, a2dp_type);
}
...
void btif_av_set_audio_delay(const RawAddress& peer_address, uint16_t delay,
                             const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  test::mock::btif_av::btif_av_set_audio_delay(peer_address, delay, a2dp_type);
}
...
bool btif_av_stream_ready(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_stream_ready(a2dp_type);
}
void btif_av_stream_start(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  test::mock::btif_av::btif_av_stream_start(a2dp_type);
}
...
bool btif_av_stream_started_ready(const A2dpType a2dp_type) {
  inc_func_call_count(__func__);
  return test::mock::btif_av::btif_av_stream_started_ready(a2dp_type);
}
