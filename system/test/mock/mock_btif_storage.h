...
struct btif_has_ble_keys {
  ...
  std::function<bool(const std::string& bdstr)> body{ [](const std::string& /* bdstr */) {
    return return_value;
  } };
...
struct btif_in_fetch_bonded_device {
  static bt_status_t return_value;
  std::function<bt_status_t(const std::string& bdstr)> body{ [](const std::string& /* bdstr */) {
    return return_value;
  } };
...
struct btif_storage_get_adapter_property {
  static bt_status_t return_value;
  std::function<bt_status_t(bt_property_t* property)> body{ [](bt_property_t* /* property */) {
    return return_value;
  } };
...
struct btif_storage_get_gatt_cl_db_hash {
  ...
  std::function<Octet16(const RawAddress& bd_addr)> body{ [](const RawAddress& /* bd_addr */) {
    return return_value;
  } };
...
struct btif_storage_get_gatt_cl_supp_feat {
  ...
  std::function<uint8_t(const RawAddress& bd_addr)> body{ [](const RawAddress& /* bd_addr */) {
    return return_value;
  } };
...
struct btif_storage_get_remote_addr_type {
  ...
  std::function<bt_status_t(const RawAddress* remote_bd_addr, tBLE_ADDR_TYPE* addr_type)> body{
    [](const RawAddress* /* remote_bd_addr */, tBLE_ADDR_TYPE* /* addr_type */) -> bt_status_t {
      return return_value;
    }
  };
...
struct btif_storage_set_gatt_sr_supp_feat {
  std::function<void(const RawAddress& addr, uint8_t feat)> body{ [](const RawAddress& /* addr */,
                                                                     uint8_t /* feat */) {} };
