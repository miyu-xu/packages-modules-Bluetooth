...
void alarm_free(alarm_t* alarm) { inc_func_call_count(__func__); }
...
void semaphore_free(semaphore_t* semaphore) { inc_func_call_count(__func__); }
void semaphore_post(semaphore_t* semaphore) { inc_func_call_count(__func__); }
void semaphore_wait(semaphore_t* semaphore) { inc_func_call_count(__func__); }
