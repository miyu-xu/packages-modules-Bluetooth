...
void array_free(array_t* array) { increment_mock_function_call_count(__func__); }
...
void allocation_tracker_reset(void) { increment_mock_function_call_count(__func__); }
void allocation_tracker_uninit(void) { increment_mock_function_call_count(__func__); }
void osi_allocator_debug_dump(int fd) { increment_mock_function_call_count(__func__); }
...
void reactor_free(reactor_t* reactor) { increment_mock_function_call_count(__func__); }
void reactor_stop(reactor_t* reactor) { increment_mock_function_call_count(__func__); }
...
void mutex_global_lock(void) { increment_mock_function_call_count(__func__); }
void mutex_global_unlock(void) { increment_mock_function_call_count(__func__); }
...
void thread_free(thread_t* thread) { increment_mock_function_call_count(__func__); }
void thread_join(thread_t* thread) { increment_mock_function_call_count(__func__); }
void thread_stop(thread_t* thread) { increment_mock_function_call_count(__func__); }
...
void osi_free(void* ptr) { increment_mock_function_call_count(__func__); }
void osi_free_and_reset(void** p_ptr) { increment_mock_function_call_count(__func__); }
...
void alarm_cleanup(void) { increment_mock_function_call_count(__func__); }
void alarm_debug_dump(int fd) { increment_mock_function_call_count(__func__); }
void alarm_free(alarm_t* alarm) { increment_mock_function_call_count(__func__); }
...
void buffer_free(buffer_t* buffer) { increment_mock_function_call_count(__func__); }
...
void socket_free(socket_t* socket) { increment_mock_function_call_count(__func__); }
...
void list_clear(list_t* list) { increment_mock_function_call_count(__func__); }
void list_free(list_t* list) { increment_mock_function_call_count(__func__); }
...
void ringbuffer_free(ringbuffer_t* rb) { increment_mock_function_call_count(__func__); }
...
void wakelock_cleanup(void) { increment_mock_function_call_count(__func__); }
void wakelock_debug_dump(int fd) { increment_mock_function_call_count(__func__); }
