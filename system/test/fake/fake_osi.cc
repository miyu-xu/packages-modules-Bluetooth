...
static list_node_t* list_free_node_(list_t* l, list_node_t* node) {
  log::assert_that(l, "assert failed: l");
  log::assert_that(node, "assert failed: node");
...
FakeOsi::FakeOsi() {
  ...
  test::mock::osi_list::list_insert_after.body =
      [](list_t* l, list_node_t* prev_node, void* data) {
        log::assert_that(l, "assert failed: l");
        log::assert_that(prev_node, "assert failed: prev_node");
        log::assert_that(data, "assert failed: data");
