...
void reset_mock_function_count_map() { increment_mock_function_call_count_get().clear(); }

void dump_mock_function_count_map() {
  LOG_INFO("Mock function count map size:%zu", increment_mock_function_call_count_get().size());
