...
bool RepeatingTimer::SchedulePeriodic(
  ...
  uint64_t time_now_us = is_clock_monotonic_raw_ ? time_get_os_monotonic_raw_us() : time_get_os_boottime_us();
  ...
  period_ = period;
  uint64_t time_until_next_us = time_next_task_us - (is_clock_monotonic_raw_ ? time_get_os_monotonic_raw_us() : time_get_os_boottime_us());
...
void RepeatingTimer::RunTask() {
  ...
  uint64_t time_before_task_us = is_clock_monotonic_raw_ ? time_get_os_monotonic_raw_us() : time_get_os_boottime_us();
  task_.Run();
  uint64_t time_after_task_us = is_clock_monotonic_raw_ ? time_get_os_monotonic_raw_us() : time_get_os_boottime_us();
  auto task_time_us =
