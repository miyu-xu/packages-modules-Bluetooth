...
TEST_F(MessageLoopThreadTest, test_name) {
  ...
  message_loop_thread.DoInThread(FROM_HERE,
                                 base::BindOnce(&MessageLoopThreadTest::GetName,
...
TEST_F(MessageLoopThreadTest, test_thread_id) {
  ...
  message_loop_thread.DoInThread(
          FROM_HERE,
          base::BindOnce(&MessageLoopThreadTest::GetThreadId, base::Unretained(this),
...
TEST_F(MessageLoopThreadTest, test_set_realtime_priority_success) {
  ...
  message_loop_thread.DoInThread(
          ...
          base::BindOnce(&MessageLoopThreadTest::GetSchedulingPolicyAndPriority,
                         base::Unretained(this), &scheduling_policy, &scheduling_priority,
                         std::move(execution_promise)));
...
TEST_F(MessageLoopThreadTest, shut_down_while_in_callback) {
  ...
  message_loop_thread.DoInThread(
          FROM_HERE,
          base::BindOnce(&MessageLoopThreadTest::SleepAndGetName, base::Unretained(this),
