...
TEST(BluetoothLogTest, null_string_parameter) {
  ...
  EXPECT_STREQ(androidLogMessage->message,
               "system/log/src/vlog_test.cc:167 TestBody: input: (nullptr)");
  ...
  EXPECT_STREQ(androidLogMessage->message,
               "system/log/src/vlog_test.cc:175 TestBody: input: (nullptr)");
  ...
  EXPECT_STREQ(androidLogMessage->message,
               "system/log/src/vlog_test.cc:183 TestBody: input: hello world");
}
