...
TEST(TruncatingBufferTest, 1byte) {
  ...
  log_internal::truncating_buffer<2> buffer_1;
  log_internal::truncating_buffer<3> buffer_2;
...
TEST(TruncatingBufferTest, 2bytes) {
  ...
  log_internal::truncating_buffer<3> buffer_1;
  log_internal::truncating_buffer<4> buffer_2;
  log_internal::truncating_buffer<5> buffer_3;
...
TEST(TruncatingBufferTest, 3bytes) {
  ...
  log_internal::truncating_buffer<4> buffer_1;
  log_internal::truncating_buffer<5> buffer_2;
  log_internal::truncating_buffer<6> buffer_3;
  log_internal::truncating_buffer<7> buffer_4;
...
TEST(TruncatingBufferTest, 4bytes) {
  ...
  log_internal::truncating_buffer<5> buffer_1;
  log_internal::truncating_buffer<6> buffer_2;
  log_internal::truncating_buffer<7> buffer_3;
  log_internal::truncating_buffer<8> buffer_4;
  log_internal::truncating_buffer<9> buffer_5;
