...
#define BTA_JV_L2CAP_ERR_UNKNOWN 1
#define BTA_JV_L2CAP_ERR_ACL_FAILURE 2
#define BTA_JV_L2CAP_ERR_CL_SEC_FAILURE 3
#define BTA_JV_L2CAP_ERR_INSUFFICIENT_AUTHENTICATION 4
#define BTA_JV_L2CAP_ERR_INSUFFICIENT_AUTHORIZATION 5
#define BTA_JV_L2CAP_ERR_INSUFFICIENT_ENCRYP_KEY_SIZE 6
#define BTA_JV_L2CAP_ERR_INSUFFICIENT_ENCRYP 7
#define BTA_JV_L2CAP_ERR_INVALID_SOURCE_CID 8
#define BTA_JV_L2CAP_ERR_SOURCE_CID_ALREADY_ALLOCATED 9
#define BTA_JV_L2CAP_ERR_NO_RESOURCES 10
#define BTA_JV_L2CAP_ERR_NO_PSM 11
#define BTA_JV_L2CAP_ERR_TIMEOUT 12
...
typedef struct {
  ...
  /* Error that triggered the L2CAP connection close callback.
