 ...
 * Service ID
 */
enum : tBTA_SERVICE_MASK {
  BTA_A2DP_SOURCE_SERVICE_ID = (1UL << 3), /* A2DP Source profile. */
  BTA_HSP_SERVICE_ID = (1UL << 5),         /* Headset profile. */
  BTA_HFP_SERVICE_ID = (1UL << 6),         /* Hands-free profile. */
  BTA_BIP_SERVICE_ID = (1UL << 13),        /* Basic Imaging profile */
  BTA_A2DP_SINK_SERVICE_ID = (1UL << 18),  /* A2DP Sink */
  BTA_HID_SERVICE_ID = (1UL << 20),        /* HID */
  BTA_PBAP_SERVICE_ID = (1UL << 22),       /* PhoneBook Access Server*/
  BTA_HFP_HS_SERVICE_ID = (1UL << 24),     /* HSP HS role */
  BTA_MAP_SERVICE_ID = (1UL << 25),        /* Message Access Profile */
  BTA_MN_SERVICE_ID = (1UL << 26),         /* Message Notification Service */
  BTA_PCE_SERVICE_ID = (1UL << 28),        /* PhoneBook Access Client */
  BTA_SDP_SERVICE_ID = (1UL << 29),        /* SDP Search */
  BTA_HIDD_SERVICE_ID = (1UL << 30),       /* HID Device */

  /* BLE profile service ID */
  BTA_BLE_SERVICE_ID = (1UL << 31),  /* GATT profile */
  BTA_USER_SERVICE_ID = (1UL << 32), /* User requested UUID */
  BTA_MAX_SERVICE_ID = (1UL << 33),
};
