...
typedef enum : uint8_t {
  ...
  BTA_DM_NO_CTKD_ENC_KEY_NOT_P256_EVT = 34, /* Encryption Key was to weak to perform CTKD */
} tBTA_DM_SEC_EVT;
...
typedef struct {
  RawAddress bd_addr;
} tBTA_DM_NO_CTKD_ENC_KEY_NOT_P256;
...
typedef union {
  ...
  tBTA_DM_NO_CTKD_ENC_KEY_NOT_P256 no_ctkd;
} tBTA_DM_SEC;
