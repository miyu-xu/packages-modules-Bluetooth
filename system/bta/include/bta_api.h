...
enum : uint8_t {
  ...
  BTA_DM_UNUSED_05 = 5,
  BTA_DM_SEARCH_CANCEL_CMPL_EVT = 6, /* Search cancelled */
  BTA_DM_DID_RES_EVT = 7,            /* Vendor/Product ID search result */
  BTA_DM_GATT_OVER_SDP_RES_EVT = 8,  /* GATT services over SDP discovered */
};
...
inline std::string bta_dm_search_evt_text(const tBTA_DM_SEARCH_EVT& event) {
  switch (event) {
    ...
    CASE_RETURN_TEXT(BTA_DM_UNUSED_05);
