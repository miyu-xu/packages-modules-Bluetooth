...
class BtaAvConfig {
 public:
  ...
  const uint8_t* getPMetaEvtIds1() const { return p_meta_evt_ids_1; }
 ...
 private:
  ...
  const uint8_t* p_meta_evt_ids;   /* the metadata Get Capabilities response
                                  for event id */
  const uint8_t* p_meta_evt_ids_1; /* the metadata Get Capabilities response
                                for event id */
...
class BtaAvConfig::Builder {
 public:
  ...
  Builder() : bta_av_config() {
    ...
    bta_av_config.p_meta_evt_ids_1 = nullptr;
  }
  ...
  Builder& setMetaEvtIds1(const uint8_t* metaEvtIds) {
    bta_av_config.p_meta_evt_ids_1 = metaEvtIds;
    return *this;
  }
