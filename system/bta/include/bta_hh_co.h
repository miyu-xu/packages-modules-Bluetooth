...
void bta_hh_co_data(uint8_t dev_handle, uint8_t* p_rpt, uint16_t len,
                    ...
                    uint8_t ctry_code, const tTypedAddressTransport& addr_transport,
                    uint8_t app_id);
 ...
 *
 ******************************************************************************/
tBTA_HH_RPT_CACHE_ENTRY* bta_hh_le_co_cache_load(const tTypedAddressTransport& addr_transport,
                                                 uint8_t* p_num_rpt,
                                                 uint8_t app_id);
 ...
 *
 ******************************************************************************/
void bta_hh_le_co_reset_rpt_cache(const tTypedAddressTransport& addr_transport, uint8_t app_id);
