...
const controller_t* controller_get_interface() {
  ...
  controller_instance->supports_ble_coded_phy = &supports_ble_coded_phy;
  controller_instance->supports_simple_pairing = &supports_simple_pairing;
  controller_instance->supports_secure_connections =
      &supports_secure_connections;
  controller_instance->supports_simultaneous_le_bredr =
      &supports_simultaneous_le_bredr;
  controller_instance->supports_reading_remote_extended_features =
      &supports_reading_remote_extended_features;
  controller_instance->supports_interlaced_inquiry_scan =
      &supports_interlaced_inquiry_scan;
  controller_instance->supports_rssi_with_inquiry_results =
      &supports_rssi_with_inquiry_results;
  controller_instance->supports_extended_inquiry_response =
      &supports_extended_inquiry_response;
  controller_instance->supports_central_peripheral_role_switch =
  ...
  controller_instance->supports_3_slot_packets = &supports_3_slot_packets;
  controller_instance->supports_5_slot_packets = &supports_5_slot_packets;
  controller_instance->supports_classic_2m_phy = &supports_classic_2m_phy;
  controller_instance->supports_classic_3m_phy = &supports_classic_3m_phy;
  controller_instance->supports_3_slot_edr_packets =
      &supports_3_slot_edr_packets;
  controller_instance->supports_5_slot_edr_packets =
      &supports_5_slot_edr_packets;
  controller_instance->supports_sco = &supports_sco;
  controller_instance->supports_hv2_packets = &supports_hv2_packets;
  controller_instance->supports_hv3_packets = &supports_hv3_packets;
  controller_instance->supports_ev3_packets = &supports_ev3_packets;
  controller_instance->supports_ev4_packets = &supports_ev4_packets;
  controller_instance->supports_ev5_packets = &supports_ev5_packets;
  controller_instance->supports_esco_2m_phy = &supports_esco_2m_phy;
  controller_instance->supports_esco_3m_phy = &supports_esco_3m_phy;
  controller_instance->supports_3_slot_esco_edr_packets =
      &supports_3_slot_esco_edr_packets;
  controller_instance->supports_role_switch = &supports_role_switch;
  controller_instance->supports_hold_mode = &supports_hold_mode;
  controller_instance->supports_sniff_mode = &supports_sniff_mode;
  controller_instance->supports_park_mode = &supports_park_mode;
  controller_instance->supports_non_flushable_pb = &supports_non_flushable_pb;
  controller_instance->supports_sniff_subrating = &supports_sniff_subrating;
  controller_instance->supports_encryption_pause = &supports_encryption_pause;
  ...
  controller_instance->supports_ble = &supports_ble;
  controller_instance->supports_ble_packet_extension =
      &supports_ble_packet_extension;
  controller_instance->supports_ble_connection_parameters_request =
      &supports_ble_connection_parameters_request;
  controller_instance->supports_ble_privacy = &supports_ble_privacy;
  controller_instance->supports_ble_set_privacy_mode =
      &supports_ble_set_privacy_mode;
  controller_instance->supports_ble_extended_advertising =
      &supports_ble_extended_advertising;
  controller_instance->supports_ble_periodic_advertising =
      &supports_ble_periodic_advertising;
  controller_instance->supports_ble_peripheral_initiated_feature_exchange =
      &supports_ble_peripheral_initiated_feature_exchange;
  controller_instance->supports_ble_connection_parameter_request =
      &supports_ble_connection_parameter_request;
  controller_instance->supports_ble_periodic_advertising_sync_transfer_sender =
  ...
  controller_instance->supports_ble_isochronous_broadcaster =
      &supports_ble_isochronous_broadcaster;
  controller_instance->supports_ble_synchronized_receiver =
      &supports_ble_synchronized_receiver;
  controller_instance->supports_ble_connection_subrating =
      &supports_ble_connection_subrating;
  controller_instance->supports_ble_connection_subrating_host =
