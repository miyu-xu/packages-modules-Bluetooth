...
#include "test/fake/fake_stack_btm_interface.h"
...
TEST_F(BtaDmTest, bta_dm_set_encryption) {
  ...
  fake_btm_client_interface.security.BTM_SetEncryption =
...
TEST_F(BtaDmTest, bta_dm_remname_cback__typical) {
  bta_dm_search_cb = {
      .p_search_cback = nullptr,
      .p_btm_inq_info = nullptr,
      .services = 0,
      .services_to_search = 0,
      .services_found = 0,
      .p_sdp_db = nullptr,
      .state = BTA_DM_SEARCH_IDLE,
      .peer_bdaddr = kRawAddress,
      .name_discover_done = false,
      .peer_name = {},
      .search_timer = nullptr,
      .service_index = 0,
      .p_pending_search = nullptr,
      .pending_discovery_queue = nullptr,
      .wait_disc = false,
      .sdp_results = false,
      .uuid = {},
      .peer_scn = 0,
      .transport = {},
      .p_scan_cback = nullptr,
      .p_csis_scan_cback = nullptr,
      .client_if = 0,
      .uuid_to_search = 0,
      .gatt_disc_active = false,
      .conn_id = 0,
      .gatt_close_timer = nullptr,
      .pending_close_bda = {},
  };
  ...
  fake_btm_client_interface.security.BTM_SecDeleteRmtNameNotifyCallback =
...
TEST_F(BtaDmTest,
  ...
  fake_btm_client_interface.peer.BTM_ReadDevInfo =
