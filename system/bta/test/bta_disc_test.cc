...
void bta_dm_find_services_via_sdp(tBTA_DM_SDP_STATE* state);
...
TEST_F(BtaInitializedTest, bta_dm_find_services_via_sdp) {
  ...
  bluetooth::legacy::testing::bta_dm_find_services_via_sdp(state.get());
}
