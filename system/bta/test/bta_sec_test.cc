...
protected:
  void SetUp() override {
    ...
    bluetooth::testing::set_stack_rnr_interface(&mock_stack_rnr_interface_);
  }

  void TearDown() override {
    bluetooth::testing::reset_rnr_interface();
    BtaWithHwOnTest::TearDown();
  }

  bluetooth::stack::rnr::Mock mock_stack_rnr_interface_;
};
