...
TEST(GattDatabaseTest, serialized_hash_test_including_128_bit_uuid) {
  DatabaseBuilder builder;
  // 1.
  builder.AddService(0x0001, 0x001f, Uuid::From16Bit(0x1800), true);
  // 2.
  builder.AddService(0x0020, 0x003f, Uuid::From16Bit(0x1801), true);
  // 3.
  builder.AddService(0x0f00, 0x0f05, Uuid::From16Bit(0x180f), true);
  // 4.
  builder.AddService(0x0f06, 0x0fff, Uuid::From16Bit(0x180f), true);
  // 5.
  builder.AddService(0x4400, 0x44ff, Uuid::From16Bit(0x1844), true);
  // 6.
  builder.AddService(0x4600, 0x46ff, Uuid::From16Bit(0x1846), true);
  // 7.
  builder.AddService(0x4d00, 0x4dff, Uuid::From16Bit(0x184d), true);
  // 8.
  builder.AddService(0x4e00, 0x4eff, Uuid::From16Bit(0x184e), true);
  // 9.
  builder.AddService(0x4f00, 0x4fff, Uuid::From16Bit(0x184f), true);
  // 10.
  builder.AddService(0x5000, 0x50ff, Uuid::From16Bit(0x1850), true);
  // 11.
  builder.AddService(0x5300, 0x53ff, Uuid::From16Bit(0x1853), true);
  // 12.
  builder.AddService(0x5500, 0x55ff, Uuid::From16Bit(0x1855), true);
  // 13.
  builder.AddService(0x8000, 0x80ff, Uuid::From16Bit(0xfe03), true);
  // 14.
  builder.AddService(0x8100, 0x81ff, Uuid::From16Bit(0xfe2c), true);
  // 15.
  //    builder.AddService(
  //            0xa000, 0xa0ff,
  //            //UUID: 86868686868686868686868686868686
  //            Uuid::From128BitLE(Uuid::UUID128Bit{{0x86, 0x86, 0x86, 0x86, 0x86, 0x86, 0x86, 0x86,
  //            0x86,
  //                                                 0x86, 0x86, 0x86, 0x86, 0x86, 0x86, 0x86}}),
  //            true);
  //    builder.AddService(0xa100, 0xa1ff,
  //          //UUID: 00006d6f632e746e696f706c65637865
  //            Uuid::From128BitLE(Uuid::UUID128Bit{{0x00, 0x00, 0x6d, 0x6f, 0x63, 0x2e, 0x74, 0x6e,
  //            0x69,
  //                                                 0x6f, 0x70, 0x6c, 0x65, 0x63, 0x78, 0x65}}),
  //            true);
  ...
  builder.AddCharacteristic(0x0026, 0x0027, Uuid::From16Bit(0x2b3a), 0x02);
  builder.AddCharacteristic(0x0028, 0x0029, Uuid::From16Bit(0x2b2a), 0x02);

  // 3.
  builder.AddCharacteristic(0x0f01, 0x0f02, Uuid::From16Bit(0x2b2a), 0x12);
  builder.AddDescriptor(0x0f03, Uuid::From16Bit(0x2902));
  builder.AddDescriptor(0x0f04, Uuid::From16Bit(0x2907));

  // 4.
  builder.AddCharacteristic(0x0f07, 0x0f08, Uuid::From16Bit(0x2a19), 0x12);
  builder.AddDescriptor(0x0f09, Uuid::From16Bit(0x2902));
  builder.AddDescriptor(0x0f0a, Uuid::From16Bit(0x2907));

  // 5.
  builder.AddCharacteristic(0x4401, 0x4402, Uuid::From16Bit(0x2b7d), 0x12);
  builder.AddDescriptor(0x4403, Uuid::From16Bit(0x2902));
  builder.AddCharacteristic(0x4404, 0x4405, Uuid::From16Bit(0x2b7e), 0x08);
  ...
  builder.AddDescriptor(0x4f05, Uuid::From16Bit(0x2902));
  ...
  // 11.
  builder.AddIncludedService(0x5301, Uuid::From16Bit(0x1846), 0x4600, 0x46ff);
  ...
  builder.AddCharacteristic(
          0x8001, 0x8002,
          // UUID: 7630f8dd90a361aca743053077b14ef0
          Uuid::From128BitLE(Uuid::UUID128Bit{{0x76, 0x30, 0xf8, 0xdd, 0x90, 0xa3, 0x61, 0xac, 0xa7,
                                               0x43, 0x05, 0x30, 0x77, 0xb1, 0x4e, 0xf0}}),
          0x08);
  builder.AddCharacteristic(
          0x8003, 0x8004,
          // UUID: 0b42821f64722f8ab44b79185ba0ee2b
          Uuid::From128BitLE(Uuid::UUID128Bit{{0x0b, 0x42, 0x82, 0x1f, 0x64, 0x72, 0x2f, 0x8a, 0xb4,
                                               0x4b, 0x79, 0x18, 0x5b, 0xa0, 0xee, 0x2b}}),
          0x10);
  ...
  builder.AddCharacteristic(
          0x8101, 0x8102,
          // UUID: ea0b1032de01b08e1448668333122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x33, 0x12, 0x2c, 0xfe}}),
          0x02);
  builder.AddCharacteristic(
          0x8103, 0x8104,
          // UUID: ea0b1032de01b08e1448668334122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x34, 0x12, 0x2c, 0xfe}}),
          0x18);
  builder.AddDescriptor(0x8105, Uuid::From16Bit(0x2902));
  builder.AddCharacteristic(
          0x8106, 0x8107,
          // UUID: ea0b1032de01b08e1448668335122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x35, 0x12, 0x2c, 0xfe}}),
          0x18);
  builder.AddDescriptor(0x8108, Uuid::From16Bit(0x2902));
  builder.AddCharacteristic(
          0x8109, 0x810a,
          // UUID: ea0b1032de01b08e1448668336122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x36, 0x12, 0x2c, 0xfe}}),
          0x08);
  builder.AddCharacteristic(
          0x810b, 0x810c,
          // UUID: ea0b1032de01b08e1448668337122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x37, 0x12, 0x2c, 0xfe}}),
          0x18);
  builder.AddDescriptor(0x810d, Uuid::From16Bit(0x2902));
  builder.AddCharacteristic(
          0x810e, 0x810f,
          // UUID: ea0b1032de01b08e144866833a122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x3a, 0x12, 0x2c, 0xfe}}),
          0x1a);
  builder.AddDescriptor(0x8110, Uuid::From16Bit(0x2902));
  builder.AddCharacteristic(
          0x8111, 0x8112,
          // UUID: ea0b1032de01b08e1448668339122cfe
          Uuid::From128BitLE(Uuid::UUID128Bit{{0xea, 0x0b, 0x10, 0x32, 0xde, 0x01, 0xb0, 0x8e, 0x14,
                                               0x48, 0x66, 0x83, 0x39, 0x12, 0x2c, 0xfe}}),
          0x02);

  // 15.
  //    builder.AddCharacteristic(
  //          0xa001, 0xa002,
  //          //UUID: 97979797979797979797979797979797
  //          Uuid::From128BitLE(Uuid::UUID128Bit{{0x97, 0x97, 0x97, 0x97, 0x97, 0x97, 0x97, 0x97,
  //          0x97,
  ...
  //    builder.AddCharacteristic(
  //            0xa101, 0xa102,
  //            //UUID: 02006d6f632e746e696f706c65637865
  //            Uuid::From128BitLE(Uuid::UUID128Bit{{0x02, 0x00, 0x6d, 0x6f, 0x63, 0x2e, 0x74, 0x6e,
  //            0x69,
  //                                                 0x6f, 0x70, 0x6c, 0x65, 0x63, 0x78, 0x65}}),
  //            0x0c);
  ...
  //    builder.AddCharacteristic(
  //            0xa104, 0xa105,
  //            //UUID: 01006d6f632e746e696f706c65637865
  //            Uuid::From128BitLE(Uuid::UUID128Bit{{0x01, 0x00, 0x6d, 0x6f, 0x63, 0x2e, 0x74, 0x6e,
  //            0x69,
  //                                                 0x6f, 0x70, 0x6c, 0x65, 0x63, 0x78, 0x65}}),
  //            0x10);
  ...
  Octet16 expected_hash{0xdc, 0xde, 0x9c, 0x26, 0x85, 0x63, 0xd1, 0x11,
                        0x53, 0xf8, 0x09, 0xae, 0x0a, 0x59, 0x88, 0x0e};
  EXPECT_EQ(db.Hash(), expected_hash);
