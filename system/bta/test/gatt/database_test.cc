...
TEST(GattDatabaseTest, serialized_hash_test_including_128_bit_uuid) {
  ...
  // 11.
  builder.AddService(0x5300, 0x5300, Uuid::From16Bit(0x1853), true);
  // 12.
  ...
  // 3.
  builder.AddCharacteristic(0x0f01, 0x0f02, Uuid::From16Bit(0x2a19), 0x12);
  ...
  // 15.
  builder.AddCharacteristic(0xa001, 0xa002, Uuid::From128BitBE(Uuid::UUID128Bit{{0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77}}), 0x1c);
