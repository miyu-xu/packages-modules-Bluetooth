...
struct AudioSetConfigurationProviderJson {
  ...
  AudioSetConfigurationProviderJson() {
    dual_32k_bidirection_supported_ = osi_property_get_bool(
        "persist.bluetooth.leaudio_dual_32k_bidirection.supported", true);
 ...
 private:
  ...
  /* property to check if bidirection 32k dual mic is supported or not */
  bool dual_32k_bidirection_supported_;
  ...
  AudioSetConfiguration AudioSetConfigurationFromFlat(
    ...
    bool dual_dev_one_chan_stereo_sink_gte_32k = false;
    bool dual_dev_one_chan_stereo_source_gte_32k = false;
    bool single_dev_one_chan_stereo_sink_gte_32k = false;
    bool single_dev_one_chan_stereo_source_gte_32k = false;
      ...
      for (auto subconfig : *codec_cfg->subconfigurations()) {
        if (subconfig->direction() == le_audio::types::kLeAudioDirectionSink) {
          processSubconfig(*subconfig, qos_sink,
                           dual_dev_one_chan_stereo_sink_gte_32k,
                           single_dev_one_chan_stereo_sink_gte_32k, subconfigs);
        } else {
          processSubconfig(
              *subconfig, qos_source, dual_dev_one_chan_stereo_source_gte_32k,
              single_dev_one_chan_stereo_source_gte_32k, subconfigs);
        }
      }
    } else {
    ...
    if (!dual_32k_bidirection_supported_) {
      if ((dual_dev_one_chan_stereo_sink_gte_32k &&
           dual_dev_one_chan_stereo_source_gte_32k) ||
          (single_dev_one_chan_stereo_sink_gte_32k &&
           single_dev_one_chan_stereo_source_gte_32k)) {
  ...
  void processSubconfig(
      ...
      bool& dual_dev_one_chan_stereo_gte_32k,
      bool& single_dev_one_chan_stereo_gte_32k,
      std::vector<SetConfiguration>& subconfigs) {
    ...
    if (subconfigs.back().device_cnt == 2 && subconfigs.back().ase_cnt == 2) {
      dual_dev_one_chan_stereo_gte_32k |= true;
    }
    if (subconfigs.back().device_cnt == 1 && subconfigs.back().ase_cnt == 2) {
      single_dev_one_chan_stereo_gte_32k |= true;
    }
  }
