...
bool LeAudioDeviceGroup::SetPreferredAudioSetConfiguration(
  ...
  preferred_config_.sink = std::make_unique<btle_audio_codec_config_t>(input_codec_config);
  preferred_config_.source = std::make_unique<btle_audio_codec_config_t>(output_codec_config);
