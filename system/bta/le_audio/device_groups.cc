...
void LeAudioDeviceGroup::ClearSinkCisesFromConfiguration(void) {
...
void LeAudioDeviceGroup::ClearSourceCisesFromConfiguration(void) {
  LOG_INFO("Group %p, group_id %d", this, group_id_);
...
void LeAudioDeviceGroup::ClearAllCises(void) {
  ...
  cig.cises.clear();
  ClearSinkCisesFromConfiguration();
  ClearSourceCisesFromConfiguration();
}
...
uint8_t LeAudioDeviceGroup::CigConfiguration_::GetFirstFreeCisId(
...
types::LeAudioConfigurationStrategy LeAudioDeviceGroup::GetGroupStrategy(
  ...
  LOG_DEBUG("Channel count bitmap for group %d (device %s) is %d", group_id_,
            ADDRESS_TO_LOGGABLE_CSTR(device->address_), channel_count_bitmap);
...
void LeAudioDeviceGroup::CigConfiguration_::GenerateCisIds(
...
bool LeAudioDeviceGroup::CigConfiguration_::AssignCisIds(
...
void LeAudioDeviceGroup::CigConfiguration_::AssignCisConnHandles(
...
void LeAudioDeviceGroup::CigConfiguration_::UnassignCis(
    LeAudioDevice* leAudioDevice) {
  ASSERT_LOG(leAudioDevice, "Invalid device");
...
bool CheckIfStrategySupported(types::LeAudioConfigurationStrategy strategy,
  ...
  switch (strategy) {
    ...
    case types::LeAudioConfigurationStrategy::STEREO_ONE_CIS_PER_DEVICE: {
      ...
      auto requested_channel_count =
          LeAudioCodecConfigBase::FromLtvMap(conf.codec.params)
              .GetChannelCount();
      LOG_DEBUG("requested chan cnt: %d, chan mask: %s",
