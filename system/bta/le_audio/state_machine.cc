 ...
 private:
  ...
  void CigCreate(LeAudioDeviceGroup* group) {
    ...
    for (struct cis& cis : group->cises_) {
      ...
      max_sdu_size_mtos = max_sdu_size_mtos_temp ? max_sdu_size_mtos_temp : 0;
      max_sdu_size_stom = max_sdu_size_stom_temp ? max_sdu_size_stom_temp : 0;
      rtn_mtos = rtn_mtos_temp ? rtn_mtos_temp : 0;
      rtn_stom = rtn_stom_temp ? rtn_stom_temp : 0;
