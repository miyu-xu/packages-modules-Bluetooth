 ...
 public:
  ...
  virtual void UpdateActiveAudioConfig(
      ...
      std::function<void(const offload_config& config, uint8_t direction)>
          update_receiver);
  virtual const ::bluetooth::le_audio::set_configurations::AudioSetConfigurations*
  GetOffloadCodecConfig(::bluetooth::le_audio::types::LeAudioContextType ctx_type);
  virtual const ::bluetooth::le_audio::broadcast_offload_config* GetBroadcastOffloadConfig(
