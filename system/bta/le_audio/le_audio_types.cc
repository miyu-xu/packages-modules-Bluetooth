...
const std::map<uint8_t, uint32_t> LeAudioCodecConfigBase::sampling_freq_map = {
...
const std::map<uint8_t, uint32_t> LeAudioCodecConfigBase::frame_duration_map = {
...
std::ostream& operator<<(std::ostream& os,
                         const types::LeAudioCodecConfigBase& config) {
  os << " LeAudioCodecConfigBase(SamplFreq="
