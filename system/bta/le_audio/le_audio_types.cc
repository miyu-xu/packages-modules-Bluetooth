...
const std::map<uint8_t, uint32_t> LeAudioCoreCodecConfig::frame_duration_map = {
  ...
  { codec_spec_conf::kLeAudioCodecFrameDur10000us, LeAudioCodecConfiguration::kInterval10000Us }
};
...
const std::map<uint32_t, uint8_t> LeAudioCoreCodecConfig::data_interval_map = {
  ...
  { LeAudioCodecConfiguration::kInterval10000Us, codec_spec_conf::kLeAudioCodecFrameDur10000us },
};
...
std::ostream& operator<<(std::ostream& os, const types::AseState& state) {
  static const char* char_value_[7] = {
    "IDLE", "CODEC_CONFIGURED", "QOS_CONFIGURED", "ENABLING", "STREAMING", "DISABLING", "RELEASING",
  };
