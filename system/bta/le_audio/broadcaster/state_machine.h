...
class BroadcastStateMachine : public StateMachine<3> {
 public:
  ...
  static const std::underlying_type<Message>::type MESSAGE_MAX =
  ...
  static const std::underlying_type<State>::type STATE_MAX =
  ...
  virtual bluetooth::le_audio::BroadcastId GetBroadcastId() = 0;
