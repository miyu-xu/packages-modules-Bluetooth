...
static const std::vector<uint8_t> default_metadata = {
  ...
  bluetooth::le_audio::types::kLeAudioMetadataTypeStreamingAudioContext, default_context & 0x00FF,
  (default_context & 0xFF00) >> 8
};
...
static const std::vector<uint8_t> media_metadata = {
  bluetooth::le_audio::types::kLeAudioMetadataStreamingAudioContextLen + 1,
  bluetooth::le_audio::types::kLeAudioMetadataTypeStreamingAudioContext, media_context & 0x00FF,
  (media_context & 0xFF00) >> 8
};
        ...
        broadcaster::BroadcastSubgroupCodecConfig(
                kLeAudioCodecIdVendor1,
                {
                        broadcaster::BroadcastSubgroupBisCodecConfig{
                                ...
                                std::vector<uint8_t>{ 0x00, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60,
...
TEST_F(BroadcasterTest, VendorCodecConfig) {
  ...
  ASSERT_EQ(0,
            memcmp(expected_subgroup_codec_conf.GetVendorCodecSpecData()->data(),
