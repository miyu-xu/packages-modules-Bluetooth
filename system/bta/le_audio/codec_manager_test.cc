...
TEST_F(CodecManagerTestAdsp, testStreamConfigurationVendor) {
  ...
  stream_map_info_sink_left.codec_id = vendor_code_48_2.id;
  stream_map_info_sink_left.codec_config = vendor_code_48_2.params;
  stream_map_info_sink_left.vendor_codec_config = vendor_code_48_2.vendor_params;
  ...
  AppendMetadataLtvEntryForStreamingContext(stream_map_info_sink_left.metadata,
  ...
  stream_map_info_sink_right.codec_id = vendor_code_48_2.id;
  stream_map_info_sink_right.codec_config = vendor_code_48_2.params;
  stream_map_info_sink_right.vendor_codec_config = vendor_code_48_2.vendor_params;
  ...
  AppendMetadataLtvEntryForStreamingContext(stream_map_info_sink_right.metadata,
                                            types::AudioContexts(types::LeAudioContextType::GAME));

  stream_map_info stream_map_info_source_right(cises[1].conn_handle,
                                               codec_spec_conf::kLeAudioLocationFrontRight, true);
  stream_map_info_source_right.codec_id = vendor_code_48_2.id;
  stream_map_info_source_right.codec_config = vendor_code_48_2.params;
  stream_map_info_source_right.vendor_codec_config = vendor_code_48_2.vendor_params;
  ...
  AppendMetadataLtvEntryForStreamingContext(stream_map_info_source_right.metadata,
                                            types::AudioContexts(types::LeAudioContextType::GAME));
  ...
  for (auto direction : {bluetooth::le_audio::types::kLeAudioDirectionSink,
    ...
    for (const auto& info : config.stream_map) {
      if (info.stream_handle == 96) {
        ...
        ASSERT_EQ(vendor_code_48_2.id, info.codec_id);
        ASSERT_EQ(vendor_code_48_2.params, info.codec_config);
        ASSERT_EQ(vendor_code_48_2.vendor_params, info.vendor_codec_config);
