...
class LeAudioDeviceGroup {
 public:
  ...
  bool UpdateGroupAudioContextTypeAvailability(types::AudioContexts contexts);
  void UpdateGroupAudioContextTypeAvailability(void);
  ...
  inline types::AudioContexts GetGroupAvailableContexts(void) {
