...
types::LeAudioContextType AudioContentToLeAudioContext(audio_content_type_t content_type,
                                                       audio_usage_t usage);
types::AudioContexts GetAudioContextsFromSourceMetadata(const source_metadata_v7& source_metadata);
types::AudioContexts GetAudioContextsFromSinkMetadata(const sink_metadata_v7& sink_metadata);
