...
public:
  ...
  BidirectionalPair<AudioContexts> DirectionalRealignMetadataAudioContexts(
    ...
    log::debug("111 remote_metadata.source= {}", ToString(remote_metadata.source));
    log::debug("111 remote_metadata.sink= {}", ToString(remote_metadata.sink));
    ...
    log::debug("222 remote_metadata.source= {}", ToString(remote_metadata.source));
    log::debug("222 remote_metadata.sink= {}", ToString(remote_metadata.sink));
    ...
    if (remote_metadata.get(remote_direction).test_any(all_bidirectional_contexts)) {
      ...
      if (is_ongoing_call_on_other_direction) {
        ...
        log::debug("333 remote_metadata.source= {}", ToString(remote_metadata.source));
        log::debug("333 remote_metadata.sink= {}", ToString(remote_metadata.sink));
