...
class LeAudioClientImpl : public LeAudioClient {
 public:
  ...
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder setup dt_us=" << +dt_us << ", sr_hz= " << +sr_hz << ", enc_size=" << +enc_size;
      ...
      lc3_encoder_left = lc3_setup_encoder(dt_us, sr_hz, lc3_encoder_left_mem.get());
      lc3_encoder_right = lc3_setup_encoder(dt_us, sr_hz, lc3_encoder_right_mem.get());
 ...
 private:
  ...
  std::unique_ptr<uint8_t[]> lc3_encoder_left_mem;
  std::unique_ptr<uint8_t[]> lc3_encoder_right_mem;
