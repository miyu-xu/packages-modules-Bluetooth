...
class LeAudioClientImpl : public LeAudioClient {
 public:
  ...
  bool StartSendingAudio(int group_id) {
    ...
    if (use_new_encoder) {
      if (lc3_encoder_left_mem) {
        ...
        free(lc3_encoder_left_mem);//.reset(nullptr);
        free(lc3_encoder_right_mem);//.reset(nullptr);
      }
      int dt_us = current_source_codec_config.data_interval_us;
      int sr_hz = current_source_codec_config.sample_rate;
  ...
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder address left=" << +lc3_encoder_left_mem;
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder address right=" << +lc3_encoder_right_mem;
