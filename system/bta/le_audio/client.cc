...
lc3_encoder_mem_48k_t lc3_encoder_left_mem __attribute__ ((__aligned__(64)));
lc3_encoder_mem_48k_t lc3_encoder_right_mem __attribute__ ((__aligned__(64)));
 ...
 public:
  ...
  bool StartSendingAudio(int group_id) {
    ...
    if (use_new_encoder) {
      ...
      //   lc3_encoder_left_mem.reset(nullptr);
      //   lc3_encoder_right_mem.reset(nullptr);
      // }
      int dt_us = current_source_codec_config.data_interval_us;
      int sr_hz = current_source_codec_config.sample_rate;
      unsigned enc_size = lc3_encoder_size(dt_us, sr_hz);

      // lc3_encoder_left_mem = std::make_unique<uint8_t[]>(enc_size);
      // lc3_encoder_right_mem = std::make_unique<uint8_t[]>(enc_size);
 
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder setup dt_us=" << +dt_us << ", sr_hz= " << +sr_hz << ", enc_size=" << +enc_size;
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder left addr=" << &lc3_encoder_left_mem;
  LOG(WARNING)  << " ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ encoder right addr=" << &lc3_encoder_right_mem;
