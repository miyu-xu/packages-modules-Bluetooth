...
protected:
  ...
  void TestSetupRemoteDevices(int group_id) {
    ...
    LeAudioClient::Get()->SetCcidInformation(
        gmcs_ccid, static_cast<int>(LeAudioContextType::MEDIA));
    LeAudioClient::Get()->SetCcidInformation(
        gtbs_ccid, static_cast<int>(LeAudioContextType::CONVERSATIONAL));
  ...
  void TestSetCodecPreference(
      ...
      bool set_while_streaming,
      bool is_using_set_before_streaming_codec_during_streaming,
      bool is_using_set_while_streaming_codec_during_streaming,
      bool is_reconfig) {
    ...
    if (context_type == LeAudioContextType::MEDIA) {
      ...
      ccids = types::BidirectionalPair<std::vector<uint8_t>>{{gtbs_ccid},
                                                             {gtbs_ccid}};
      EXPECT_CALL(mock_state_machine_, StartStream(_, _, _, ccids)).Times(1);
    ...
    ASSERT_EQ(LeAudioClient::Get()->IsUsingPreferredCodecConfig(
                  group_id, static_cast<int>(context_type)),
    ...
    if (set_while_streaming) {
      ...
      if (context_type == LeAudioContextType::MEDIA) {
        ...
        ccids = types::BidirectionalPair<std::vector<uint8_t>>{{gtbs_ccid},
                                                               {gtbs_ccid}};
        EXPECT_CALL(mock_state_machine_, StartStream(_, _, _, ccids)).Times(1);
        StartStreaming(AUDIO_USAGE_VOICE_COMMUNICATION,
                       AUDIO_CONTENT_TYPE_SPEECH, group_id);
      }
    }
...
TEST_F(UnicastTest, TwoEarbudsClearPreferenceBeforeMedia) {
  ...
  TestSetCodecPreference(
      &preferred_codec_config_before_media, nullptr, LeAudioContextType::MEDIA,
...
TEST_F(UnicastTest, TwoEarbudsSetPreferenceSuccessDuringMediaWithReconfig) {
  ...
  TestSetCodecPreference(
      nullptr, &preferred_codec_config_during_media, LeAudioContextType::MEDIA,
      group_id, set_before_media, set_while_media,
      is_using_set_before_media_codec_during_media,
      is_using_set_while_media_codec_during_media, is_reconfig);
}
...
TEST_F(
  ...
  bool is_reconfig = true;
  TestSetCodecPreference(
      &preferred_codec_config_before_media,
      &preferred_codec_config_during_media, LeAudioContextType::MEDIA, group_id,
      set_before_media, set_while_media,
      is_using_set_before_media_codec_during_media,
      is_using_set_while_media_codec_during_media, is_reconfig);
}
...
TEST_F(UnicastTest, TwoEarbudsClearPreferenceBeforeConv) {
  ...
  bool is_reconfig = false;
  TestSetCodecPreference(
      &preferred_codec_config_before_conv, nullptr,
...
TEST_F(UnicastTest, TwoEarbudsSetPreferenceSuccessDuringConvWithReconfig) {
  ...
  bool is_reconfig = true;
  TestSetCodecPreference(
      nullptr, &preferred_codec_config_during_conv,
      LeAudioContextType::CONVERSATIONAL, group_id, set_before_conv,
      set_while_conv, is_using_set_before_conv_codec_during_conv,
      is_using_set_while_conv_codec_during_conv, is_reconfig);
  LeAudioClient::Get()->SetInCall(false);
...
TEST_F(
    UnicastTest,
    TwoEarbudsSetPreferenceSucessBeforeConvClearPreferenceDuringConvWithReconfig) {
  int group_id = 2;
  TestSetupRemoteDevices(group_id);
  ...
  bool is_reconfig = true;
  TestSetCodecPreference(
      &preferred_codec_config_before_conv, &preferred_codec_config_during_conv,
      LeAudioContextType::CONVERSATIONAL, group_id, set_before_conv,
      set_while_conv, is_using_set_before_conv_codec_during_conv,
      is_using_set_while_conv_codec_during_conv, is_reconfig);
  LeAudioClient::Get()->SetInCall(false);
...
TEST_F(UnicastTest, TwoEarbudsSetPreferenceWhenIdleForBothMediaAndConv) {
  ...
  bool is_using_set_while_conv_codec_during_conv = false;
  is_reconfig = false;
  TestSetCodecPreference(nullptr, nullptr, LeAudioContextType::CONVERSATIONAL,
                         group_id, set_before_conv, set_while_conv,
                         is_using_set_before_conv_codec_during_conv,
                         is_using_set_while_conv_codec_during_conv,
                         is_reconfig);
  LeAudioClient::Get()->SetInCall(false);
...
TEST_F(UnicastTest, TwoEarbudsSetPreferenceWhenConvForBothMediaAndConv) {
  ...
  bool is_reconfig = false;
  TestSetCodecPreference(
      nullptr, nullptr, LeAudioContextType::MEDIA, group_id, set_before_media,
