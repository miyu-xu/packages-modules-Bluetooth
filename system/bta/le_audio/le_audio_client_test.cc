...
TEST_F_WITH_FLAGS(UnicastTest, TwoEarbudsStreamingContextSwitchReconfigure,
                  REQUIRES_FLAGS_DISABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  uint8_t group_size = 2;
  int group_id = 2;
...
TEST_F_WITH_FLAGS(UnicastTest,
                  TwoEarbudsStreamingContextSwitchReconfigure_SpeedUpReconfigFlagEnabled,
                  REQUIRES_FLAGS_ENABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  uint8_t group_size = 2;
  int group_id = 2;
 ...
 * use case).
 */
TEST_F_WITH_FLAGS(UnicastTest, UpdateNotSupportedContextTypeUnspecifiedAvailable,
                  REQUIRES_FLAGS_DISABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
...
TEST_F_WITH_FLAGS(UnicastTest,
                  UpdateNotSupportedContextTypeUnspecifiedAvailable_SpeedUpReconfigFlagEnabled,
                  REQUIRES_FLAGS_ENABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
 ...
 */
TEST_F_WITH_FLAGS(UnicastTest, UpdateMultipleBidirContextTypes,
                  REQUIRES_FLAGS_DISABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
...
TEST_F_WITH_FLAGS(UnicastTest, UpdateMultipleBidirContextTypes_SpeedUpReconfigFlagEnabled,
                  REQUIRES_FLAGS_ENABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
...
TEST_F_WITH_FLAGS(UnicastTest, MusicDuringCallContextTypes,
                  REQUIRES_FLAGS_DISABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
...
TEST_F_WITH_FLAGS(UnicastTest, MusicDuringCallContextTypes_SpeedUpReconfigFlagEnabled,
                  REQUIRES_FLAGS_ENABLED(
                          ACONFIG_FLAG(TEST_BT, leaudio_speed_up_reconfiguration_between_call))) {
  const RawAddress test_address0 = GetTestAddress(0);
  int group_id = bluetooth::groups::kGroupUnknown;
