...
TEST_F(UnicastTest, GroupSetActive_CurrentCodecSentOfActive) {
  ...
  os::SetSystemProperty(kFlagPrefix + "leaudio_codec_config_callback_order_fix",
                        std::string("true"));
...
TEST_F(UnicastTest, TestUnidirectionalVoiceAssistant_Sink) {
  ...
  os::SetSystemProperty(kFlagPrefix + "le_audio_support_unidirectional_voice_assistant",
                        std::string("true"));
...
TEST_F(UnicastTest, TwoEarbudsStreamingContextSwitchReconfigure) {
  // Flag is FALSE. Remove the test when flag will be removing
  os::SetSystemProperty(kFlagPrefix + "leaudio_speed_up_reconfiguration_between_call",
                        std::string("false"));
...
TEST_F(UnicastTest, MusicDuringCallContextTypes_SpeedUpReconfigFlagEnabled) {
  std::string flagString = kFlagPrefix + "leaudio_speed_up_reconfiguration_between_call";
