 ...
 * as UNSPECIFED for the backwards compatibility.
...
/* When a certain context is unavailable and not supported we should stream that
 * context under the UNSPECIFED label for the backwards compatibility.
 */
