...
class MockAudioHalClientEventReceiver
    : public AudioHalClient::LeAudioSinkCallbacks {
 public:
  MOCK_METHOD((void), OnAudioSuspend, (std::promise<void> do_suspend_promise),
              (override));
  MOCK_METHOD((void), OnAudioResume, (), (override));
...
class LeAudioClientAudioTest : public ::testing::Test {
 protected:
  void SetUp(void) override {
    ...
    leAudioUnicastClientAudioSource = AudioHalClient::Get();
    leAudioUnicastClientAudioSink = AudioHalClient::Get();
  }

  bool AcquireLeAudioSinkHalClient(void) {
    audio_sink_instance_ = leAudioUnicastClientAudioSink->AcquireUnicastSink();
    return is_source_audio_hal_acquired;
  }

  bool ReleaseLeAudioSinkHalClient(void) {
    leAudioUnicastClientAudioSink->Release(audio_sink_instance_);
    audio_sink_instance_ = nullptr;
    return !is_source_audio_hal_acquired;
  }

  bool AcquireLeAudioSourceHalClient(void) {
    audio_source_instance_ =
        leAudioUnicastClientAudioSource->AcquireUnicastSource();
  ...
  AudioHalClient* leAudioUnicastClientAudioSource;
  AudioHalClient* leAudioUnicastClientAudioSink;
  ...
  AudioHalClient::LeAudioSink* audio_sink_instance_ = nullptr;
  AudioHalClient::LeAudioSource* audio_source_instance_ = nullptr;
