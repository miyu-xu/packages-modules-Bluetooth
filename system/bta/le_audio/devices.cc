...
uint32_t PickAudioLocation(types::LeAudioConfigurationStrategy strategy,
  ...
  LOG_ERROR(
      "%s: Unable to find location which has not been already assigned."
      " Strategy: %hhu, device_locations: %lx, group_locations: %lx.",
      __func__, strategy, device_locations.to_ulong(),
