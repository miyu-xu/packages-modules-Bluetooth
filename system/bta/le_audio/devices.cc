...
static std::string getLocation(uint32_t location) {
...
void LeAudioDevice::Dump(int fd) {
  ...
  std::string snk_location = getLocation(snk_audio_locations_.to_ulong());
  std::string src_location = getLocation(src_audio_locations_.to_ulong());
