...
bool LeAudioDevice::ConfigureAses(
    ...
    BidirectionalPair<AudioContexts> metadata_context_types,
    BidirectionalPair<std::vector<uint8_t>> ccid_lists, bool reuse_cis_id) {
...
bool LeAudioDeviceGroup::ConfigureAses(
    const set_configurations::AudioSetConfiguration* audio_set_conf,
    types::LeAudioContextType context_type,
    types::BidirectionalPair<AudioContexts> metadata_context_types,
...
bool LeAudioDeviceGroup::IsMetadataChanged(
    BidirectionalPair<AudioContexts> context_types,
