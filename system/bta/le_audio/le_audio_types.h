...
struct stream_configuration {
  ...
  /* cis_handle, audio allocation*/
  std::vector<std::pair<uint16_t, uint32_t>>
      sink_offloader_streams_audio_allocation;
  /* cis_handle, connection state, stereo for conneected, 0 for disconnected */
  std::vector<std::pair<uint16_t, uint32_t>> sink_offloader_streams_connection;
  bool sink_offloader_changed;
  bool sink_not_all_cises_connected;
  bool sink_is_initialed;
  ...
  /* cis_handle, audio allocation*/
  std::vector<std::pair<uint16_t, uint32_t>>
      source_offloader_streams_audio_allocation;
  /* cis_handle, connection state, stereo for conneected, 0 for disconnected */
  std::vector<std::pair<uint16_t, uint32_t>>
      source_offloader_streams_connection;
  bool source_offloader_changed;
  bool source_not_all_cises_connected;
  bool source_is_initialed;
};
