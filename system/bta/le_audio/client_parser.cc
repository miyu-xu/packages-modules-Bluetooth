...
static std::map<uint8_t, std::string> ctp_response_code_map_string = {
  ...
  {    kCtpResponseCodeRejectedConfigurationParameterValue, "Rejected Configuration Parameter Value" },
  {     kCtpResponseCodeInvalidConfigurationParameterValue,  "Invalid Configuration Parameter Value" },
...
static std::map<uint8_t, std::map<uint8_t, std::string>*> ctp_response_code_map = {
  { kCtpResponseCodeUnsupportedConfigurationParameterValue, &ctp_configuration_reason_map_string },
