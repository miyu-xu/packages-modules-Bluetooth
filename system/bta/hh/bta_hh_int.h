...
/* action functions */
void bta_hh_api_disc_act(tBTA_HH_DEV_CB* p_cb,
                                const tBTA_HH_DATA* p_data);
...
void bta_hh_ctrl_dat_act(tBTA_HH_DEV_CB* p_cb,
                                const tBTA_HH_DATA* p_data);
...
void bta_hh_write_dev_act(tBTA_HH_DEV_CB* p_cb,
                                 const tBTA_HH_DATA* p_data);
void bta_hh_get_dscp_act(tBTA_HH_DEV_CB* p_cb,
                                const tBTA_HH_DATA* p_data);
void bta_hh_handsk_act(tBTA_HH_DEV_CB* p_cb, const tBTA_HH_DATA* p_data);
void bta_hh_maint_dev_act(tBTA_HH_DEV_CB* p_cb,
                                 const tBTA_HH_DATA* p_data);
void bta_hh_open_cmpl_act(tBTA_HH_DEV_CB* p_cb,
                                 const tBTA_HH_DATA* p_data);
void bta_hh_open_failure(tBTA_HH_DEV_CB* p_cb,
                                const tBTA_HH_DATA* p_data);
...
void bta_hh_le_write_dev_act(tBTA_HH_DEV_CB* p_cb,
                                    const tBTA_HH_DATA* p_data);
...
void bta_hh_le_open_fail(tBTA_HH_DEV_CB* p_cb,
                                const tBTA_HH_DATA* p_data);
