 ...
 *
 ******************************************************************************/
void BTA_HhOpen(const tTypedAddressTransport& dev_bda) {
...
void BTA_HhSendData(uint8_t dev_handle,
                    UNUSED_ATTR const tTypedAddressTransport& dev_bda,
                    BT_HDR* p_data) {
 ...
 *
 ******************************************************************************/
void BTA_HhAddDev(const tTypedAddressTransport& bda,
