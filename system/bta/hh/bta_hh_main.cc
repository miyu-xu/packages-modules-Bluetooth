...
/*******************************************************************************
 *
 * Function         bta_hh_hdl_common_event
 *
 ...
 *
 ******************************************************************************/
void bta_hh_hdl_common_event(tBTA_HH_INT_EVT event, const tBTA_HH_DATA* p_data) {
...
bool bta_hh_hdl_event(const BT_HDR_RIGID* p_msg) {
  ...
  if (p_cb != nullptr) {
    ...
    bta_hh_hdl_common_event(event, (tBTA_HH_DATA*)p_msg);
  }
