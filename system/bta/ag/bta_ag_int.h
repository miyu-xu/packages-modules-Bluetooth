...
typedef enum {
  ...
  BTA_AG_SCO_SWB_SETTINGS_UNKNOWN = 0xFFFF,
...
struct tBTA_AG_SCB {
  ...
  tBTA_AG_SCO_SWB_SETTINGS codec_swb_settings;   /* settings to be used for the
                                                    aptX Voice SWB eSCO */
  bool is_swb_codec; /* Flag to determine aptX Voice SWB codec  */
