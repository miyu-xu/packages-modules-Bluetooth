...
const uint8_t bta_pan_st_idle[][BTA_PAN_NUM_COLS] = {
  ...
  /* CI_TX_READY */
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST },
  /* CI_RX_READY */
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST },
  /* CI_TX_FLOW */
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST },
  ...
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST },
  /* PAN_CONN_OPEN */
  { BTA_PAN_CONN_OPEN, BTA_PAN_OPEN_ST },
  /* PAN_CONN_CLOSE */
  { BTA_PAN_CONN_OPEN, BTA_PAN_IDLE_ST },
  /* FLOW_ENABLE */
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST },
  /* BNEP_DATA */
  {    BTA_PAN_IGNORE, BTA_PAN_IDLE_ST }
...
const uint8_t bta_pan_st_open[][BTA_PAN_NUM_COLS] = {
  ...
  /* CI_TX_READY */
  {    BTA_PAN_TX_PATH, BTA_PAN_OPEN_ST },
  /* CI_RX_READY */
  {    BTA_PAN_RX_PATH, BTA_PAN_OPEN_ST },
  /* CI_TX_FLOW */
  {    BTA_PAN_TX_FLOW, BTA_PAN_OPEN_ST },
  /* CI_RX_WRITE */
  {     BTA_PAN_IGNORE, BTA_PAN_OPEN_ST },
  /* CI_RX_WRITEBUF */
  {  BTA_PAN_WRITE_BUF, BTA_PAN_OPEN_ST },
  /* PAN_CONN_OPEN */
  {     BTA_PAN_IGNORE, BTA_PAN_OPEN_ST },
  /* PAN_CONN_CLOSE */
  { BTA_PAN_CONN_CLOSE, BTA_PAN_IDLE_ST },
  /* FLOW_ENABLE */
  {    BTA_PAN_RX_PATH, BTA_PAN_OPEN_ST },
  /* BNEP_DATA */
  {    BTA_PAN_TX_PATH, BTA_PAN_OPEN_ST }
...
const uint8_t bta_pan_st_closing[][BTA_PAN_NUM_COLS] = {
  ...
  /* CI_TX_READY */
  {    BTA_PAN_TX_PATH, BTA_PAN_CLOSING_ST },
  /* CI_RX_READY */
  {    BTA_PAN_RX_PATH, BTA_PAN_CLOSING_ST },
  /* CI_TX_FLOW */
  {    BTA_PAN_TX_FLOW, BTA_PAN_CLOSING_ST },
  /* CI_RX_WRITE */
  {     BTA_PAN_IGNORE, BTA_PAN_CLOSING_ST },
  /* CI_RX_WRITEBUF */
  {   BTA_PAN_FREE_BUF, BTA_PAN_CLOSING_ST },
  /* PAN_CONN_OPEN */
  {     BTA_PAN_IGNORE, BTA_PAN_CLOSING_ST },
  /* PAN_CONN_CLOSE */
  { BTA_PAN_CONN_CLOSE,    BTA_PAN_IDLE_ST },
