...
TEST_F(CsisClientTest, test_storage_content) {
  ...
  GetSearchCompleteEvent(1);
  ASSERT_EQ(1,
            CsisClient::Get()->GetGroupId(GetTestAddress(1),
  ...
  GetSearchCompleteEvent(2);
  ASSERT_EQ(1,
            CsisClient::Get()->GetGroupId(GetTestAddress(2),
                                          bluetooth::Uuid::From16Bit(UUID_COMMON_AUDIO_SERVICE)));
  ...
  ASSERT_EQ(2,
            CsisClient::Get()->GetGroupId(GetTestAddress(3),
                                          bluetooth::Uuid::From16Bit(UUID_COMMON_AUDIO_SERVICE)));
  ...
  ASSERT_EQ(3,
            CsisClient::Get()->GetGroupId(GetTestAddress(4),
                                          bluetooth::Uuid::From16Bit(UUID_COMMON_AUDIO_SERVICE)));
