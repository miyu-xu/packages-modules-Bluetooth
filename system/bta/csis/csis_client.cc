 ...
 private:
  ...
  void CsisActiveObserverSet(bool enable) {
    bool is_ad_type_filter_support =
        bluetooth::shim::is_ad_type_filter_support();
    LOG_INFO("CYDBG CSIS Discovery SET: %d, is_ad_type_filter_support: %d",
             enable, is_ad_type_filter_support);
    if (is_ad_type_filter_support) {
