  ...
  bool OnCsisServiceFound(std::shared_ptr<CsisDevice> device,
    ...
    for (const gatt::Characteristic& charac : service->characteristics) {
      if (charac.uuid == kCsisLockUuid) {
        ...
        LOG_DEBUG(
            "Lock UUID found handle: 0x%04x, ccc handle: 0x%04x, devce: %s",
            csis_inst->svc_data.lock_handle.val_hdl,
        ...
        LOG_DEBUG("Rank UUID found handle: 0x%04x, devce: %s",
        ...
        LOG_DEBUG(
            "SIRK UUID found handle: 0x%04x, ccc handle: 0x%04x, devce: %s",
            csis_inst->svc_data.sirk_handle.val_hdl,
        ...
        LOG_DEBUG(
            "Size UUID found handle: 0x%04x, ccc handle: 0x%04x, devce: %s",
            csis_inst->svc_data.size_handle.val_hdl,
