...
void bta_gattc_write(tBTA_GATTC_CLCB* p_clcb,
                            const tBTA_GATTC_DATA* p_data);
void bta_gattc_op_cmpl(tBTA_GATTC_CLCB* p_clcb,
                              const tBTA_GATTC_DATA* p_data);
void bta_gattc_q_cmd(tBTA_GATTC_CLCB* p_clcb,
                            const tBTA_GATTC_DATA* p_data);
void bta_gattc_search(tBTA_GATTC_CLCB* p_clcb,
                             const tBTA_GATTC_DATA* p_data);
void bta_gattc_fail(tBTA_GATTC_CLCB* p_clcb,
                           const tBTA_GATTC_DATA* p_data);
void bta_gattc_confirm(tBTA_GATTC_CLCB* p_clcb,
                              const tBTA_GATTC_DATA* p_data);
void bta_gattc_execute(tBTA_GATTC_CLCB* p_clcb,
                              const tBTA_GATTC_DATA* p_data);
void bta_gattc_read_multi(tBTA_GATTC_CLCB* p_clcb,
                                 const tBTA_GATTC_DATA* p_data);
void bta_gattc_ci_open(tBTA_GATTC_CLCB* p_clcb,
                              const tBTA_GATTC_DATA* p_data);
...
void bta_gattc_send_open_cback(tBTA_GATTC_RCB* p_clreg,
                                      tGATT_STATUS status,
...
bool bta_gattc_check_bg_conn(tGATT_IF client_if,
...
/* discovery functions */
void bta_gattc_disc_res_cback(uint16_t conn_id,
                                     tGATT_DISC_TYPE disc_type,
                                     tGATT_DISC_RES* p_data);
void bta_gattc_disc_cmpl_cback(uint16_t conn_id,
                                      tGATT_DISC_TYPE disc_type,
                                      tGATT_STATUS status);
...
const gatt::Service* bta_gattc_get_service_for_handle_srcb(
    tBTA_GATTC_SERV* p_srcb, uint16_t handle);
const gatt::Characteristic* bta_gattc_get_characteristic(
