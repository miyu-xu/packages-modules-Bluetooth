...
/* bta_gattc_store */
extern bool bta_gattc_hash_load(const Octet16& hash, tBTA_GATTC_SERV* p_srcb);
extern bool bta_gattc_hash_write(
    const Octet16& hash, const std::vector<gatt::StoredAttribute>& attr);
