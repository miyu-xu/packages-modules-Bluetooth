...
static void bta_av_api_register(tBTA_AV_DATA* p_data) {
  ...
  do {
    ...
    if ((android::sysprop::bluetooth::A2dp::a2dp_src_sink_coexist().value_or(false) && !(bta_av_cb.reg_role & (1 << local_role))) ||
      (!android::sysprop::bluetooth::A2dp::a2dp_src_sink_coexist().value_or(false) && bta_av_cb.reg_audio == 0)) {
    ...
    if ((android::sysprop::bluetooth::A2dp::a2dp_src_sink_coexist().value_or(false) && !(bta_av_cb.reg_role & (1 << local_role))) ||
      (!android::sysprop::bluetooth::A2dp::a2dp_src_sink_coexist().value_or(false) && !bta_av_cb.reg_audio)) {
