 ...
 *             or tBTA_JV_L2CAP_ERROR_UNKNOWN if reason isn't defined yet.
 *
 ******************************************************************************/
static tBTA_JV_L2CAP_ERROR bta_jv_from_gap_l2cap_err(tL2CAP_CONN l2cap_result) {
  switch (l2cap_result) {
    case L2CAP_CONN_ACL_CONNECTION_FAILED:
      return BTA_JV_L2CAP_ERR_ACL_FAILURE;
    case L2CAP_CONN_CLIENT_SECURITY_CLEARANCE_FAILED:
      return BTA_JV_L2CAP_ERR_CL_SEC_FAILURE;
    case L2CAP_CONN_INSUFFICIENT_AUTHENTICATION:
      return BTA_JV_L2CAP_ERR_INSUFFICIENT_AUTHENTICATION;
    case L2CAP_CONN_INSUFFICIENT_AUTHORIZATION:
      return BTA_JV_L2CAP_ERR_INSUFFICIENT_AUTHORIZATION;
    case L2CAP_CONN_INSUFFICIENT_ENCRYP_KEY_SIZE:
      return BTA_JV_L2CAP_ERR_INSUFFICIENT_ENCRYP_KEY_SIZE;
    case L2CAP_CONN_INSUFFICIENT_ENCRYP:
      return BTA_JV_L2CAP_ERR_INSUFFICIENT_ENCRYP;
    case L2CAP_CONN_INVALID_SOURCE_CID:
      return BTA_JV_L2CAP_ERR_INVALID_SOURCE_CID;
    case L2CAP_CONN_SOURCE_CID_ALREADY_ALLOCATED:
      return BTA_JV_L2CAP_ERR_SOURCE_CID_ALREADY_ALLOCATED;
    case L2CAP_CONN_NO_RESOURCES:
      return BTA_JV_L2CAP_ERR_NO_RESOURCES;
    case L2CAP_CONN_NO_PSM:
      return BTA_JV_L2CAP_ERR_NO_PSM;
    case L2CAP_CONN_TIMEOUT:
      return BTA_JV_L2CAP_ERR_TIMEOUT;
    default:
      return BTA_JV_L2CAP_ERR_UNKNOWN;
  }
}
/******************************************************************************/
...
static void bta_jv_l2cap_client_cback(uint16_t gap_handle, uint16_t event,
  ...
  switch (event) {
    ...
    case GAP_EVT_CONN_CLOSED:
      ...
      evt_data.l2c_close.err = bta_jv_from_gap_l2cap_err(data->l2cap_result);
