 ...
 *
 ******************************************************************************/
static tBTA_JV_L2CAP_REASON bta_jv_from_gap_l2cap_err(tL2CAP_CONN l2cap_result) {
  switch (l2cap_result) {
  ...
  switch (event) {
    ...
    case GAP_EVT_CONN_CLOSED:
      ...
      evt_data.l2c_close.reason =
              data != nullptr ? bta_jv_from_gap_l2cap_err(to_l2cap_result_code(data->l2cap_result))
