...
TEST_F(VolumeControlDeviceTest, test_enqueue_remaining_requests) {
  ...
  std::vector<uint16_t> expected_to_read{0x0016 /* volume flags */,
                                         0x0025 /* gain setting properties 1 */,
                                         0x0027 /* audio input type 1 */,
                                         0x0029 /* audio input status 1 */,
                                         0x002e /* audio input description 1 */,
                                         0x0045 /* gain setting properties 2 */,
                                         0x0047 /* audio input type 2 */,
                                         0x0049 /* audio input status 2 */,
                                         0x004e /* audio input description 2 */,
                                         0x0065 /* audio location 1 */,
  ...
  std::map<uint16_t, uint16_t> expected_to_write_value_ccc_handle_map{
          {0x0029, 0x002a} /* audio input status ccc 1 */,
          {0x0049, 0x004a} /* audio input status ccc 2 */,
          {0x004e, 0x004f} /* audio input description ccc 2 */,
