...
class HearingAidImpl : public HearingAid {
 ...
 public:
  ...
  HearingAidImpl(bluetooth::hearing_aid::HearingAidCallbacks* callbacks,
    ...
    log::info("default_data_interval_ms={}", default_data_interval_ms);
    log::info("overwrite_min_ce_len={}", overwrite_min_ce_len);
    log::info("overwrite_max_ce_len={}", overwrite_max_ce_len);
  ...
  void OnReadOnlyPropertiesRead(uint16_t conn_id, tGATT_STATUS status,
    ...
    log::info(
        ...
        "  render_delay={}\n"
        "  preparation_delay={}\n"
        "  G722@16kHz_supported={}\n"
        "  G722@24kHz_supported={}\n",
  ...
  void SendAudio(uint8_t* encoded_data, uint16_t packet_size,
    ...
    if (!hearingAid->playback_started || !hearingAid->command_acked) {
      log::warn("Playback stalled, device={},cmd send={}, cmd acked={}",
