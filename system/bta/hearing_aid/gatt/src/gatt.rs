        ...
        try_stream!({
            ...
            loop {
                ...
                let attribute_data_list = match result {
                    Ok(att::ReadByGroupTypeRsp { attribute_data_list }) => Ok(attribute_data_list),
                ...
                {
                    let uuid =
                        if let Ok(crate::att_packets::ServiceAttributeValueUuid16 { uuid }) =
                            attribute_value.try_into()
                        {
                            Ok(uuid.into())
                        } else if let Ok(crate::att_packets::ServiceAttributeValueUuid128 {
                            uuid,
                        }) = attribute_value.try_into()
                        {
                            Ok(uuid.into())
                        ...
                        .map_err(DiscoveryError::InternalError)?;
            ...
            loop {
                let result = self
                    ...
                    .transaction(att::FindByTypeValueReq {
                        ...
                        attribute_value: (&crate::att_packets::ServiceAttributeValueUuid {
                            uuid: uuid.into(),
                        })
                            .try_into()
                            .unwrap(),
    ...
    pub fn find_included_services(
        ...
        try_stream!({
            ...
            loop {
                ...
                {
                    let service = if let Ok(crate::att_packets::IncludeAttributeValueUuid16 {
                        attribute_handle,
                        end_group_handle,
                        uuid,
                    }) = attribute_value.try_into()
                    {
                        Ok(Service { attribute_handle, end_group_handle, uuid: uuid.into() })
                    } else if let Ok(crate::att_packets::IncludeAttributeValueUuid128 {
                        attribute_handle,
                        end_group_handle,
                    }) = attribute_value.try_into()
                    {
                        ...
                        let result = self
                            ...
                            .await
                            .map_err(|err| match RecoverableDiscoveryError::try_from(err) {
                                Ok(RecoverableDiscoveryError::AttributeNotFound) => {
                                    DiscoveryError::InternalError(
                                        InternalDiscoveryError::ServiceAttributeNotFound(
                                            attribute_handle,
                                        ),
                                    )
                                }
                        ...
                        let att::ReadRsp { ref attribute_value } = result?;

                        let att::ServiceAttributeValueUuid128 { uuid } = attribute_value
                            .try_into()
    ...
    pub fn discover_all_characteristics_of_a_service(
        ...
        let characteristics = try_stream!({
            ...
            loop {
                ...
                {
                    if let Ok(crate::att_packets::CharacteristicAttributeValueUuid16 {
                        properties,
                    ...
                    } else if let Ok(crate::att_packets::CharacteristicAttributeValueUuid128 {
                        properties,
                        value_attribute_handle,
                        uuid,
                    }) = attribute_value.try_into()
        ...
        try_stream!({
            ...
            loop {
                ...
                let find_information_rsp = match result {
                    Ok(find_information_rsp) => Ok(find_information_rsp),
                    // This sub-procedure is complete when the ATT_ERROR_RSP PDU is received
                    // and the Error Code parameter is set to Attribute Not Found (0x0A)
                    Err(Ok(RecoverableDiscoveryError::AttributeNotFound)) => {
                        break;
                ...
                let last_handle = match find_information_rsp.specialize() {
                    Ok(crate::att_packets::FindInformationRspChild::FindInformationRsp16(
                        ...
                        Ok(information_data.last().map(|data| data.attribute_handle))
                    }
                    Ok(crate::att_packets::FindInformationRspChild::FindInformationRsp128(
                    ...
                    Ok(crate::att_packets::FindInformationRspChild::None) => {
                        Err(InternalDiscoveryError::InvalidFindInformationRsp(find_information_rsp))
                    }
...
pub mod tests {
    ...
    fn uuid_to_uuid16(uuid: Uuid) -> crate::att_packets::Uuid16 {
        /*let uuid: crate::att_packets::Uuid = uuid.into();
        (&uuid).try_into().unwrap()*/
        crate::att_packets::Uuid16 { value: uuid.to_le_bytes().deref().try_into().unwrap() }
    }

    fn uuid_to_uuid128(uuid: Uuid) -> crate::att_packets::Uuid128 {
        crate::att_packets::Uuid128 { value: uuid.get_as_128().to_le_bytes() }
    }
            ...
            .receive_transaction(|request: att::ReadByTypeReq| {
                ...
                Ok(att::ReadByTypeRsp {
                    attribute_data_list: [att::AttributeData {
                        ...
                        attribute_value: (&crate::att_packets::IncludeAttributeValueUuid128 {
                ...
                Ok(att::ReadByTypeRsp {
                    attribute_data_list: [
                        att::AttributeData {
                            ...
                            attribute_value:
                                (&crate::att_packets::CharacteristicAttributeValueUuid16 {
                                    properties: 0x02,
                                    value_attribute_handle: att::AttributeHandle::new(0x0204)
                                        .unwrap(),
                                    uuid: uuid_to_uuid16(UUID1),
                                })
                                    .try_into()
                        ...
                        att::AttributeData {
                            ...
                            attribute_value:
                                (&crate::att_packets::CharacteristicAttributeValueUuid128 {
                                    properties: 0x02,
                                    value_attribute_handle: att::AttributeHandle::new(0x0212)
                                        .unwrap(),
                                    uuid: uuid_to_uuid128(UUID2),
                                })
                                    .try_into()
                                    .unwrap(),
                        },
