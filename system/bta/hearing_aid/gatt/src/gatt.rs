    ...
    pub fn discover_all_primary_services(
        ...
        try_stream!({
            ...
            loop {
                ...
                {
                    let uuid = if let Ok(att::ServiceAttributeValueUuid16 { uuid }) =
                        attribute_value.try_into()
                    {
                        uuid.into()
                    } else if let Ok(att::ServiceAttributeValueUuid128 { uuid }) =
                        attribute_value.try_into()
                    {
                        uuid.into()
                    } else {
            ...
            loop {
                let result = self
                    ...
                    .transaction(att::FindByTypeValueReq {
                        ...
                        attribute_value: att::ServiceAttributeValueUuid { uuid: uuid.into() }
                            .try_into()
                            .unwrap(),
                    })
                    .await
        ...
        try_stream!({
            ...
            loop {
                ...
                let last_handle = match find_information_rsp.specialize() {
                    ...
                    Ok(crate::att_packets::FindInformationRspChild::None) => Err(
