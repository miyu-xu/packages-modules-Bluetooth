...
pub enum AttributeValueChild {
    ...
    ServiceAttributeValue16(ServiceAttributeValue16),
    ServiceAttributeValue128(ServiceAttributeValue128),
    IncludeAttributeValue(IncludeAttributeValue),
    IncludeAttributeValue16(IncludeAttributeValue16),
    IncludeAttributeValue128(IncludeAttributeValue128),
    CharacteristicAttributeValue(CharacteristicAttributeValue),
    CharacteristicAttributeValue16(CharacteristicAttributeValue16),
    CharacteristicAttributeValue128(CharacteristicAttributeValue128),
    None,
}
impl AttributeValue {
    pub fn specialize(&self) -> Result<AttributeValueChild, DecodeError> {
        Ok(match () {
            () => AttributeValueChild::ServiceAttributeValue(self.try_into()?),
            () => AttributeValueChild::ServiceAttributeValue16(self.try_into()?),
            () => AttributeValueChild::ServiceAttributeValue128(self.try_into()?),
            () => AttributeValueChild::IncludeAttributeValue(self.try_into()?),
            () => AttributeValueChild::IncludeAttributeValue16(self.try_into()?),
            () => AttributeValueChild::IncludeAttributeValue128(self.try_into()?),
            () => AttributeValueChild::CharacteristicAttributeValue(self.try_into()?),
            () => AttributeValueChild::CharacteristicAttributeValue16(self.try_into()?),
            () => AttributeValueChild::CharacteristicAttributeValue128(self.try_into()?),
...
impl Packet for ErrorRsp {
    fn encoded_len(&self) -> usize {
        3 + self.attribute_handle_in_error.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
...
impl Packet for FindInformationReq {
    fn encoded_len(&self) -> usize {
        1 + self.starting_handle.encoded_len() + self.ending_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl Packet for FindInformationRsp16 {
    fn encoded_len(&self) -> usize {
        2 + self.information_data.iter().map(Packet::encoded_len).sum::<usize>()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        buf.put_u8(self.format());
...
impl Packet for InformationData16 {
    fn encoded_len(&self) -> usize {
        16 + self.attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
...
impl Packet for InformationData128 {
    fn encoded_len(&self) -> usize {
        128 + self.attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.attribute_handle.encode(buf)?;
        self.uuid.encode(buf)?;
...
impl Packet for FindByTypeValueReq {
    fn encoded_len(&self) -> usize {
        17 + self.starting_handle.encoded_len() + self.ending_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl FindByTypeValueRsp {
    fn decode_partial(parent: &Pdu) -> Result<Self, DecodeError> {
        ...
        let mut handles_information_list = Vec::new();
        while !buf.is_empty() {
...
impl Packet for FindByTypeValueRsp {
    fn encoded_len(&self) -> usize {
        1 + self.handles_information_list.iter().map(Packet::encoded_len).sum::<usize>()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl Packet for HandlesInformation {
    fn encoded_len(&self) -> usize {
        self.found_attribute_handle.encoded_len() + self.group_end_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
...
impl ReadByTypeReq {
    fn decode_partial(parent: &Pdu) -> Result<Self, DecodeError> {
        ...
        let (starting_handle, mut buf) = AttributeHandle::decode(buf)?;
        let (ending_handle, mut buf) = AttributeHandle::decode(buf)?;
        let (attribute_type, mut buf) = Uuid::decode(buf)?;
        if buf.is_empty() {
...
impl Packet for ReadByTypeReq {
    fn encoded_len(&self) -> usize {
        1 + self.starting_handle.encoded_len()
            + self.ending_handle.encoded_len()
            + self.attribute_type.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl Packet for ReadReq {
    fn encoded_len(&self) -> usize {
        1 + self.attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl Packet for AttributeData {
    fn encoded_len(&self) -> usize {
        self.attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.attribute_handle.encode(buf)?;
        self.attribute_value.encode(buf)?;
...
impl ReadByGroupTypeReq {
    fn decode_partial(parent: &Pdu) -> Result<Self, DecodeError> {
        ...
        let (starting_handle, mut buf) = AttributeHandle::decode(buf)?;
        let (ending_handle, mut buf) = AttributeHandle::decode(buf)?;
        let (attribute_group_type, mut buf) = Uuid::decode(buf)?;
        if buf.is_empty() {
...
impl Packet for ReadByGroupTypeReq {
    fn encoded_len(&self) -> usize {
        1 + self.starting_handle.encoded_len()
            + self.ending_handle.encoded_len()
            + self.attribute_group_type.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        buf.put_u8(u8::from(self.opcode()));
        self.encode_partial(buf)?;
...
impl Packet for GroupAttributeData {
    fn encoded_len(&self) -> usize {
        self.attribute_handle.encoded_len() + self.end_group_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.attribute_handle.encode(buf)?;
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ServiceAttributeValue {
    pub uuid: Uuid,
}
impl TryFrom<&AttributeValue> for ServiceAttributeValue {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<ServiceAttributeValue, Self::Error> {
        ServiceAttributeValue::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for ServiceAttributeValue {
    type Error = DecodeError;
...
impl TryFrom<&ServiceAttributeValue> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &ServiceAttributeValue) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
...
impl Packet for ServiceAttributeValue {
    fn encoded_len(&self) -> usize {
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ServiceAttributeValue16 {
    pub uuid: Uuid16,
}
impl TryFrom<&AttributeValue> for ServiceAttributeValue16 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<ServiceAttributeValue16, Self::Error> {
        ServiceAttributeValue16::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for ServiceAttributeValue16 {
    type Error = DecodeError;
...
impl TryFrom<&ServiceAttributeValue16> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &ServiceAttributeValue16) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl Packet for ServiceAttributeValue16 {
    fn encoded_len(&self) -> usize {
        16
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ServiceAttributeValue128 {
    pub uuid: Uuid128,
}
impl TryFrom<&AttributeValue> for ServiceAttributeValue128 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<ServiceAttributeValue128, Self::Error> {
        ServiceAttributeValue128::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for ServiceAttributeValue128 {
    type Error = DecodeError;
...
impl TryFrom<&ServiceAttributeValue128> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &ServiceAttributeValue128) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl Packet for ServiceAttributeValue128 {
    fn encoded_len(&self) -> usize {
        128
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct IncludeAttributeValue {
    pub attribute_handle: AttributeHandle,
    pub end_group_handle: AttributeHandle,
    pub uuid: Uuid,
}
impl TryFrom<&AttributeValue> for IncludeAttributeValue {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<IncludeAttributeValue, Self::Error> {
        IncludeAttributeValue::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for IncludeAttributeValue {
    type Error = DecodeError;
...
impl TryFrom<&IncludeAttributeValue> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValue) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl Packet for IncludeAttributeValue {
    fn encoded_len(&self) -> usize {
        self.attribute_handle.encoded_len()
            + self.end_group_handle.encoded_len()
            + self.uuid.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.encode_partial(buf)?;
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct IncludeAttributeValue16 {
    pub attribute_handle: AttributeHandle,
    pub end_group_handle: AttributeHandle,
    pub uuid: Uuid16,
}
impl TryFrom<&AttributeValue> for IncludeAttributeValue16 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<IncludeAttributeValue16, Self::Error> {
        IncludeAttributeValue16::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for IncludeAttributeValue16 {
    type Error = DecodeError;
...
impl TryFrom<&IncludeAttributeValue16> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValue16) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl Packet for IncludeAttributeValue16 {
    fn encoded_len(&self) -> usize {
        16 + self.attribute_handle.encoded_len() + self.end_group_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.encode_partial(buf)?;
        Ok(())
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct IncludeAttributeValue128 {
    pub attribute_handle: AttributeHandle,
    pub end_group_handle: AttributeHandle,
}
impl TryFrom<&AttributeValue> for IncludeAttributeValue128 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<IncludeAttributeValue128, Self::Error> {
        IncludeAttributeValue128::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for IncludeAttributeValue128 {
    type Error = DecodeError;
...
impl TryFrom<&IncludeAttributeValue128> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValue128) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl Packet for IncludeAttributeValue128 {
    fn encoded_len(&self) -> usize {
        self.attribute_handle.encoded_len() + self.end_group_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CharacteristicAttributeValue {
    pub properties: u8,
    pub value_attribute_handle: AttributeHandle,
    pub uuid: Uuid,
}
impl TryFrom<&AttributeValue> for CharacteristicAttributeValue {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<CharacteristicAttributeValue, Self::Error> {
        CharacteristicAttributeValue::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for CharacteristicAttributeValue {
    type Error = DecodeError;
...
impl TryFrom<&CharacteristicAttributeValue> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValue) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl CharacteristicAttributeValue {
    fn decode_partial(parent: &AttributeValue) -> Result<Self, DecodeError> {
        let mut buf: &[u8] = &parent.payload;
        if buf.remaining() < 1 {
            return Err(DecodeError::InvalidLengthError {
                obj: "CharacteristicAttributeValue",
                wanted: 1,
                got: buf.remaining(),
            });
        }
...
impl Packet for CharacteristicAttributeValue {
    fn encoded_len(&self) -> usize {
        1 + self.value_attribute_handle.encoded_len() + self.uuid.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.encode_partial(buf)?;
        Ok(())
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CharacteristicAttributeValue16 {
    pub properties: u8,
    pub value_attribute_handle: AttributeHandle,
    pub uuid: Uuid16,
}
impl TryFrom<&AttributeValue> for CharacteristicAttributeValue16 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<CharacteristicAttributeValue16, Self::Error> {
        CharacteristicAttributeValue16::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for CharacteristicAttributeValue16 {
    type Error = DecodeError;
...
impl TryFrom<&CharacteristicAttributeValue16> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValue16) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl CharacteristicAttributeValue16 {
    fn decode_partial(parent: &AttributeValue) -> Result<Self, DecodeError> {
        let mut buf: &[u8] = &parent.payload;
        if buf.remaining() < 1 {
            return Err(DecodeError::InvalidLengthError {
                obj: "CharacteristicAttributeValue16",
                wanted: 1,
                got: buf.remaining(),
            });
        }
...
impl Packet for CharacteristicAttributeValue16 {
    fn encoded_len(&self) -> usize {
        17 + self.value_attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.encode_partial(buf)?;
        Ok(())
...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CharacteristicAttributeValue128 {
    pub properties: u8,
    pub value_attribute_handle: AttributeHandle,
    pub uuid: Uuid128,
}
impl TryFrom<&AttributeValue> for CharacteristicAttributeValue128 {
    type Error = DecodeError;
    fn try_from(parent: &AttributeValue) -> Result<CharacteristicAttributeValue128, Self::Error> {
        CharacteristicAttributeValue128::decode_partial(&parent)
    }
}
impl TryFrom<AttributeValue> for CharacteristicAttributeValue128 {
    type Error = DecodeError;
...
impl TryFrom<&CharacteristicAttributeValue128> for AttributeValue {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValue128) -> Result<AttributeValue, Self::Error> {
        let mut payload = Vec::new();
        packet.encode_partial(&mut payload)?;
        Ok(AttributeValue { payload })
    }
...
impl CharacteristicAttributeValue128 {
    fn decode_partial(parent: &AttributeValue) -> Result<Self, DecodeError> {
        let mut buf: &[u8] = &parent.payload;
        if buf.remaining() < 1 {
            return Err(DecodeError::InvalidLengthError {
                obj: "CharacteristicAttributeValue128",
                wanted: 1,
                got: buf.remaining(),
            });
        }
...
impl Packet for CharacteristicAttributeValue128 {
    fn encoded_len(&self) -> usize {
        129 + self.value_attribute_handle.encoded_len()
    }
    fn encode(&self, buf: &mut impl BufMut) -> Result<(), EncodeError> {
        self.encode_partial(buf)?;
        Ok(())
