...
impl Into<crate::att_packets::Uuid> for Uuid {
    fn into(self) -> crate::att_packets::Uuid {
        // TODO: remove unwrap by changing PDL
        match self.to_le_bytes() {
            UuidBytes::Uuid16(value) => (&crate::att_packets::Uuid16 { value }).try_into().unwrap(),
            UuidBytes::Uuid128(value) => {
                (&crate::att_packets::Uuid128 { value }).try_into().unwrap()
            }
        }
    }
}

impl From<crate::att_packets::Uuid16> for Uuid {
    fn from(uuid: crate::att_packets::Uuid16) -> Self {
        Self::uuid16(u16::from_le_bytes(uuid.value))
    }
}

impl From<crate::att_packets::Uuid128> for Uuid {
    fn from(uuid: crate::att_packets::Uuid128) -> Self {
