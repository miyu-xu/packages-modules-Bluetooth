...
impl TryFrom<&FindInformationRsp> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&FindInformationRsp> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&FindInformationRsp16> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp16) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&FindInformationRsp16> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp16) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&FindInformationRsp128> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp128) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&FindInformationRsp128> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &FindInformationRsp128) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&ReadReq> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &ReadReq) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&ReadReq> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &ReadReq) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&ReadRsp> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &ReadRsp) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&ReadRsp> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &ReadRsp) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&ServiceAttributeValueUuid> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &ServiceAttributeValueUuid) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&ServiceAttributeValueUuid> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &ServiceAttributeValueUuid) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&IncludeAttributeValueUuid16> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValueUuid16) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&IncludeAttributeValueUuid16> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValueUuid16) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&IncludeAttributeValueUuid128> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValueUuid128) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&IncludeAttributeValueUuid128> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &IncludeAttributeValueUuid128) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&CharacteristicAttributeValueUuid16> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValueUuid16) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&CharacteristicAttributeValueUuid16> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValueUuid16) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
...
impl TryFrom<&CharacteristicAttributeValueUuid128> for Bytes {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValueUuid128) -> Result<Self, Self::Error> {
        packet.encode_to_bytes()
    }
}
impl TryFrom<&CharacteristicAttributeValueUuid128> for Vec<u8> {
    type Error = EncodeError;
    fn try_from(packet: &CharacteristicAttributeValueUuid128) -> Result<Self, Self::Error> {
        packet.encode_to_vec()
    }
