...
static const char kPropertyBtaDmPmSniffMaxIntervalOverwrite[] =
    "bluetooth.core.classic.bta_dm_pm_sniff_max_interval.overwrite";
...
static tBTM_PM_PWR_MD get_sniff_entry(uint8_t index) {
  ...
  uint16_t bta_dm_pm_sniff_max_interval_overwrite = uint16_t(
      osi_property_get_int32(kPropertyBtaDmPmSniffMaxIntervalOverwrite, 0));
  ...
  if (bta_dm_pm_sniff_max_interval_overwrite > 0) {
    pwr_mds_cache[0].max = bta_dm_pm_sniff_max_interval_overwrite;
  }
