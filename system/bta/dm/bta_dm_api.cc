...
void BTA_DmBleObserve(bool start, uint8_t duration,
  ...
  LOG_DEBUG("%s:start = %d ", __func__, start);
...
void BTA_DmBleCsisObserve(bool observe, tBTA_DM_SEARCH_CBACK* p_results_cb) {
  LOG_DEBUG("%s:enable = %d ", __func__, observe);
 ...
 *
 ******************************************************************************/
void BTA_VendorInit(void) { LOG_DEBUG("BTA_VendorInit"); }
...
void BTA_DmClearEventFilter(void) {
  LOG_DEBUG("BTA_DmClearEventFilter");
...
void BTA_DmClearEventMask(void) {
  LOG_DEBUG("BTA_DmClearEventMask");
...
void BTA_DmClearFilterAcceptList(void) {
  LOG_DEBUG("BTA_DmClearFilterAcceptList");
...
void BTA_DmSetEventFilterConnectionSetupAllDevices() {
  LOG_DEBUG("BTA_DmSetEventFilterConnectionSetupAllDevices");
  do_in_main_thread(
      FROM_HERE,
...
void BTA_DmAllowWakeByHid(
  ...
  LOG_DEBUG("BTA_DmAllowWakeByHid");
...
void BTA_DmRestoreFilterAcceptList(
  ...
  LOG_DEBUG("BTA_DmRestoreFilterAcceptList");
...
void BTA_DmSetDefaultEventMaskExcept(uint64_t mask, uint64_t le_mask) {
  LOG_DEBUG("BTA_DmSetDefaultEventMaskExcept");
  do_in_main_thread(
      FROM_HERE,
...
void BTA_DmSetEventFilterInquiryResultAllDevices() {
  LOG_DEBUG("BTA_DmSetEventFilterInquiryResultAllDevices");
  do_in_main_thread(
      FROM_HERE,
