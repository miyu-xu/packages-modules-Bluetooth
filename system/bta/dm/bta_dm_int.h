...
typedef struct {
  ...
  tBTA_DM_SEC_CBACK* p_sec_csis_cback;
...
void bta_dm_ble_csis_sec_cb_register(tBTA_DM_SEC_CBACK*);
void bta_dm_ble_csis_confirm_device_reply(const RawAddress& bd_addr,
                                          bool accept);
