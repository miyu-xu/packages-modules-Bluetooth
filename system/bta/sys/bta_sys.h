...
void bta_sys_start_timer(alarm_t* alarm, uint64_t interval_ms,
...
void bta_sys_sco_close(uint8_t id, uint8_t app_id,
                              const RawAddress& peer_addr);
void bta_sys_sco_use(uint8_t id, uint8_t app_id,
                            const RawAddress& peer_addr);
void bta_sys_sco_unuse(uint8_t id, uint8_t app_id,
                              const RawAddress& peer_addr);
void bta_sys_idle(uint8_t id, uint8_t app_id,
                         const RawAddress& peer_addr);
void bta_sys_busy(uint8_t id, uint8_t app_id,
                         const RawAddress& peer_addr);

void bta_sys_ssr_cfg_register(tBTA_SYS_SSR_CFG_CBACK* p_cback);
void bta_sys_chg_ssr_config(uint8_t id, uint8_t app_id,
...
void bta_sys_collision_register(uint8_t bta_id,
