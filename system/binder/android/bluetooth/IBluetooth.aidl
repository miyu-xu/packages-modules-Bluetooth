...
interface IBluetooth
{
    ...
    // For Socket
    @JavaPassthrough(annotation="@android.annotation.RequiresNoPermission")
    oneway void logL2capcocServerConnection(in BluetoothDevice device, int port, boolean isSecured, int result, long connectionLatencyMillis, long socketCreationLatencyMillis, long socketAcceptanceLatencyMillis, long timeoutMillis, in SynchronousResultReceiver receiver);

    @JavaPassthrough(annotation="@android.annotation.RequiresNoPermission")
    IBluetoothSocketManager getSocketManager();

    @JavaPassthrough(annotation="@android.annotation.RequiresNoPermission")
    oneway void logL2capcocClientConnection(in BluetoothDevice device, int port, boolean isSecured, int result, long endToEndLatencyMillis, long socketCreationLatencyMillis, long socketConnectionLatencyMillis, in SynchronousResultReceiver receiver);
