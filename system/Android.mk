...
$(bluetooth_cert_src_and_bin_zip): $(SOONG_ZIP) \
...
LOCAL_bluetooth_cert_srcs_zip := \
	$(SOONG_OUT_DIR)/.intermediates/packages/modules/Bluetooth/system/BluetoothCertAndSrcs/gen/bluetooth_cert_srcs.zip
...
$(bluetooth_cert_tests_py_package_zip): PRIVATE_bluetooth_cert_srcs_zip := $(LOCAL_bluetooth_cert_srcs_zip)
$(bluetooth_cert_tests_py_package_zip): $(SOONG_ZIP) \
	...
	$(hide) unzip -o -q $(PRIVATE_bluetooth_cert_srcs_zip) -d $(dir $@)bluetooth_cert_tests
