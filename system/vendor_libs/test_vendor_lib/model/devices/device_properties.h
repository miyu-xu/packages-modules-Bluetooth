...
static constexpr uint64_t Page0LmpFeatures() {
  LMPFeaturesPage0Bits features[] = {
      ...
      LMPFeaturesPage0Bits::AFH_CAPABLE_SLAVE,
      LMPFeaturesPage0Bits::AFH_CLASSIFICATION_SLAVE,
      ...
      LMPFeaturesPage0Bits::AFH_CAPABLE_MASTER,
      LMPFeaturesPage0Bits::AFH_CLASSIFICATION_MASTER,
