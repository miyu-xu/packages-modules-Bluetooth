...
HfpClientInterface::Offload* HfpClientInterface::GetOffload(
  ...
  if (bta_ag_get_sco_offload_enabled()) {
    ...
    HfpDecodingTransport::offloading_hal_interface =
        new aidl::BluetoothAudioSinkClientInterface(
            HfpDecodingTransport::instance_, message_loop);
    if (!HfpDecodingTransport::offloading_hal_interface->IsValid()) {
      LOG(FATAL) << __func__
                 << ": BluetoothAudio HAL for HFP offloading is invalid";
      delete HfpDecodingTransport::offloading_hal_interface;
      HfpDecodingTransport::offloading_hal_interface = nullptr;
      delete HfpDecodingTransport::instance_;
      HfpDecodingTransport::instance_ = static_cast<HfpDecodingTransport*>(
          HfpDecodingTransport::software_hal_interface->GetTransportInstance());
      delete HfpDecodingTransport::software_hal_interface;
      HfpDecodingTransport::software_hal_interface = nullptr;
      delete HfpDecodingTransport::instance_;
      return nullptr;
