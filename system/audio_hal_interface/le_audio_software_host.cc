...
void LeAudioClientInterface::Sink::SetPcmParameters(
  ...
  log::info("sample_rate={}, bits_per_sample={}, channels_count={}, data_interval_us={}",
      params.sample_rate, params.bits_per_sample, params.channels_count, params.data_interval_us);
