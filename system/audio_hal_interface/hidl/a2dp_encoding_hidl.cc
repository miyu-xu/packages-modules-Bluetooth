...
bool a2dp_get_selected_hal_codec_config(A2dpCodecConfig* a2dp_config, CodecConfiguration* codec_config) {
...
static bool a2dp_get_selected_hal_pcm_config(A2dpCodecConfig* a2dp_codec_configs, PcmParameters* pcm_config) {
