...
#define LOG_TAG "BTAudioClientLeAudioHIDL"
...
AudioConfiguration_2_2 offload_config_to_hal_audio_config(
  ...
  le_audio_config.config.unicastConfig() = {
      ...
      .lc3Config = {
          .pcmBitDepth =
              le_audio_bit_rate2audio_hal(offload_config.bits_per_sample),
          .samplingFrequency =
              le_audio_sample_rate2audio_hal(offload_config.sampling_rate),
          .frameDuration =
              le_audio_frame_duration2audio_hal(offload_config.frame_duration),
...
void LeAudioTransport::LeAudioSetSelectedHalPcmConfig(uint32_t sample_rate_hz,
  ...
  pcm_config_.bitsPerSample = le_audio_bit_rate2audio_hal(bit_rate);
