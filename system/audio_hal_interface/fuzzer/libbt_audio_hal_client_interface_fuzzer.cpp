...
constexpr SampleRate kSampleRates[] = { SampleRate::RATE_UNKNOWN, SampleRate::RATE_44100,
                                        SampleRate::RATE_48000,   SampleRate::RATE_88200,
                                        SampleRate::RATE_96000,   SampleRate::RATE_176400,
                                        SampleRate::RATE_192000,  SampleRate::RATE_16000,
                                        SampleRate::RATE_24000 };
...
static CodecConfiguration LdacCodecConfigurationsGenerator(FuzzedDataProvider* mFdp) {
  LdacQualityIndex qualityIndexes[] = { LdacQualityIndex::QUALITY_HIGH,
                                        LdacQualityIndex::QUALITY_MID,
                                        LdacQualityIndex::QUALITY_LOW,
