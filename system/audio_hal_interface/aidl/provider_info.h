...
class ProviderInfo {
 public:
   ...
   * by the provider.
   ***/
  std::optional<CodecInfo*> GetCodec(btav_a2dp_codec_index_t codec_index) const;
 ...
 private:
  std::unordered_map<btav_a2dp_codec_index_t, CodecInfo*>
      assigned_source_codec_indexes;
  std::unordered_map<btav_a2dp_codec_index_t, CodecInfo*>
      assigned_sink_codec_indexes;
};
