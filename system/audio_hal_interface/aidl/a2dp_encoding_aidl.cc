...
provider::get_a2dp_configuration(
  ...
  switch (result->parameters.channelMode) {
    ...
    case ChannelMode::STEREO:
      ...
      break;
    default:
      LOG(FATAL) << "unknown channel mode";
      break;
      break;
  }
  switch (result->parameters.samplingFrequencyHz) {
    case 44100:
    ...
    case 24000:
      ...
      break;
    default:
      LOG(FATAL) << "unknown sampling frequency "
                 << result->parameters.samplingFrequencyHz;
      break;
  }

  switch (result->parameters.bitdepth) {
    case 16:
    ...
    case 32:
      ...
      break;
    default:
      LOG(FATAL) << "unknown bit depth " << result->parameters.bitdepth;
      break;
  }
