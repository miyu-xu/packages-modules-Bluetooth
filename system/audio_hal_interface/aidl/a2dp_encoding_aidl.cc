...
bool setup_codec() {
  ...
  if (provider::supports_codec(a2dp_config->codecIndex())) {
    ...
    switch (a2dp_config->codecIndex()) {
      ...
      case BTAV_A2DP_CODEC_INDEX_SOURCE_AAC:
        parameters_start = 3;
        parameters_size = codec_info[0] - 2;
        break;
      default:
        parameters_start = 9;
        parameters_size = codec_info[0] - 8;
        break;
    }

    std::copy(codec_info + parameters_start,
              codec_info + parameters_start + parameters_size,
...
provider::get_a2dp_configuration(
  ...
  for (auto const& sep : remote_seps) {
    ...
    switch (sep.capabilities[2]) {
      ...
      case A2DP_MEDIA_CT_AAC: {
        ...
        capabilities_start = 2;
        capabilities_end = sep.capabilities[0];
        break;
      }
    ...
    capabilities.id = id;
    std::copy(sep.capabilities + capabilities_start,
  ...
  switch (user_preferences.channel_mode) {
    case BTAV_A2DP_CODEC_CHANNEL_MODE_MONO:
      hint.codecParameters.channelMode = ChannelMode::MONO;
      break;
    case BTAV_A2DP_CODEC_CHANNEL_MODE_STEREO:
      hint.codecParameters.channelMode = ChannelMode::STEREO;
      break;
    default:
      break;
  }
  switch (user_preferences.sample_rate) {
    case BTAV_A2DP_CODEC_SAMPLE_RATE_44100:
      hint.codecParameters.samplingFrequencyHz = 44100;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_48000:
      hint.codecParameters.samplingFrequencyHz = 48000;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_88200:
      hint.codecParameters.samplingFrequencyHz = 88200;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_96000:
      hint.codecParameters.samplingFrequencyHz = 96000;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_176400:
      hint.codecParameters.samplingFrequencyHz = 176400;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_192000:
      hint.codecParameters.samplingFrequencyHz = 192000;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_16000:
      hint.codecParameters.samplingFrequencyHz = 16000;
      break;
    case BTAV_A2DP_CODEC_SAMPLE_RATE_24000:
      hint.codecParameters.samplingFrequencyHz = 24000;
      break;
    default:
      break;
  }
  switch (user_preferences.bits_per_sample) {
    case BTAV_A2DP_CODEC_BITS_PER_SAMPLE_16:
      hint.codecParameters.bitdepth = 16;
      break;
    case BTAV_A2DP_CODEC_BITS_PER_SAMPLE_24:
      hint.codecParameters.bitdepth = 24;
      break;
    case BTAV_A2DP_CODEC_BITS_PER_SAMPLE_32:
      hint.codecParameters.bitdepth = 32;
      break;
    default:
      break;
  }
  ...
  // remote capabilities.
  auto result = active_hal_interface->GetA2dpConfiguration(
  ...
  a2dp_configuration.codec_index =
      provider_info->SourceCodecIndex(result->id).value();
  a2dp_configuration.codec_config = result->configuration;
