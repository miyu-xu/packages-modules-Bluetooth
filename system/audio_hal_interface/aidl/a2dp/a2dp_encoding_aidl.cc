...
public:
  ...
  void SourceMetadataChanged(bool is_gaming_mode);
...
void A2dpTransport::SourceMetadataChanged(bool is_gaming_mode) {
  stream_callbacks_->UpdateSourceMetadata(is_gaming_mode);
}
