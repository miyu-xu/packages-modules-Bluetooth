...
static bool is_valid_audio_location(std::optional<AudioChannelAllocation> audio_location,
...
static uint32_t get_audio_location(std::optional<AudioChannelAllocation> audio_location,
                                   AudioLocation supported_channel) {
  if (audio_location.has_value()) {
