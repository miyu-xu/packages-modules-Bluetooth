...
PrepareReferenceAseConfigurationSetting(
  ...
  if (source_locations) {
    ...
    auto is_left = source_locations.value() & le_audio::codec_spec_conf::kLeAudioLocationFrontLeft;
    auto is_right =
            source_locations.value() & le_audio::codec_spec_conf::kLeAudioLocationFrontRight;
    auto [aidl_ase_config_source, stack_ase_config_source] =
            PrepareReferenceAseDirectionConfigLc3(is_left, is_right, true);
