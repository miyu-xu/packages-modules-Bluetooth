...
std::
    vector<::aidl::android::hardware::bluetooth::audio::CodecSpecificConfigurationLtv> static GetAidlCodecSpecificConfigurationFromStack(
...
::aidl::android::hardware::bluetooth::audio::IBluetoothAudioProvider::
  ...
  if (sink_reqs) {
    ...
    for (auto const& stack_req : *sink_reqs) {
      ...
      // TODO: Add the codec enforcement mechanism in the stack
  ...
  // TODO: Add the feature flags mechanism in the stack
  // aidl_reqs.flags
