...
GetStackBroadcastConfigurationFromAidlFormat(
  ...
  ::bluetooth::le_audio::broadcaster::BroadcastConfiguration cfg{
    ...
    .qos = ::bluetooth::le_audio::broadcaster::BroadcastQosConfig(setting.retransmitionNum,
...
::bluetooth::le_audio::types::DataPathConfiguration GetStackDataPathFromAidlFormat(
  ...
  auto config = ::bluetooth::le_audio::types::
            DataPathConfiguration{ .dataPathId = static_cast<uint8_t>(dp.dataPathId),
                                   .dataPathConfig = {},
                                   .isoDataPathConfig = {
                                           .codecId = GetStackCodecIdFromAidlFormat(
                                                   dp.isoDataPathConfiguration.codecId),
                                           .isTransparent =
                                                   dp.isoDataPathConfiguration.isTransparent,
                                           .controllerDelayUs =
                                                   (uint32_t)dp.isoDataPathConfiguration
                                                           .controllerDelayUs,
                                           .configuration = {},
                                   } };
