...
ndk::ScopedAStatus BluetoothAudioPortImpl::startConfirmation(bool status) {
  return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus BluetoothAudioPortImpl::suspendConfirmation(bool status) {
  return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus BluetoothAudioPortImpl::updateSinklatency(int latencyMs) {
  return ndk::ScopedAStatus::ok();
}
