...
void Device::RegisterInterfaces(
  ...
  log::assert_that(media_interface, "assert failed: media_interface");
  log::assert_that(a2dp_interface, "assert failed: a2dp_interface");
...
void Device::VendorPacketHandler(uint8_t label,
  ...
  log::assert_that(media_interface_, "assert failed: media_interface_");
