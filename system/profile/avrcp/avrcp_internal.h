...
class A2dpInterface {
 public:
  ...
  virtual void connect_delayed(uint8_t handle, const RawAddress& peer_address,
                               bool peer_sink_supported,
                               bool peer_source_supported) = 0;
  virtual uint16_t find_audio_source_service(const RawAddress& peer_address,
