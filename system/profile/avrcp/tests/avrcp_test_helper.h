...
class MockAvrcpInterface : public AvrcpInterface {
  ...
  MOCK_METHOD8(AddRecord,
               uint16_t(uint16_t, const char*, const char*, uint16_t, uint32_t, bool, uint16_t,
                        uint16_t));
...
class MockSdpInterface : public SdpInterface {
  ...
  MOCK_METHOD6(InitDiscoveryDb,
               bool(tSDP_DISCOVERY_DB*, uint32_t, uint16_t, const bluetooth::Uuid*, uint16_t,
                    uint16_t*));
