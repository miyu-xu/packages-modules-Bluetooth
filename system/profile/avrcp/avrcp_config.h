...
#define AVRCP_SUPF_TG_1_5 (AVRC_SUPF_TG_CAT1 | AVRC_SUPF_TG_MULTI_PLAYER | \
                          AVRC_SUPF_TG_APP_SETTINGS | AVRC_SUPF_TG_BROWSE)
#endif

// Supported Features for AVRCP Version 1.4
#ifndef AVRCP_SUPF_TG_1_4
#define AVRCP_SUPF_TG_1_4 (AVRC_SUPF_TG_CAT1 | AVRC_SUPF_TG_MULTI_PLAYER | \
                          AVRC_SUPF_TG_APP_SETTINGS | AVRC_SUPF_TG_BROWSE)
#endif
