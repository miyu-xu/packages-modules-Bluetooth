...
typedef struct device_iot_config_section_iter_t
    device_iot_config_section_iter_t;

bool device_iot_config_has_section(const char* section);
bool device_iot_config_exist(const char* section, const char* key);
bool device_iot_config_get_int(const char* section, const char* key,
                               int* value);
bool device_iot_config_addr_get_int(const RawAddress& peer_addr,
                                    const char* key, int* value);
bool device_iot_config_set_int(const char* section, const char* key, int value);
bool device_iot_config_addr_set_int(const RawAddress& peer_addr,
                                    const char* key, int value);
bool device_iot_config_int_add_one(const char* section, const char* key);
bool device_iot_config_addr_int_add_one(const RawAddress& peer_addr,
                                        const char* key);

bool device_iot_config_get_hex(const char* section, const char* key,
                               int* value);
bool device_iot_config_addr_get_hex(const RawAddress& peer_addr,
                                    const char* key, int* value);
bool device_iot_config_set_hex(const char* section, const char* key, int value,
                               int byte_num);
...
bool device_iot_config_addr_set_hex_if_greater(const RawAddress& peer_addr,
                                               const char* key, int value,
                                               int byte_num);
bool device_iot_config_get_str(const char* section, const char* key,
                               char* value, int* size_bytes);
bool device_iot_config_set_str(const char* section, const char* key,
                               const char* value);
...
// const device_iot_config_section_iter_t*
// device_iot_config_section_begin(void); const
// device_iot_config_section_iter_t* device_iot_config_section_end(void); const
// device_iot_config_section_iter_t* device_iot_config_section_next(const
// device_iot_config_section_iter_t* section); const char*
// device_iot_config_section_name(const device_iot_config_section_iter_t*
// section);
