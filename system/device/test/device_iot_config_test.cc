...
TEST_F(DeviceIotConfigDisabledTest, test_device_iot_config_disabled) {
...

  {
    ...
    EXPECT_FALSE(device_iot_config_has_section(NULL));
...

  {
    ...
    EXPECT_FALSE(device_iot_config_exist(NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_get_int(NULL, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_get_int(peer_addr, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_set_int(NULL, NULL, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_set_int(peer_addr, NULL, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_int_add_one(NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_int_add_one(peer_addr, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_get_hex(NULL, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_get_hex(peer_addr, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_set_hex(NULL, NULL, 0, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_set_hex(peer_addr, NULL, 0, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(
        device_iot_config_addr_set_hex_if_greater(peer_addr, NULL, 0, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_get_str(NULL, NULL, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_set_str(NULL, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_set_str(peer_addr, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_get_bin(NULL, NULL, NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_set_bin(NULL, NULL, NULL, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_addr_set_bin(peer_addr, NULL, NULL, 0));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_FALSE(device_iot_config_remove(NULL, NULL));
    EXPECT_TRUE(mock_function_count_map.empty());
  }

  {
    ...
    EXPECT_EQ(device_iot_config_get_bin_length(NULL, NULL), 0u);
    EXPECT_TRUE(mock_function_count_map.empty());
  }
