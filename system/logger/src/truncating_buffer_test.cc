...
TEST(TruncatingBufferTest, 1byte) {
  ...
  logger::truncating_buffer<2> buffer_1;
  logger::truncating_buffer<3> buffer_2;
...
TEST(TruncatingBufferTest, 2bytes) {
  ...
  logger::truncating_buffer<3> buffer_1;
  logger::truncating_buffer<4> buffer_2;
  logger::truncating_buffer<5> buffer_3;
...
TEST(TruncatingBufferTest, 3bytes) {
  ...
  logger::truncating_buffer<4> buffer_1;
  logger::truncating_buffer<5> buffer_2;
  logger::truncating_buffer<6> buffer_3;
  logger::truncating_buffer<7> buffer_4;
...
TEST(TruncatingBufferTest, 4bytes) {
  ...
  logger::truncating_buffer<5> buffer_1;
  logger::truncating_buffer<6> buffer_2;
  logger::truncating_buffer<7> buffer_3;
  logger::truncating_buffer<8> buffer_4;
  logger::truncating_buffer<9> buffer_5;
