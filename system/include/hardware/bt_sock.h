...
typedef enum {
  BTSOCK_ERROR_UNKNOWN = 0,
  BTSOCK_ERROR_NONE = 1,
  BTSOCK_ERROR_SERVER_START_FAILURE = 2,
  BTSOCK_ERROR_CLIENT_INIT_FAILURE = 3,
  BTSOCK_ERROR_LISTEN_FAILURE = 4,
  BTSOCK_ERROR_CONNECTION_FAILURE = 5,
  BTSOCK_ERROR_OPEN_FAILURE = 6,
  BTSOCK_ERROR_OFFLOAD_SERVER_NOT_ACCEPTING = 7,
  BTSOCK_ERROR_OFFLOAD_HAL_OPEN_FAILURE = 8,
  BTSOCK_ERROR_SEND_TO_APP_FAILURE = 9,
  BTSOCK_ERROR_RECEIVE_DATA_FAILURE = 10,
  BTSOCK_ERROR_READ_SIGNALED_FAILURE = 11,
  BTSOCK_ERROR_WRITE_SIGNALED_FAILURE = 12,
  BTSOCK_ERROR_SEND_SCN_FAILURE = 13,
  BTSOCK_ERROR_SCN_ALLOCATION_FAILURE = 14,
  BTSOCK_ERROR_ADD_SDP_FAILURE = 15,
  BTSOCK_ERROR_SDP_DISCOVERY_FAILURE = 16,
} btsock_error_code_t;
