 ...
 */
typedef enum {
  BTAV_A2DP_CODEC_INDEX_SOURCE_MIN = BT_CODEC_INDEX_SOURCE_MIN,

  // Add an entry for each source codec here.
  // NOTE: The values should be same as those listed in the following file:
  //   BluetoothCodecConfig.java
  BTAV_A2DP_CODEC_INDEX_SOURCE_SBC = BT_CODEC_INDEX_SOURCE_SBC,
  BTAV_A2DP_CODEC_INDEX_SOURCE_AAC = BT_CODEC_INDEX_SOURCE_AAC,
  BTAV_A2DP_CODEC_INDEX_SOURCE_APTX = BT_CODEC_INDEX_SOURCE_APTX,
  BTAV_A2DP_CODEC_INDEX_SOURCE_APTX_HD = BT_CODEC_INDEX_SOURCE_APTX_HD,
  BTAV_A2DP_CODEC_INDEX_SOURCE_LDAC = BT_CODEC_INDEX_SOURCE_LDAC,

  BTAV_A2DP_CODEC_INDEX_SOURCE_MAX = BT_CODEC_INDEX_SOURCE_MAX,

  BTAV_A2DP_CODEC_INDEX_SINK_MIN = BT_CODEC_INDEX_SINK_MIN,

  // Add an entry for each sink codec here
  BTAV_A2DP_CODEC_INDEX_SINK_SBC = BT_CODEC_INDEX_SINK_SBC,
  BTAV_A2DP_CODEC_INDEX_SINK_AAC = BT_CODEC_INDEX_SINK_AAC,
  BTAV_A2DP_CODEC_INDEX_SINK_LDAC = BT_CODEC_INDEX_SINK_LDAC,
