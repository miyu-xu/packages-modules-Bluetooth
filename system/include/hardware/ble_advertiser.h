...
class BleAdvertiserInterface {
 public:
  ...
  using StatusCallback = base::RepeatingCallback<void(uint8_t /* status */)>;
  using IdStatusCallback = base::RepeatingCallback<void(
      uint8_t /* advertiser_id */, uint8_t /* status */)>;
  using IdTxPowerStatusCallback = base::RepeatingCallback<void(
      uint8_t /* advertiser_id */, int8_t /* tx_power */,
      uint8_t /* status */)>;
  using ParametersCallback = base::RepeatingCallback<void(
