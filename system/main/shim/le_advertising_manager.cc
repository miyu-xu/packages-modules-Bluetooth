...
class BleAdvertiserInterfaceImpl : public BleAdvertiserInterface,
 ...
 public:
  ...
  const bluetooth::common::RepeatingCallback<void(Address, AddressType)>
      scan_callback =
          bluetooth::common::Bind(&BleAdvertiserInterfaceImpl::on_scan,
                                  bluetooth::common::Unretained(this));

  const bluetooth::common::RepeatingCallback<void(ErrorCode, uint8_t, uint8_t)>
  ...
  void OnAdvertisingSetStarted(int reg_id, uint8_t advertiser_id,
    ...
    do_in_jni_thread(
        FROM_HERE,
        base::BindRepeating(&AdvertisingCallbacks::OnAdvertisingSetStarted,
  ...
  void OnAdvertisingEnabled(uint8_t advertiser_id, bool enable,
    ...
    do_in_jni_thread(FROM_HERE, base::BindRepeating(
                                    &AdvertisingCallbacks::OnAdvertisingEnabled,
  ...
  void OnAdvertisingDataSet(uint8_t advertiser_id, uint8_t status) {
    do_in_jni_thread(FROM_HERE, base::BindRepeating(
                                    &AdvertisingCallbacks::OnAdvertisingDataSet,
                                    base::Unretained(advertising_callbacks_),
  ...
  void OnScanResponseDataSet(uint8_t advertiser_id, uint8_t status) {
    do_in_jni_thread(
        FROM_HERE,
        base::BindRepeating(&AdvertisingCallbacks::OnScanResponseDataSet,
                            base::Unretained(advertising_callbacks_),
                            advertiser_id, status));
  }
  ...
  void OnPeriodicAdvertisingDataSet(uint8_t advertiser_id, uint8_t status) {
    do_in_jni_thread(
        FROM_HERE,
        base::BindRepeating(&AdvertisingCallbacks::OnPeriodicAdvertisingDataSet,
                            base::Unretained(advertising_callbacks_),
                            advertiser_id, status));
  }
  ...
  void OnPeriodicAdvertisingEnabled(uint8_t advertiser_id, bool enable,
    ...
    do_in_jni_thread(
        FROM_HERE,
        base::BindRepeating(&AdvertisingCallbacks::OnPeriodicAdvertisingEnabled,
                            base::Unretained(advertising_callbacks_),
                            advertiser_id, enable, status));
  }
  ...
  void OnOwnAddressRead(uint8_t advertiser_id, uint8_t address_type,
    ...
    do_in_jni_thread(FROM_HERE, base::BindRepeating(
                                    &AdvertisingCallbacks::OnOwnAddressRead,
                                    base::Unretained(advertising_callbacks_),
