...
class ConnectAddressWithType : public bluetooth::common::IRedactedLoggable {
 public:
  ...
  std::string const ToStringForLogging() const override {
    std::stringstream ss;
    ss << address_.ToStringForLogging() << "["
       << FilterAcceptListAddressTypeText(type_) << "]";
    return ss.str();
  }
  std::string const ToRedactedStringForLogging() const override {
    std::stringstream ss;
    ss << address_.ToStringForLogging() << "["
       << FilterAcceptListAddressTypeText(type_) << "]";
    return ss.str();
