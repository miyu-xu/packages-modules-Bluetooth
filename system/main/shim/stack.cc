...
void Stack::Stop() {
  ...
  if (!com::android::bluetooth::flags::same_handler_for_all_modules()) {
    // Clear the handler only if the flag is not defined, otherwise it will be cleared by the registry
  ...
  if (!com::android::bluetooth::flags::same_handler_for_all_modules()) {
    // delete the handler only if the flag is not defined, otherwise it will be deleted by the registry
