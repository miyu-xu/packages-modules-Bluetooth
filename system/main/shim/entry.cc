...
hci::HciInterface* GetHciLayer() {
  return Stack::GetInstance()->GetInstance<hci::HciLayer>();
}
...
hal::SnoopLogger* GetSnoopLogger() {
  return Stack::GetInstance()->GetInstance<hal::SnoopLogger>();
}
...
hci::AclManager* GetAclManager() {
  return Stack::GetInstance()->GetInstance<hci::AclManager>();
}
