...
public:
  ...
  bool NotifyAclConnectionStateChange(int aclHandle, bluetooth::hci::AclLinkType linkType,
                                      bluetooth::hci::ConnectionState state) {
  ...
  bool NotifyAclPowerModeChange(int aclHandle, bluetooth::hci::AclPowerMode powerMode,
                                int interval) {
  ...
  void onReceiveSocketCloseRequest(bluetooth::Uuid /*socket_id*/,
