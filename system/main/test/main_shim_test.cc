...
protected:
  void SetUp() override {
    ...
    /* extern */ test::mock_lpp_offload_manager_ =
            new bluetooth::hci::testing::MockLppOffloadManager();
  }
  void TearDown() override {
    ...
    delete test::mock_lpp_offload_manager_;
    test::mock_lpp_offload_manager_ = nullptr;
