...
class ConcretePacket : public ::bluetooth::Packet {
 public:
  ...
  std::pair<size_t, size_t> GetPayloadIndices() const override {
    // Implement the GetPayloadIndices method logic
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  // Creating a packet using a shared_ptr to the concrete subclass
