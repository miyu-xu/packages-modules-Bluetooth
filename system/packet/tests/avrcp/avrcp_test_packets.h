...
std::vector<uint8_t> get_capabilities_response_events_supported = { 0x0c, 0x48, 0x00, 0x00, 0x19,
                                                                    0x58, 0x10, 0x00, 0x00, 0x05,
                                                                    0x03, 0x03, 0x01, 0x02, 0x05 };

// AVRCP Get Element Attributes request for current playing song and attribute
// Title
std::vector<uint8_t> get_element_attributes_request_partial = { 0x01, 0x48, 0x00, 0x00, 0x19, 0x58,
                                                                0x20, 0x00, 0x00, 0x0d, 0x00, 0x00,
...
std::vector<uint8_t> get_element_attributes_request_full = {
  0x01, 0x48, 0x00, 0x00, 0x19, 0x58, 0x20, 0x00, 0x00, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00,
  0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x06
};
...
std::vector<uint8_t> list_player_application_setting_attributes_request = { 0x01, 0x48, 0x00, 0x00,
                                                                            0x19, 0x58, 0x11, 0x00,
                                                                            0x00, 0x00 };
...
std::vector<uint8_t> register_play_status_notification = { 0x03, 0x48, 0x00, 0x00, 0x19,
                                                           0x58, 0x31, 0x00, 0x00, 0x05,
                                                           0x01, 0x00, 0x00, 0x00, 0x05 };

// AVRCP Register Volume Changed Notification
std::vector<uint8_t> register_volume_changed_notification = { 0x03, 0x48, 0x00, 0x00, 0x19,
                                                              0x58, 0x31, 0x00, 0x00, 0x05,
...
std::vector<uint8_t> interim_track_changed_notification = { 0x0f, 0x48, 0x00, 0x00, 0x19,
                                                            0x58, 0x31, 0x00, 0x00, 0x09,
                                                            0x02, 0x01, 0x02, 0x03, 0x04,
                                                            0x05, 0x06, 0x07, 0x08 };

// AVRCP Changed Playback Position Notification
std::vector<uint8_t> changed_play_pos_notification = { 0x0d, 0x48, 0x00, 0x00, 0x19,
                                                       0x58, 0x31, 0x00, 0x00, 0x05,
                                                       0x05, 0x00, 0x00, 0x00, 0x00 };

// AVRCP Interim Changed Player Setting Notification
std::vector<uint8_t> interim_changed_player_setting_notification = { 0x0f, 0x48, 0x00, 0x00, 0x19,
                                                                     0x58, 0x31, 0x00, 0x00, 0x0a,
                                                                     0x08, 0x04, 0x01, 0x01, 0x02,
                                                                     0x01, 0x03, 0x01, 0x04, 0x01 };
...
// player ID 1
std::vector<uint8_t> interim_addressed_player_notification = { 0x0f, 0x48, 0x00, 0x00, 0x19,
                                                               0x58, 0x31, 0x00, 0x00, 0x05,
                                                               0x0b, 0x00, 0x01, 0x00, 0x00 };

// AVRCP Interim UIDs Changed Notification
std::vector<uint8_t> interim_uids_notificaiton = { 0x0f, 0x48, 0x00, 0x00, 0x19, 0x58, 0x31,
...
std::vector<uint8_t> get_folder_items_request_now_playing = { 0x71, 0x00, 0x0a, 0x03, 0x00,
...
std::vector<uint8_t> get_folder_items_media_player_response = {
  0x71, 0x00, 0x3c, 0x04, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x34, 0x00, 0x01, 0x01, 0x00, 0x00,
  0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb7, 0x01, 0x0c, 0x0a, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x6a, 0x00, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
  0x65, 0x2e, 0x61, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64, 0x2e, 0x6d, 0x75, 0x73, 0x69, 0x63
};
...
std::vector<uint8_t> get_item_attributes_request_all_attributes_with_cover_art = {
  0x73, 0x00, 0x2C, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x08, 0x00,
  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00,
  0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x08
};
