...
static size_t samples_per_ticks(size_t microseconds, uint32_t sample_rate,
                                size_t channel_count) {
  return microseconds * sample_rate * channel_count / 1000000;
}
...
int adev_open_output_stream(struct audio_hw_device* dev,
  ...
  *stream_out = nullptr;
  ...
  out->frames_count_ =
      samples_per_ticks(out->preferred_data_interval_us, out->sample_rate_, 1);
