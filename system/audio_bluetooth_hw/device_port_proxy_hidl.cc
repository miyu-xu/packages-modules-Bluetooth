...
bool BluetoothAudioPortHidl::init_session_type(audio_devices_t device) {
  ...
  if (!BluetoothAudioSessionControl_2_2::IsSessionReady(session_type_hidl_)) {
...
void BluetoothAudioPortHidl::TearDown() {
  ...
  LOG(INFO) << __func__ << ": session_type=" << toString(session_type_hidl_)
            << ", cookie=" << StringPrintf("%#hx", cookie_);
  BluetoothAudioSessionControl_2_2::UnregisterControlResultCback(
...
bool BluetoothAudioPortHidl::GetPreferredDataIntervalUs(
  ...
  const ::android::hardware::bluetooth::audio::V2_2::AudioConfiguration&
      hal_audio_cfg =
          BluetoothAudioSessionControl_2_2::GetAudioConfig(session_type_hidl_);
...
bool BluetoothAudioPortHidl::Start() {
  ...
  if (state_ == BluetoothStreamState::STANDBY) {
    ...
    if (BluetoothAudioSessionControl_2_2::StartStream(session_type_hidl_)) {
...
bool BluetoothAudioPortHidl::Suspend() {
  ...
  if (state_ == BluetoothStreamState::STARTED) {
    ...
    if (BluetoothAudioSessionControl_2_2::SuspendStream(session_type_hidl_)) {
...
void BluetoothAudioPortHidl::Stop() {
  ...
  LOG(INFO) << __func__ << ": session_type=" << toString(session_type_hidl_)
            ...
            << ", state=" << state_ << " request";
  state_ = BluetoothStreamState::DISABLED;
  BluetoothAudioSessionControl_2_2::StopStream(session_type_hidl_);
  LOG(INFO) << __func__ << ": session_type=" << toString(session_type_hidl_)
            << ", cookie=" << StringPrintf("%#hx", cookie_)
            << ", state=" << state_ << " done";
}
...
void BluetoothAudioPortHidl::UpdateMetadata(
  ...
  BluetoothAudioSessionControl_2_2::UpdateTracksMetadata(session_type_hidl_,
                                                         source_metadata);
}

void BluetoothAudioPortHidl::UpdateSinkMetadata(
  ...
  BluetoothAudioSessionControl_2_2::UpdateSinkMetadata(session_type_hidl_,
                                                       sink_metadata);
}
...
size_t BluetoothAudioPortHidlOut::WriteData(const void* buffer,
  ...
  if (!BluetoothAudioPortHidl::is_stereo_to_mono_) {
    return BluetoothAudioSessionControl_2_2::OutWritePcmData(session_type_hidl_,
                                                             buffer, bytes);
  }
...
size_t BluetoothAudioPortHidlIn::ReadData(void* buffer, size_t bytes) const {
  if (!BluetoothAudioPortHidl::in_use()) return 0;
  return BluetoothAudioSessionControl_2_2::InReadPcmData(session_type_hidl_,
                                                         buffer, bytes);
}
