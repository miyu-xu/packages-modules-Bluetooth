...
class Dck:
    ...
    def Register(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> empty_pb2.Empty:
...
class DckServicer:
    def Register(self, request: empty_pb2.Empty, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_DckServicer_to_server(servicer: DckServicer, server: grpc.Server) -> None:
    rpc_method_handlers = {
