...
class LeAudio:
    ...
    def Open(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
...
class LeAudioServicer:
    async def Open(self, request: le_audio_pb2.OpenRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_LeAudioServicer_to_server(servicer: LeAudioServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
