...
class HID:
    ...
    def SendHostReport(self, address: bytes = b'', report_type: hid_pb2.HidReportType = HID_REPORT_TYPE_UNSPECIFIED, report: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hid_pb2.SendHostReportResponse]:
...
class HIDServicer:
    async def SendHostReport(self, request: hid_pb2.SendHostReportRequest, context: grpc.ServicerContext) -> hid_pb2.SendHostReportResponse:
