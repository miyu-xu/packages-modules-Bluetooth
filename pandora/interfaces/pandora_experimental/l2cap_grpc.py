...
class L2CAP:
    ...
    def CreateLECreditBasedChannel(self, connection: host_pb2.Connection = host_pb2.Connection(), psm: int = 0, secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.CreateLECreditBasedChannelResponse:
    ...
    def SendData(self, connection: host_pb2.Connection = host_pb2.Connection(), data: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.SendDataResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ReceiveData(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.ReceiveDataResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ListenL2CAPChannel(self, connection: host_pb2.Connection = host_pb2.Connection(), secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.ListenL2CAPChannelResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptL2CAPChannel(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.AcceptL2CAPChannelResponse:
        return self.channel.unary_unary(  # type: ignore
...
class L2CAPServicer:
    def CreateLECreditBasedChannel(self, request: l2cap_pb2.CreateLECreditBasedChannelRequest, context: grpc.ServicerContext) -> l2cap_pb2.CreateLECreditBasedChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def SendData(self, request: l2cap_pb2.SendDataRequest, context: grpc.ServicerContext) -> l2cap_pb2.SendDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def ReceiveData(self, request: l2cap_pb2.ReceiveDataRequest, context: grpc.ServicerContext) -> l2cap_pb2.ReceiveDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def ListenL2CAPChannel(self, request: l2cap_pb2.ListenL2CAPChannelRequest, context: grpc.ServicerContext) -> l2cap_pb2.ListenL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def AcceptL2CAPChannel(self, request: l2cap_pb2.AcceptL2CAPChannelRequest, context: grpc.ServicerContext) -> l2cap_pb2.AcceptL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
