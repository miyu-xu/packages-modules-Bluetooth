...
class PAN:
    ...
    def EnableTethering(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[pan_pb2.EnableTetheringResponse]:
    ...
    def ConnectPan(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[pan_pb2.ConnectPanResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class PANServicer:
    async def EnableTethering(self, request: pan_pb2.EnableTetheringRequest, context: grpc.ServicerContext) -> pan_pb2.EnableTetheringResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ConnectPan(self, request: pan_pb2.ConnectPanRequest, context: grpc.ServicerContext) -> pan_pb2.ConnectPanResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
