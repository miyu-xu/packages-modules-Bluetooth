...
class Os:
    ...
    def Log(self, text: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> os_pb2.LogResponse:
    ...
    def SetAccessPermission(self, address: bytes = b'', access_type: os_pb2.AccessType = ACCESS_MESSAGE, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> empty_pb2.Empty:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SendPing(self, ip_address: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> empty_pb2.Empty:
        return self.channel.unary_unary(  # type: ignore
            '/pandora.Os/SendPing',
...
class OsServicer:
    def Log(self, request: os_pb2.LogRequest, context: grpc.ServicerContext) -> os_pb2.LogResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def SetAccessPermission(self, request: os_pb2.SetAccessPermissionRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def SendPing(self, request: os_pb2.SendPingRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_OsServicer_to_server(servicer: OsServicer, server: grpc.Server) -> None:
    rpc_method_handlers = {
