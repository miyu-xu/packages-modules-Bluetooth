...
class Opp:
    ...
    def OpenRfcommChannel(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
    ...
    def OpenL2capChannel(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptPutOperation(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[opp_pb2.AcceptPutOperationResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class OppServicer:
    async def OpenRfcommChannel(self, request: opp_pb2.OpenRfcommChannelRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def OpenL2capChannel(self, request: opp_pb2.OpenL2capChannelRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AcceptPutOperation(self, request: empty_pb2.Empty, context: grpc.ServicerContext) -> opp_pb2.AcceptPutOperationResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_OppServicer_to_server(servicer: OppServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
