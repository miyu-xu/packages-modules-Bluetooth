...
class HFP:
    ...
    def MakeCall(self, number: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.MakeCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AnswerCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.AnswerCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DeclineCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.DeclineCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetAudioPath(self, audio_path: hfp_pb2.AudioPath = AUDIO_PATH_UNKNOWN, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SetAudioPathResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SwapActiveCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SwapActiveCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetInBandRingtone(self, enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SetInBandRingtoneResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetVoiceRecognition(self, connection: host_pb2.Connection = host_pb2.Connection(), enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SetVoiceRecognitionResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ClearCallHistory(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.ClearCallHistoryResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AnswerCallAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.AnswerCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def EndCallAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.EndCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DeclineCallAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.DeclineCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ConnectToAudioAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.ConnectToAudioAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DisconnectFromAudioAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.DisconnectFromAudioAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def MakeCallAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), number: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.MakeCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def CallTransferAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.CallTransferAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetVoiceRecognitionAsHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SetVoiceRecognitionAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SendDtmfFromHandsfree(self, connection: host_pb2.Connection = host_pb2.Connection(), code: int = 0, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[hfp_pb2.SendDtmfFromHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class HFPServicer:
    ...
    async def SetBatteryLevel(self, request: hfp_pb2.SetBatteryLevelRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def MakeCall(self, request: hfp_pb2.MakeCallRequest, context: grpc.ServicerContext) -> hfp_pb2.MakeCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AnswerCall(self, request: hfp_pb2.AnswerCallRequest, context: grpc.ServicerContext) -> hfp_pb2.AnswerCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DeclineCall(self, request: hfp_pb2.DeclineCallRequest, context: grpc.ServicerContext) -> hfp_pb2.DeclineCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetAudioPath(self, request: hfp_pb2.SetAudioPathRequest, context: grpc.ServicerContext) -> hfp_pb2.SetAudioPathResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SwapActiveCall(self, request: hfp_pb2.SwapActiveCallRequest, context: grpc.ServicerContext) -> hfp_pb2.SwapActiveCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetInBandRingtone(self, request: hfp_pb2.SetInBandRingtoneRequest, context: grpc.ServicerContext) -> hfp_pb2.SetInBandRingtoneResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetVoiceRecognition(self, request: hfp_pb2.SetVoiceRecognitionRequest, context: grpc.ServicerContext) -> hfp_pb2.SetVoiceRecognitionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ClearCallHistory(self, request: hfp_pb2.ClearCallHistoryRequest, context: grpc.ServicerContext) -> hfp_pb2.ClearCallHistoryResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AnswerCallAsHandsfree(self, request: hfp_pb2.AnswerCallAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.AnswerCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def EndCallAsHandsfree(self, request: hfp_pb2.EndCallAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.EndCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DeclineCallAsHandsfree(self, request: hfp_pb2.DeclineCallAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.DeclineCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ConnectToAudioAsHandsfree(self, request: hfp_pb2.ConnectToAudioAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.ConnectToAudioAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DisconnectFromAudioAsHandsfree(self, request: hfp_pb2.DisconnectFromAudioAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.DisconnectFromAudioAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def MakeCallAsHandsfree(self, request: hfp_pb2.MakeCallAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.MakeCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def CallTransferAsHandsfree(self, request: hfp_pb2.CallTransferAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.CallTransferAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def EnableSlcAsHandsfree(self, request: hfp_pb2.EnableSlcAsHandsfreeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DisableSlcAsHandsfree(self, request: hfp_pb2.DisableSlcAsHandsfreeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetVoiceRecognitionAsHandsfree(self, request: hfp_pb2.SetVoiceRecognitionAsHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.SetVoiceRecognitionAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SendDtmfFromHandsfree(self, request: hfp_pb2.SendDtmfFromHandsfreeRequest, context: grpc.ServicerContext) -> hfp_pb2.SendDtmfFromHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
