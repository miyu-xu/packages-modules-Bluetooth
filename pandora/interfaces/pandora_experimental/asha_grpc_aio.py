...
class Asha:
    ...
    def Register(self, capability: int = 0, hisyncid: List[int] = [], wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
    ...
    def Start(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[asha_pb2.StartResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def PlaybackAudio(self, iterator: AsyncIterator[asha_pb2.PlaybackAudioRequest], timeout: Optional[float] = None) -> Awaitable[asha_pb2.PlaybackAudioResponse]:
    ...
    def Stop(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[asha_pb2.StopResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def WaitPeripheral(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[asha_pb2.WaitPeripheralResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class AshaServicer:
    async def Register(self, request: asha_pb2.RegisterRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def CaptureAudio(self, request: asha_pb2.CaptureAudioRequest, context: grpc.ServicerContext) -> AsyncGenerator[asha_pb2.CaptureAudioResponse, None]:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
        yield asha_pb2.CaptureAudioResponse()  # no-op: to make the linter happy

    async def Start(self, request: asha_pb2.StartRequest, context: grpc.ServicerContext) -> asha_pb2.StartResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def PlaybackAudio(self, request: AsyncIterator[asha_pb2.PlaybackAudioRequest], context: grpc.ServicerContext) -> asha_pb2.PlaybackAudioResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def Stop(self, request: asha_pb2.StopRequest, context: grpc.ServicerContext) -> asha_pb2.StopResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def WaitPeripheral(self, request: asha_pb2.WaitPeripheralRequest, context: grpc.ServicerContext) -> asha_pb2.WaitPeripheralResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_AshaServicer_to_server(servicer: AshaServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
