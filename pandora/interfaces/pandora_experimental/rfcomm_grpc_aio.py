...
class RFCOMM:
    ...
    def ConnectToServer(self, address: bytes = b'', uuid: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.ConnectionResponse]:
    ...
    def StartServer(self, name: str = '', uuid: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.StartServerResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptConnection(self, server: rfcomm_pb2.ServerId = rfcomm_pb2.ServerId(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.AcceptConnectionResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Disconnect(self, connection: rfcomm_pb2.RfcommConnection = rfcomm_pb2.RfcommConnection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.DisconnectionResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def StopServer(self, server: rfcomm_pb2.ServerId = rfcomm_pb2.ServerId(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.StopServerResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Send(self, connection: rfcomm_pb2.RfcommConnection = rfcomm_pb2.RfcommConnection(), data: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.TxResponse]:
        return self.channel.unary_unary(  # type: ignore
            '/pandora.RFCOMM/Send',
    ...
    def Receive(self, connection: rfcomm_pb2.RfcommConnection = rfcomm_pb2.RfcommConnection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[rfcomm_pb2.RxResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class RFCOMMServicer:
    async def ConnectToServer(self, request: rfcomm_pb2.ConnectionRequest, context: grpc.ServicerContext) -> rfcomm_pb2.ConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def StartServer(self, request: rfcomm_pb2.ServerOptions, context: grpc.ServicerContext) -> rfcomm_pb2.StartServerResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AcceptConnection(self, request: rfcomm_pb2.AcceptConnectionRequest, context: grpc.ServicerContext) -> rfcomm_pb2.AcceptConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def Disconnect(self, request: rfcomm_pb2.DisconnectionRequest, context: grpc.ServicerContext) -> rfcomm_pb2.DisconnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def StopServer(self, request: rfcomm_pb2.StopServerRequest, context: grpc.ServicerContext) -> rfcomm_pb2.StopServerResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
