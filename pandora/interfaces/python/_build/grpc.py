...
finalized_bt_test_interfaces_directory = f'{package_directory}/../../../../../../external/pandora/bt-test-interfaces'
proto_directory = f'{bt_test_interfaces_directory}/pandora_experimental'
...
def build():
    ...
    print(finalized_bt_test_interfaces_directory)
    ...
    protoc.main([
        ...
        f'-I{finalized_bt_test_interfaces_directory}',
        f'-I{proto_include}',
