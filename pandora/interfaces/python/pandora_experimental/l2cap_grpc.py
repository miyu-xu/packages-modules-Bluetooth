...
setattr(CreateLECreditBasedChannelRequest, '__new__', lambda _, *args, **kwargs: l2cap_pb2.CreateLECreditBasedChannelRequest(*args, **kwargs))  # type: ignore

@dataclass
class CreateLECreditBasedChannelResponse(Message):
    pass

setattr(CreateLECreditBasedChannelResponse, '__new__', lambda _, *args, **kwargs: l2cap_pb2.CreateLECreditBasedChannelResponse(*args, **kwargs))  # type: ignore
...
setattr(SendDataRequest, '__new__', lambda _, *args, **kwargs: l2cap_pb2.SendDataRequest(*args, **kwargs))  # type: ignore

@dataclass
class SendDataResponse(Message):
    pass

setattr(SendDataResponse, '__new__', lambda _, *args, **kwargs: l2cap_pb2.SendDataResponse(*args, **kwargs))  # type: ignore

@dataclass
class ReceiveDataRequest(Message):
    connection: 'host_pb2.Connection' = host_pb2.Connection()

setattr(ReceiveDataRequest, '__new__', lambda _, *args, **kwargs: l2cap_pb2.ReceiveDataRequest(*args, **kwargs))  # type: ignore

@dataclass
class ReceiveDataResponse(Message):
    data: bytes = b''

setattr(ReceiveDataResponse, '__new__', lambda _, *args, **kwargs: l2cap_pb2.ReceiveDataResponse(*args, **kwargs))  # type: ignore
...
setattr(ListenL2CAPChannelRequest, '__new__', lambda _, *args, **kwargs: l2cap_pb2.ListenL2CAPChannelRequest(*args, **kwargs))  # type: ignore

@dataclass
class ListenL2CAPChannelResponse(Message):
    pass

setattr(ListenL2CAPChannelResponse, '__new__', lambda _, *args, **kwargs: l2cap_pb2.ListenL2CAPChannelResponse(*args, **kwargs))  # type: ignore

@dataclass
class AcceptL2CAPChannelRequest(Message):
    connection: 'host_pb2.Connection' = host_pb2.Connection()

setattr(AcceptL2CAPChannelRequest, '__new__', lambda _, *args, **kwargs: l2cap_pb2.AcceptL2CAPChannelRequest(*args, **kwargs))  # type: ignore

@dataclass
class AcceptL2CAPChannelResponse(Message):
    pass

setattr(AcceptL2CAPChannelResponse, '__new__', lambda _, *args, **kwargs: l2cap_pb2.AcceptL2CAPChannelResponse(*args, **kwargs))  # type: ignore
...
class L2CAP:
    ...
    def CreateLECreditBasedChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), psm: int = 0, secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> CreateLECreditBasedChannelResponse:
    ...
    def SendData(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), data: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> SendDataResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ReceiveData(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> ReceiveDataResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ListenL2CAPChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> ListenL2CAPChannelResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptL2CAPChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> AcceptL2CAPChannelResponse:
        return self.channel.unary_unary(  # type: ignore
...
class L2CAPServicer:
    def CreateLECreditBasedChannel(self, request: CreateLECreditBasedChannelRequest, context: grpc.ServicerContext) -> CreateLECreditBasedChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def SendData(self, request: SendDataRequest, context: grpc.ServicerContext) -> SendDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def ReceiveData(self, request: ReceiveDataRequest, context: grpc.ServicerContext) -> ReceiveDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def ListenL2CAPChannel(self, request: ListenL2CAPChannelRequest, context: grpc.ServicerContext) -> ListenL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def AcceptL2CAPChannel(self, request: AcceptL2CAPChannelRequest, context: grpc.ServicerContext) -> AcceptL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
