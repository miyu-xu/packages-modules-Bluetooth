...
from pandora_experimental.pan_grpc import EnableTetheringRequest, EnableTetheringResponse, ConnectPanRequest, ConnectPanResponse
...
class PAN:
    ...
    def EnableTethering(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[EnableTetheringResponse]:
    ...
    def ConnectPan(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[ConnectPanResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class PANServicer:
    async def EnableTethering(self, request: EnableTetheringRequest, context: grpc.ServicerContext) -> EnableTetheringResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ConnectPan(self, request: ConnectPanRequest, context: grpc.ServicerContext) -> ConnectPanResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_PANServicer_to_server(servicer: PANServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
