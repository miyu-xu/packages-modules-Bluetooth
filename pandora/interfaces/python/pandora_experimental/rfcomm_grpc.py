...
setattr(ConnectionRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.ConnectionRequest(*args, **kwargs))  # type: ignore

@dataclass
class RfcommConnection(Message):
    id: int = 0

setattr(RfcommConnection, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.RfcommConnection(*args, **kwargs))  # type: ignore

@dataclass
class ConnectionResponse(Message):
    connection: 'RfcommConnection' = RfcommConnection()

setattr(ConnectionResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.ConnectionResponse(*args, **kwargs))  # type: ignore
...
setattr(ServerOptions, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.ServerOptions(*args, **kwargs))  # type: ignore

@dataclass
class ServerId(Message):
    id: int = 0

setattr(ServerId, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.ServerId(*args, **kwargs))  # type: ignore

@dataclass
class StartServerResponse(Message):
    server: 'ServerId' = ServerId()

setattr(StartServerResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.StartServerResponse(*args, **kwargs))  # type: ignore

@dataclass
class StopServerRequest(Message):
    server: 'ServerId' = ServerId()

setattr(StopServerRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.StopServerRequest(*args, **kwargs))  # type: ignore

@dataclass
class StopServerResponse(Message):
    pass

setattr(StopServerResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.StopServerResponse(*args, **kwargs))  # type: ignore

@dataclass
class AcceptConnectionRequest(Message):
    server: 'ServerId' = ServerId()

setattr(AcceptConnectionRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.AcceptConnectionRequest(*args, **kwargs))  # type: ignore

@dataclass
class AcceptConnectionResponse(Message):
    connection: 'RfcommConnection' = RfcommConnection()

setattr(AcceptConnectionResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.AcceptConnectionResponse(*args, **kwargs))  # type: ignore

@dataclass
class DisconnectionRequest(Message):
    connection: 'RfcommConnection' = RfcommConnection()

setattr(DisconnectionRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.DisconnectionRequest(*args, **kwargs))  # type: ignore

@dataclass
class DisconnectionResponse(Message):
    pass

setattr(DisconnectionResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.DisconnectionResponse(*args, **kwargs))  # type: ignore
...
setattr(TxRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.TxRequest(*args, **kwargs))  # type: ignore

@dataclass
class TxResponse(Message):
    pass

setattr(TxResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.TxResponse(*args, **kwargs))  # type: ignore

@dataclass
class RxRequest(Message):
    connection: 'RfcommConnection' = RfcommConnection()

setattr(RxRequest, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.RxRequest(*args, **kwargs))  # type: ignore

@dataclass
class RxResponse(Message):
    data: bytes = b''

setattr(RxResponse, '__new__', lambda _, *args, **kwargs: rfcomm_pb2.RxResponse(*args, **kwargs))  # type: ignore
...
class RFCOMM:
    ...
    def ConnectToServer(self, address: bytes = b'', uuid: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> ConnectionResponse:
    ...
    def StartServer(self, name: str = '', uuid: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> StartServerResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptConnection(self, server: 'ServerId' = ServerId(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> AcceptConnectionResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Disconnect(self, connection: 'RfcommConnection' = RfcommConnection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> DisconnectionResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def StopServer(self, server: 'ServerId' = ServerId(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> StopServerResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Send(self, connection: 'RfcommConnection' = RfcommConnection(), data: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> TxResponse:
        return self.channel.unary_unary(  # type: ignore
            '/pandora.RFCOMM/Send',
    ...
    def Receive(self, connection: 'RfcommConnection' = RfcommConnection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> RxResponse:
        return self.channel.unary_unary(  # type: ignore
...
class RFCOMMServicer:
    def ConnectToServer(self, request: ConnectionRequest, context: grpc.ServicerContext) -> ConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def StartServer(self, request: ServerOptions, context: grpc.ServicerContext) -> StartServerResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def AcceptConnection(self, request: AcceptConnectionRequest, context: grpc.ServicerContext) -> AcceptConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def Disconnect(self, request: DisconnectionRequest, context: grpc.ServicerContext) -> DisconnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def StopServer(self, request: StopServerRequest, context: grpc.ServicerContext) -> StopServerResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def Send(self, request: TxRequest, context: grpc.ServicerContext) -> TxResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    def Receive(self, request: RxRequest, context: grpc.ServicerContext) -> RxResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
