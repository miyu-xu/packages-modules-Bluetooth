...
from pandora_experimental.l2cap_grpc import CreateLECreditBasedChannelRequest, CreateLECreditBasedChannelResponse, SendDataRequest, SendDataResponse, ReceiveDataRequest, ReceiveDataResponse, ListenL2CAPChannelRequest, ListenL2CAPChannelResponse, AcceptL2CAPChannelRequest, AcceptL2CAPChannelResponse
...
class L2CAP:
    ...
    def CreateLECreditBasedChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), psm: int = 0, secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[CreateLECreditBasedChannelResponse]:
    ...
    def SendData(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), data: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SendDataResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ReceiveData(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[ReceiveDataResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ListenL2CAPChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), secure: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[ListenL2CAPChannelResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AcceptL2CAPChannel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[AcceptL2CAPChannelResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class L2CAPServicer:
    async def CreateLECreditBasedChannel(self, request: CreateLECreditBasedChannelRequest, context: grpc.ServicerContext) -> CreateLECreditBasedChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SendData(self, request: SendDataRequest, context: grpc.ServicerContext) -> SendDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ReceiveData(self, request: ReceiveDataRequest, context: grpc.ServicerContext) -> ReceiveDataResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ListenL2CAPChannel(self, request: ListenL2CAPChannelRequest, context: grpc.ServicerContext) -> ListenL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AcceptL2CAPChannel(self, request: AcceptL2CAPChannelRequest, context: grpc.ServicerContext) -> AcceptL2CAPChannelResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
