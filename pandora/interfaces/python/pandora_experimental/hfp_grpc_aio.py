...
from pandora_experimental.hfp_grpc import AudioPath
from pandora_experimental.hfp_grpc import EnableSlcRequest, DisableSlcRequest, SetBatteryLevelRequest, AnswerCallRequest, AnswerCallResponse, DeclineCallRequest, DeclineCallResponse, SetAudioPathRequest, SetAudioPathResponse, SwapActiveCallRequest, SwapActiveCallResponse, SetInBandRingtoneRequest, SetInBandRingtoneResponse, MakeCallRequest, MakeCallResponse, SetVoiceRecognitionRequest, SetVoiceRecognitionResponse, ClearCallHistoryRequest, ClearCallHistoryResponse, AnswerCallAsHandsfreeRequest, AnswerCallAsHandsfreeResponse, EndCallAsHandsfreeRequest, EndCallAsHandsfreeResponse, DeclineCallAsHandsfreeRequest, DeclineCallAsHandsfreeResponse, ConnectToAudioAsHandsfreeRequest, ConnectToAudioAsHandsfreeResponse, DisconnectFromAudioAsHandsfreeRequest, DisconnectFromAudioAsHandsfreeResponse, MakeCallAsHandsfreeRequest, MakeCallAsHandsfreeResponse, CallTransferAsHandsfreeRequest, CallTransferAsHandsfreeResponse, EnableSlcAsHandsfreeRequest, DisableSlcAsHandsfreeRequest, SetVoiceRecognitionAsHandsfreeRequest, SetVoiceRecognitionAsHandsfreeResponse, SendDtmfFromHandsfreeRequest, SendDtmfFromHandsfreeResponse
...
class HFP:
    ...
    def EnableSlc(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
    ...
    def DisableSlc(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetBatteryLevel(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), battery_percentage: int = 0, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def MakeCall(self, number: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[MakeCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AnswerCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[AnswerCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DeclineCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[DeclineCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetAudioPath(self, audio_path: AudioPath = AudioPath.AUDIO_PATH_UNKNOWN, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SetAudioPathResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SwapActiveCall(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SwapActiveCallResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetInBandRingtone(self, enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SetInBandRingtoneResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetVoiceRecognition(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SetVoiceRecognitionResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ClearCallHistory(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[ClearCallHistoryResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def AnswerCallAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[AnswerCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def EndCallAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[EndCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DeclineCallAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[DeclineCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ConnectToAudioAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[ConnectToAudioAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DisconnectFromAudioAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[DisconnectFromAudioAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def MakeCallAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), number: str = '', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[MakeCallAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def CallTransferAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[CallTransferAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def EnableSlcAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def DisableSlcAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetVoiceRecognitionAsHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), enabled: bool = False, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SetVoiceRecognitionAsHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SendDtmfFromHandsfree(self, connection: 'host_pb2.Connection' = host_pb2.Connection(), code: int = 0, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[SendDtmfFromHandsfreeResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class HFPServicer:
    async def EnableSlc(self, request: EnableSlcRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DisableSlc(self, request: DisableSlcRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetBatteryLevel(self, request: SetBatteryLevelRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def MakeCall(self, request: MakeCallRequest, context: grpc.ServicerContext) -> MakeCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AnswerCall(self, request: AnswerCallRequest, context: grpc.ServicerContext) -> AnswerCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DeclineCall(self, request: DeclineCallRequest, context: grpc.ServicerContext) -> DeclineCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetAudioPath(self, request: SetAudioPathRequest, context: grpc.ServicerContext) -> SetAudioPathResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SwapActiveCall(self, request: SwapActiveCallRequest, context: grpc.ServicerContext) -> SwapActiveCallResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetInBandRingtone(self, request: SetInBandRingtoneRequest, context: grpc.ServicerContext) -> SetInBandRingtoneResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetVoiceRecognition(self, request: SetVoiceRecognitionRequest, context: grpc.ServicerContext) -> SetVoiceRecognitionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ClearCallHistory(self, request: ClearCallHistoryRequest, context: grpc.ServicerContext) -> ClearCallHistoryResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def AnswerCallAsHandsfree(self, request: AnswerCallAsHandsfreeRequest, context: grpc.ServicerContext) -> AnswerCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def EndCallAsHandsfree(self, request: EndCallAsHandsfreeRequest, context: grpc.ServicerContext) -> EndCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DeclineCallAsHandsfree(self, request: DeclineCallAsHandsfreeRequest, context: grpc.ServicerContext) -> DeclineCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ConnectToAudioAsHandsfree(self, request: ConnectToAudioAsHandsfreeRequest, context: grpc.ServicerContext) -> ConnectToAudioAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DisconnectFromAudioAsHandsfree(self, request: DisconnectFromAudioAsHandsfreeRequest, context: grpc.ServicerContext) -> DisconnectFromAudioAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def MakeCallAsHandsfree(self, request: MakeCallAsHandsfreeRequest, context: grpc.ServicerContext) -> MakeCallAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def CallTransferAsHandsfree(self, request: CallTransferAsHandsfreeRequest, context: grpc.ServicerContext) -> CallTransferAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def EnableSlcAsHandsfree(self, request: EnableSlcAsHandsfreeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def DisableSlcAsHandsfree(self, request: DisableSlcAsHandsfreeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetVoiceRecognitionAsHandsfree(self, request: SetVoiceRecognitionAsHandsfreeRequest, context: grpc.ServicerContext) -> SetVoiceRecognitionAsHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SendDtmfFromHandsfree(self, request: SendDtmfFromHandsfreeRequest, context: grpc.ServicerContext) -> SendDtmfFromHandsfreeResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_HFPServicer_to_server(servicer: HFPServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
