...
class RFCOMMService(RFCOMMServicer):
  ...
  async def ConnectToServer(
      self, request: ConnectionRequest, context: grpc.ServicerContext
  ) -> ConnectionResponse:
    # TODO
  ...
  async def StartServer(
      self, request: ServerOptions, context: grpc.ServicerContext
  ) -> StartServerResponse:
  ...
  async def AcceptConnection(
      self, request: AcceptConnectionRequest, context: grpc.ServicerContext
  ) -> AcceptConnectionResponse:
  ...
  async def Disconnect(
      self, request: DisconnectionRequest, context: grpc.ServicerContext
  ) -> DisconnectionResponse():
    # TODO
  ...
  async def StopServer(
      self, request: StopServerRequest, context: grpc.ServicerContext
  ) -> StopServerResponse:
