...
from pandora_experimental.config_pb2 import (ENCRYPTION_KEY, IDENTITY_KEY, LINK_KEY, SIGNING_KEY, KeyDistribution,
                                             OverrideConfigRequest)
...
class ConfigService(ConfigServicer):
    ...
    @utils.rpc
    async def OverrideConfig(self, request: OverrideConfigRequest, context: grpc.ServicerContext) -> Empty:
