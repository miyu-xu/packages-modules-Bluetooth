...
from bumble.gatt import Characteristic, CharacteristicValue, Descriptor, Service, TemplateService
...
class ServiceWithAdvertisingData(Service):
    UUID = None
    ...
    def __init__(self, uuid, characteristics: list, device: Device):
        ...
        super().__init__(self.UUID, characteristics)  # type : ignore[no-untyped-call]
