...
class DckGattService(TemplateService):
    ...
    UUID = CCC_DK_UUID
    UUID_SPSM = BumbleUUID("D3B5A130-9E23-4B3A-8BE4-6B1EE5F980A3", "Spsm value")
    UUID_SPSM_DK_VERSION = BumbleUUID("D3B5A130-9E23-4B3A-8BE4-6B1EE5B780A3", "DK version")
    UUID_DEVICE_DK_VERSION = BumbleUUID("BD4B9502-3F54-11EC-B919-0242AC120005", "Device DK version")
    ...
    def __init__(self, device: Device):
        ...
        self.psm = device.register_l2cap_server(0, on_l2cap_server)  # type: ignore
        self.spsm_characteristic = Characteristic(
        ...
        self.spsm_dk_version = Characteristic(
        ...
        def on_device_version_write(value: bytes):
            ...
            self.device_dk_version = value

        self.device_dk_version = Characteristic(
        ...
        characteristics = [self.spsm_characteristic, self.spsm_dk_version, self.device_dk_version]

        super().init(characteristics)  # type: ignore[no-untyped-call]
