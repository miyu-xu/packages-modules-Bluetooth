...
class HostService(host_grpc_aio.HostServicer):
    ...
    async def Connect(self, request: host_pb2.ConnectRequest,
        ...
        connection = utils.Connection(address, floss_enums.BtTransport.BREDR)
        return host_pb2.ConnectResponse(connection=utils.connection_to(connection))
    ...
    async def WaitConnection(self, request: host_pb2.WaitConnectionRequest,
        ...
        connection = utils.Connection(address, floss_enums.BtTransport.BREDR)
        return host_pb2.WaitConnectionResponse(connection=utils.connection_to(connection))
    ...
    async def Advertise(self, request: host_pb2.AdvertiseRequest,
        ...
        try:
            ...
            while True:
                ...
                connection = utils.Connection(address, floss_enums.BtTransport.BREDR)
                yield host_pb2.AdvertiseResponse(connection=utils.connection_to(connection))
