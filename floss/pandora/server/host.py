...
class HostService(host_grpc_aio.HostServicer):
    ...
    def __init__(self, server: grpc.aio.Server, bluetooth: bluetooth_module.Bluetooth, security: security_grpc_aio.SecurityServicer):
        self.server = server
    ...
    async def Connect(self, request: host_pb2.ConnectRequest,
        ...
        class PairingObserver(adapter_client.BluetoothCallbacks):
            ...
            def on_ssp_request(self, remote_device, class_of_device, variant, passkey):
                ...
                if variant in (floss_enums.SspVariant.CONSENT,
                               floss_enums.SspVariant.PASSKEY_CONFIRMATION):
