...
from autotest_lib.client.cros.bluetooth.floss.floss_enums import (BtTransport, LePhy, GattStatus)
...
class FlossGattClient(GattClientCallbacks):
    ...
    @glib_call(False)
    def connect_client(self, address, is_direct=False, transport=BtTransport.LE, opportunistic=False, phy=LePhy.PHY1M):
