...
async def serve(port):
    ...
    # FIXME: Someone calls the basicConfig before us. Remove force flag after the dependency issue is resolved.
    logging.basicConfig(filename='/var/log/grpc_server_log', filemode='a', level=logging.DEBUG, force=True)
    ...
    try:
        while True:
            ...
            host_servie = host.HostService(server, bluetooth)
            host_grpc_aio.add_HostServicer_to_server(host_servie, server)
