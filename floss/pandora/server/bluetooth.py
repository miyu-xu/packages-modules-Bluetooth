...
import common  # pylint: disable=g-bad-import-order, unused-import
...
from autotest_lib.client.cros.bluetooth.floss import manager_client
...
class Bluetooth(object):
    ...
    def setup_mainloop(self):
        ...
        self.thread = threading.Thread(name=floss_utils.GLIB_THREAD_NAME,
    ...
    def start_advertising_set(self, parameters, advertise_data, scan_response, periodic_parameters, periodic_data,
        ...
        scan_response = floss_utils.make_kv_optional_value(
            self.advertising_client.make_dbus_advertise_data(scan_response))
        periodic_parameters = floss_utils.make_kv_optional_value(
            self.advertising_client.make_dbus_periodic_advertising_parameters(periodic_parameters))
        periodic_data = floss_utils.make_kv_optional_value(
