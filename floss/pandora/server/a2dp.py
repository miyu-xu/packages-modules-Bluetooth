...
class A2DPService(a2dp_grpc_aio.A2DPServicer):
    ...
    async def Start(self, request: a2dp_pb2.StartRequest, context: grpc.ServicerContext) -> a2dp_pb2.StartResponse:
        ...
        try:
            ...
            await context.abort(grpc.StatusCode.UNKNOWN, f'Failed to select audio output node: {e}')
        ...
        try:
            ...
            await context.abort(grpc.StatusCode.UNKNOWN, f'Failed to start {target} subprocess: {e}')
    ...
    async def Suspend(self, request: a2dp_pb2.SuspendRequest,
        ...
        try:
            ...
            await context.abort(grpc.StatusCode.UNKNOWN, f'Failed to stop {target} subprocess: {e}')
    ...
    async def PlaybackAudio(self, request: AsyncIterator[a2dp_pb2.PlaybackAudioRequest],
        ...
        try:
            ...
            await context.abort(grpc.StatusCode.UNKNOWN, f'PlaybackAudio failed: {e}')
