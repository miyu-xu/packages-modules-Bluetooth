...
class FlossTelephonyClient:
    ...
    @utils.glib_call(None)
    def set_last_call(self, number):
        """Sets last call with the specified phone number.

        Args:
            number: The phone number to be set as the last call.
    ...
    @utils.glib_call(None)
    def set_memory_call(self, number):
        """Sets memory call with the specified phone number.

        Args:
            number: The phone number to be set for the memory call.
