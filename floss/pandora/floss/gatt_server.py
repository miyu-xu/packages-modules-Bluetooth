...
class FlossGattServer(GattServerCallbacks):
    ...
    def __define_services(self):
        ...
        self.uuid_to_value[self.SERVICE_ATTR_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.SERVER_CHANGED_CHAR_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.SERVER_SUP_FEAT_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.CLIENT_SUP_FEAT_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.DATABASE_HASH_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.LONG_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.DESCRIPTOR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.KEY_SIZE_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.UNAUTHORIZED_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.AUTHENTICATION_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.INVALID_FOR_LE_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.INVALID_FOR_BR_EDR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.NO_READ_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.NO_WRITE_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.SHORT_CHAR_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.WRITE_NO_RESPONSE_CHAR_UUID] = self.LONG_TEST_VALUE
        self.uuid_to_value[self.NOTIFY_CHAR_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.AUTHENTICATE_SHORT_CHAR_UUID] = self.SHORT_TEST_VALUE
        self.uuid_to_value[self.CCC_DESCRIPTOR_UUID] = self.INDICATION_VALUE
        self.uuid_to_value[self.LONG_CHAR_512_UUID] = self.LONG_TEST_VALUE_512
        self.uuid_to_value[self.MITM_SHORT_CHAR_UUID] = self.SHORT_TEST_VALUE
    ...
    def make_dbus_descriptor(self, uuid, instance_id, permissions):
        ...
        """
        desc_uuid = bluetooth_gatt_service.get_uuid_as_list(uuid)
        return {
    ...
    def make_dbus_characteristic(self, uuid, instance_id, properties, permissions, key_size, write_type, descriptors):
        ...
        char_uuid = bluetooth_gatt_service.get_uuid_as_list(uuid)
        return {
    ...
    def make_dbus_service(self, service):
        ...
        service_uuid = bluetooth_gatt_service.get_uuid_as_list(service['uuid'])
        return {
