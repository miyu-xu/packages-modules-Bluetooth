...
class FlossGattServer(GattServerCallbacks):
    ...
    def on_server_connection_state(self, server_id, connected, addr):
        ...
        Args:
            ...
            addr: Remote device MAC address.
        """
        logging.debug('on_server_connection_state: server_id: %s, connection_state: %s, device address: %s',
    ...
    def on_characteristic_read_request(self, addr, trans_id, offset, is_long, handle):
        ...
        Args:
            ...
            handle: The characteristic handle.
        """
        logging.debug('on_characteristic_read_request: device address: %s, trans_id: %s, offset: %s, is_long: %s, '
                      'handle: %s', addr, trans_id, offset, is_long, handle)
    ...
    def on_descriptor_read_request(self, addr, trans_id, offset, is_long, handle):
        ...
        Args:
            ...
            handle: The descriptor handle.
        """
        logging.debug('on_descriptor_read_request: device address: %s, trans_id: %s, offset: %s, is_long: %s, '
                      'handle: %s', addr, trans_id, offset, is_long, handle)
    ...
    def on_characteristic_write_request(self, addr, trans_id, offset, len, is_prep, need_rsp, handle, value):
        ...
        Args:
            ...
            value: The value that should be written to the attribute.
        """
        logging.debug('on_characteristic_write_request: device address: %s, trans_id: %s, offset: %s, length: %s, '
                      'is_prep: %s, need_rsp: %s, handle: %s, values: %s', addr, trans_id, offset, len, is_prep,
    ...
    def on_descriptor_write_request(self, addr, trans_id, offset, len, is_prep, need_rsp, handle, value):
        ...
        Args:
            ...
            value: The value that should be written to the descriptor.
        """
        logging.debug('on_descriptor_write_request: device address: %s, trans_id: %s, offset: %s, length: %s, '
                      'is_prep: %s, need_rsp: %s, handle: %s, values: %s', addr, trans_id, offset, len, is_prep,
                      need_rsp, handle, value)
    ...
    def on_execute_write(self, addr, trans_id, exec_write):
        ...
        Args:
            ...
            exec_write: A boolean value that indicates whether the write operation should be executed or canceled.
        """
        logging.debug('on_execute_write: device address: %s, trans_id: %s, exec_write: %s', addr, trans_id,
                      exec_write)
    ...
    def on_phy_update(self, addr, tx_phy, rx_phy, status):
        ...
        Args:
            ...
            status: floss_enums.GattStatus.
        """
        logging.debug('on_phy_update: device address: %s, tx_phy: %s, rx_phy: %s, status: %s', addr, tx_phy,
                      rx_phy, status)
    ...
    def on_phy_read(self, addr, tx_phy, rx_phy, status):
        ...
        Args:
            ...
            status: floss_enums.GattStatus.
        """
        logging.debug('on_phy_read: device address: %s, tx_phy: %s, rx_phy: %s, status: %s', addr, tx_phy,
                      rx_phy, status)
    ...
    def on_connection_updated(self, addr, interval, latency, timeout, status):
        ...
        Args:
            ...
            status: floss_enums.GattStatus.
        """
        logging.debug('on_connection_updated: device address: %s, interval: %s, latency: %s, timeout: %s, '
                      'status: %s', addr, interval, latency, timeout, status)
    ...
    def on_subrate_change(self, addr, subrate_factor, latency, cont_num, timeout, status):
        ...
        Args:
            ...
            status: floss_enums.GattStatus.
        """
        logging.debug('on_subrate_change: device address: %s, subrate_factor: %s, latency: %s, cont_num: %s, '
                      'timeout: %s, status: %s', addr, subrate_factor, latency, cont_num, timeout, status)
