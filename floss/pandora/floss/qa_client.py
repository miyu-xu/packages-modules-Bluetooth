...
class FlossQAClient(BluetoothQACallbacks):
    ...
    def rfcomm_send_msc(self, dlci, addr):
        """Sends MSC command over RFCOMM to a specified Bluetooth device.

        Args:
            dlci: The Data Link Control Identifier (DLCI) for the RFCOMM channel.
            addr: The Bluetooth address of the target device.
    ...
    def get_hid_report(self, addr, report_type, report_id):
        ...
        Args:
            addr: The Bluetooth address of the target device.
            report_type: The type of Bluetooth report.
            report_id: The id of Bluetooth report.
    ...
    def send_hid_data(self, addr, data):
        """Sends HID report data to a specific device address.
