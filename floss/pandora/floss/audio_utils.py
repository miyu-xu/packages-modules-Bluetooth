...
def _poll_for_condition(condition, timeout=20, sleep_interval=1, desc='waiting for condition'):
    ...
    """
    try:
        utils.poll_for_condition(condition=condition, timeout=timeout, sleep_interval=sleep_interval, desc=desc)
