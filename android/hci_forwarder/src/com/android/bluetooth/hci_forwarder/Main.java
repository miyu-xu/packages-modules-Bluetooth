...
public class Main extends MonitoringInstrumentation {
    ...
    class BluetoothHciCallbacksHidl extends IBluetoothHciCallbacks.Stub {
        ...
        public void isoDataReceived(ArrayList<Byte> data) {
            try {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (service_aidl == null && service_hidl == null) {
            Log.w(TAG, "No HCI HAL available");
            return;
        }
            ...
            try {
                ...
                switch (type) {
                    case HCI_PACKET_TYPE_COMMAND:
                        if (service_hidl != null) {
                            service_hidl.sendHciCommand(toByteList(buf));
                        } else {
                    ...
                    case HCI_PACKET_TYPE_ACL_DATA:
                        if (service_hidl != null) {
                            service_hidl.sendAclData(toByteList(buf));
                        } else {
                    ...
                    case HCI_PACKET_TYPE_SCO_DATA:
                        if (service_hidl != null) {
                            service_hidl.sendScoData(toByteList(buf));
                        } else {
                    ...
                    case HCI_PACKET_TYPE_ISO_DATA:
                        if (service_hidl != null) {
                            service_hidl.sendIsoData(toByteList(buf));
                        } else {
                            service_aidl.sendIsoData(buf);
                        }
                        break;
                    default:
    ...
    static private ArrayList<Byte> toByteList(byte[] array) {
