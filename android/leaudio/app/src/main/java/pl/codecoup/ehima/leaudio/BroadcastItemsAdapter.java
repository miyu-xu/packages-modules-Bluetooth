...
public class BroadcastItemsAdapter extends RecyclerView.Adapter<BroadcastItemsAdapter.BroadcastItemHolder> {
    private List<BluetoothLeBroadcastMetadata> mBroadcastMetadata = new ArrayList<>();
    private Map<Integer /*broadcastId*/, Boolean /*isPlaying*/> mBroadcastPlayback = new HashMap<>();
    ...
    public void onBindViewHolder(@NonNull BroadcastItemHolder holder, int position) {
        ...
        if (isPlaying) {
            holder.background.setCardBackgroundColor(ColorStateList.valueOf(Color.parseColor("#92b141")));
    ...
    public void addBroadcasts(Integer broadcastId) {
        if (!mBroadcastPlayback.containsKey(broadcastId)) mBroadcastPlayback.put(broadcastId, false);
    }
    ...
    class BroadcastItemHolder extends RecyclerView.ViewHolder {
        private TextView mTextViewBroadcastId;
