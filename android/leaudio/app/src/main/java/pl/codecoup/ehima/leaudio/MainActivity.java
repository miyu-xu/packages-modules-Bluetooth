...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent)
    {
        ...
        if(requestCode == 0xc0de)
        {
            if (intent != null) {
                ...
                Toast.makeText(MainActivity.this, message + "(" + resultCode + ")", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void setupViewsProfileUiEventListeners() {
        recyclerViewAdapter.setOnLeAudioInteractionListener(
                new LeAudioRecycleViewAdapter.OnLeAudioInteractionListener() {
                    ...
                    public void onConnectClick(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper) {
                        Toast.makeText(MainActivity.this,
                                "Connecting Le Audio to " + leAudioDeviceStateWrapper.device.toString(),
                                Toast.LENGTH_SHORT).show();
                    ...
                    public void onDisconnectClick(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper) {
                        Toast.makeText(MainActivity.this,
                                "Disconnecting Le Audio from " + leAudioDeviceStateWrapper.device.toString(),
                                Toast.LENGTH_SHORT).show();
                        leAudioViewModel.connectLeAudio(leAudioDeviceStateWrapper.device, false);
                    }

                    @Override
                    public void onStreamActionClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, Integer group_id, Integer content_type, Integer action) {
                        leAudioViewModel.streamAction(group_id, action, content_type);
                    }

                    @Override
                    public void onGroupSetClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, Integer group_id) {
                        leAudioViewModel.groupSet(leAudioDeviceStateWrapper.device, group_id);
                    }

                    @Override
                    public void onGroupUnsetClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, Integer group_id) {
                        leAudioViewModel.groupUnset(leAudioDeviceStateWrapper.device, group_id);
                    }

                    @Override
                    public void onGroupDestroyClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, Integer group_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onGroupSetLockClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, Integer group_id, boolean lock) {
                        leAudioViewModel.groupSetLock(group_id, lock);
                    }

                    @Override
                    public void onMicrophoneMuteChanged(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, boolean mute, boolean is_from_user) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
        ...
        recyclerViewAdapter.setOnVolumeControlInteractionListener(
                new LeAudioRecycleViewAdapter.OnVolumeControlInteractionListener() {
                    ...
                    @Override
                    public void onVolumeChanged(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int volume, boolean is_from_user) {
                        if (is_from_user) {
                    ...
                    @Override
                    public void onCheckedChanged(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, boolean is_checked) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGetStateButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGainValueChanged(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id, int value) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputMuteSwitched(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id, boolean is_muted) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputSetGainModeButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id, boolean is_auto) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGetGainPropsButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGetTypeButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGetStatusButton(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputGetDescriptionButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onInputSetDescriptionButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int input_id, String description) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputGetGainButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputGainOffsetGainValueChanged(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id, int value) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputGetLocationButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputSetLocationButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id, int location) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputGetDescriptionButtonClicked(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    @Override
                    public void onOutputSetDescriptionButton(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper, int output_id, String description) {
                        // Not available anymore
                        Toast.makeText(MainActivity.this, "Operation not supported on this API version",
                                Toast.LENGTH_SHORT).show();
                    }
        ...
        recyclerViewAdapter.setOnHapInteractionListener(
                new LeAudioRecycleViewAdapter.OnHapInteractionListener() {
                    ...
                    public void onDisconnectClick(LeAudioDeviceStateWrapper leAudioDeviceStateWrapper) {
                        Toast.makeText(MainActivity.this,
                                "Disconnecting HAP from " + leAudioDeviceStateWrapper.device.toString(),
                                Toast.LENGTH_SHORT).show();
                        leAudioViewModel.connectHap(leAudioDeviceStateWrapper.device, false);
                    }

                    @Override
                    public void onReadPresetInfoClicked(BluetoothDevice device,
                            int preset_index) {
                        leAudioViewModel.hapReadPresetInfo(device, preset_index);
                    }

                    @Override
                    public void onSetActivePresetClicked(BluetoothDevice device,
                            int preset_index) {
                        leAudioViewModel.hapSetActivePreset(device, preset_index);
                    }

                    @Override
                    public void onChangePresetNameClicked(BluetoothDevice device,
                            int preset_index, String name) {
                    ...
                    public void onPreviousGroupPresetClicked(BluetoothDevice device) {
                        ...
                        if (!sent)
                            Toast.makeText(MainActivity.this, "Group " + group_id + " operation failed", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void setupViewModelObservers() {
        List<LeAudioDeviceStateWrapper> devices = leAudioViewModel.getAllLeAudioDevicesLive().getValue();
