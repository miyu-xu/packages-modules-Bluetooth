...
class AndroidPandoraDevice(PandoraDevice):
    ...
    def __init__(self, android_device):
        ...
        port = 8999
        self.android_device.services.register('pandora', AndroidService, configs={'port': port})
    ...
    def create(cls, config):
        ...
        if not android_devices:
            raise mobly.signals.ControllerError('Expected to get at least 1 android controller objects, got 0.')
