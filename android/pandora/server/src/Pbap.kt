...
class Pbap(val context: Context) : PBAPImplBase(), Closeable {
    ...
    companion object {
        ...
        const val DEFAULT_NOTE =
            ...
            Suspendisse sollicitudin, metus ut gravida semper, nunc ipsum ullamcorper nunc,
            ut maximus nulla nunc dignissim justo.
            Duis nec nisi leo. Proin tristique massa mi, imperdiet tempus nibh vulputate quis.
