...
class Gmap(val context: Context) : GMAPImplBase(), Closeable {
    ...
    init {
        Log.i(TAG, "Gmap initialized")
    }

    override fun gmapStart(request: GmapStartRequest, responseObserver: StreamObserver<Empty>) {
        grpcUnary<Empty>(scope, responseObserver) {
            ...
            // Configure the selected device as active device if it is not already.
    ...
    override fun gmapPlaybackAudio(
        responseObserver: StreamObserver<GmapPlaybackAudioResponse>
    ): StreamObserver<GmapPlaybackAudioRequest> {
        Log.i(TAG, "gmapPlaybackAudio")
        ...
        return object : StreamObserver<GmapPlaybackAudioRequest> {
            override fun onNext(request: GmapPlaybackAudioRequest) {
            ...
            override fun onCompleted() {
                responseObserver.onNext(GmapPlaybackAudioResponse.getDefaultInstance())
