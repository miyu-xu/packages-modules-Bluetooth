...
fun BluetoothDevice.toConnection(): Connection {
  val internal_connection_ref =
    InternalConnectionRef.newBuilder()
      ...
      .setTransport(this.type)
      .build()
  val cookie = Any.parseFrom(ByteString.copyFrom(internal_connection_ref.toString().toByteArray()))
