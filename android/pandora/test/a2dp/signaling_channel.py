...
class SignalingChannel(EventEmitter):
    ...
    async def expect_discover(self, seid_information: List[av.SeidInformation]):
    ...
    async def expect_get_caps(self, service_capabilities: List[ServiceCapability]):
    ...
    async def expect_set_conf(self):
    ...
    async def expect_open(self, timeout: float = 3.0):
    ...
    async def expect_start(self, timeout: float = 3.0):
    ...
    async def expect_suspend(self, timeout: float = 3.0):
    ...
    async def expect_close(self, timeout: float = 3.0):
    ...
    async def expect_open_stream_as_acceptor(self,
        ...
        await self.expect_discover(seid_information)
        await self.expect_get_caps(service_capabilities)
        await self.expect_set_conf()
        await self.expect_open()
