...
class SignalingChannel(EventEmitter):
    ...
    async def accept_get_caps(self, service_capabilities: List[ServiceCapability]):
    ...
    async def accept_set_conf(self):
    ...
    async def accept_open_stream(self,
        ...
        await self.accept_get_caps(service_capabilities)
        await self.accept_set_conf()
