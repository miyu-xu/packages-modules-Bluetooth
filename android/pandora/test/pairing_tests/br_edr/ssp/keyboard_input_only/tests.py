...
from pairing_tests.br_edr.debug_pairing_processor import DebugPairingProcessor
from pairing_tests.br_edr.pairing_processors_impl import BREDRPasskeyNotifEntryPairingProcessor
...
@add_common_tests(
    ...
    pairing_process_class=BREDRPasskeyNotifEntryPairingProcessor,
