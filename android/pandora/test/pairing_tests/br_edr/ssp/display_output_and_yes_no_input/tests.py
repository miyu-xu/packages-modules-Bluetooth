...
from pairing_tests.br_edr.pairing_processors_impl import BREDRNumericComparisonPairingProcessor
...
@add_common_tests(
    ...
    pairing_process_class=BREDRNumericComparisonPairingProcessor,
    service_accessor_classes=[BumbleHidServiceAccessor],
)
@add_boilerplate_methods
class BREDRDisplayYesNoTestClass(base_test.BaseTestClass):
