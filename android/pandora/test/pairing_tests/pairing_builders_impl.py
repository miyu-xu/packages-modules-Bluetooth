...
from pairing_tests.interfaces import (
    IAclConnectionBuilder,
    IPairingBuilder,
    IPairingProcessor,
    IServiceAccessor,
)
...
class DedicatedPairingBuilderRefInitAcl(IPairingBuilder):
    ...
    def __init__(self, dut, ref, acl_connection_builder: IAclConnectionBuilder,
                 pair_processor_cls: Type[IPairingProcessor]):
        self._dut = dut
        self._ref = ref
    ...
    async def start(self):
        ...
        self._pairing_processor = self._pair_processor_cls(self._init_pairing_event_stream, self._resp_pairing_event_stream)
...
class GeneralPairingBuilderRefInitAcl(IPairingBuilder):
    ...
    def __init__(self, dut, ref, service_accessor: IServiceAccessor,
                 pair_processor_cls: Type[IPairingProcessor]):
        self._dut = dut
        self._ref = ref
