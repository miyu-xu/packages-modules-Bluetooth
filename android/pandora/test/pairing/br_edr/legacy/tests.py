...
class BREDRLegacyTestClass(BREDRPairTestBase):
    ...
    async def accept_pairing(self):
        ...
        init_pairing_fut = asyncio.create_task(anext(self.initiator_pairing_event_stream))
        ...
        responder_pairing_fut = asyncio.create_task(anext(self.responder_pairing_event_stream))
