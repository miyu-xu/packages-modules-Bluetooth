...
class LeSecurityTest(base_test.BaseTestClass):  # type: ignore[misc]
    ...
    async def test_le_pairing_success(  # pytype: disable=wrong-arg-types
        ...
        if ref_connection_role == HCI_CENTRAL_ROLE and authentication_direction == "dutref":
            # TODO: Support SMP_Security_Request on Bumble
            raise signals.TestSkip('Bumble does not support SMP_Security_Request yet')
