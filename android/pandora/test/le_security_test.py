...
class LeSecurityTest(base_test.BaseTestClass):  # type: ignore[misc]
    ...
    async def test_le_pairing_accepted(  # pytype: disable=wrong-arg-types
        self,
    ...
    async def make_le_connection(central: PandoraDevice, central_address_type: OwnAddressType,
                                 peripheral: PandoraDevice,
                                 peripheral_address_type: OwnAddressType) -> Tuple[Connection, Connection]:
