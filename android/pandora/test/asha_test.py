...
class ASHATest(base_test.BaseTestClass):  # type: ignore[misc]
    ...
    async def test_music_start(self) -> None:
        ...
        _, start_result = await asyncio.gather(self.dut.aio.asha.Start(), start_future)
    ...
    async def test_set_volume(self) -> None:
        ...
        _ = await asyncio.gather(self.dut.aio.asha.Start())
        _, volume_result = await asyncio.gather(self.dut.aio.asha.SetVolume(1), volume_future)
    ...
    async def test_music_stop(self) -> None:
        ...
        _ = await asyncio.gather(self.dut.aio.asha.Start())
        _, stop_result = await asyncio.gather(self.dut.aio.asha.Stop(), stop_future)
