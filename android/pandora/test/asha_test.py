...
class AshaTest(base_test.BaseTestClass):  # type: ignore[misc]
    ...
    async def setup_test(self) -> None:
        ...
        # We have to update the config before the reset otherwise it'll be overriden
        random_indentity_list = [
        ...
        if self.current_test_info.name in random_indentity_list:
