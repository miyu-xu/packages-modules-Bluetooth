...
Copied from tools/rootcanal/scripts/test_channel.py to make build system happy, we probably
should not merge as-is at the moment.
"""
...
class RootCanal:
    ...
    def __init__(self):
        # port is CF_DEVICE_CONTROL_ROOTCANAL_PORT defined in tradefed
