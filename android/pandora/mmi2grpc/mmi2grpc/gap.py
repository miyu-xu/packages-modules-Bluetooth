...
from pandora_experimental.host_pb2 import AddressType, AdvertisingData
...
class GAPProxy(ProfileProxy):
    ...
    @assert_description
    def TSC_MMI_iut_start_general_inquiry_found(self, **kwargs):
        """
        ...
        # TODO: check manually, then link with RunInquiry

        return "OK"

    @assert_description
    def TSC_MMI_iut_send_att_read_by_type_request_name_request(self, **kwargs):
        """
    ...
    @assert_description
    def TSC_MMI_iut_confirm_device_discovery(self, **kwargs):
        """
        Please confirm that IUT has discovered PTS and retrieved its name PTS-
        GAP-177A
        """
