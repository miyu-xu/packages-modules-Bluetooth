...
class GAPProxy(ProfileProxy):
    ...
    def TSC_MMI_iut_send_advertising_report_event_service_uuid(self, **kwargs):
        ...
        self.host.StartAdvertising(
            own_address_type=OwnAddressType.PUBLIC,
            data=DataTypes(complete_service_class_uuids_128=["955798ce-3022-455c-b759-ee8edcd73d1a"],))
        return "OK"
    ...
    def TSC_MMI_iut_start_general_discovery(self, **kwargs):
        ...
        self.inquiry_events = self.host.Inquiry()
    ...
    def TSC_MMI_iut_confirm_general_discovered_device(self, pts_addr: bytes, **kwargs):
        ...
        for event in self.inquiry_events:
    ...
    def TSC_MMI_iut_start_general_discovery_DM(self, pts_addr: bytes, **kwargs):
        ...
        def search_le():
            ...
            inquiry_events = self.host.Inquiry()
            for event in inquiry_events:
                if event.address == pts_addr and flags_match(event.flags, GENERAL_MASK):
                    inquiry_events.cancel()
                    discovered_le = True
                    return
