...
class HOGPProxy(ProfileProxy):
    ...
    def _mmi_2004(self, **kwargs):
        """
        Please confirm that 6 digit number is matched with 807786.
        """

        self.sm.ProvidePairingConfirmation(connection=self.connection, pairing_confirmation_value=value)
