...
class HAPProxy(ProfileProxy):
    ...
    def IUT_ORDER_WRITE_READ_ALL_PRESET(self, test: str, **kwargs):
        ...
        self.hap.GetAllPresetsInfo(connection=self.connection)
    ...
    def IUT_READ_PRESET_INDEX(self, test: str, index: str, num_presets: str, **kwargs):
        ...
        self.hap.GetPresetInfo(connection=self.connection, index=int(index))
    ...
    def IUT_CONFIGURE_TO_STREAMING_STATE(self, test: str, **kwargs):
        ...
        # self.hap.LeAudioConnect(connection=self.connection)
        self.hap.LeAudioSetActive(connection=self.connection)
    ...
    #
    # @assert_description
    # def _mmi_20105(self, **kwargs):
    #     """
    #     Please write to Client Characteristic Configuration Descriptor of
    #     Hearing Aid Preset Control Point characteristic to enable indication.
    #     """
    #
    #     if (self.discovered_services is None):
    #         self.discovered_services = self.gatt.DiscoverServices(connection=self.connection).services
    #
    ...
    #             if (uuid_16 == HEARING_AID_PRESET_CONTROL_POINT_UUID):
    #                 for descriptor in characteristic.descriptors:
    #                     desc_uuid_16 = short_uuid(descriptor.uuid)
    #                     if (desc_uuid_16 == CCCD_UUID):
