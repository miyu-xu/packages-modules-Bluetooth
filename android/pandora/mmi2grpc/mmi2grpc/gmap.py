...
from pandora_experimental.gmap_pb2 import GmapPlaybackAudioRequest
...
class GMAPProxy(ProfileProxy):
    ...
    def __init__(self, channel, rootcanal):
        ...
        def convert_frame(data):
            return GmapPlaybackAudioRequest(data=data)

        self.audio = AudioSignal(lambda frames: self.gmap.GmapPlaybackAudio(map(convert_frame, frames)),
    ...
    def _mmi_311(self, **kwargs):
        ...
        self.gmap.GmapStart(connection=self.connection)
        self.audio.start()
        return "OK"
