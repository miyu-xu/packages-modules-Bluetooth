...
class HFPProxy(ProfileProxy):
    ...
    def test_started(self, test: str, pts_addr: bytes, **kwargs):
        print(f'in test_started with {test}', file=sys.stderr)
        if test in [
                'HFP/AG/ACC/BI-12-I',
                'HFP/AG/ACC/BI-13-I',
                'HFP/AG/ACC/BI-14-I',
    ...
    def TSC_disable_ag_cellular_network_expect_notification(self, **kwargs):
        ...
        raise NotImplementedError(self.__class__.__name__ + '.TSC_disable_ag_cellular_network_expect_notification       (ง •̀_•́)ง  ')
    ...
    def TSC_disable_ag_cellular_network_expect_no_notification(self, **kwargs):
        ...
        # raise NotImplementedError(self.__class__.__name__ + '.TSC_disable_ag_cellular_network_expect_no_notification       (ง •̀_•́)ง  ')
