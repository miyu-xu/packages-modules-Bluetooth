...
class HFPProxy(ProfileProxy):
    ...
    def TSC_signal_strength_verify(self, **kwargs):
        ...
        print(f'Try to print from TSC_signal_strength_verify' + ", ".join(f"{key}={value}" for key, value in kwargs.items()), file=sys.stderr)
        return "OK"
    ...
    def TSC_iut_disable_network(self, **kwargs):
        ...
        raise NotImplementedError(self.__class__.__name__ +
                                  '.TSC_iut_disable_network       (ง •̀_•́)ง  ')
        return "OK"
    ...
    def TSC_make_battery_discharged(self, **kwargs):
        ...
        self.hfp.SetBatteryLevel(battery_percentage=42)
    ...
    def TSC_make_battery_charged(self, **kwargs):
        ...
        self.hfp.SetBatteryLevel(battery_percentage=100)
