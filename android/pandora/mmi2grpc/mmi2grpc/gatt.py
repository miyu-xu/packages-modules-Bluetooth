...
class GATTProxy(ProfileProxy):
    ...
    def MMI_IUT_RECEIVE_INDICATION(self, **kwargs):
        ...
        """
        self.characteristic_notification_received = self.gatt.IsCharacteristicNotificationReceived(
            connection=self.connection).characteristic_notification_received
        assert self.characteristic_notification_received is True
