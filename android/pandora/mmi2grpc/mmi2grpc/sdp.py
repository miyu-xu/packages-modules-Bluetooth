...
class SDPProxy(ProfileProxy):
    ...
    def TSC_SDP_mmi_verify_browsable_services(self, **kwargs):
        ...
        Android only returns a subset of the profiles:
            0x110A, 0x1112, 0x111F, 0x112F, 0x1132,

        Adding or Removing services from Android will cause this test to fail.
        Updating the description will cause it to pass again.
