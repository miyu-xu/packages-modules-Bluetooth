...
oneway interface IBluetoothVolumeControlCallback {
    ...
    void onAudioLocationChanged(in BluetoothDevice device, in int instanceId, in int audioLocation);
    void onAudioDescriptionChanged(in BluetoothDevice device, in int instanceId, in String audioDescription);
