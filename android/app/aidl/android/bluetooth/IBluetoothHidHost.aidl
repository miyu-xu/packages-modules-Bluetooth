...
interface IBluetoothHidHost {
    ...
    boolean setPreferredTransport(in BluetoothDevice device, int transport, in AttributionSource attributionSource);
    int getPreferredTransport(in BluetoothDevice device, in AttributionSource attributionSource);
