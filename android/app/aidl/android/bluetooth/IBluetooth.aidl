...
interface IBluetooth
{
    ...
    @JavaPassthrough(annotation="@android.annotation.RequiresNoPermission")
    oneway void logRfcommConnectionAttempt(in BluetoothDevice device, boolean isSecured, int resultCode, long socketCreationTimeNanos, int uuidCode, in SynchronousResultReceiver receiver);
