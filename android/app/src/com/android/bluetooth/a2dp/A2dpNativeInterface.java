...
public class A2dpNativeInterface {
    ...
    private final BluetoothAdapter mNativeCallback;

    private BluetoothCodecType[] mSupportedCodecTypes;

    @VisibleForTesting
    private A2dpNativeInterface(@NonNull AdapterService adapterService,
            @NonNull A2dpNativeCallback nativeCallback) {
