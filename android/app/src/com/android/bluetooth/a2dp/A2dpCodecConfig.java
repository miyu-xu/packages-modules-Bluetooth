    ...
    private BluetoothCodecConfig[] assignCodecConfigPriorities() {
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_sbc",
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_aac",
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_aptx",
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_aptx_hd",
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_ldac",
        ...
        try {
            value = SystemProperties.getInt(
                "ro.bluetooth.a2dp_source_codec_priority_lc3",
