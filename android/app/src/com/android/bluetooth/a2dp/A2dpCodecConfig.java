    ...
    private BluetoothCodecConfig[] assignCodecConfigPriorities() {
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.sbc",
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.aac",
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.aptx",
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.aptx_hd",
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.ldac",
        ...
        try {
            value = SystemProperties.getInt(
                "bluetooth.a2dp.source_codec.sbc.priority.lc3",
