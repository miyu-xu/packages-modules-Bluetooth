...
public class BluetoothMapMetricsUtils {
    ...
    static class ContentProfileErrorReported {
        static void writeException(int profile, int fileNameEnum, int type, int tag) {
        ...
        static void writeErrorLog(int profile, int fileNameEnum, int type, int tag) {
            BluetoothStatsLog.write(
                    BluetoothStatsLog.BLUETOOTH_CONTENT_PROFILE_ERROR_REPORTED,
                    BluetoothProfile.MAP,
                    fileNameEnum,
        ...
        static void writeWarnLog(int profile, int fileNameEnum, int type, int tag) {
            BluetoothStatsLog.write(
                    BluetoothStatsLog.BLUETOOTH_CONTENT_PROFILE_ERROR_REPORTED,
                    BluetoothProfile.MAP,
                    fileNameEnum,
