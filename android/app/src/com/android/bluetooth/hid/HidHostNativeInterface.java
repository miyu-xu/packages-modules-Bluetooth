...
public class HidHostNativeInterface {
    ...
    boolean setProtocolMode(byte[] address, int addressType, int transportType, byte protocolMode) {
    ...
    private native boolean getIdleTimeNative(byte[] btAddress, int addressType, int transportType);
}
