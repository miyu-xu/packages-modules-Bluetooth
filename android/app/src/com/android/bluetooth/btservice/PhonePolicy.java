...
public class PhonePolicy implements AdapterService.BluetoothStateCallback {
    ...
    public void profileConnectionStateChanged(
        ...
        mHandler.post(() -> processProfileStateChanged(device, profile, fromState, toState));
    }
    ...
    private void processProfileStateChanged(
            BluetoothDevice device, int profile, int prevState, int nextState) {
        Log.d(
                TAG,
                ("processProfileStateChanged(" + device + ", " + getProfileName(profile) + ": ")
