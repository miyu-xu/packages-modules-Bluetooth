...
public class AdapterNativeInterface {
    ...
    int connectSocket(
            byte[] address, int type, byte[] uuid, int port, int flag, int callingUid, int regId) {
        return connectSocketNative(address, type, uuid, port, flag, callingUid, regId);
    }
    ...
    int createSocketChannel(
            ...
            int callingUid,
            int regId) {
        return createSocketChannelNative(type, serviceName, uuid, port, flag, callingUid, regId);
    }
