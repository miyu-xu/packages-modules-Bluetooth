...
public class AdapterNativeInterface {
    ...
    int connectSocket(byte[] address, int type, byte[] uuid, int port, int flag, int callingUid, int regId, boolean offload) {
        return connectSocketNative(address, type, uuid, port, flag, callingUid, regId, offload);
    }

    int createSocketChannel(
            int type, String serviceName, byte[] uuid, int port, int flag, int callingUid, int regId, boolean offload) {
        return createSocketChannelNative(type, serviceName, uuid, port, flag, callingUid, regId, offload);
    }
    ...
    private native int connectSocketNative(
            byte[] address, int type, byte[] uuid, int port, int flag, int callingUid, int regId, boolean offload);
