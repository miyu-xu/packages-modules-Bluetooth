...
final class RemoteDevices {
    ...
    class DeviceProperties {
        ...
        */
        ...
        /**
         * @return the mIsHiddenInUI
        */
        boolean isHiddenInUI() {
            synchronized (mObject) {
                return mIsHiddenInUI;
            }
        }

        void setIsHiddenInUI(boolean isHiddenInUI) {
            synchronized (mObject) {
                this.mIsHiddenInUI = isHiddenInUI;
            }
        }
                ...
                synchronized (mObject) {
                    ...
                    switch (type) {
                        ...
                        case AbstractionLayer.BT_PROPERTY_REMOTE_IS_COORDINATED_SET_MEMBER:
                            ...
                            break;
                        case AbstractionLayer.BT_PROPERTY_REMOTE_IS_HIDDEN_IN_UI:
                            deviceProperties.setIsHiddenInUI(val[0] != 0);
                            break;
                    }
                }
            }
    ...
    void deviceFoundCallback(byte[] address) {
        ...
        intent.putExtra(BluetoothDevice.EXTRA_IS_HIDDEN_IN_UI,
                deviceProp.isHiddenInUI());
