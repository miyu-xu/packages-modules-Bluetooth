...
final class RemoteDevices {
    ...
    class DeviceProperties {
        ...
        */
        ...
        /**
         * @return the mIsHiddenFromUser
        */
        boolean isHiddenFromUser() {
            synchronized (mObject) {
                return mIsHiddenFromUser;
            }
        }

        void setIsHiddenFromUser(boolean isHiddenFromUser) {
            synchronized (mObject) {
                this.mIsHiddenFromUser = isHiddenFromUser;
            }
        }
                ...
                synchronized (mObject) {
                    ...
                    switch (type) {
                        ...
                        case AbstractionLayer.BT_PROPERTY_REMOTE_IS_COORDINATED_SET_MEMBER:
                            ...
                            break;
                        case AbstractionLayer.BT_PROPERTY_REMOTE_IS_HIDDEN_FROM_USER:
                            deviceProperties.setIsHiddenFromUser(val[0] != 0);
                            break;
                    }
                }
            }
    ...
    void deviceFoundCallback(byte[] address) {
        ...
        intent.putExtra(BluetoothDevice.EXTRA_IS_HIDDEN_FROM_USER,
                deviceProp.isHiddenFromUser());
