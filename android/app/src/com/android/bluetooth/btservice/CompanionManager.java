...
public class CompanionManager {
    ...
    public int verifyGattSubratingPriority(
        ...
        return verifyGattSubratingPriorityDefault(subrateFactor, latency, contNum);
    }

    private int verifyGattSubratingPriorityDefault(int subrateFactor, int latency, int contNum) {
