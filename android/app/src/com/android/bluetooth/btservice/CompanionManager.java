...
public class CompanionManager {
    ...
    public int verifyGattSubratingPriority(
            ...
            int latency,
            int contNum) {
        return verifyGattSubratingPriorityDefault(requestedMode, subrateFactor, latency, contNum);
    }
    ...
    public int getGattSubratingParameters(
            BluetoothDevice device, int type, @BluetoothGatt.SubrateMode int priority) {
        return getGattSubratingParameterDefault(type, priority);
    }
