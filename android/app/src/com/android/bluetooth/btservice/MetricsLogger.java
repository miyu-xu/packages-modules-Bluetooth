...
public class MetricsLogger {
    ...
    private void logConnectionStateChanges(int profile, Intent connIntent) {
        ...
        byte[] remoteDeviceInfoBytes = getRemoteDeviceInfoProto(device, isDeIdentifiedLogging);
     ...
     */
    public byte[] getRemoteDeviceInfoProto(BluetoothDevice device, boolean isDeIdentifiedLogging) {
        if (!mInitialized) {
            return null;
        }
        ...
        writeFieldIfNotNull(
                ...
                getAllowlistedDeviceNameHash(
                        mAdapterService.getRemoteName(device), isDeIdentifiedLogging));
    ...
    private String getMatchedString(List<String> wordBreakdownList, boolean isDeIdentifiedLogging) {
        ...
        return (matchedString.equals("") && isDeIdentifiedLogging)
    ...
    protected String getAllowlistedDeviceNameHash(
            String deviceName, boolean isDeIdentifiedLogging) {
        List<String> wordBreakdownList = getWordBreakdownList(deviceName);
        String matchedString = getMatchedString(wordBreakdownList, isDeIdentifiedLogging);
    ...
    public void logBluetoothEvent(BluetoothDevice device, int eventType, int state, int uid) {
        ...
        BluetoothStatsLog.write(
                ...
                getRemoteDeviceInfoProto(device, isDeIdentifiedLogging));
    }
