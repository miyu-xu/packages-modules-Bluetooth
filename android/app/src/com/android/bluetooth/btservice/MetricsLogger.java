...
public class MetricsLogger {
    ...
    private ArrayList<String> getWordBreakdown(String deviceName) {
    ...
    private byte[] getMatchedSha256(ArrayList<String> wordBreakdownList) {
    ...
    protected boolean logSanitizedBluetoothDeviceName(int metricId, String deviceName) {
        ...
        byte[] matchedSha256 = getMatchedSha256(wordBreakdownList);
    ...
    protected void statslogBluetoothDeviceNames(int metricId, String sha256) {
        Log.d(TAG,
