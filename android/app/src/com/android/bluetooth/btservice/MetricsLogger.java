...
public class MetricsLogger {
    ...
    private static final long BLUETOOTH_COUNTER_METRICS_ACTION_DURATION_MILLIS = 10000L;//6L * 3600L * 1000L;
    ...
    class CounterDrainer extends TimerTask {
        @Override
        public void run() {
    ...
    protected void scheduleDrains() {
        ...
        Date executionTime = new Date(
                System.currentTimeMillis() + BLUETOOTH_COUNTER_METRICS_ACTION_DURATION_MILLIS);
        mTimer.schedule(new CounterDrainer(), executionTime);
