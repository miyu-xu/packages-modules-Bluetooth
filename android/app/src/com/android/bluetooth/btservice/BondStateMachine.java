        ...
        if (newState == BluetoothDevice.BOND_NONE) {
            ...
            if (isBondLostMetdadata != null
                ...
                MetricsLogger.getInstance()
                        .logBluetoothEvent(
                                device,
                                BluetoothStatsLog.BLUETOOTH_CROSS_LAYER_EVENT_REPORTED__EVENT_TYPE__TRANSITION,
                                BluetoothStatsLog.BLUETOOTH_CROSS_LAYER_EVENT_REPORTED__STATE__ACTION_KEY_MISSING_TO_BOND_NONE,
                                0);
            }
        }
