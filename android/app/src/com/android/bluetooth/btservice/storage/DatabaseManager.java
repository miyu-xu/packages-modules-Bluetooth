...
public class DatabaseManager {
    ...
    public boolean setAudioPolicyMetadata(BluetoothDevice device, BluetoothAudioPolicy policies) {
        synchronized (mMetadataCache) {
            ...
            entity.connectDuringCallAudioPolicy = policies.getConnectDuringCallPolicy();
            entity.inBandRingAudioPolicy = policies.getInBandRingPolicy();
    ...
    public BluetoothAudioPolicy getAudioPolicyMetadata(BluetoothDevice device) {
        synchronized (mMetadataCache) {
            ...
            return new BluetoothAudioPolicy.Builder()
                    ...
                    .setConnectDuringCallPolicy(entity.connectDuringCallAudioPolicy)
                    .setInBandRingPolicy(entity.inBandRingAudioPolicy)
                    .build();
        }
    }
