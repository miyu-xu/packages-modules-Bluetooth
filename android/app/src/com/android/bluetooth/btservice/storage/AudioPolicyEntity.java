...
class AudioPolicyEntity {
    ...
    @ColumnInfo(name = "connect_during_call_audio_policy")
    public int connectDuringCallAudioPolicy;
    ...
    AudioPolicyEntity() {
        ...
        connectDuringCallAudioPolicy = BluetoothAudioPolicy.POLICY_DEFAULT;
        inBandRingtoneAudioPolicy = BluetoothAudioPolicy.POLICY_DEFAULT;
    }

    AudioPolicyEntity(int callEstablishAudioPolicy, int connectDuringCallAudioPolicy,
            int inBandRingtoneAudioPolicy) {
        this.callEstablishAudioPolicy = callEstablishAudioPolicy;
        this.connectDuringCallAudioPolicy = connectDuringCallAudioPolicy;
    ...
    public String toString() {
        ...
        builder.append("callEstablishAudioPolicy=")
                ...
                .append("|connectDuringCallAudioPolicy=")
                .append(metadataToString(connectDuringCallAudioPolicy))
