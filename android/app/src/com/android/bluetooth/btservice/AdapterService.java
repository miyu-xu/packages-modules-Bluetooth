...
public class AdapterService extends Service {
    ...
    public static class AdapterServiceBinder extends IBluetooth.Stub {
        ...
        @Override
        public void setInactiveAudioDeviceUponConnection(
                BluetoothDevice device,
                boolean inactive,
                AttributionSource source,
                SynchronousResultReceiver receiver) {
            try {
                receiver.send(setInactiveAudioDeviceUponConnection(device, inactive, source));
            } catch (RuntimeException e) {
                receiver.propagateException(e);
            }
        }
        ...
        private int setInactiveAudioDeviceUponConnection(
                BluetoothDevice device, boolean inactive, AttributionSource source) {
            AdapterService service = getService();
            if (service == null) {
                return BluetoothStatusCodes.ERROR_BLUETOOTH_NOT_ENABLED;
            }
            if (!callerIsSystemOrActiveOrManagedUser(
                    service, TAG, "setInactiveAudioDeviceUponConnection")) {
                return BluetoothStatusCodes.ERROR_BLUETOOTH_NOT_ALLOWED;
            }
            if (device == null) {
                throw new IllegalArgumentException("device cannot be null");
            ...
            enforceBluetoothPrivilegedPermission(service);
            return service.mDatabaseManager.setInactiveAudioDeviceUponConnection(device, inactive);
        }

        @Override
        public void isInactiveAudioDeviceUponConnection(
                BluetoothDevice device,
                AttributionSource source,
                SynchronousResultReceiver receiver) {
            try {
                receiver.send(isInactiveAudioDeviceUponConnection(device, source));
            } catch (RuntimeException e) {
                receiver.propagateException(e);
            }
        }
        ...
        private boolean isInactiveAudioDeviceUponConnection(
                BluetoothDevice device, AttributionSource source) {
            AdapterService service = getService();
            if (service == null) {
                return false;
            ...
            if (!callerIsSystemOrActiveOrManagedUser(
                    service, TAG, "isInactiveAudioDeviceUponConnection")) {
            ...
            enforceBluetoothPrivilegedPermission(service);
            return service.mDatabaseManager.isInactiveAudioDeviceUponConnection(device);
        }
    }
