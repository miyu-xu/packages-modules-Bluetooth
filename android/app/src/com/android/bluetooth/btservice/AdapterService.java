...
public class AdapterService extends Service {
    ...
    public void setBatteryLevel(BluetoothDevice device, int batteryLevel, boolean fromHfp) {
        if (batteryLevel == BATTERY_LEVEL_UNKNOWN) {
            mRemoteDevices.resetBatteryLevel(device, fromHfp);
        } else {
            mRemoteDevices.updateBatteryLevel(device, batteryLevel, fromHfp);
        }
    }
