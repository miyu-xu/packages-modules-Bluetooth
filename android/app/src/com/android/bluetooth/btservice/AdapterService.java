...
public class AdapterService extends Service {
    ...
    private void setProfileServiceState(Class service, int state) {
        if (state == BluetoothAdapter.STATE_ON) {
            ...
            try {
                profileService = (ProfileService)service.getDeclaredConstructor(Context.class).newInstance(this);
            ...
            if (profileService != null) {
                ...
                Log.e(TAG, "setProfileServiceState(" + service.getSimpleName() + ", STATE_OFF): profile is already stopped");
            }
        }
    }
