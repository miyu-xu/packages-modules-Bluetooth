...
public class AdapterService extends Service {
    ...
    private int getIdleCurrentMa() {
        return BluetoothProperties.idle_cur_ma().orElse(0);
    }

    private int getTxCurrentMa() {
        return BluetoothProperties.tx_cur_ma().orElse(0);
    }

    private int getRxCurrentMa() {
        return BluetoothProperties.rx_cur_ma().orElse(0);
    }

    private double getOperatingVolt() {
        return BluetoothProperties.operating_voltage_mv().orElse(0) / 1000.0;
    }
