...
public class AdapterService extends Service {
    ...
    public static class AdapterServiceBinder extends IBluetooth.Stub {
        ...
        private int setPreferredAudioProfiles(BluetoothDevice device, Bundle modeToProfileBundle,
            ...
            BluetoothDevice groupLead = service.mLeAudioService.getLeadDevice(device);
            if (groupLead == null) {
                return BluetoothStatusCodes.ERROR_DEVICE_NOT_BONDED;
            }
            ...
            if (modeToProfileBundle.containsKey(BluetoothAdapter.AUDIO_MODE_OUTPUT_ONLY)
                    && service.isOutputOnlyAudioSupported(groupLead)) {
            ...
            if (modeToProfileBundle.containsKey(BluetoothAdapter.AUDIO_MODE_DUPLEX)
                    && service.isDuplexAudioSupported(groupLead)) {
            ...
            return service.mDatabaseManager.setPreferredAudioProfiles(groupLead,
                    strippedPreferences);
        }
        ...
        private Bundle getPreferredAudioProfiles(BluetoothDevice device,
            ...
            Bundle storedBundle = service.mDatabaseManager.getPreferredAudioProfiles(groupLead);
            if (storedBundle.isEmpty()) {
                ...
                if (service.isOutputOnlyAudioSupported(groupLead)) {
                    storedBundle.putInt(BluetoothAdapter.AUDIO_MODE_OUTPUT_ONLY, outputOnlyDefault);
                }
                if (service.isDuplexAudioSupported(groupLead)) {
