...
public class AdapterService extends Service {
    ...
    private static final int MESSAGE_PROFILE_SERVICE_BINDED = 5;
    private static final int MESSAGE_PROFILE_SERVICE_UNBINDED = 6;
    ...
    class AdapterServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_PROFILE_SERVICE_UNREGISTERED:
                    ...
                    break;
                case MESSAGE_PROFILE_SERVICE_BINDED:
                    verboseLog("handleMessage() - MESSAGE_PROFILE_SERVICE_BINDED");
                    gattBinded((IBinder) msg.obj);
                    break;
                case MESSAGE_PROFILE_SERVICE_UNBINDED:
                    verboseLog("handleMessage() - MESSAGE_PROFILE_SERVICE_UNBINDED");
                    gattUnbinded();
                    break;
        ...
        private void gattBinded(IBinder service) {
            mBluetoothGatt = IBluetoothGatt.Stub.asInterface(service);
            try {
                mBluetoothGatt.startService();
            } catch (RemoteException e) {
                Log.e(TAG, "gattBinded: RemoteException", e);
            }
        }

        private void gattUnbinded() {
            mBluetoothGatt = null;
            Log.e(TAG, "Gatt service has disconnected from AdapterService unexpectedly");
        }
    ...
    class GattServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            mHandler.obtainMessage(MESSAGE_PROFILE_SERVICE_BINDED, service).sendToTarget();
        }
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            ...
            mHandler.sendEmptyMessage(MESSAGE_PROFILE_SERVICE_UNBINDED);
        }
    }
