...
public class AdapterService extends Service {
    ...
    void switchCodecCallback(boolean isLowLatencyBufferSize) {
        ...
        BluetoothCodecStatus codecStatus = mA2dpService.getCodecStatus(activeDevices.get(0));
        mA2dpService.switchCodecByBufferSize(
                isLowLatencyBufferSize, codecStatus.getCodecConfig().getCodecType());
    }
