...
public class AdapterService extends Service {
     ...
     */
    private class PendingAudioProfilePreferenceRequest {
    ...
    public boolean isAllSupportedClassicAudioProfilesActive(BluetoothDevice device) {
        ...
        boolean a2dpSupported = isProfileSupported(device, BluetoothProfile.A2DP);
        boolean hfpSupported = isProfileSupported(device, BluetoothProfile.HEADSET);
