...
public class AdapterService extends Service {
    ...
    private Set<BluetoothStateCallback> mLocalCallbacks;
    ...
    void updateAdapterState(int prevState, int newState) {
        ...
        if (mLocalCallbacks != null) {
            for (BluetoothStateCallback callback : mLocalCallbacks) {
                callback.onBluetoothStateChange(prevState, newState);
            }
        }
    ...
    public void registerBluetoothStateCallback(BluetoothStateCallback callback) {
