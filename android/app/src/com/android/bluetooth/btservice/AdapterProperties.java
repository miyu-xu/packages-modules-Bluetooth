...
class AdapterProperties {
    ...
    private int numberOfSupportedOffloadedLeCocSockets;
    ...
    /**
     * @return the numberOfSupportedOffloadedLeCocSockets
     */
    int getNumberOfSupportedOffloadedLeCocSockets() {
        return numberOfSupportedOffloadedLeCocSockets;
    }
    ...
    private void updateLppOffloadFeatureSupport(byte[] val) {
        ...
        numberOfSupportedOffloadedLeCocSockets = (0xFF & ((int) val[0]));

        Log.d(
                TAG,
                "BT_PROPERTY_LPP_OFFLOAD_FEATURES: update from Offload HAL"
                        + " numberOfSupportedOffloadedLeCocSockets = "
                        + numberOfSupportedOffloadedLeCocSockets);
    }
