...
class AdapterProperties {
    ...
    private boolean mIsSocketHwOffloadSupported;
    ...
    /**
     * @return Socket hardware offload support
     */
    boolean isSocketHwOffloadSupported() {
        return mIsSocketHwOffloadSupported;
    }
    ...
    private void updateLppOffloadFeatureSupport(byte[] val) {
        ...
        mIsSocketHwOffloadSupported = ((0xFF & ((int) val[0])) != 0);

        Log.d(
                TAG,
                "BT_PROPERTY_LPP_OFFLOAD_FEATURES: update from Offload HAL"
                        + " mIsSocketHwOffloadSupported = "
                        + mIsSocketHwOffloadSupported);
    }
