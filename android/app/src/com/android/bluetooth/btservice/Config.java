...
public class Config {
    ...
    static void init(Context ctx) {
        ...
        if (unicastEnabled && bcastDynamicSwitchSupported) {
            final String bcastDynamicDisabled =
                    SystemProperties.get(LE_AUDIO_BROADCAST_SWITCHER_DISABLED_PROPERTY, "none");
            if (bcastDynamicDisabled.equals("true")) {
                setBcastProfileStatus(false);
            } else if (bcastDynamicDisabled.equals("false")) {
