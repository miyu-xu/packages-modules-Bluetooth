...
public class Config {
    ...
    private static final String LE_AUDIO_STATUS_ENABLE_UNICAST = "Enable Unicast";
    private static final String LE_AUDIO_STATUS_ENABLE_UNICAST_BROADCAST =
    ...
    static void init(Context ctx) {
        ...
        } else if (leAudioSwitchStatus.equals(LE_AUDIO_STATUS_ENABLE_UNICAST)
                && leAudioDynamicSwitchSupported) {
            setLeAudioProfileStatus(true);
            setBroadcastProfileStatus(false);
        } else if (leAudioSwitchStatus.equals(LE_AUDIO_STATUS_ENABLE_UNICAST_BROADCAST)
