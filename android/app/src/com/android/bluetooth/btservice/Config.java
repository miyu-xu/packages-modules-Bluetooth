...
public class Config {
    ...
    private static final String LE_AUDIO_DYNAMIC_DISABLED_PROPERTY =
    ...
    static void init(Context ctx) {
        ...
        if (leAudioDynamicSwitchSupported) {
            final String leAudioDynamicDisabled = SystemProperties
                    .get(LE_AUDIO_DYNAMIC_DISABLED_PROPERTY, "none");
            if (leAudioDynamicDisabled.equals("true")) {
                setLeAudioProfileStatus(false);
            } else if (leAudioDynamicDisabled.equals("false")) {
