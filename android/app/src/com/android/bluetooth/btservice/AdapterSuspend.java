    ...
    public final DeviceStateManager.DeviceStateCallback mDeviceStateCallback =
            new DeviceStateManager.DeviceStateCallback() {
                ...
                public void onDeviceStateChanged(@NonNull DeviceState state) {
                    ...
                    Log.i(TAG, "Check state transition: " + mCurrentState + " => " + nextState);
                    Log.i(TAG, "Init wake status: " + mWakeByBt);
                    ...
                    Log.i(TAG, "Update state: " + mCurrentState + " => " + nextState);
                    Log.i(TAG, "Final wake status: " + mWakeByBt);
