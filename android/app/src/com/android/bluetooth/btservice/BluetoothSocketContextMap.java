...
public class BluetoothSocketContextMap {
    ...
    public static class App {
        ...
        App(int regId, int protocol, int state, int appUid, String pkgName) {
            this.regId = regId;
            this.protocol = protocol;
            this.state = state;
            this.appUid = appUid;
    ...
    public App add(int regId, int protocol, int state, int appUid, String pkgName) {
        synchronized (mAppsLock) {
            App app = new App(regId, protocol, state, appUid, pkgName);
            mApps.add(app);
            return app;
        }
    }
