...
public final class Utils {
    ...
    private static final Map<Void, Boolean> isInstrumentationTestModeCache = new ConcurrentHashMap<>();
    ...
    public static boolean isInstrumentationTestMode() {
        return isInstrumentationTestModeCache.computeIfAbsent(null, key -> {
            try {
