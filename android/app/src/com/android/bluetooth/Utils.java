...
public final class Utils {
    ...
    /**
     * Returns true if the BLUETOOTH_PRIVILEGED permission is needed and granted for
     * the calling app. This permission is needed if advertising address type is set
     * to ADDRESS_TYPE_RANDOM or ADDRESS_TYPE_PUBLIC. Returns false if the result is
     * a soft denial. Throws SecurityException if the result is a hard denial.
     * <p>
     * Should be used in situations where data will be delivered and hence the
     * app op should be noted.
     */
