...
public class BassClientService extends ProfileService {
    ...
    private void updateStoredSinkMetadata(
            BluetoothDevice device,
    ...
    public void addSource(
        ...
        for (BluetoothDevice device : devices) {
            ...
            /* Store metadata for sink device */
            updateStoredSinkMetadata(device, Optional.of(sourceMetadata.getBroadcastId()), sourceMetadata);
    ...
    public void modifySource(
        ...
        updateStoredSinkMetadata(sink, Optional.of(updatedMetadata.getBroadcastId()), updatedMetadata);
    ...
    public void removeSource(BluetoothDevice sink, int sourceId) {
        ...
        for (Map.Entry<BluetoothDevice, Integer> deviceSourceIdPair : devices.entrySet()) {
            ...
            if (statusCode != BluetoothStatusCodes.SUCCESS) {
                updateStoredSinkMetadata(device, Optional.empty(), null);
    ...
    public void handleDeviceDisconnection(BluetoothDevice sink, boolean isIntentional) {
        ...
        while (iterator.hasNext()) {
            ...
            if (isIntentional) {
                ...
                updateStoredSinkMetadata(sink, Optional.empty(), null);
