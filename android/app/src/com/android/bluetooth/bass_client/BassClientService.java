...
public class BassClientService extends ProfileService {
        ...
        if (hasGroupOpTrigger(device)) {
            ...
            if (csipClient != null) {
                List<BluetoothDevice> groupDevices =
                        csipClient.getGroupDevices(device, BluetoothUuid.CAP);
    ...
    public void addSource(BluetoothDevice sink, BluetoothLeBroadcastMetadata sourceMetadata,
        ...
        addSource(getGroupDevices(sink), sourceMetadata);
    }

    private void addSource(List<BluetoothDevice> devices,
