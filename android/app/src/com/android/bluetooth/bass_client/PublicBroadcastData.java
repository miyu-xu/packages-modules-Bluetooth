...
class PublicBroadcastData {
    ...
    static PublicBroadcastData parsePublicBroadcastData(byte[] serviceData) {
        if (serviceData == null) {
            ...
            throw new IllegalArgumentException("PublicBroadcastData: serviceData is null");
        }
        ...
        int offset = 0;
        // Parse Public broadcast annoucement features
        ...
        // Parse Public broadcast annoucement metadata
