...
public class BassConstants {
    ...
    public static final UUID BASS_UUID_GATT =
    ...
    public static int ADV_ADDRESS_DONT_MATCHES_EXT_ADV_ADDRESS = 0x00000001;
    public static int ADV_ADDRESS_DONT_MATCHES_SOURCE_ADV_ADDRESS = 0x00000002;
