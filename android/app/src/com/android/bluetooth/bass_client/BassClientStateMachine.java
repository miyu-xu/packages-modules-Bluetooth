...
class BassClientStateMachine extends StateMachine {
    ...
    private void processBroadcastReceiverState(
        ...
        if (receiverState.length == 0
            ...
            numSubGroups = receiverState[BassConstants.BCAST_RCVR_STATE_BADCODE_START_IDX
                    + BassConstants.BCAST_RCVR_STATE_BADCODE_SIZE];
            ...
            for (int i = 0; i < numSubGroups; i++) {
                ...
                offset = offset + BassConstants.BCAST_RCVR_STATE_BIS_SYNC_SIZE;
    ...
    void acquireAllBassChars() {
        ...
        if (mBluetoothGatt != null) {
            ...
            service = mBluetoothGatt.getService(BassConstants.BASS_UUID_GATT);
        }
        if (service == null) {
