...
public class BassClientStateMachine extends StateMachine {
    ...
    @VisibleForTesting
    public class ConnectedProcessing extends State {
        @Override
        public void enter() {
    ...
    public static class BluetoothGattTestableWrapper {
        public final android.bluetooth.BluetoothGatt mWrappedBluetoothGatt;

        BluetoothGattTestableWrapper(android.bluetooth.BluetoothGatt bluetoothGatt) {
        ...
        /**
         * See {@link android.bluetooth.BluetoothGatt#readCharacteristic(
        ...
        /**
         * See {@link android.bluetooth.BluetoothGatt#writeCharacteristic(
