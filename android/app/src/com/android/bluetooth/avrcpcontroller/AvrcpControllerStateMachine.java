...
class AvrcpControllerStateMachine extends StateMachine {
    ...
    private void notifyBrowseNodeChanged(BrowseTree.BrowseNode node) {
        ...
        if (scope == AvrcpControllerService.BROWSE_SCOPE_NOW_PLAYING && isActive()) {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case MESSAGE_PROCESS_GET_FOLDER_ITEMS:
                    ...
                    notifyBrowseNodeChanged(mBrowseNode);
                ...
                case MESSAGE_PROCESS_GET_PLAYER_ITEMS:
                    ...
                    if (!rootNode.isCached()) {
                        ...
                        notifyBrowseNodeChanged(rootNode);
                    }
                    transitionTo(mConnected);
                    break;
