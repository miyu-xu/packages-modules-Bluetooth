...
public class AvrcpTargetService extends ProfileService {
    ...
    private final BroadcastReceiver mUserSwitchedReceiver =
            new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    // EXTRA_USER_HANDLE is sent for both ACTION_USER_UNLOCKED
                    ...
                    // Only registered intent is ACTION_USER_UNLOCKED
    ...
    protected boolean start() {
        ...
        getApplicationContext().registerReceiver(mUserSwitchedReceiver, userFilter);
