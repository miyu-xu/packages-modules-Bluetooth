...
public class CoverArt {
    ...
    CoverArt(Image image) {
        ...
        mImage = Bitmap.createScaledBitmap(
                image.getImage(), THUMBNAIL_SIZE, THUMBNAIL_SIZE, false);
    }
    ...
    public BipImageProperties getImageProperties() {
        ...
        BipImageFormat pngVariantFormat = BipImageFormat.createVariant(
                pngEncoding, pngPixel, THUMBNAIL_SIZE, null);
