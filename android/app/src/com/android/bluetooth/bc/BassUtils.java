...
final class BassUtils {
        ...
        private final Map<ArrayList<IBleBroadcastAudioScanAssistCallback>, ScanCallback>
        ...
        BassUtils (BCService service) {
            ...
            mLeAudioSourceScanCallbacks =
                    new HashMap<ArrayList<IBleBroadcastAudioScanAssistCallback>,
                                                ScanCallback>();
                                    ...
                                    if (cbs != null) {
                                        for (IBleBroadcastAudioScanAssistCallback cb : cbs) {
                                           try {
                                               ...
                                               Log.e(TAG,
                                               "Exception while calling onBleBroadcastSourceFound");
                                           }
                                        }
                                    } else {
