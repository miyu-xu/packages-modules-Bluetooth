...
//           }
   ...
   private List<BleBroadcastSourceChannel> getListOfBisIndices(int bisIndices, int subGroupId, byte[] metaData) {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CONNECT:
                    ...
                    if ((mBluetoothGatt = mDevice.connectGatt(mService, mIsAllowedList, mGattCallback,
...
//                         }
    ...
    private byte[] convertSourceInfoToAddSourceByteArray(BleBroadcastSourceInfo srcInfo) {
        ...
        for (int i=0; i<base_.getNumberOfSubgroupsofBIG(); i++) {
            ...
            //int bisIndexValue = convertBisIndicesToIntegerValue(srcInfo.getBroadcastChannelsSyncStatus());
            int bisIndexValue = convertBisIndicesToIntegerValue(mService.getBassUtils().selectBises(
