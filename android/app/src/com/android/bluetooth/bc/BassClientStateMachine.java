...
*/
    ...
    private void broadcastReceiverState(BleBroadcastSourceInfo state,
    ...
    private void processBroadcastReceiverState (byte[] receiverState,
        ...
        if (receiverState.length == 0 ||
           ...
           if (srcInfo.isEmptyEntry()) {
            ...
            byte[] metaData = null;
            if (encryptionStatus == BleBroadcastSourceInfo.BROADCAST_ASSIST_ENC_STATE_BADCODE) {
        ...
        BleBroadcastSourceInfo oldSourceInfo =
                mBleBroadcastSourceInfos.get(characteristic.getInstanceId());
...
*/
    ...
    private byte[] convertSourceInfoToUpdateSourceByteArray(BleBroadcastSourceInfo srcInfo) {
        ...
        BCService.PAResults paRes = null;
        BleBroadcastSourceInfo existingSI =
...
*/
                ...
                case GATT_TXN_PROCESSED:
                    ...
                    if (status == BluetoothGatt.GATT_SUCCESS) {
                        if (mPendingOperation == SET_BCAST_CODE) {
                           ...
                           sendPendingCallbacks(mPendingOperation, mPendingSourceId,
                                BleBroadcastAudioScanAssistCallback.BASS_STATUS_SUCCESS);
                        }
                    } else {
                        ...
                        sendPendingCallbacks(mPendingOperation, mPendingSourceId,
                                BleBroadcastAudioScanAssistCallback.BASS_STATUS_FAILURE);
                    }
                    transitionTo(mConnected);
                    break;
                case GATT_TXN_TIMEOUT:
                    ...
                    //mService.notifyOperationCompletion(mDevice, mPendingOperation);
                    sendPendingCallbacks(mPendingOperation, mPendingSourceId,
                            BleBroadcastAudioScanAssistCallback.BASS_STATUS_TXN_TIMEOUT);
                    mPendingOperation = -1;
                    transitionTo(mConnected);
                    mPendingSourceId = -1;
               break;
