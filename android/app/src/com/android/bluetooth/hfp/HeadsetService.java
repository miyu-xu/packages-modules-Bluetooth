...
public class HeadsetService extends ProfileService {
    ...
    boolean startVoiceRecognition(BluetoothDevice device) {
        ...
        enableSwbCodec(HeadsetHalConstants.BTHF_SWB_CODEC_VENDOR_APTX, true);
        return true;
    }
    ...
    boolean stopVoiceRecognition(BluetoothDevice device) {
        ...
        enableSwbCodec(HeadsetHalConstants.BTHF_SWB_CODEC_VENDOR_APTX, false);
        return true;
    }
    ...
    /** Enable SWB Codec. */
    public void enableSwbCodec(int swbCodec, boolean enable) {
        logD("enableSwbCodec: swbCodec: " + swbCodec + "enable: " + enable);
        boolean result = mNativeInterface.enableSwb(swbCodec, enable);
        logD("enableSwbCodec result: " + result);
    }

    /** Check whether SWB Codec is enabled. */
    public boolean isSwbEnabled(int swbCodec) {
        boolean enable = mNativeInterface.isSwbEnabled(swbCodec);
        logD("isSwbEnabled: swbCodec: " + swbCodec + "enabled: " + enable);
        return enable;
    }
