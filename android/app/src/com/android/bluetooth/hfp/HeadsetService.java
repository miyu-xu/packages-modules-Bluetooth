...
public class HeadsetService extends ProfileService {
    ...
    protected boolean start() {
        ...
        mIsAptXSwbPmEnabled = BluetoothProperties.swb_aptx_power_management().orElse(false);
    ...
    boolean startVoiceRecognition(BluetoothDevice device) {
        ...
        enableSwbCodec(HeadsetHalConstants.BTHF_SWB_CODEC_APTX, true);
        return true;
    }
    ...
    public void enableSwbCodec(int swbCodec, boolean enable) {
        ...
        mNativeInterface.enableSwb(swbCodec, enable);
    }
