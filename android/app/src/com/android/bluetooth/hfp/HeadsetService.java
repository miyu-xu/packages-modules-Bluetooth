...
public class HeadsetService extends ProfileService {
    ...
    void phoneStateChanged(int numActive, int numHeld, int callState, String number,
        ...
        if (callState == HeadsetHalConstants.CALL_STATE_IDLE) {
            BluetoothAudioPolicy currentPolicy = mAdapterService.getAudioPolicy(mActiveDevice);
            if (currentPolicy != null && currentPolicy.getConnectingPolicy()
    ...
    public boolean isInbandRingingEnabled() {
        ...
        boolean inbandRingAllowedByPolicy = true;
        ...
        if (audioConnectableDevices.size() == 1) {
            ...
            if (callAudioPolicy != null && callAudioPolicy.getInBandRingPolicy()
                    == BluetoothAudioPolicy.POLICY_NOT_ALLOWED) {
                inbandRingAllowedByPolicy = false;
            }
        }
