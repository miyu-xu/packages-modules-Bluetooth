...
public class BatteryStateMachine extends StateMachine {
    ...
    class Disconnected extends State {
        private static final String TAG =
                BatteryStateMachineConfig.TAG_PREFIX + Disconnected.class.getSimpleName();
    ...
    class Connecting extends State {
        private static final String TAG =
                BatteryStateMachineConfig.TAG_PREFIX + Connecting.class.getSimpleName();
    ...
    class Disconnecting extends State {
        private static final String TAG =
                BatteryStateMachineConfig.TAG_PREFIX + Disconnecting.class.getSimpleName();
    ...
    class Connected extends State {
        private static final String TAG =
                BatteryStateMachineConfig.TAG_PREFIX + Connected.class.getSimpleName();
