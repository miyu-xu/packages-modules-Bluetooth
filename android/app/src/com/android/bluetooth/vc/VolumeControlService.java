...
public class VolumeControlService extends ProfileService {
    ...
    static class BluetoothVolumeControlBinder extends IBluetoothVolumeControl.Stub
        ...
        @RequiresPermission(allOf = {BLUETOOTH_CONNECT, BLUETOOTH_PRIVILEGED})
        private <R> R aics_setter(
                AudioInputControl.Descriptor descriptor,
                AttributionSource source,
                BiFunction<VolumeControlInputDescriptor, VolumeControlNativeInterface, R> fn,
                R defaultValue) {
            validateAudioInputControlDescriptor(descriptor);
            ...
            return fn.apply(inputs, service.mNativeInterface);
        }
        ...
        public boolean setAudioInputDescription(
            ...
            return aics_setter(
                    ...
                    source,
                    (i, n) -> {
                        return i.setDescription(descriptor.mInstanceId, description, n);
                    },
                    false);
        }
    }
