...
public class VolumeControlService extends ProfileService {
    ...
    static class BluetoothVolumeControlBinder extends IBluetoothVolumeControl.Stub
        ...
        public void registerCallback(
            ...
            enforceBluetoothPrivilegedPermission(service);
            service.mHandler.post(() -> service.registerCallback(callback));
        }
        ...
        public void notifyNewRegisteredCallback(
            ...
            enforceBluetoothPrivilegedPermission(service);
            service.mHandler.post(() -> service.notifyNewRegisteredCallback(callback));
        }
        ...
        public void unregisterCallback(
            ...
            enforceBluetoothPrivilegedPermission(service);
            service.mHandler.post(() -> service.mCallbacks.unregister(callback));
        }
    }
