...
public class VolumeControlService extends ProfileService {
    ...
    void onExtAudioInStatusChanged(BluetoothDevice device, int id, @Status int status) {
        String logInfo =
    ...
    static class BluetoothVolumeControlBinder extends IBluetoothVolumeControl.Stub
        ...
        public int getAudioInputControlPointsCountForDevice(
            ...
            validateBluetoothDevice(device);
            return aics_wrapper(source, device, i -> i.size(), 0);
        }
        ...
        public boolean isAudioInputDescriptionWritable(
                AttributionSource source, BluetoothDevice device, int instanceId) {
            return aics_wrapper(source, device, i -> i.isDescriptionWritable(instanceId), false);
        }
        ...
        @Override
        public @Status int getAudioInputStatus(
                AttributionSource source, BluetoothDevice device, int instanceId) {
            return aics_wrapper(
        ...
        public int getAudioInputGainSetting(
                AttributionSource source, BluetoothDevice device, int instanceId) {
            return aics_wrapper(source, device, i -> i.getGainSetting(instanceId), 0);
        }
        ...
        public boolean setAudioInputGainMode(
                ...
                int instanceId,
                @GainMode int gainMode) {
            return aics_wrapper(source, device, i -> i.setGainMode(instanceId, gainMode), false);
        }
        ...
        public boolean setAudioInputMute(
            ...
            return aics_wrapper(source, device, i -> i.setMute(instanceId, mute), false);
        }
    }
