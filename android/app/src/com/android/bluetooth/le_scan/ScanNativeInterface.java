...
public class ScanNativeInterface {
    ...
    public void gattClientMsftAdvMonitorRemove(int monitor_handle) {
        gattClientMsftAdvMonitorRemoveNative(monitor_handle);
    }
    ...
    void onMsftAdvMonitorRemove(int status) {
        ...
        mScanHelper.onMsftAdvMonitorRemove(status);
    }
