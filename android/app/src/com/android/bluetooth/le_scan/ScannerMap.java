...
public class ScannerMap {
    ...
    private final HashMap<Integer, AppScanStats> mAppScanStatsMap =
            new HashMap<Integer, AppScanStats>();

    private final ConcurrentLinkedQueue<ScannerApp> mApps = new ConcurrentLinkedQueue<ScannerApp>();
    ...
    public void dumpApps(StringBuilder sb, ProfileService ps) {
        for (ScannerApp entry : mApps) {
            ps.println(sb, "    app_if: " + entry.mId + ", appName: " + entry.mName);
        }
    }
