...
/* package */ class MsftAdvMonitor {
    ...
    public MsftAdvMonitor(ScanFilter filter) {
        ...
        mMonitor.rssi_threshold_low_time_interval = 0x28; // hardcoded to 40ms
        ...
        if (filter.getServiceDataUuid() != null) {
            ...
            // Extract the two-byte pattern encoded in the third and
            // fourth bytes of the UUID in reverse order.
