...
public class AppScanStats {
        ...
        switch (type) {
            case ScanSettings.CALLBACK_TYPE_ALL_MATCHES:
                return BluetoothStatsLog
                        .LE_APP_SCAN_STATE_CHANGED__LE_SCAN_CALLBACK_TYPE__SCAN_CALLBACK_TYPE_ALL_MATCHES;
            case ScanSettings.CALLBACK_TYPE_FIRST_MATCH:
                return BluetoothStatsLog
                        .LE_APP_SCAN_STATE_CHANGED__LE_SCAN_CALLBACK_TYPE__SCAN_CALLBACK_TYPE_FIRST_MATCH;
            case ScanSettings.CALLBACK_TYPE_MATCH_LOST:
                return BluetoothStatsLog
                        .LE_APP_SCAN_STATE_CHANGED__LE_SCAN_CALLBACK_TYPE__SCAN_CALLBACK_TYPE_MATCH_LOST;
            case ScanSettings.CALLBACK_TYPE_ALL_MATCHES_AUTO_BATCH:
                return BluetoothStatsLog
                        .LE_APP_SCAN_STATE_CHANGED__LE_SCAN_CALLBACK_TYPE__SCAN_CALLBACK_TYPE_ALL_MATCHES_AUTO_BATCH;
            default:
                return BluetoothStatsLog
                        .LE_APP_SCAN_STATE_CHANGED__LE_SCAN_CALLBACK_TYPE__SCAN_CALLBACK_TYPE_UNKNOWN;
        }
    }
    ...
    private static int convertScanMode(int mode) {
        switch (mode) {
            case ScanSettings.SCAN_MODE_OPPORTUNISTIC:
                return BluetoothStatsLog
    ...
    synchronized void recordHwFilterNotAvailableCountMetrics(
        ...
        if (Flags.bleScanAdvMetricsRedesign()) {
            BluetoothStatsLog.write(
                    ...
                    convertScanType(getScanFromScannerId(scannerId)),
                    BluetoothStatsLog
                            .LE_SCAN_ABUSED__LE_SCAN_ABUSE_REASON__REASON_HW_FILTER_NOT_AVAILABLE,
    ...
    synchronized void recordTrackingHwFilterNotAvailableCountMetrics(
        ...
        if (Flags.bleScanAdvMetricsRedesign()) {
            BluetoothStatsLog.write(
                    ...
                    convertScanType(getScanFromScannerId(scannerId)),
                    BluetoothStatsLog
                            .LE_SCAN_ABUSED__LE_SCAN_ABUSE_REASON__REASON_TRACKING_HW_FILTER_NOT_AVAILABLE,
                    numOfTrackableAdv);
        }
        MetricsLogger.getInstance()
                .cacheCount(
