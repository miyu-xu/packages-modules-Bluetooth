...
public class ScanManager {
    ...
    class ScanNative {
        ...
        void configureRegularScanParams() {
            ...
            int curPhyMask = 0;
            if (mLastConfiguredScanSetting1m != Integer.MIN_VALUE) {
                curPhyMask |= BluetoothDevice.PHY_LE_1M_MASK;
            }
            if (mLastConfiguredScanSettingCoded != Integer.MIN_VALUE) {
                curPhyMask |= BluetoothDevice.PHY_LE_CODED_MASK;
            }
