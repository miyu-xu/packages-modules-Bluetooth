...
public class ScanManager {
    ...
    private class ScanNative {
        ...
        private final boolean mIsMsftEnabled;
        ...
        void startRegularScan(ScanClient client) {
            if ((isFilteringSupported() || mIsMsftEnabled)
        ...
        private void addFiltersMsft(ScanClient client) {
            if (client.filters == null
                ...
                Log.e(TAG, "Should be using all-pass filter");
                return;
            }
        ...
        private void updateScanMsft(ScanClient client) {
