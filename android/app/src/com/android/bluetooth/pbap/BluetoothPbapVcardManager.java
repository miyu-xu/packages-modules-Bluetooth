...
public class BluetoothPbapVcardManager {
    ...
    private static final Pattern SEPARATOR_COMPILED_PATTERN = Pattern.compile(SEPARATOR);
    ...
    public String stripTelephoneNumber(String vCard) {
        String[] attr = SEPARATOR_COMPILED_PATTERN.split(vCard);
        String stripedVCard = "";
    ...
    public static class VCardFilter {
        ...
        public String apply(String vCard, boolean vCardType21) {
            ...
            String[] lines = SEPARATOR_COMPILED_PATTERN.split(vCard);
