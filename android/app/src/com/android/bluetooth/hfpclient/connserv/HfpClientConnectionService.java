...
public class HfpClientConnectionService extends ConnectionService {
    ...
    public static void onConnectionStateChanged(BluetoothDevice device, int newState, int oldState) {
    ...
    private void onConnectionStateChangedInternal(BluetoothDevice device, int newState, int oldState) {
