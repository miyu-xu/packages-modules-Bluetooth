...
public class HeadsetClientService extends ProfileService {
    ...
    // TODO(206035301): Remove this along with BluetoothHeadsetClientCall once we know other form
    // factors won't be impacted
    ...
    private static class BluetoothHeadsetClientBinder extends IBluetoothHeadsetClient.Stub
        ...
        public List<BluetoothHeadsetClientCall> getCurrentCalls(BluetoothDevice device,
            ...
            List<BluetoothHeadsetClientCall> legacy = new ArrayList<BluetoothHeadsetClientCall>();
            for (HfpClientCall call : calls) {
                legacy.add(toLegacyCall(call));
            }
            return legacy;
        }
