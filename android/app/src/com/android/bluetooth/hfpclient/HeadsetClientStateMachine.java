...
public class HeadsetClientStateMachine extends StateMachine {
    ...
    public void setAudioPolicy(BluetoothAudioPolicy policies) {
        ...
        if (mAudioPolicyRemoteSupported != BluetoothAudioPolicy.REMOTE_STATUS_SUPPORTED) {
    ...
    public void setAudioPolicyRemoteSupported(boolean supported) {
        if (supported) {
            mAudioPolicyRemoteSupported = BluetoothAudioPolicy.REMOTE_STATUS_SUPPORTED;
        } else {
            mAudioPolicyRemoteSupported = BluetoothAudioPolicy.REMOTE_STATUS_NOT_SUPPORTED;
        }
    }
