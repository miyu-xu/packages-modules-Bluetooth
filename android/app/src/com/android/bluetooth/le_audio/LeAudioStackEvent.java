...
public class LeAudioStackEvent {
    ...
    public static final int EVENT_TYPE_HEALTH_BASED_DEV_RECOMENDATION = 9;
    public static final int EVENT_TYPE_HEALTH_BASED_GROUP_RECOMENDATION = 10;
    ...
    static final int HEALTH_RECOMENDATION_ACTION_NONE = 0;
    static final int HEALTH_RECOMENDATION_ACTION_DISABLE = 1;
    static final int HEALTH_RECOMENDATION_ACTION_CONSIDER_DISABLING = 2;
    ...
    private static String eventTypeToString(int type) {
        switch (type) {
            ...
            case EVENT_TYPE_HEALTH_BASED_DEV_RECOMENDATION:
                return "EVENT_TYPE_HEALTH_BASED_DEV_RECOMENDATION";
            case EVENT_TYPE_HEALTH_BASED_GROUP_RECOMENDATION:
                return "EVENT_TYPE_HEALTH_BASED_GROUP_RECOMENDATION";
            default:
    ...
    private static String eventTypeValue1ToString(int type, int value) {
        switch (type) {
            ...
            case EVENT_TYPE_HEALTH_BASED_DEV_RECOMENDATION:
                switch (value) {
                    case HEALTH_RECOMENDATION_ACTION_NONE:
                        return "ACTION_DISABLE";
                    case HEALTH_RECOMENDATION_ACTION_CONSIDER_DISABLING:
