...
public class LeAudioService extends ProfileService {
    ...
    public void updateBroadcast(int broadcastId, BluetoothLeAudioContentMetadata metadata) {
        ...
        if (!instanceId.isPresent()) {
            for (Map.Entry<Integer, Integer> entry : mBroadcastIdMap.entrySet()) {
        ...
        if (mLeAudioBroadcasterNativeInterface != null) {
            ...
            mLeAudioBroadcasterNativeInterface.updateMetadata(instanceId.get(),
    ...
    public void stopBroadcast(Integer broadcastId) {
        ...
        if (mLeAudioBroadcasterNativeInterface != null) {
            ...
            mLeAudioBroadcasterNativeInterface.stopBroadcast(instanceId.get());
        }
    }
    ...
    /**
     * Get all the running broadcast metadata.
     * @param instanceId broadcast instance identifier
    ...
    void messageFromNative(LeAudioStackEvent stackEvent) {
        ...
        // Some events require device state machine
            ...
            mBroadcastMetadataList.remove(instanceId);
