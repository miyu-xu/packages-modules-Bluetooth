...
public class LeAudioService extends ProfileService {
    ...
    private boolean updateActiveDevices(Integer groupId, Integer oldSupportedAudioDirections,
        ...
        boolean isNewActiveOutDevice = false;
        boolean isNewActiveInDevice = false;

        if (isActive) {
            device = getFirstDeviceFromGroup(groupId);
        }

        isNewActiveOutDevice = updateActiveOutDevice(device, groupId, oldSupportedAudioDirections,
                newSupportedAudioDirections);
        isNewActiveInDevice = updateActiveInDevice(device, groupId, oldSupportedAudioDirections,
                newSupportedAudioDirections);
