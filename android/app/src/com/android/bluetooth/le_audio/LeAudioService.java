...
public class LeAudioService extends ProfileService {
    ...
    private final ReentrantLock mUnicastCallbackLock = new ReentrantLock();
    private final ReentrantLock mBroadcastCallbackLock = new ReentrantLock();
