...
public class LeAudioService extends ProfileService {
     ...
     * @param hasFallbackDevice whether any fallback device exists when {@code device} is null.
     * @return true on success, otherwise false
     */
    public boolean setActiveDevice(BluetoothDevice device, boolean hasFallbackDevice) {
        ...
        // hasFallbackDevice is not used when device is not null.
    ...
    public synchronized void deviceDisconnected(BluetoothDevice device, boolean hasFallbackDevice) {
        ...
        synchronized (mGroupLock) {
            ...
            if (getConnectedPeerDevices(deviceDescriptor.mGroupId).isEmpty()) {
                ...
                if (descriptor.mIsActive) {
                    /* Notify Native layer */
                    setActiveDevice(null, hasFallbackDevice);
                    descriptor.mIsActive = false;
