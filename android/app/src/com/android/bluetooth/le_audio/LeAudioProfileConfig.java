...
public class LeAudioProfileConfig {
    ...
    static void enableTmapCallGateway() {
        ...
        if (options.contains(
                        BluetoothProperties.TmapCallGatewayOptions_values.BAP_BROADCAST_ASSISTANT)
                || options.contains(
                        BluetoothProperties.TmapCallGatewayOptions_values.BAP_SCAN_DELEGATOR)) {
    ...
    static void enableTmapUnicastMediaSender() {
        ...
        if (options.contains(
                        BluetoothProperties.TmapUnicastMediaSenderOptions_values
                                .BAP_BROADCAST_ASSISTANT)
                || options.contains(
                        BluetoothProperties.TmapUnicastMediaSenderOptions_values
                                .BAP_SCAN_DELEGATOR)) {
        ...
        if (options.contains(
                BluetoothProperties.TmapUnicastMediaSenderOptions_values.BAP_SCAN_DELEGATOR)) {
    ...
    static void enableTmapBroadcastMediaSender() {
        ...
        if (options.contains(
                        BluetoothProperties.TmapBroadcastMediaSenderOptions_values
                                .BAP_BROADCAST_ASSISTANT)
                || options.contains(
                        BluetoothProperties.TmapBroadcastMediaSenderOptions_values
                                .BAP_SCAN_DELEGATOR)) {
        ...
        if (options.contains(
                BluetoothProperties.TmapBroadcastMediaSenderOptions_values.BAP_SCAN_DELEGATOR)) {
            sEnabled.put(TMAP_BROADCAST_MEDIA_SENDER, BAP_SCAN_DELEGATOR, true);
        }

        if (options.contains(
                BluetoothProperties.TmapBroadcastMediaSenderOptions_values.VCP_VOLUME_CONTROLLER)) {
    ...
    static void enablePbpPublicBroadcastSource() {
        ...
        if (options.contains(
                BluetoothProperties.PbpPublicBroadcastSourceOptions_values
                        .MCP_MEDIA_CONTROL_SERVER)) {
    ...
    static void enablePbpPublicBroadcastAssistant() {
        ...
        if (options.contains(
                BluetoothProperties.PbpPublicBroadcastAssistantOptions_values
                        .VCP_VOLUME_CONTROLLER)) {
            sEnabled.put(PBP_ASSISTANT, VCP_VOLUME_CONTROLLER, true);
        }

        if (options.contains(
                BluetoothProperties.PbpPublicBroadcastAssistantOptions_values.BAP_SCAN_DELEGATOR)) {
    ...
    static void enableHapHearingAidUnicastClient() {
        ...
        if (options.contains(
                BluetoothProperties.HapHearingAidUnicastClientOptions_values
                        .CCP_CALL_CONTROL_SERVER)) {
