...
public class LeAudioProfileConfig {
    ...
    static final Set<Integer> TMAP_CALL_GATEWAY_DEPENDENCIES =
            Set.of(
                    ...
                    BAP_AUDIO_SOURCE,
                    BAP_AUDIO_SINK,
                    BAP_BROADCAST_ASSISTANT, // spec-optional, but we'll enable it
    ...
    static final Set<Integer> TMAP_UNICAST_MEDIA_SENDER_DEPENDENCIES =
            Set.of(
                    BAP_UNICAST_CLIENT,
                    BAP_AUDIO_SOURCE,
                    BAP_AUDIO_SINK, // spec-optional, but we'll enable it
                    BAP_BROADCAST_ASSISTANT, // spec-optional, but we'll enable it
    ...
    static final Set<Integer> TMAP_BROADCAST_MEDIA_SENDER_DEPENDENCIES =
            Set.of(
                    ...
                    BAP_BROADCAST_ASSISTANT, // spec-optional, but we'll enable it
                    VCP_VOLUME_CONTROLLER, // spec-optional, but we'll enable it
                    CSIP_SET_COORDINATOR); // spec-optional, but we'll enable it

    @VisibleForTesting
    static final Set<Integer> PBP_PUBLIC_BROADCAST_ASSISTANT_DEPENDENCIES =
            Set.of(
    ...
    static final Set<Integer> HAP_HEARING_AID_UNICAST_CLIENT_DEPENDENCIES =
            Set.of(
                    ...
                    BAP_AUDIO_SOURCE,
                    BAP_AUDIO_SINK, // spec-optional, but we'll enable it
                    CCP_CALL_CONTROL_SERVER, // spec-optional, but we'll enable it
                    CSIP_SET_COORDINATOR);
    ...
    private static final Map<Integer, Set<Integer>> PROFILE_ROLE_DEPENDENCIES =
            Map.ofEntries(
                    ...
                    Map.entry(PBP_ASSISTANT, PBP_PUBLIC_BROADCAST_ASSISTANT_DEPENDENCIES),
    ...
    static {
        ...
        Log.v(TAG, "Enabled use cases:");
        for (int profile : sEnabledUseCases) {
            Log.i(TAG, "  profile= " + idToString(profile));
        }
        Log.v(TAG, "Enabled dependencies:");
    ...
    static void enableUseCase(int profile) {
        Log.v(TAG, "Enabling use case: " + idToString(profile));
    ...
    public static boolean isPbpPublicBroadcastAssistantEnabled() {
        return sEnabledUseCases.contains(PBP_ASSISTANT);
    }
