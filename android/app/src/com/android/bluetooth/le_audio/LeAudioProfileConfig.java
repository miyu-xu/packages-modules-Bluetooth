...
public class LeAudioProfileConfig {
    ...
    static void enablePbpPublicBroadcastSource() {
        sEnabled.put(PBP_SOURCE, BAP_BROADCAST_SOURCE, STATUS_ENABLED);
        ...
        if (options.contains(BluetoothProperties.PbpPublicBroadcastSourceOptions_values
                .MCP_MEDIA_CONTROL_SERVER)) {
            sEnabled.put(PBP_SOURCE, MCP_MEDIA_CONTROL_SERVER, STATUS_ENABLED);
        }

        if (options.contains(BluetoothProperties.PbpPublicBroadcastSourceOptions_values
                .CCP_CALL_CONTROL_SERVER)) {
            sEnabled.put(PBP_SOURCE, CCP_CALL_CONTROL_SERVER, STATUS_ENABLED);
        }
    }

    static void enablePbpPublicBroadcastAssistant() {
        sEnabled.put(PBP_ASSISTANT, BAP_BROADCAST_ASSISTANT, STATUS_ENABLED);
        sEnabled.put(PBP_ASSISTANT, CSIP_SET_COORDINATOR, STATUS_ENABLED);
        ...
        if (options.contains(BluetoothProperties.PbpPublicBroadcastAssistantOptions_values
                .VCP_VOLUME_CONTROLLER)) {
            sEnabled.put(PBP_ASSISTANT, VCP_VOLUME_CONTROLLER, STATUS_ENABLED);
        }

        if (options.contains(BluetoothProperties.PbpPublicBroadcastAssistantOptions_values
                .BAP_SCAN_DELEGATOR)) {
            sEnabled.put(PBP_ASSISTANT, BAP_SCAN_DELEGATOR, STATUS_ENABLED);
        }
    }

    static void enableHapHearingAidUnicastClient() {
        sEnabled.put(HAP_UNICAST_CLIENT, BAP_UNICAST_CLIENT, STATUS_ENABLED);
        sEnabled.put(HAP_UNICAST_CLIENT, BAP_AUDIO_SOURCE, STATUS_ENABLED);
        sEnabled.put(HAP_UNICAST_CLIENT, CSIP_SET_COORDINATOR, STATUS_ENABLED);
        ...
        if (options.contains(BluetoothProperties.HapHearingAidUnicastClientOptions_values
                .CCP_CALL_CONTROL_SERVER)) {
            sEnabled.put(HAP_UNICAST_CLIENT, CCP_CALL_CONTROL_SERVER, STATUS_ENABLED);
        }
    }
    ...
    public static boolean isFrameworkProfileEnabledForUseCase(
        ...
        return sEnabled.get(useCase, profile) == STATUS_ENABLED;
    }
