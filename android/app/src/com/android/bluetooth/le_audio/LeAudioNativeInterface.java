...
public class LeAudioNativeInterface {
     ...
     */
    public void setGroupAllowedContextMask(int groupId, int sinkContextTypes,
            int sourceContextTypes) {
        Log.d(TAG, "setGroupAllowedContextMask groupId=" + groupId
                + ", sinkContextTypes=" + sinkContextTypes
                + ", sourceContextTypes=" + sourceContextTypes);
        setGroupAllowedContextMaskNative(groupId, sinkContextTypes,
                sourceContextTypes);
    }
    ...
    private native void setGroupAllowedContextMaskNative(int groupId, int sinkContextTypes,
            int sourceContextTypes);
}
