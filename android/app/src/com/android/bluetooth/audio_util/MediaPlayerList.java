...
public class MediaPlayerList {
     ...
     */
    public void getFolderItems(int playerId, String mediaId, GetFolderItemsCallback cb, AvrcpCoverArtService coverArtService) {
                            ...
                            if (coverArtService != null) {
                                for (ListItem item : results) {
                                    if (item != null && item.song != null && item.song.image != null) {
                                        String imageHandle = coverArtService.storeImage(item.song.image);
                                        if (imageHandle != null) {
