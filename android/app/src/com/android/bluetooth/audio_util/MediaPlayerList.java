...
public class MediaPlayerList {
    ...
    private void initPlayersLists() {
        if (Flags.browsingRefactor()) {
            ...
            for (ResolveInfo info : getValidBrowsablePlayersPackages()) {
                MediaBrowserWrapper wrapper = new MediaBrowserWrapper(
                        mContext,
                        mLooper,
    ...
    /**
     * Retrieves the {@link MediaBrowserWrapper} corresponding to the {@code mediaId} and plays
     * it.
     *
     * <p>See {@link #playItem}.
     */
