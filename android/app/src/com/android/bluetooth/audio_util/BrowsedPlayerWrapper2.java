...
class BrowsedPlayerWrapper2 {
    ...
    private static final String TAG = BrowsedPlayerWrapper2.class.getSimpleName();
    ...
    private final Runnable mDisconnectRunnable = () -> disconnect();
    ...
    public void getFolderItems(String mediaId, GetFolderItemsCallback callback) {
        ...
        browseRequest(() -> {
            ...
            mWrappedBrowser.subscribe(mediaId, new BrowserSubscriptionCallback(mLooper, mediaId));
        });
    }
    ...
    private class BrowserSubscriptionCallback extends MediaBrowser.SubscriptionCallback {
        ...
        public BrowserSubscriptionCallback(Looper looper, String mediaId) {
            ...
            mTimeoutRunnable = () -> {
                onChildrenLoaded(mediaId, Collections.emptyList());
            };
            mTimeoutHandler.postDelayed(mTimeoutRunnable, BROWSER_DISCONNECT_TIMEOUT.toMillis());
        }
        ...
        public void onChildrenLoaded(String parentId, List<MediaItem> children) {
            ...
            mRunHandler.post(() -> {
                for (GetFolderItemsCallback callback : mSubscribedIds.get(parentId)) {
                    Log.v(TAG, "getFolderItems for " + mPackageName + " and " + parentId
                            + ": callback called with " + browsableContent.size() + " items.");
        ...
        public void onError(String parentId) {
            onChildrenLoaded(parentId, Collections.emptyList());
        }
