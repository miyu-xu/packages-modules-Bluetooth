...
public class PlayerSettingsManager {
    ...
    public PlayerSettingsManager(MediaPlayerList mediaPlayerList, AvrcpTargetService service) {
        ...
        mMediaPlayerList.setPlayerSettingsCallback(
                (mMediaPlayerWrapper) -> activePlayerChanged(mMediaPlayerWrapper));
     ...
     */
    private void activePlayerChanged(MediaPlayerWrapper mMediaPlayerWrapper) {
        if (mActivePlayerController != null) {
            mActivePlayerController.unregisterCallback(mControllerCallback);
        }
        if (mMediaPlayerWrapper != null) {
            mActivePlayerController = new MediaControllerCompat(mService,
                    MediaSessionCompat.Token.fromToken(mMediaPlayerWrapper.getSessionToken()));
     ...
     */
    public boolean setPlayerRepeatMode(int shuffleMode) {
        if (mActivePlayerController == null) {
            return false;
        }
