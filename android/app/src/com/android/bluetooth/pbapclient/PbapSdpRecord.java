...
public class PbapSdpRecord {
    private static final String TAG = PbapSdpRecord.class.getSimpleName();
    ...
    /**
     * Version is represented as a series of specification defined constants, in the form:
     *     0x[Major 2 bytes][Minor 2 bytes] -> [Major].[Minor]
     *
     * For example, 0x0102 is 1.2.
     */
