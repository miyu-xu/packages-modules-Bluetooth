...
class PbapClientContactsStorage {
    ...
    private static ArrayList<ContentProviderOperation> constructInsertOperationsForContact(
        ...
        // Add Custom PBAP metadata to contact, if one was added. This allows us to track which raw
        // contact data pertains to a given phonebook. That way, if we delete a cached phonebook, we
        // can clean up _only_ the raw contacts that match that given phonebook.
