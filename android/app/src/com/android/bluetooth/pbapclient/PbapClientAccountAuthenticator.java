 ...
 *
 * In order to store contacts on device, we need to associate them with an AccountManager Account.
 * This allows for easy management, including deletion.
 *
 * This class is hosted by a service object, which AccountManagerService can use to interact with
...
public class PbapClientAccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    @Override
    public Bundle addAccount(AccountAuthenticatorResponse r, String accountType, String authTokenType, String[] requiredFeatures,
            Bundle options) throws NetworkErrorException {
        Log.d(TAG, "addAccount(accountType=" + accountType + ", authTokenType=" + authTokenType + ", requiredFeatures=" + Arrays.toString(requiredFeatures) + ")");
    ...
    @Override
    public Bundle getAuthToken(AccountAuthenticatorResponse r, Account account, String authTokenType,
            Bundle options) throws NetworkErrorException {
        Log.d(TAG, "getAuthToken(account=" + account + ", authTokenType=" + authTokenType + ", options=" + options + ")");
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public Bundle updateCredentials(AccountAuthenticatorResponse r, Account account, String authTokenType,
            Bundle options) throws NetworkErrorException {
        Log.d(TAG, "updateCredentials(account=" + account+ ", authTokenType=" + authTokenType + ", options=" + options + ")");
        return null;
    }
    ...
    public Bundle hasFeatures(AccountAuthenticatorResponse r, Account account, String[] features)
            throws NetworkErrorException {
        Log.d(TAG, "hasFeatures(Account=" + account + ", features=" + Arrays.toString(features) + ")");
