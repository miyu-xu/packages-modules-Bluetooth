...
public class PbapClientAccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    @Override
    public Bundle addAccount(AccountAuthenticatorResponse r, String accountType,
            String authTokenType, String[] requiredFeatures,
            Bundle options) throws NetworkErrorException {
        Log.d(TAG, "addAccount(accountType=" + accountType + ", authTokenType=" + authTokenType +
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse r, Account account,
        ...
        Log.d(TAG, "getAuthToken(account=" + account + ", authTokenType=" + authTokenType
                + ", options=" + options + ")");
        throw new UnsupportedOperationException();
    }
    ...
    public Bundle updateCredentials(AccountAuthenticatorResponse r, Account account,
            String authTokenType, Bundle options) throws NetworkErrorException {
        Log.d(TAG, "updateCredentials(account=" + account+ ", authTokenType=" + authTokenType
                + ", options=" + options + ")");
        return null;
    }
