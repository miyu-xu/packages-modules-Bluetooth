...
public class PbapApplicationParameters {
    ...
    // from the fact that each field is 2 bytes -> 16 bits -> [0, 65535]
    public static final int MAX_PHONEBOOK_SIZE = 65535;

    // Application Parameter Header keys (PBAP 1.2.3, Section 6.2.1)
    public static final byte HEADER_ORDER = 0x01;
    public static final byte HEADER_SEARCH_VALUE = 0x02;
    public static final byte HEADER_SEARCH_PROPERTY = 0x03;
    public static final byte HEADER_MAX_LIST_COUNT = 0x04;
    public static final byte HEADER_LIST_START_OFFSET = 0x05;
    public static final byte HEADER_PROPERTY_SELECTOR = 0x06;
    public static final byte HEADER_FORMAT = 0x07;
    public static final byte HEADER_PHONEBOOK_SIZE = 0x08;
    public static final byte HEADER_NEW_MISSED_CALLS = 0x09;
    public static final byte HEADER_PRIMARY_FOLDER_VERSION = 0x0A;
    public static final byte HEADER_SECONDARY_FOLDER_VERSION = 0x0B;
    public static final byte HEADER_VCARD_SELECTOR = 0x0C;
    public static final byte HEADER_DATABASE_IDENTIFIER = 0x0D;
    public static final byte HEADER_VCARD_SELECTOR_OPERATOR = 0x0E;
    public static final byte HEADER_RESET_NEW_MISSED_CALLS = 0x0F;
    public static final byte HEADER_PBAP_SUPPORTED_FEATURES = 0x10;
    ...
    public static final short RETURN_SIZE_ONLY = 0;

    private long mProperties; // 64-bit property selector bit field, 8 bytes
    private byte mFormat; // Vcard format, 0 or 1, 1 byte, From PbapVcardList object
    private int mMaxListCount; // The total number of items to fetch, used in batching, 2 bytes
    private int mListStartOffset; // The item index to start at, used in batching, 2 bytes

    // We don't support/use ResetNewMissedCalls, vCardSelector, or vCardSelectorOperator
    ...
    public String toString() {
        return "<" + TAG + " properties=" + propertiesToString(getPropertySelectorMask()) + " format=" + getVcardFormat() + " maxListCount=" + getMaxListCount() + " listStartOffset=" + getListStartOffset() + ">";
    }
}
