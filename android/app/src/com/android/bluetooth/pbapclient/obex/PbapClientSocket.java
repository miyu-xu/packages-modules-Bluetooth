...
public class PbapClientSocket {
    ...
    public static PbapClientSocket getL2capSocketForDevice(BluetoothDevice device, int psm)
        ...
        if (sInjectedInput != null || sInjectedOutput != null) {
            return new PbapClientSocket(device, BluetoothSocket.TYPE_L2CAP, sInjectedInput,
                    sInjectedOutput);
        }
    ...
    public static PbapClientSocket getRfcommSocketForDevice(BluetoothDevice device, int channel)
            throws IOException {
        if (sInjectedInput != null || sInjectedOutput != null) {
            return new PbapClientSocket(device, BluetoothSocket.TYPE_RFCOMM, sInjectedInput,
                    sInjectedOutput);
        }
    ...
    private PbapClientSocket(BluetoothDevice device, int type, InputStream input,
            OutputStream output) {
        mSocket = null;
