...
class PbapClientConnectionHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_DISCONNECT:
                ...
                mPbapClientStateMachine.sendMessage(PbapClientStateMachineOld.MSG_CONNECTION_CLOSED);
                break;
            ...
            case MSG_DOWNLOAD:
                ...
                if (mPseRec.isRepositorySupported(
    ...
    void downloadContacts(String path) {
        try {
            ...
            while ((numberOfContactsRemaining > 0) && (startOffset <= PbapApplicationParameters.MAX_PHONEBOOK_SIZE)) {
                ...
                params = new PbapApplicationParameters(
                    PbapApplicationParameters.PROPERTIES_ALL,
            ...
            if ((startOffset > PbapApplicationParameters.MAX_PHONEBOOK_SIZE) && (numberOfContactsRemaining > 0)) {
