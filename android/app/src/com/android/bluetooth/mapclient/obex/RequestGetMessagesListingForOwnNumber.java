 ...
 */
final class RequestGetMessagesListingForOwnNumber extends Request {
     ...
     * then the next 8, etc.
     */
    private class MessagesSlidingWindow {
        ...
        public boolean moveWindow() {
            ...
            logD(String.format("MessagesSlidingWindow, moveWindow: startOffset=%d, maxCount=%d",
    ...
    protected void readResponse(InputStream stream) {
        ...
        if (response == null) {
            ...
            logD("null Response, moving to next window");
            moveToNextWindow();
            return;
        }
        ...
        if (messageListing == null || messageListing.isEmpty()) {
            ...
            logD("no messages, moving to next folder");
            moveToNextFolder();
            return;
        }
        ...
        logD(String.format("Folder=%s, # of msgs=%d, startOffset=%d, maxCount=%d",
        ...
        for (int i = 0; i < messageListing.size(); i++) {
            ...
            if (number != null && !number.trim().isEmpty()) {
                ...
                logD(String.format("phone number found = %s", mPhoneNumber));
                return;
            }
        }
