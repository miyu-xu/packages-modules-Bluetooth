            ...
            switch (paramId) {
                ...
                case PARAM_CONNECTION_STATUS_ID:
                    ...
                    if (paramLength != PARAM_CONNECTION_STATUS_LENGTH) {
                        Log.e(TAG, "Received PARAM_CONNECTION_STATUS with wrong length: " + paramLength
                                        + " skipping this parameter.");
                        skip(is, paramLength + skipLen);
                        success = false;
                    } else {
                ...
                case PARAM_ATR_ID:
                    ...
                    break;
                default:
                    Log.e(TAG, "Received unknown parameter ID: " + paramId + " length: " + paramLength
                                    + " skipping this parameter.");
                    skip(is, paramLength + skipLen);
            }
        }
...
//            Log.i(TAG, "RIL_UNSOL_RIL_CONNECTED received, ignoring");
...
//            break;
            case SapApi.RIL_SIM_SAP_STATUS: {
                ...
                if (indMsg.hasStatusChange()) {
                    ...
                    Log.i(TAG, "RIL_UNSOL_SIM_SAP_STATUS_IND received value = " + mStatusChange);
                } else {
