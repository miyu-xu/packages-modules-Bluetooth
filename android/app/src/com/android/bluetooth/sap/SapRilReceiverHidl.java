...
public class SapRilReceiverHidl implements ISapRilReceiver {
     ...
     */
    @Override public void connectReq(int serial, int maxMsgSizeBytes) throws RemoteException {
     ...
     * @param serial Id to match req-resp. Resp must include same serial.
     */
    @Override public void disconnectReq(int serial) throws RemoteException {
     ...
     */
    @Override public void powerReq(int serial, boolean powerOn) throws RemoteException {
     ...
     * @param serial Id to match req-resp. Resp must include same serial.
     */
    @Override public void resetSimReq(int serial) throws RemoteException {
     ...
     */
    @Override public void setTransferProtocolReq(int serial, int transferProtocol) throws RemoteException {
     ...
     * @param serial Id to match req-resp. Resp must include same serial.
     */
    @Override public void transferAtrReq(int serial) throws RemoteException {
