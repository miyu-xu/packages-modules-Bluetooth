        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_CONNECT: {
                    ...
                    if (!connectPanNative(mAdapterService.getBrEdrAddressForNative(device),
                ...
                case MESSAGE_DISCONNECT: {
                    BluetoothDevice device = (BluetoothDevice) msg.obj;
                    if (!disconnectPanNative(mAdapterService.getBrEdrAddressForNative(device))) {
                        handlePanDeviceStateChange(device, mPanIfName,
                ...
                case MESSAGE_CONNECT_STATE_CHANGED: {
                    ...
                    final BluetoothDevice device = mAdapterService.getDeviceFromNative(cs.addr);
