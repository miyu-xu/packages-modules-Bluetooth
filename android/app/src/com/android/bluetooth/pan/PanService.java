...
public class PanService extends ProfileService {
    ...
    private HashMap<Integer, IBluetoothPanCallback> mBluetoothTetheringCallbacks;
        ...
        public void setBluetoothTethering(IBluetoothPanCallback callback, int id,
            ...
            try {
                ...
                if (service != null) {
                    ...
                    service.setBluetoothTethering(callback, id, value, source.getPackageName(),
    ...
    void setBluetoothTethering(IBluetoothPanCallback callback, int id, boolean value,
        ...
        if (callback != null) {
            if (value) {
                mBluetoothTetheringCallbacks.put(id, callback);
            } else if (mBluetoothTetheringCallbacks.containsKey(id)) {
                mBluetoothTetheringCallbacks.remove(id);
            }
