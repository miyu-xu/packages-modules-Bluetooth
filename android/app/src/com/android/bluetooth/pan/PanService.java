...
public class PanService extends ProfileService {
    ...
    @VisibleForTesting final ConcurrentHashMap<BluetoothDevice, BluetoothPanDevice> mPanDevices = new ConcurrentHashMap<>();
    ...
    PanService(AdapterService adapterService, PanNativeInterface nativeInterface) {
        ...
        mNativeInterface = requireNonNullElseGet(nativeInterface, () -> new PanNativeInterface(this));
        ...
        int maxPanDevice;
        try {
            maxPanDevice = getResources().getInteger(com.android.bluetooth.R.integer.config_max_pan_devices);
