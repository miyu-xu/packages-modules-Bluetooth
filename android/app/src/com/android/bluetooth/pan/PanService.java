...
public class PanService extends ProfileService {
    ...
    void setBluetoothTethering(IBluetoothPanCallback callback, int id, int callerUid,
        ...
        if (callback != null) {
            if (value) {
                mBluetoothTetheringCallbacks.put(id + callerUid, callback);
            } else if (mBluetoothTetheringCallbacks.containsKey(id + callerUid)) {
                mBluetoothTetheringCallbacks.remove(id + callerUid);
            }
