...
/* package */class ScanFilterQueue {
    ...
    public static final int TYPE_WIFI_NAN_HASH = 0; //Wifi Aware spec
    public static final int TYPE_INVALID = 0xFF;
    ...
    void addTransportDiscoveryData(int orgId, int tdsFlags, int tdsFlagsMask,
            byte[] transportData, byte[] transportDataMask, int meta_data_type, byte[] meta_data) {
        Entry entry = new Entry();
        ...
        entry.meta_data_type = meta_data_type;
