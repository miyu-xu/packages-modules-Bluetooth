...
/* package */class ScanFilterQueue {
    ...
    public static final int TYPE_ADVERTISING_DATA_TYPE_DATA = 7;
    ...
    void addAdvertisingDataTypeData(int adType, byte[] data, byte[] dataMask) {
        Entry entry = new Entry();
        entry.type = TYPE_ADVERTISING_DATA_TYPE_DATA;
    ...
    void addScanFilter(ScanFilter filter) {
        ...
        if (filter.getAdvertisingDataType() > 0) {
            addAdvertisingDataTypeData(filter.getAdvertisingDataType(),
