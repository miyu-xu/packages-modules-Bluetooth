...
public class GattService extends ProfileService {
    ...
    private TransactionalScanHelper mTransactionalScanHelper = new TransactionalScanHelper();
    ...
    protected void start() {
        ...
        mTransactionalScanHelper.start(
            this,
            mAdapterService,
    ...
    protected void cleanup() {
        ...
        mTransactionalScanHelper.cleanup();
    ...
    public void notifyProfileConnectionStateChange(int profile, int fromState, int toState) {
        mTransactionalScanHelper.notifyProfileConnectionStateChange(profile, fromState, toState);
    }
    ...
    static class BluetoothGattBinder extends IBluetoothGatt.Stub
        ...
        private void registerScanner(IScannerCallback callback, WorkSource workSource,
            ...
            service.mTransactionalScanHelper
                    .registerScanner(service, callback, workSource, attributionSource);
        }
        ...
        private void unregisterScanner(int scannerId, AttributionSource attributionSource) {
            ...
            service.mTransactionalScanHelper
                    .unregisterScanner(service, scannerId, attributionSource);
        }
        ...
        private void startScan(int scannerId, ScanSettings settings, List<ScanFilter> filters,
            ...
            service.mTransactionalScanHelper
                    .startScan(service, scannerId, settings, filters, attributionSource);
        }
        ...
        private void startScanForIntent(PendingIntent intent, ScanSettings settings,
            ...
            service.mTransactionalScanHelper
                    .registerPiAndStartScan(service, intent, settings, filters, attributionSource);
        }
        ...
        private void stopScanForIntent(PendingIntent intent, AttributionSource attributionSource)
            ...
            service.mTransactionalScanHelper
                    .stopScan(service, intent, attributionSource);
        }
        ...
        private void stopScan(int scannerId, AttributionSource attributionSource) {
            ...
            service.mTransactionalScanHelper
                    .stopScan(service, scannerId, attributionSource);
        }
        ...
        private void flushPendingBatchResults(int scannerId, AttributionSource attributionSource) {
            ...
            service.mTransactionalScanHelper
                    .flushPendingBatchResults(service, scannerId, attributionSource);
        }
        ...
        private void registerSync(ScanResult scanResult, int skip, int timeout,
            ...
            service.mTransactionalScanHelper
                    .registerSync(service, scanResult, skip, timeout, callback, attributionSource);
        }
        ...
        public void transferSync(BluetoothDevice bda, int serviceData , int syncHandle,
            ...
            service.mTransactionalScanHelper
                    .transferSync(service, bda, serviceData , syncHandle, attributionSource);
        }
        ...
        public void transferSetInfo(BluetoothDevice bda, int serviceData , int advHandle,
            ...
            service.mTransactionalScanHelper
                    .transferSetInfo(service, bda, serviceData , advHandle, callback, attributionSource);
        }
        ...
        public void unregisterSync(IPeriodicAdvertisingCallback callback,
            ...
            service.mTransactionalScanHelper
                    .unregisterSync(service, callback, attributionSource);
        }
    ...
    void onTrackAdvFoundLost(AdvtFilterOnFoundOnLostInfo trackingInfo) throws RemoteException {
        ...
        TransactionalScanHelper.ScannerMap.App app = mScannerMap.getById(trackingInfo.getClientIf());
    ...
    @SuppressLint("AndroidFrameworkRequiresPermission")
    public void enforceImpersonatationPermissionIfNeeded(WorkSource workSource) {
        if (workSource != null) {
    ...
    void dumpRegisterId(StringBuilder sb) {
        sb.append("  Scanner:\n");
        mTransactionalScanHelper.dumpRegisterId(sb);
        sb.append("  Client:\n");
        for (Integer appId : mClientMap.getAllAppsIds()) {
    ...
    public void dump(StringBuilder sb) {
        ...
        mTransactionalScanHelper.dump(sb);
