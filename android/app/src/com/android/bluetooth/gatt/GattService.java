...
public class GattService extends ProfileService {
    ...
    private void sendBatchScanResults(TransactionalScanHelper.ScannerMap.App app, ScanClient client,
    ...
    void registerPiAndStartScan(PendingIntent pendingIntent, ScanSettings settings,
        ...
        // Don't start scan if the Pi scan already in mTransactionalScanHelper.mScannerMap.
        if (mTransactionalScanHelper.mScannerMap.getByContextInfo(piInfo) != null) {
            Log.d(TAG, "Don't startScan(PI) since the same Pi scan already in mTransactionalScanHelper.mScannerMap.");
            return;
        }
    ...
    void continuePiStartScan(int scannerId, TransactionalScanHelper.ScannerMap.App app) {
        ...
        AppScanStats scanStats = mTransactionalScanHelper.mScannerMap.getAppScanStatsById(scannerId);
        if (scanStats != null) {
