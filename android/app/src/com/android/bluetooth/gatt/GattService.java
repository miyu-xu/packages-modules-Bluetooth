...
public class GattService extends ProfileService {
    ...
    void subrateModeRequest(int clientIf, String address, int subrateMode,
        ...
        switch (subrateMode) {
            case BluetoothGatt.SUBRATE_REQUEST_HIGH:
                subrateMin =
            ...
            case BluetoothGatt.SUBRATE_REQUEST_LOW_POWER:
                subrateMin =
                ...
                contNumber =
                        getResources().getInteger(R.integer.subrate_mode_low_power_cont_number);
                break;

            default:
                // Using the values for SUBRATE_REQUEST_BALANCED.
                subrateMin =
