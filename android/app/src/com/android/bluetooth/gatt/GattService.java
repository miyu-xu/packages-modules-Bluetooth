...
public class GattService extends ProfileService {
    ...
    private TransitionalScanHelper pTransitionalScanHelper;
    ...
    /** This is only used when Flags.scanManagerRefactor() is true. */
    public void setTransitionalScanHelper(TransitionalScanHelper transitionalScanHelper) {
        pTransitionalScanHelper = transitionalScanHelper;
    }
    ...
    TransitionalScanHelper getTransitionalScanHelper() {
        if (!Flags.scanManagerRefactor()) {
            ...
            return pTransitionalScanHelper;
        }
    }
                            ...
                            public void handleMessage(Message msg) {
                                synchronized (mTestModeLock) {
                                    ...
                                    for (String test : TEST_MODE_BEACONS) {
                                        getTransitionalScanHelper().onScanResultInternal(
                                                0x1b,
                                                0x1,
                                                "DD:34:02:05:5C:4D",
                                                1,
    ...
    public void notifyProfileConnectionStateChange(int profile, int fromState, int toState) {
        getTransitionalScanHelper().notifyProfileConnectionStateChange(profile, fromState, toState);
    }
