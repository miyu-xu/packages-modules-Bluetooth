...
public class AppAdvertiseStats {
    ...
    static void recordAdvertiseDurationCount(Duration duration, boolean isConnectable,
            boolean inPeriodic) {
    ...
    static void recordAdvertiseEnableCount(boolean enable, boolean isConnectable,
            boolean inPeriodic) {
        if (enable) {
