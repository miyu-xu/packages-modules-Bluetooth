...
public class AdvertiseManager {
    ...
    AdvertiseManager(GattService service) {
        this(service, new AdvertiserMap());
    }

    @VisibleForTesting
    AdvertiseManager(GattService service, AdvertiserMap advertiserMap) {
        Log.d(TAG, "advertise manager created");
        mService = service;
        mNativeInterface = AdvertiseManagerNativeInterface.getInstance();
