 ...
 *
 * @param <C> the type of the callback for map entries
 */
public class ContextMap<C> {
    ...
    public class App {
        ...
        protected App(UUID uuid, C callback, String name) {
            this.uuid = uuid;
    ...
    protected App getAppByPredicate(Predicate<App> predicate) {
        synchronized (mAppsLock) {
