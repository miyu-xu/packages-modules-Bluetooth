...
public class ScanManager {
    ...
    private static final String SCAN_MODE_SCREEN_OFF_LOW_POWER_WINDOW_PROPERTY =
            "bluetooth.core.le.scan_screen_off_low_power_window";
    private static final String SCAN_MODE_SCREEN_OFF_LOW_POWER_INTERVAL_PROPERTY =
    ...
    public static final int SCAN_MODE_SCREEN_OFF_LOW_POWER_WINDOW_MS =
            SystemProperties.getInt(SCAN_MODE_SCREEN_OFF_LOW_POWER_WINDOW_PROPERTY, 512);
    public static final int SCAN_MODE_SCREEN_OFF_LOW_POWER_INTERVAL_MS =
            SystemProperties.getInt(SCAN_MODE_SCREEN_OFF_LOW_POWER_INTERVAL_PROPERTY, 10240);
