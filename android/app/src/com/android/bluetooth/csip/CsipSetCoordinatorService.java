...
public class CsipSetCoordinatorService extends ProfileService {
            ...
            if (mLocks.containsKey(groupId)) {
                try {
                    callback.onGroupLockSet(groupId,
                            BluetoothStatusCodes.ERROR_CSIP_GROUP_LOCK_FAILED_LOCKED_BY_OTHER,
                            true);
    ...
    int getApiStatusCode(int nativeResult) {
        switch (nativeResult) {
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_SUCCES:;
                return BluetoothStatusCodes.SUCCESS;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_INVALID_GROUP:
                return BluetoothStatusCodes.ERROR_CSIP_GROUP_LOCK_FAILED_INVALID_GROUP;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_GROUP_EMPTY:
                return BluetoothStatusCodes.ERROR_CSIP_GROUP_LOCK_FAILED_GROUP_EMPTY;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_GROUP_NOT_CONNECTED:
                return BluetoothStatusCodes.ERROR_CSIP_GROUP_LOCK_FAILED_GROUP_NOT_CONNECTED;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_LOCKED_BY_OTHER:
                return BluetoothStatusCodes.ERROR_CSIP_GROUP_LOCK_FAILED_LOCKED_BY_OTHER;
            ...
            default:
                Log.e (TAG, " Unknow status code: " + nativeResult);
