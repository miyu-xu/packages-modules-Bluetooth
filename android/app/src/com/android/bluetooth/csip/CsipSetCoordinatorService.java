    ...
    int getApiStatusCode(int nativeResult) {
        switch (nativeResult) {
            ...
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_INVALID_GROUP:
                return BluetoothStatusCodes.LE_CSIP_GROUP_LOCK_FAILED_INVALID_GROUP;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_GROUP_EMPTY:
                return BluetoothStatusCodes.LE_CSIP_GROUP_LOCK_FAILED_GROUP_EMPTY;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_GROUP_NOT_CONNECTED:
                return BluetoothStatusCodes.LE_CSIP_GROUP_LOCK_FAILED_GROUP_NOT_CONNECTED;
            case IBluetoothCsipSetCoordinator.CSIS_GROUP_LOCK_FAILED_LOCKED_BY_OTHER:
                return BluetoothStatusCodes.LE_CSIP_GROUP_LOCK_FAILED_LOCKED_BY_OTHER;
            case IBluetoothCsipSetCoordinator.CSIS_LOCKED_GROUP_MEMBER_LOST:
                return BluetoothStatusCodes.LE_CSIP_LOCKED_GROUP_MEMBER_LOST;
