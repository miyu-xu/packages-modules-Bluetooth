...
static jmethodID method_onHealthBaseRecommendationAction;
static jmethodID method_onHealthBaseGroupRecommendationAction;
 ...
 public:
  ...
  void OnHealthBaseRecommendationAction(
    ...
    sCallbackEnv->SetByteArrayRegion(addr.get(), 0, sizeof(RawAddress),
                                     (jbyte*)&bd_addr);
    sCallbackEnv->CallVoidMethod(mCallbacksObj,
                                 method_onHealthBaseRecommendationAction,
  ...
  void OnHealthBaseGroupRecommendationAction(
    ...
    sCallbackEnv->CallVoidMethod(mCallbacksObj,
                                 method_onHealthBaseGroupRecommendationAction,
...
static void classInitNative(JNIEnv* env, jclass clazz) {
  ...
  method_onAudioGroupCodecConf =
      env->GetMethodID(clazz, "onAudioGroupCodecConf",
                       ...
                       "[Landroid/bluetooth/BluetoothLeAudioCodecConfig;)V");
  method_onHealthBaseRecommendationAction =
      env->GetMethodID(clazz, "onHealthBaseRecommendationAction", "([BI)V");
  method_onHealthBaseGroupRecommendationAction =
      env->GetMethodID(clazz, "onHealthBaseGroupRecommendationAction", "(II)V");
}
