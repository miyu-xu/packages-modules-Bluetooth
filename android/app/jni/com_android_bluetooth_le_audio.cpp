...
jobject prepareLeBroadcastSubgroupObject(
  ...
  // Serialize codec ID
  long long_codec_id = subgroup.codec_config.codec_id |
                       ((long)subgroup.codec_config.vendor_company_id << 16) |
                       ((long)subgroup.codec_config.vendor_codec_id << 32);
  ...
  return env->NewObject(
      ...
      (jlong)long_codec_id, codec_config_meta_obj.get(), content_meta_obj.get(),
