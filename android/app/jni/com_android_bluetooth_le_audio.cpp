...
static void classInitNative(JNIEnv* env, jclass clazz) {
  ...
  android_bluetooth_BluetoothLeAudioCodecConfig.getSampleRate =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getSampleRate",
                       "()I");
  android_bluetooth_BluetoothLeAudioCodecConfig.getBitsPerSample =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getBitsPerSample",
                       "()I");
  android_bluetooth_BluetoothLeAudioCodecConfig.getChannelCount =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getChannelCount",
                       "()I");
  android_bluetooth_BluetoothLeAudioCodecConfig.getFrameDuration =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getFrameDuration",
                       "()I");
  android_bluetooth_BluetoothLeAudioCodecConfig.getOctetsPerFrame =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getOctetsPerFrame",
                       "()I");
  android_bluetooth_BluetoothLeAudioCodecConfig.getCodecPriority =
      env->GetMethodID(jniBluetoothLeAudioCodecConfigClass, "getCodecPriority",
                       "()I");
