...
static jmethodID method_onExtAudioInGainSettingsPropertiesChanged;
...
public:
  ...
  void OnExtAudioInGainSettingsPropertiesChanged(const RawAddress& bd_addr, uint8_t ext_input_id,
    ...
    sCallbackEnv->SetByteArrayRegion(addr.get(), 0, sizeof(RawAddress),
                                     reinterpret_cast<const jbyte*>(&bd_addr));
    sCallbackEnv->CallVoidMethod(mCallbacksObj, method_onExtAudioInGainSettingsPropertiesChanged,
...
int register_com_android_bluetooth_vc(JNIEnv* env) {
  ...
  const JNIJavaMethod javaMethods[] = {
          ...
          {"onExtAudioInGainSettingsPropertiesChanged", "(IIII[B)V",
           &method_onExtAudioInGainSettingsPropertiesChanged},
