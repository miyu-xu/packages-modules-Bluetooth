...
static jint createSocketChannelNative(JNIEnv* env, jobject /* obj */, jint type,
                                      ...
                                      jlong hubId, jlong endPointId, jboolean autoSwitch) {
  int socket_fd = INVALID_FD;
  jbyte* uuidBytes = nullptr;
  Uuid btUuid;
...
int register_com_android_bluetooth_btservice_AdapterService(JNIEnv* env) {
  const JNINativeMethod methods[] = {
          ...
          {"connectSocketNative", "([BI[BIIIILjava/lang/String;JJZ)I",
           reinterpret_cast<void*>(connectSocketNative)},
          {"createSocketChannelNative", "(ILjava/lang/String;[BIIIILjava/lang/String;JJZ)I",
