...
// /// TODO
// /// # Safety
// /// DO NOT CALL! Only called from Java.
// pub unsafe extern "C" fn JNI_OnLoadd(vm: *mut JavaVM, reserved: *mut c_void) -> jint {
//     JNI_OnLoad_wrapped(vm, reserved)
// }

// extern "C" {
//     /// todo
//     #[link_name = "JNI_OnLoad"]
//     pub fn JNI_OnLoad_wrapped(vm: *mut JavaVM, reserved: *mut c_void) -> jint;
// }
