...
int register_com_android_bluetooth_hap_client(JNIEnv* env) {
  const char* className = "com/android/bluetooth/hap/HapClientNativeInterface";
  ...
  // Initialize BluetoothHapPresetInfo (Bluetooth Framework)
  ...
  env->DeleteLocalRef(jniBluetoothBluetoothHapPresetInfoClass);
