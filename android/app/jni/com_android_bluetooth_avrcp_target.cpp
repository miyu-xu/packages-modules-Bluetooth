...
static jboolean setPlayerSettings(const RawAddress& address,
                                  jbyteArray settings,
                                  jbyteArray values);
static void listPlayerSettingsText(const RawAddress& address, jbyteArray settings);
...
/*static jboolean setPlayerSettings(const RawAddress& address,
  ...
  jstring j_bdaddr = sCallbackEnv->NewStringUTF(address.ToString().c_str());
  return sCallbackEnv->CallBooleanMethod(mJavaInterface, method_setPlayerSettings,
                               j_bdaddr, settings, values);
}*/
...
/*static void listPlayerSettingValuesText(const RawAddress& address,
  ...
  jstring j_bdaddr = sCallbackEnv->NewStringUTF(address.ToString().c_str());
  sCallbackEnv->CallVoidMethod(mJavaInterface, method_listPlayerSettingValuesText,
                               j_bdaddr, setting, values);
}*/
