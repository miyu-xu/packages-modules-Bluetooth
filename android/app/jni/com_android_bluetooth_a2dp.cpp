...
int register_com_android_bluetooth_a2dp(JNIEnv* env) {
  const char* className = "com/android/bluetooth/a2dp/A2dpNativeInterface";

  const JNINativeMethod sMethods[] = {
      {"initNative",
       "(I[Landroid/bluetooth/BluetoothCodecConfig;[Landroid/bluetooth/"
       "BluetoothCodecConfig;)V",
       (void*)initNative},
  ...
  JNIJavaCallbackMethod sCallbacksMethods[] = {
  ...
  jniRegisterJavaCallbacksOrDie(env, className, sCallbacksMethods,
                                NELEM(sCallbacksMethods));

  JNIJavaCallbackMethod sCodecConfigCallbacksMethods[] = {
      {"<init>", "(IIIIIJJJJ)V",
       &android_bluetooth_BluetoothCodecConfig.constructor},
      {"getCodecType", "()I",
  ...
  jniRegisterJavaCallbacksOrDie(env, "android/bluetooth/BluetoothCodecConfig",
                                sCodecConfigCallbacksMethods,
                                NELEM(sCodecConfigCallbacksMethods));
  ALOGE("WILLIAM ====== successfully load native a2dp");
  return result;
}
}
