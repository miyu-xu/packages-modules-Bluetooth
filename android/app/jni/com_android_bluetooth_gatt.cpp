...
static void gattClientScanFilterParamAddNative(JNIEnv* env, jobject /* object */, jobject params) {
  ...
  methodId = env->GetMethodID(filtparam.get(), "clientIf", "()I");
  uint8_t client_if = env->CallIntMethod(params, methodId);

  methodId = env->GetMethodID(filtparam.get(), "filtIndex", "()I");
  uint8_t filt_index = env->CallIntMethod(params, methodId);

  methodId = env->GetMethodID(filtparam.get(), "featSeln", "()I");
  ...
  methodId = env->GetMethodID(filtparam.get(), "filtLogicType", "()I");
  ...
  methodId = env->GetMethodID(filtparam.get(), "delyMode", "()I");
  ...
  methodId = env->GetMethodID(filtparam.get(), "foundTimeOutCnt", "()I");
  filt_params->found_timeout_cnt = env->CallIntMethod(params, methodId);

  methodId = env->GetMethodID(filtparam.get(), "numOfTrackEntries", "()I");
