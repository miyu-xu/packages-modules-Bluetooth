...
static int register_com_android_bluetooth_gatt_scan(JNIEnv* env) {
  const char* className = "com/android/bluetooth/gatt/ScanNativeInterface";
  ...
  return REGISTER_NATIVE_METHODS(env, className, methods);
}
...
static int register_com_android_bluetooth_gatt_advertise_manager(JNIEnv* env) {
  ...
  const JNIJavaCallbackMethod callbacksMethods[] = {
...
static int register_com_android_bluetooth_gatt_distance_measurement(
    JNIEnv* env) {
  const char* className =
      "com/android/bluetooth/gatt/DistanceMeasurementNativeInterface";
...
static int register_com_android_bluetooth_gatt_(JNIEnv* env) {
  const char* className = "com/android/bluetooth/gatt/GattNativeInterface";
...
int register_com_android_bluetooth_gatt(JNIEnv* env) {
  return register_com_android_bluetooth_gatt_scan(env) &
         register_com_android_bluetooth_gatt_advertise_manager(env) &
         register_com_android_bluetooth_gatt_periodic_scan(env) &
         register_com_android_bluetooth_gatt_distance_measurement(env) &
         register_com_android_bluetooth_gatt_(env);
}
}  // namespace android
