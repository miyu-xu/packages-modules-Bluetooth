...
public class PairingTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        if (mBluetoothAdapter.isEnabled()) {
            ...
            assertThat(offLatch.await(TIMEOUT_BLUETOOTH_DISABLE, TimeUnit.SECONDS)).isTrue();
        ...
        if (mBluetoothAdapter.isEnabled() == false) {
            ...
            assertThat(onLatch.await(TIMEOUT_BLUETOOTH_ENABLE, TimeUnit.SECONDS)).isTrue();
        }
    ...
    public void classicPairing() throws Exception {
        ...
        assertThat(connectLatch.await(TIMEOUT_CONNECT, TimeUnit.SECONDS)).isTrue();

        assertThat(waitConnectionLatch.await(TIMEOUT_WAIT_CONNECTION, TimeUnit.SECONDS)).isTrue();
        ...
        assertThat(waitPairingEventLatch.await(TIMEOUT_WAIT_PAIRING_EVENT, TimeUnit.SECONDS)).isTrue();

        assertThat(waitPairingRequestLatch.await(TIMEOUT_WAIT_PAIRING_REQUEST, TimeUnit.SECONDS)).isTrue();
        ...
        assertThat(secureLatch.await(TIMEOUT_SECURE, TimeUnit.SECONDS)).isTrue();

        assertThat(waitBondedLatch.await(TIMEOUT_BONDING, TimeUnit.SECONDS)).isTrue();
        ...
        assertThat(waitDisconnectionLatch.await(TIMEOUT_DISCONNECTION, TimeUnit.SECONDS)).isTrue();
