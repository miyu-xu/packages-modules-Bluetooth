...
public class LeAdvertisingTest {
    ...
    private static final long TIMEOUT_ADVERTISING = 5;
    private static final long TIMEOUT_SCAN = 1;
    ...
    public static void setUpClass() throws Exception {
        ...
        AdvertisingSetCallback mAdvertisingSetCallback = new AdvertisingSetCallback() {
            ...
            public void onOwnAddressRead(AdvertisingSet advertisingSet, int addressType,
                ...
                advertisingSet.enableAdvertising(true, 1000, 0);
            }
        ...
        assertThat(advertisingLatch.await(TIMEOUT_ADVERTISING, TimeUnit.SECONDS)).isTrue();
    ...
    public void advertisingSet() throws Exception {
        ...
        scanLatch.await();
        assertThat(scanLatch.await(TIMEOUT_SCAN, TimeUnit.SECONDS)).isTrue();
