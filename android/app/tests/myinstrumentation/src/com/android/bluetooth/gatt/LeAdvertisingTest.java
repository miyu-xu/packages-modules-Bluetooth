    ...
    public static void setUpClass() throws Exception {
        ...
        AdvertisingSetCallback mAdvertisingSetCallback = new AdvertisingSetCallback() {
            ...
            public void onAdvertisingSetStarted(AdvertisingSet advertisingSet, int txPower, int status) {
                Log.i(LOG_TAG, "onAdvertisingSetStarted "+ "advertisingSet:" + advertisingSet + " txPower:" + txPower + " status:"+ status);
                advertisingSet.getOwnAddress();
            }

            @Override
            public void onOwnAddressRead(AdvertisingSet advertisingSet, int addressType, String address) {
                Log.i(LOG_TAG, "onOwnAddressRead " + "advertisingSet:" + advertisingSet + " addressType:" + addressType + " address:" + address);
