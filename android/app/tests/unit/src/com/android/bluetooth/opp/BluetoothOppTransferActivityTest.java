...
public class BluetoothOppTransferActivityTest {
    ...
    public void setUp() {
        ...
        mIntent = new Intent();
        mIntent.setClass(InstrumentationRegistry.getInstrumentation().getTargetContext(),
        ...
        mCursorMockDataList = new ArrayList<>(List.of(
                ...
                new CursorMockData(BluetoothShare.USER_CONFIRMATION, 11, BluetoothShare.USER_CONFIRMATION_HANDOVER_CONFIRMED)
        ));
    }
