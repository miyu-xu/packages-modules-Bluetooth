...
public class BluetoothMapConvoListingElementTest {
    ...
    private final BluetoothMapConvoContactElement TEST_CONTACT_ELEMENT =
            new BluetoothMapConvoContactElement("test_bt_uci", "test_name", "test_display_name",
                    "test_presence_status", 2, TEST_LAST_ACTIVITY, 2, 1, "1111");

    private final List<BluetoothMapConvoContactElement> TEST_CONTACTS = new ArrayList<>(
            Arrays.asList(TEST_CONTACT_ELEMENT));
    ...
    public void incrementVersionCounter() {
        ...
        assertThat(mListingElement.getVersionCounter()).isEqualTo(1);
    }

    @Test
    public void removeContactWithObject() {
        mListingElement.removeContact(TEST_CONTACT_ELEMENT);
        assertThat(mListingElement.getContacts()).isEmpty();
    }

    @Test
    public void removeContactWithIndex() {
        mListingElement.removeContact(0);
        assertThat(mListingElement.getContacts()).isEmpty();
    }
