...
public class BluetoothOppTransferHistoryTest extends
        ActivityInstrumentationTestCase2<BluetoothOppTransferHistory> {
    @Mock
    Cursor mCursor;
    @Spy
    ...
    public BluetoothOppTransferHistoryTest() {
        super(BluetoothOppTransferHistory.class);
    }
    ...
    public void onOptionsItemSelected_clearAllSelected_promptWarning() {
        ...
        mIntent.putExtra("direction", BluetoothShare.DIRECTION_INBOUND);
        setActivityIntent(mIntent);
        BluetoothOppTransferHistory activity = getActivity();
        InstrumentationRegistry.getInstrumentation().waitForIdleSync();
