...
public class BluetoothOppObexServerSessionTest {
    ...
    @Test
    public void onPut_userDenied_returnObexHttpBadRequest() throws IOException {
    ...
    @Test
    public void onPut_zeroLengthHeader_returnLengthRequired() throws IOException {
        String name = "";
        long length = 0;
    ...
    @Test
    public void onPut_zeroLengthName_returnHttpBadRequest() throws IOException {
        String name = "";
        long length = 10;
        String mimeType = "text/plain";
        HeaderSet headerSet = new HeaderSet();
    ...
    @Test
    public void onPut_noMimeType_returnHttpBadRequest() throws IOException {
    ...
    @Test
    public void onPut_unsupportedMimeType_returnHttpBadRequest() throws IOException {
    ...
    @Test
    public void onPut_returnObexHttpOk() throws IOException {
    ...
    @Test
    public void onConnect_nullTarget_returnHttpNotAcceptable() {
    ...
    @Test
    public void onConnect_returnObexHttpOk() {
        HeaderSet request = new HeaderSet();
        HeaderSet reply = new HeaderSet();
    ...
    @Test
    public void onDisconnect_replyObexHttpOk() {
        HeaderSet request = new HeaderSet();
        HeaderSet reply = new HeaderSet();
    ...
    @Test
    public void onClose_nothingThrow() {
        Handler handler = mock(Handler.class);
        mServerSession.start(handler, 0);
