...
public class PbapPhonebookTest {
    ...
    public void testParsePhonebook_forIncomingCallHistory_incomingCallHistoryParsed()
        ...
        String call1 =
                createCallHistory(
                        VERSION_21, INCOMING_CALL, "20240101T100000", "Foo", "Bar", "+12345678901");
        String call2 =
                createCallHistory(
                        VERSION_21, INCOMING_CALL, "20240101T110000", "Baz", "Bar", "+12345678902");
    ...
    public void testParsePhonebook_forOutgoingCallHistory_outgoingCallHistoryParsed()
        ...
        String call1 =
                createCallHistory(
                        VERSION_21, OUTGOING_CALL, "20240101T100000", "Foo", "Bar", "+12345678901");
        String call2 =
                createCallHistory(
                        VERSION_21, OUTGOING_CALL, "20240101T110000", "Baz", "Bar", "+12345678902");
        String historyString = createPhonebook(Arrays.asList(new String[] {call1, call2}));
    ...
    public void testParsePhonebook_forMissedCallHistory_missedCallHistoryParsed()
        ...
        String call1 =
                createCallHistory(
                        VERSION_21, MISSED_CALL, "20240101T100000", "Foo", "Bar", "+12345678901");
        String call2 =
                createCallHistory(
                        VERSION_21, MISSED_CALL, "20240101T110000", "Baz", "Bar", "+12345678902");
        String historyString = createPhonebook(Arrays.asList(new String[] {call1, call2}));
    ...
    private String createCallHistory(
