...
public class PbapClientAccountManagerTest {
    ...
    ArgumentCaptor<BroadcastReceiver> mReceiverCaptor = ArgumentCaptor.forClass(BroadcastReceiver.class);
    ...
    public void setUp() throws Exception {
        ...
        TestUtils.mockGetSystemService(mMockContext, Context.ACCOUNT_SERVICE, AccountManager.class, mMockAccountManager);
        setAvailableAccounts(new Account[]{});
        setAccountVisibility(AccountManager.VISIBILITY_NOT_VISIBLE);
        doReturn(true).when(mMockAccountManager).addAccountExplicitly(any(Account.class), nullable(String.class), nullable(Bundle.class));
        doReturn(true).when(mMockAccountManager).removeAccountExplicitly(any(Account.class));

        TestUtils.mockGetSystemService(mMockContext, Context.USER_SERVICE, UserManager.class, mMockUserManager);
    ...
    public void testGetAccountForDevice_withNullDevice_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> mAccountManager.getAccountForDevice(null));
    }
    ...
    public void testStartAccountManager_userUnlockedAccountVisibleNoAccounts_accountsInitialized() {
        ...
        verify(mMockCallback, times(1)).onAccountsChanged(mFromAccountsCaptor.capture(), mToAccountsCaptor.capture());
    ...
    public void testStartAccountManager_userUnlockedAccountVisibleHasAccount_accountsInitialized() {
        ...
        Account[] accounts = new Account[] {
            getAccountForDevice(device1),
            getAccountForDevice(device2)
        };
    ...
    public void testAddAccount_accountDoesNotExist_accountInAccountsListAndReturnsTrue() {
        ...
        verify(mMockCallback, times(2)).onAccountsChanged(mFromAccountsCaptor.capture(), mToAccountsCaptor.capture());
        List<Account> toAccounts = mToAccountsCaptor.getValue();
    ...
    public void testAddAccounts_accountManagerOperationFails_returnsFalse() {
        doReturn(false).when(mMockAccountManager).addAccountExplicitly(any(Account.class), nullable(String.class), nullable(Bundle.class));
    ...
    private void setAccountVisibility(int visibility) {
        doReturn(visibility).when(mMockAccountManager).getAccountVisibility(any(Account.class), anyString());
    }
