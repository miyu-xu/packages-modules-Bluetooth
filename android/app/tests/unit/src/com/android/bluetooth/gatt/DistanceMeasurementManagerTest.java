...
public class DistanceMeasurementManagerTest {
    ...
    private static final int MEASUREMENT_FREQUENCY_LOW = 3000;
    ...
    @Test
    @TestParameters("{bondState:10}")  // BOND_NONE
    @TestParameters{"{bondState:11}")  // BOND_BONDED
    public void testCsStartMeasurementForBondedBLE(int bondState) throws RemoteException {
        ...
        if (bondState == BluetoothDevice.BOND_NONE) {
            ...
            mDistanceMeasurementManager.onDistanceMeasurementResult(IDENTITY_ADDRESS, 100,
                0, 0, 0, 0, 0, 0, 1, DistanceMeasurementMethod.DISTANCE_MEASUREMENT_METHOD_CHANNEL_SOUNDING);
            verify(mCallback).onResult(mDevice, any());
        }
    }
