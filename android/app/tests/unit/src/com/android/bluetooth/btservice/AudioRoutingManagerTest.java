...
public class AudioRoutingManagerTest {
    ...
    public void a2dpActiveDeviceSelected_setActive() {
        ...
        Assert.assertEquals(mA2dpDevice, mAudioRoutingManager.getA2dpActiveDevice());
    }
    ...
    public void headsetActiveDeviceSelected_setActive() {
        ...
        Assert.assertEquals(mHeadsetDevice, mAudioRoutingManager.getHfpActiveDevice());
    }
    ...
    public void leAudioActiveDeviceSelected_setActive() {
        ...
        Assert.assertEquals(mLeAudioDevice, mAudioRoutingManager.getLeAudioActiveDevice());
    }
    ...
    public void leAudioActive_setA2dpActiveExplicitly() {
        ...
        Assert.assertEquals(mA2dpDevice, mAudioRoutingManager.getA2dpActiveDevice());
        Assert.assertNull(mAudioRoutingManager.getLeAudioActiveDevice());
    }
    ...
    public void dualModeAudioDeviceConnected_withDualModeFeatureDisabled() {
        ...
        Assert.assertEquals(mDualModeAudioDevice, mAudioRoutingManager.getA2dpActiveDevice());
        Assert.assertEquals(mDualModeAudioDevice, mAudioRoutingManager.getHfpActiveDevice());
        ...
        Assert.assertEquals(mDualModeAudioDevice, mAudioRoutingManager.getLeAudioActiveDevice());
    }
    ...
    public void dualModeAudioDeviceConnected_withDualModeFeatureEnabled() {
        ...
        verify(mLeAudioService, timeout(TIMEOUT_MS)).setActiveDevice(mDualModeAudioDevice);
        Assert.assertNull(mAudioRoutingManager.getLeAudioActiveDevice());
        Assert.assertNull(mAudioRoutingManager.getA2dpActiveDevice());
        Assert.assertNull(mAudioRoutingManager.getHfpActiveDevice());
        ...
        a2dpActiveDeviceChanged(null);
        TestUtils.waitForLooperToFinishScheduledTask(mAudioRoutingManager.getHandlerLooper());
        Assert.assertEquals(null, mAudioRoutingManager.getA2dpActiveDevice());
        Assert.assertEquals(null, mAudioRoutingManager.getLeAudioActiveDevice());
    }
