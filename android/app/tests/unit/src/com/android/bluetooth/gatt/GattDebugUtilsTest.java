...
public class GattDebugUtilsTest {
    ...
    public void handleDebugAction() {
        ...
        intent = new Intent(ACTION_GATT_PAIRING_CONFIG);
        GattDebugUtils.handleDebugAction(mService, intent);
        int authReq = 5;
        int ioCap = 4;
        int initKey = 7;
