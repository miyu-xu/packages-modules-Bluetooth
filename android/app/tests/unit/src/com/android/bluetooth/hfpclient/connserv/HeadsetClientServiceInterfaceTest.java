...
public class HeadsetClientServiceInterfaceTest {
    ...
    private static final BluetoothHeadsetClientCall TEST_CALL = new BluetoothHeadsetClientCall(TEST_DEVICE, /* id= */ 0,
    ...
    private void makeHeadsetClientServiceAvailable() {
        ...
        assertThat(HeadsetClientService.getHeadsetClientService()).isEqualTo(mMockHeadsetClientService);
    }
    ...
    public void testEnterPrivateMode() {
        ...
        doReturn(false).when(mMockHeadsetClientService).enterPrivateMode(TEST_DEVICE, TEST_CALL_INDEX);
        assertThat(mServiceInterface.enterPrivateMode(TEST_DEVICE, TEST_CALL_INDEX)).isFalse();
        doReturn(true).when(mMockHeadsetClientService).enterPrivateMode(TEST_DEVICE, TEST_CALL_INDEX);
    ...
    public void testTerminateCall() {
        ...
        doReturn(true).when(mMockHeadsetClientService).terminateCall(TEST_DEVICE, TEST_CALL.getUUID());
        assertThat(mServiceInterface.terminateCall(TEST_DEVICE, TEST_CALL)).isTrue();
        doReturn(false).when(mMockHeadsetClientService).terminateCall(TEST_DEVICE, TEST_CALL.getUUID());
        assertThat(mServiceInterface.terminateCall(TEST_DEVICE, TEST_CALL)).isFalse();
    }
