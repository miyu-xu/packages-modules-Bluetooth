...
public class BluetoothPbapObexAuthenticatorTest {
    ...
    private static final String DEFAULT_SESSION_KEY = "0000";
    ...
    public void onAuthenticationChallenge() {
        ...
        assertThat(passwordAuthentication.getPassword()).isEqualTo(DEFAULT_SESSION_KEY.getBytes());
    }

    @Test
    public void onAuthenticationChallenge_returnsNull() {
