...
public class BluetoothOppReceiverTest {
    ...
    @Test
    public void onReceive_withActionIncomingFileConfirm_startIncomingFileConfirmActivity() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionOutboundTransfer_startTransferHistoryActivity() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionInboundTransfer_startTransferHistoryActivity() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionOpenReceivedFile_startTransferHistoryActivity() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionTransferCompleteAndHandoverInitiated_contextSendBroadcast() {
        List<BluetoothOppTestUtils.CursorMockData> cursorMockDataList;
        Cursor cursor = mock(Cursor.class);
        int idValue = 1234;
    ...
    @Test
    public void onReceive_withActionTransferComplete_noBroadcastSent() {
        List<BluetoothOppTestUtils.CursorMockData> cursorMockDataList;
        Cursor cursor = mock(Cursor.class);
        int idValue = 1234;
        Long timestampValue = 123456789L;
