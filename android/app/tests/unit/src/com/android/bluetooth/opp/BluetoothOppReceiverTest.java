...
public class BluetoothOppReceiverTest {
    ...
    @Test
    public void onReceive_withActionDeviceSelected_transferStarted() {
    ...
    @Test
    public void onReceive_withActionIncomingFileConfirm_startActivity() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionAccept_contentUpdated() {
    ...
    @Test
    public void onReceive_withActionDecline_contentUpdated() {
        Uri uri = Uri.parse("content:///important");
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionOutboundTransfer_activityStart() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionInboundTransfer_activityStart() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionOpenReceivedFile_activityStart() {
        Intent intent = new Intent();
    ...
    @Test
    public void onReceive_withActionTransferComplete_withHandoverInitiated_contextSendBroadcast() {
        List<BluetoothOppTestUtils.CursorMockData> cursorMockDataList;
        Cursor cursor = mock(Cursor.class);
        int idValue = 1234;
    ...
    @Test
    public void onReceive_withActionTransferComplete_withoutHandoverInitiated_noBroadcastSent() {
        List<BluetoothOppTestUtils.CursorMockData> cursorMockDataList;
        Cursor cursor = mock(Cursor.class);
        int idValue = 1234;
        Long timestampValue = 123456789L;
