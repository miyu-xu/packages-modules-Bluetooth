...
public class BluetoothMapObexServerTest {
    ...
    private static final String TEST_MSG_HANDLE = "msg_handle";
    ...
    public void setOwnerStatus_withAccountTypeEmail() throws Exception {
        ...
        assertThat(obexServer.setOwnerStatus(TEST_MSG_HANDLE, mParams)).isEqualTo(
    ...
    public void setOwnerStatus_withAppParamsInvalid() throws Exception {
        ...
        assertThat(mObexServer.setOwnerStatus(TEST_MSG_HANDLE, params)).isEqualTo(
    ...
    public void setOwnerStatus_withNonNullBundle() throws Exception {
        ...
        assertThat(mObexServer.setOwnerStatus(TEST_MSG_HANDLE, mParams)).isEqualTo(
