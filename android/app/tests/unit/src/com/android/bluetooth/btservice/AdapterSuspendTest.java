...
public class AdapterSuspendTest {
    ...
    private void triggerSuspend() throws Exception {
        Method handleSuspend = AdapterSuspend.class.getDeclaredMethod("handleSuspend");
        handleSuspend.setAccessible(true);
        handleSuspend.invoke(mAdapterSuspend);
    }

    private void triggerResume() throws Exception {
        Method handleResume = AdapterSuspend.class.getDeclaredMethod("handleResume");
        handleResume.setAccessible(true);
        handleResume.invoke(mAdapterSuspend);
    }

    private boolean isSuspended() throws Exception {
        Field suspended = AdapterSuspend.class.getDeclaredField("mSuspended");
        suspended.setAccessible(true);
        return (boolean) suspended.get(mAdapterSuspend);
    }
