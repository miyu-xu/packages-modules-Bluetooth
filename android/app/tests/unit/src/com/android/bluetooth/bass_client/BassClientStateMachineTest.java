...
public class BassClientStateMachineTest {
    ...
    private static final String emptyBluetoothDeviceAddress = "00:00:00:00:00:00";
    ...
    public void setUp() throws Exception {
        ...
        mEmptyTestDevice = mAdapter.getRemoteDevice(emptyBluetoothDeviceAddress);
        ...
        doReturn(mEmptyTestDevice)
                .when(mMethodProxy)
                .getDefaultAdapterRemoteDevice(emptyBluetoothDeviceAddress);
