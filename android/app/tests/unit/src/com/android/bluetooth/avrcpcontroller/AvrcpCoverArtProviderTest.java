...
public class AvrcpCoverArtProviderTest {
    ...
    @Test
    public void openFile_whenIOExceptionIsCaught() {
    ...
    public void getImageUri_withValidImageUuid() {
        ...
        assertThat(AvrcpCoverArtProvider.getImageUri(mTestDevice, uuid)).isEqualTo(
                AvrcpCoverArtProvider.CONTENT_URI.buildUpon().appendQueryParameter("device",
                        mTestDevice.getAddress()).appendQueryParameter("uuid", uuid).build());
    }
