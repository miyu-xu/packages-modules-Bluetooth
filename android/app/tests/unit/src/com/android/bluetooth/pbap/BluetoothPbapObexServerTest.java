...
public class BluetoothPbapObexServerTest {
    ...
    @Test
    public void pushHeader() throws Exception {
    ...
    @Test
    public void pushHeader_throwsExceptionWhenOpeningOutputStream() throws Exception {
        HeaderSet reply = new HeaderSet();
        Operation op = mock(Operation.class);
    ...
    @Test
    public void pushHeader_throwsExceptionWhenClosingOutputStream() throws Exception {
        HeaderSet reply = new HeaderSet();
        Operation op = mock(Operation.class);
        OutputStream os = mock(OutputStream.class);
        when(op.openOutputStream()).thenReturn(os);
    ...
    @Test
    public void parseApplicationParameter_forDefaultCase() {
    ...
    @Test
    public void parseApplicationParameter_PROPERTY_SELECTOR_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_SUPPORTEDFEATURE_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_ORDER_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_SEARCH_VALUE_TAGID() {
        int searchLength = 4;
    ...
    @Test
    public void parseApplicationParameter_SEARCH_ATTRIBUTE_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_MAXLISTCOUNT_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_LISTSTARTOFFSET_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_FORMAT_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_VCARDSELECTOR_TAGID() {
    ...
    @Test
    public void parseApplicationParameter_VCARDSELECTOROPERATOR_TAGID() {
