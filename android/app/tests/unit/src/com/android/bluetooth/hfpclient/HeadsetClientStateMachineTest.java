...
public class HeadsetClientStateMachineTest {
    ...
    /**
     * Test AM to HF and HF to AM volume symetric. The test takes the lower range set, e.g. if AM
     ...
     * they match AM. This proves that the conversion is symetric.
     */
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_HEADSETCLIENT_AM_HF_VOLUME_SYMETRIC)
    public void testAmHfVolumeSymetric() {
        int lowerRangeMin = 0;
        int lowerRangeMax = 0;
