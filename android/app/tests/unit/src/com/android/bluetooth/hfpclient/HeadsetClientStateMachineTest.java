...
import com.android.bluetooth.csip.CsipSetCoordinatorStackEvent;
import com.android.bluetooth.csip.CsipSetCoordinatorStateMachine;
...
public class HeadsetClientStateMachineTest {
    ...
    public void setUp() throws Exception {
        ...
        mHeadsetClientStateMachine = new HeadsetClientStateMachineWrapper(mHeadsetClientService,
    ...
    @Test
    public void testProcessStackEvent_CmdResult_onConnectingState() {
        initToConnectingState();
        StackEvent event = new StackEvent(StackEvent.EVENT_TYPE_CMD_RESULT);
    ...
    @Test
    public void testProcessStackEvent_Connection_State_Changed_onAudioOnState() {
        initToAudioOnState();
        StackEvent event = new StackEvent(StackEvent.EVENT_TYPE_CONNECTION_STATE_CHANGED);
        event.valueInt = HeadsetClientHalConstants.CONNECTION_STATE_DISCONNECTED;
        event.device = mTestDevice;
    ...
    @Test
    public void testProcessStackEvent_Audio_State_Changed_onAudioOnState() {
        initToAudioOnState();
