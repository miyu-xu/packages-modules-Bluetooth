...
public class HeadsetClientStateMachineTest {
    ...
    @Test
    public void testGetConnectionState_withDeviceNull() {
        Assert.assertEquals(mHeadsetClientStateMachine.getConnectionState(null),
                BluetoothProfile.STATE_DISCONNECTED);
    }

    @Test
    public void testGetConnectionState_withDeviceNotNull() {
        mHeadsetClientStateMachine.mCurrentDevice = mTestDevice;
    ...
    public void testGetConnectionStateFromAudioState() {
        ...
        Assert.assertEquals(HeadsetClientStateMachine.getConnectionStateFromAudioState(3),
                BluetoothAdapter.STATE_DISCONNECTED);
    }
    ...
    public void testGetMessageName() {
        ...
        Assert.assertEquals(HeadsetClientStateMachine.getMessageName(54), "UNKNOWN(" + 54 + ")");
    }
}
