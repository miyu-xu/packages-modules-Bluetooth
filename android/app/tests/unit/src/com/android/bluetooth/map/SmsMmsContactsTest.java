...
public class SmsMmsContactsTest {
    ...
    @Test
    public void getContactNameFromPhone_withNonNullContact_withZeroId() {
        long zeroId = 0;
    ...
    @Test
    public void getContactNameFromPhone_withNonNullContact_withNullFilter() {
        MapContact contact = MapContact.create(TEST_ID, TEST_PHONE);
        mContacts.mNames.put(TEST_PHONE, contact);
    ...
    @Test
    public void getContactNameFromPhone_withNonNullContact() {
        MapContact contact = MapContact.create(TEST_ID, TEST_PHONE);
        mContacts.mNames.put(TEST_PHONE, contact);
