...
public class BluetoothMapFolderElementTest {
    ...
    private static final String TEST_DUMMY_FOLDER_NAME = "dummy";
    ...
    private static final long TEST_DUMMY_ID = 6;
    ...
    public void setUp() throws Exception {
        ...
        mTestFolderElement.setIngore(TEST_IGNORE);
    ...
    public void getFolderById() {
        ...
        assertThat(BluetoothMapFolderElement.getFolderById(TEST_DUMMY_ID,
    ...
    public void getFolderByName() {
        ...
        BluetoothMapFolderElement dummyFolderElement = mRootFolderElement.getSubFolder(
                TEST_TELECOM_FOLDER_NAME).getSubFolder(TEST_MSG_FOLDER_NAME).addFolder(
                TEST_DUMMY_FOLDER_NAME);
        assertThat(mRootFolderElement.getFolderByName(TEST_DUMMY_FOLDER_NAME)).isNull();
        dummyFolderElement.setFolderId(TEST_DUMMY_ID);
        assertThat(mRootFolderElement.getFolderByName(TEST_DUMMY_FOLDER_NAME)).isEqualTo(
                dummyFolderElement);
    }
