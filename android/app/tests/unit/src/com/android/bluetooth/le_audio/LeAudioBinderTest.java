...
public class LeAudioBinderTest {
    ...
    private IBluetoothLeAudioCallback mLeAudioCallback = new IBluetoothLeAudioCallback.Stub() {
        @Override
    ...
    private IBluetoothLeBroadcastCallback mBroadcastCallback =
    ...
    public void registerCallback() {
        ...
        mBinder.registerCallback(mLeAudioCallback, source, recv);
        verify(mMockService.mLeAudioCallbacks).register(mLeAudioCallback);
    }
    ...
    public void unregisterCallback() {
        ...
        mBinder.unregisterCallback(mLeAudioCallback, source, recv);
        verify(mMockService.mLeAudioCallbacks).unregister(mLeAudioCallback);
    }
    ...
    public void registerLeBroadcastCallback() {
        ...
        mBinder.registerLeBroadcastCallback(mBroadcastCallback, source, recv);
        verify(mMockService.mBroadcastCallbacks).register(mBroadcastCallback);
    }
    ...
    public void unregisterLeBroadcastCallback() {
        ...
        mBinder.unregisterLeBroadcastCallback(mBroadcastCallback, source, recv);
        verify(mMockService.mBroadcastCallbacks).unregister(mBroadcastCallback);
    }
