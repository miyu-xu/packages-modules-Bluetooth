...
import static com.android.bluetooth.BluetoothActivity.STATE_DESTROYED;
...
public class BluetoothPbapActivityTest extends
    ...
    public void activityIsDestroyed_whenLaunchedWithoutIntentAction() {
        ...
        assertThat(activity.waitForState(STATE_DESTROYED, 0)).isTrue();
    }
    ...
    public void onPositive_finishesActivity() {
        ...
        assertThat(activity.waitForState(STATE_DESTROYED, 3_000)).isTrue();
    }
