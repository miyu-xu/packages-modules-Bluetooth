...
public class BluetoothPbapActivityTest {
    ...
    // TODO: recreate() fails - The Activity just finishes itself when recreated.
    //       Fix the bug and test the behavior.
    // @Test
    public void recreate() throws Exception {
        mActivityScenario.onActivity(activity -> activity.recreate());

        assertActivityState(RESUMED);
    }
