...
public class AdapterServiceFactoryResetTest {
    ...
    public void setUp() throws PackageManager.NameNotFoundException {
        ...
        AdapterNativeInterface.sInstance = mNativeInterface;
        BluetoothKeystoreNativeInterface.sInstance = mKeystoreNativeInterface;
        BluetoothQualityReportNativeInterface.sInstance = mQualityNativeInterface;
        SdpManagerNativeInterface.sInstance = mSdpNativeInterface;
        AdvertiseManagerNativeInterface.sInstance = mAdvertiseNativeInterface;
        DistanceMeasurementNativeInterface.sInstance = mDistanceNativeInterface;
        GattNativeInterface.sInstance = mGattNativeInterface;
        PeriodicScanNativeInterface.sInstance = mPeriodicNativeInterface;
    ...
    public void tearDown() {
        ...
        AdapterNativeInterface.sInstance = null;
        BluetoothKeystoreNativeInterface.sInstance = null;
        BluetoothQualityReportNativeInterface.sInstance = null;
        SdpManagerNativeInterface.sInstance = null;
        AdvertiseManagerNativeInterface.sInstance = null;
        DistanceMeasurementNativeInterface.sInstance = null;
        GattNativeInterface.sInstance = null;
        PeriodicScanNativeInterface.sInstance = null;
    }
     ...
     */
    @Test
    @Ignore("b/296127545: BluetoothInstrumentationTests should not perfom native call")
