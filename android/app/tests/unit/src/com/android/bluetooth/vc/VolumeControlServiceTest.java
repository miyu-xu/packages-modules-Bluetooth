...
public class VolumeControlServiceTest {
    ...
    public void testVolumeControlInputDescriptor() throws Exception {
        mSetFlagsRule.enableFlags(Flags.FLAG_LEAUDIO_ADD_AICS_SUPPORT);

        VolumeControlService.VolumeControlInputDescriptor descriptor =
                new VolumeControlService.VolumeControlInputDescriptor();
