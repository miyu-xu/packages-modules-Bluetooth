...
public class HeadsetStateMachineTest {
    ...
    @Test
    public void testProcessVendorSpecificAt_withValidEqualSignCommandAndArg() {
    ...
    @Test
    public void testProcessVendorSpecificAt_withValidNoEqualSignCommandCGMI() {
    ...
    @Test
    public void testProcessVendorSpecificAt_withValidNoEqualSignCommandCGMM() {
    ...
    @Test
    public void testProcessVendorSpecificAt_withValidNoEqualSignCommandCGMR() {
    ...
    @Test
    public void testProcessVendorSpecificAt_withValidNoEqualSignCommandCGSN() {
