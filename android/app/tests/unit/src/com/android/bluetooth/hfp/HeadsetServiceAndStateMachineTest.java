...
public class HeadsetServiceAndStateMachineTest {
    ...
    public void setUp() throws Exception {
        ...
        android.sysprop.bluetooth.Hfp.swb_aptx_power_management(true);
        Assert.assertTrue(android.sysprop.bluetooth.Hfp.swb_aptx_power_management().orElse(false));
    ...
    public void testVoiceRecognition_SingleHfStopSuccess() {
        ...
        verify(mNativeInterface, timeout(ASYNC_CALL_TIMEOUT_MILLIS).atLeast(1))
                .enableSwb(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX), anyBoolean());
    ...
    public void testVoiceRecognition_SingleAgStopSuccess() {
        ...
        verify(mNativeInterface, timeout(ASYNC_CALL_TIMEOUT_MILLIS).atLeast(1))
                .enableSwb(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX), anyBoolean());
        verify(mNativeInterface, timeout(ASYNC_CALL_TIMEOUT_MILLIS).atLeast(1))
                .isSwbEnabled(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX));
        verifyNoMoreInteractions(mNativeInterface);
    }
    ...
    public void testIncomingCall_NonHdNonVoipCall_AptXDisabled() {
        when(mNativeInterface.isSwbEnabled(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX)))
                .thenReturn(true);
        when(mNativeInterface.enableSwb(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX), anyBoolean()))
                .thenReturn(true);
        ...
        int swbCodec = HeadsetHalConstants.BTHF_SWB_CODEC_APTX;
        ...
        verify(mNativeInterface, times(1))
                .enableSwb(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX), eq(false));
        verifyNoMoreInteractions(mNativeInterface);
    }
    ...
    public void testIncomingCall_HdNonVoipCall_AptXEnabled() {
        ...
        verify(mNativeInterface, times(1)).sendBsir(eq(device), eq(true));
        verify(mNativeInterface, times(1))
                .enableSwb(eq(HeadsetHalConstants.BTHF_SWB_CODEC_APTX), eq(true));
        verifyNoMoreInteractions(mNativeInterface);
    }
    ...
    /**
     * Test the functionality of {@link HeadsetService#isSwbEnabled()} and {@link
     * HeadsetService#enableSwbCodec()}
     *
