...
public class BluetoothPbapCallLogComposerTest {
    ...
    private static final Uri sCallLogUri = CallLog.Calls.CONTENT_URI;
    ...
    private static final String sSelection = null;
    private static final String[] sSelectionArgs = null;
    private static final String sSortOrder = null;

    private BluetoothPbapCallLogComposer mComposer;

    @Spy
    BluetoothPbapObjectsFactory mPbapObjectsFactory = BluetoothPbapObjectsFactory.getInstance();
    ...
    public void setUp() throws Exception {
        ...
        BluetoothPbapObjectsFactory.setInstanceForTesting(mPbapObjectsFactory);

        doReturn(mMockCursor).when(mPbapObjectsFactory)
                .queryContentUri(any(), any(), any(), any(), any(), any());
    ...
    public void tearDown() throws Exception {
        BluetoothPbapObjectsFactory.setInstanceForTesting(null);
    }

    @Test
    public void testInit_success() {
        assertThat(mComposer.init(sCallLogUri, sSelection, sSelectionArgs, sSortOrder))
                .isTrue();
    ...
    public void testInit_failWhenUriIsNotSupported() {
        ...
        assertThat(uriOtherThanCallLog).isNotEqualTo(sCallLogUri);

        assertThat(mComposer.init(uriOtherThanCallLog, sSelection, sSelectionArgs, sSortOrder))
                .isFalse();
    ...
    public void testInit_failWhenCursorIsNull() {
        doReturn(null).when(mPbapObjectsFactory)
                .queryContentUri(any(), any(), any(), any(), any(), any());
    ...
    public void testCreateOneEntry_success() {
        mComposer.init(sCallLogUri, sSelection, sSelectionArgs, sSortOrder);
