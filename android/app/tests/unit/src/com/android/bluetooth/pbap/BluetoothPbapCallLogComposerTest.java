...
public class BluetoothPbapCallLogComposerTest {
    ...
    private static final Uri sValidCallLogUri = CallLog.Calls.CONTENT_URI;
    ...
    public void testInit_success() {
        assertThat(mComposer.init(sValidCallLogUri, /*selection=*/ null,
                /*selectionArgs=*/ null, /*sortOrder=*/ null)).isTrue();
        assertThat(mComposer.getErrorReason()).isEqualTo(NO_ERROR);
    }

    @Test
    public void testInit_failWhenUriIsNotSupported() {
        final Uri uriOtherThanCallLog = Uri.parse("content://not/a/call/log");
        assertThat(uriOtherThanCallLog).isNotEqualTo(sValidCallLogUri);

        assertThat(mComposer.init(uriOtherThanCallLog, /*selection=*/ null,
                /*selectionArgs=*/ null, /*sortOrder=*/ null)).isFalse();
    ...
    public void testCreateOneEntry_success() {
        mComposer.init(sValidCallLogUri, /*selection=*/ null, /*selectionArgs=*/ null,
                /*sortOrder=*/ null);
