...
public class TbsGattTest {
    ...
    public void testSetInbandRingtoneTwice() {
        ...
        BluetoothGattCharacteristic characteristic = getCharacteristic(TbsGatt.UUID_STATUS_FLAGS);
        int statusFlagValue = STATUS_FLAG_INBAND_RINGTONE_ENABLED;
        ...
        verify(mMockGattServer, times(2)).notifyCharacteristicChanged(eq(mSecondDevice),
                                eq(characteristic), eq(false), eq(valueBytes));
    }
    ...
    public void testClearInbandRingtoneTwice() {
        ...
        byte[] valueBytes = new byte[2];
        value[0] = (byte) (valueBytes & 0xFF);
        value[1] = (byte) ((valueBytes >> 8) & 0xFF);
        ...
        // clear flag
        statusFlagValue = 0;
        value[0] = (byte) (statusFlagValue & 0xFF);
        value[1] = (byte) ((statusFlagValue >> 8) & 0xFF);
