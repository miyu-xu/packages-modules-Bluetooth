...
public class BrowseTreeTest {
    ...
    @Test
    public void constructor_withDeviceNull() {
    ...
    public void getTrackFromNowPlayingList() {
        ...
        assertThat(browseTree.getTrackFromNowPlayingList(0)).isNull();
    }
    ...
    public void onConnected() {
        ...
        assertThat(browseTree.mRootNode.getChild(0).mItem.getDevice()).isEqualTo(mTestDevice);
    }
