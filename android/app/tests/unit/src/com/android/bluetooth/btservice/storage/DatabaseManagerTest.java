...
public final class DatabaseManagerTest {
    ...
    public void testSetConnectionHeadset() {
        ...
        Assert.assertTrue(mDatabaseManager
                .mMetadataCache.get(mTestDevice.getAddress()).isActiveHfpDevice);
        ...
        Assert.assertFalse(mDatabaseManager
                .mMetadataCache.get(mTestDevice.getAddress()).isActiveHfpDevice);
        Assert.assertTrue(mDatabaseManager
                .mMetadataCache.get(mTestDevice2.getAddress()).isActiveHfpDevice);
    ...
    public void testDatabaseMigration_117_118() throws IOException {
        ...
        db.close();
        db = testHelper.runMigrationsAndValidate(DB_NAME, 118, true,
                MetadataDatabase.MIGRATION_117_118);
        Cursor cursor = db.query("SELECT * FROM metadata");
