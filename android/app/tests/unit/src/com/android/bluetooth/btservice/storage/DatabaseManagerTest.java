...
public final class DatabaseManagerTest {
    ...
    public void testSetGetPreferredAudioProfiles() {
        ...
        // TEST 1: If input is invalid, throws IllegalArgumentException
        ...
        testSetGetPreferredAudioProfilesCase(false, preferences, preferences,
    ...
    void testSetGetPreferredAudioProfilesCase(boolean stored, Bundle preferencesToSet,
        ...
        Assert.assertEquals(expectedPreferences,
                mDatabaseManager.getPreferredAudioProfiles(mTestDevice));
        Assert.assertEquals(expectedPreferences,
                mDatabaseManager.getPreferredAudioProfiles(mTestDevice2));
        // Wait for database update
        TestUtils.waitForLooperToFinishScheduledTask(mDatabaseManager.getHandlerLooper());
