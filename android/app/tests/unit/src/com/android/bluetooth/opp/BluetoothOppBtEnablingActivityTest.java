...
import static com.android.bluetooth.opp.BluetoothOppBtEnablingActivity.EVENT_ONDESTROY;
...
public class BluetoothOppBtEnablingActivityTest {
    ...
    public void setUp() {
        ...
        mRealTimeoutValue = BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue;
        enableActivity(true);
    }
    ...
    public void tearDown() {
        ...
        BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue = mRealTimeoutValue;
        enableActivity(false);
    }

    @Test
    public void onCreate_bluetoothEnableTimeout_finishAfterTimeout() {
        // To speed up the test
        BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue = 100;
        ...
        verify(mBluetoothMethodProxy,
                timeout(BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue + 3_000)).
                eventTriggered(argThat(EVENT_ONDESTROY::equals));
        assertThat(mOppManager[0].mSendingFlag).isEqualTo(false);
        assertThat(activityScenario.getState()).isEqualTo(DESTROYED);
    }

    @Test
    public void onKeyDown_cancelProgress() {
        doReturn(false).when(mBluetoothMethodProxy).bluetoothAdapterIsEnabled(any());
        ActivityScenario<BluetoothOppBtEnablingActivity> activityScenario = ActivityScenario.launch(
                mIntent);
    ...
    @Test
    public void onCreate_bluetoothAlreadyEnabled_finishImmediately() {
