...
import static com.android.bluetooth.opp.BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue;
...
public class BluetoothOppBtEnablingActivityTest {
    ...
    public void onCreate_bluetoothEnableTimeout_finishAfterTimeout() throws Exception {
        ...
        Thread.sleep(BluetoothOppBtEnablingActivity.sBtEnablingTimeoutValue);
    ...
    private void assertActivityState(ActivityScenario activityScenario, Lifecycle.State state) throws Exception {
