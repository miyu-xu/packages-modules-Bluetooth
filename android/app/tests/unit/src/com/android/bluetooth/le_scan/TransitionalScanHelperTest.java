...
public class TransitionalScanHelperTest {
    ...
    public void setUp() throws Exception {
        ...
        mScanHelper = new TransitionalScanHelper(InstrumentationRegistry.getTargetContext(), () -> false);
    ...
    public void testParseBatchTimestamp() {
        long timestampNanos = mScanHelper.parseTimestampNanos(new byte[]{
                -54, 7
        });
    ...
    public void onBatchScanReportsInternal_deliverBatchScan() throws RemoteException {
        ...
        mScanHelper.onBatchScanReportsInternal(status, scannerId, reportType, numRecords, recordData);
    ...
    public void registerScanner() throws Exception {
        ...
        verify(mScannerMap).add(any(), eq(workSource), eq(callback), eq(null), any(), eq(mScanHelper));
    ...
    public void transferSetInfo() {
        ...
        mScanHelper.transferSetInfo(mDevice, serviceData, advHandle, callback,
                mAttributionSource);
