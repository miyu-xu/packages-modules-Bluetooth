...
public class FakeObexServer {
     ...
     *
     * This can be used to quickly test request objects that need a ClientSession
     */
     ...
     *
     * By specification, servers themselves cannot issue an OBEX session level disconnect.
     */
    public void close() {
     ...
     *
     * This is setup this way for easier test syntax, so one can extend the fake without needing to
     * care about the framework specifics
     */
