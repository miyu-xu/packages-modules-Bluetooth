...
public class BluetoothOppBatchTest {
    ...
    Context mContext;
    @Mock
    BluetoothOppShareInfo mMockBluetoothOppShareInfo;
    @Mock
    BluetoothOppShareInfo mMockBluetoothOppShareInfo2;
    ...
    public class BluetoothOppBatchListenerTest implements
