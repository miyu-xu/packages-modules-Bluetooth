...
public  class FakeContactsProvider extends MockContentProvider {
    ...
    public static class FakeRawContact {
        ...
        public FakeRawContact(int id, String accountType, String accountName, boolean starred,
                String phonebook) {
            mId = id;
    ...
    public void addContact(String accountType, String accountName, boolean favorite,
            String phonebook, String phone) {
    ...
    public ContentProviderResult[] applyBatch(String authority,
        ...
        Log.d(TAG, "APPLY: authority=" + authority + ", operations=" + operations.size());
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (RawContacts.CONTENT_URI.equals(base)) {
            ...
            int id = getNextId();
            FakeRawContact contact = new FakeRawContact(id, accountType, accountName,
                    (starred == null ? false : starred.booleanValue()), null);
    ...
    public int update(Uri uri, ContentValues values, String where, String[] selectionArgs) {
        Log.d(TAG, "UPDATE: uri=" + uri + ", where=" + where + ", args="
    ...
    public int delete(Uri uri, String where, String[] selectionArgs) {
        Log.d(TAG, "DELETE: uri=" + uri + ", where=" + where + ", args="
                + Arrays.toString(selectionArgs));
    ...
    public Cursor query(
        ...
        Log.d(TAG, "QUERY: uri=" + uri + ", select=" + projection + ", where=" + selection
                + ", args=" + selectionArgs + ", order=" + sortOrder);
    ...
    public void dump() {
        Log.d(TAG, "Accounts (" + mAccounts.size() + "):");
        for (int i = 0; i < mAccounts.size(); i++) {
            int id = mAccounts.keyAt(i);
            FakeAccount account = mAccounts.valueAt(i);
            Log.d(TAG, "    [" + id + "]: type=" + account.getAccountType() + ", name="
                    + account.getAccountName());
        }

        Log.d(TAG, "Contacts (raw=" + mRawContacts.size() + ", data=" + mData.size() + "):");
        for (int i = 0; i < mRawContacts.size(); i++) {
            int id = mRawContacts.keyAt(i);
            FakeRawContact contact = mRawContacts.valueAt(i);
            Log.d(TAG, "    [" + id + "]: phonebook=" + contact.getPhonebook() + ", favorite="
                    + contact.isFavorite());
