...
public class BluetoothMapIMProviderTest {
    ...
    @Test
    public void testQuery_forConversationUri() {
        ProviderInfo providerInfo = new ProviderInfo();
        providerInfo.authority = AUTHORITY;
        providerInfo.exported = true;
        providerInfo.writePermission = android.Manifest.permission.BLUETOOTH_MAP;
        ...
        Uri conversatinoUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(AUTHORITY)
                .appendPath(ACCOUNT_ID)
        ...
        mProvider.query(conversatinoUri, /*projection=*/ null, /*selection=*/ null,
                /*selectionArgs=*/ null, /*sortOrder=*/ null);
    ...
    @Test
    public void testQuery_forConvoContactUri() {
        ProviderInfo providerInfo = new ProviderInfo();
        providerInfo.authority = AUTHORITY;
        providerInfo.exported = true;
        providerInfo.writePermission = android.Manifest.permission.BLUETOOTH_MAP;
    ...
    @Test
    public void testUpdate_forFolderUri() {
    ...
    @Test
    public void testUpdate_forConversationUri() {
        Uri folderUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(AUTHORITY)
                .appendPath(ACCOUNT_ID)
                .appendPath(BluetoothMapContract.TABLE_CONVERSATION)
    ...
    @Test
    public void testUpdate_forConvoContactUri() {
        Uri folderUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(AUTHORITY)
                .appendPath(ACCOUNT_ID)
                .appendPath(BluetoothMapContract.TABLE_CONVOCONTACT)
    ...
    @Test
    public void testUpdate_forMessageUri_success() {
        Uri accountUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(AUTHORITY)
                .appendPath(ACCOUNT_ID)
                .appendPath(BluetoothMapContract.TABLE_MESSAGE)
    ...
    @Test
    public void testCall_updateFolderMethod_whenExtrasDoesNotHaveAccountId() {
    ...
    @Test
    public void testCall_updateFolderMethod_whenExtrasDoesNotHaveFolderId() {
        Bundle extras = new Bundle();
    ...
    @Test
    public void testCall_updateFolderMethod_success() {
        Bundle extras = new Bundle();
    ...
    @Test
    public void testCall_setBluetoothStateMethod_success() {
    ...
    @Test
    public void testGetAccountId_whenNotEnoughPathSegments() {
