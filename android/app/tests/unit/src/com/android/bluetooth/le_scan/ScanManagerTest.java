...
public class ScanManagerTest {
    ...
    public void testMetricsAppScanScreenOn() {
        ...
        for (int i = 0; i < scanModeMap.size(); i++) {
            ...
            final String APP_NAME = "Test" + i;
            final int UID = 10000 + i;
            final String PACKAGE_NAME = "com.test.package" + i;
            ...
            assertThat(capturedAppScanDuration).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
        }
    }
    ...
    public void testMetricsRadioScanScreenOnOffMultiScan() {
        ...
        final String APP_NAME_1 = "Test1";
        final int UID_1 = 10001;
        final String PACKAGE_NAME_1 = "com.test.package1";
        ...
        final String APP_NAME_2 = "Test2";
        final int UID_2 = 10002;
        final String PACKAGE_NAME_2 = "com.test.package2";
        ...
        assertThat(capturedRadioScanDuration1).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
        // Wait for scan test duration
        testSleep(scanTestDuration);

        // Create workSource for the third app
        final String APP_NAME_3 = "Test3";
        final int UID_3 = 10003;
        final String PACKAGE_NAME_3 = "com.test.package3";
        ...
        assertThat(capturedRadioScanDuration2).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
        // Wait for scan test duration
        testSleep(scanTestDuration);

        // Create workSource for the fourth app
        final String APP_NAME_4 = "Test4";
        final int UID_4 = 10004;
        final String PACKAGE_NAME_4 = "com.test.package3";
        ...
        assertThat(capturedRadioScanDuration3).isAtMost(scanTestDuration * 2 + DELAY_ASYNC_MS * 2);
        ...
        assertThat(capturedRadioScanDuration4).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
        Mockito.clearInvocations(mMetricsLogger);
        // Wait for scan test duration
        testSleep(scanTestDuration);
        ...
        assertThat(capturedRadioScanDuration5).isAtMost(scanTestDuration * 2 + DELAY_ASYNC_MS * 2);
        // Wait for scan test duration
        testSleep(scanTestDuration);
        ...
        assertThat(capturedRadioScanDuration6).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
        // Wait for scan test duration
        testSleep(scanTestDuration);
        ...
        assertThat(capturedRadioScanDuration7).isAtMost(scanTestDuration + DELAY_ASYNC_MS);
    }
