...
public class ActiveDeviceManagerTest {
    ...
    public void dualModeAudioDeviceConnected_withDualModeFeatureEnabled() {
        ...
        when(mAdapterService.isProfileSupported(mDualModeAudioDevice, BluetoothProfile.A2DP))
                .thenReturn(true);
        when(mAdapterService.isProfileSupported(mDualModeAudioDevice, BluetoothProfile.HEADSET))
                .thenReturn(true);
