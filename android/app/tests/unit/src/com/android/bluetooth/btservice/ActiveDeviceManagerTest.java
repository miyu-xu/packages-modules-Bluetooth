...
public class ActiveDeviceManagerTest {
    ...
    private void a2dpActiveDeviceChanged(BluetoothDevice device) {
        ...
        mActiveDeviceManager.profileActiveStateChanged(BluetoothProfile.A2DP, device);
    }
    ...
    private void headsetActiveDeviceChanged(BluetoothDevice device) {
        ...
        mActiveDeviceManager.profileActiveStateChanged(BluetoothProfile.HEADSET, device);
    }
    ...
    private void hearingAidActiveDeviceChanged(BluetoothDevice device) {
        ...
        mActiveDeviceManager.profileActiveStateChanged(BluetoothProfile.HEARING_AID, device);
    }
    ...
    private void leAudioActiveDeviceChanged(BluetoothDevice device) {
        ...
        mActiveDeviceManager.profileActiveStateChanged(BluetoothProfile.LE_AUDIO, device);
    }
