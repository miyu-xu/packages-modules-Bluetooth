...
public class HfpClientCallTest {
    ...
    public void testCreateAlertingCall() {
        HfpClientCall call = new HfpClientCall(
                ...
                /* outgoing= */ true,
                /* inBandRing= */ false);
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_ALERTING, TEST_NUMBER, false, true,
                false, call);
    }
    ...
    public void testCreateIncomingCall() {
        HfpClientCall call = new HfpClientCall(
                ...
                /* outgoing= */ false,
                /* inBandRing= */ false);
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_INCOMING, TEST_NUMBER, false, false,
                false, call);
    }
    ...
    public void testCreateWaitingCall() {
        HfpClientCall call = new HfpClientCall(
                ...
                /* outgoing= */ false,
                /* inBandRing= */ false);
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_WAITING, TEST_NUMBER, false, false,
                false, call);
    }
    ...
    public void testCreateHeldByResponseAndHoldCall() {
        HfpClientCall call = new HfpClientCall(
                ...
                /* outgoing= */ false,
                /* inBandRing= */ false);
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_HELD_BY_RESPONSE_AND_HOLD, TEST_NUMBER, false, false,
                false, call);
    }
    ...
    public void testCreateTerminatedCall() {
        HfpClientCall call = new HfpClientCall(
                ...
                /* outgoing= */ false,
                /* inBandRing= */ false);
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_TERMINATED, TEST_NUMBER, false, false,
                false, call);
    }
    ...
    public void testSetNumber() {
        ...
        assertCall(TEST_DEVICE, TEST_ID, HfpClientCall.CALL_STATE_ACTIVE, TEST_NUMBER_2, false, true,
                false, call);
    }
