...
public class BluetoothOppServiceTest {
    ...
    public void deleteShare_deleteShareAndCorrespondingBatch() {
        ...
        info.mTimestamp = infoTimestamp;
        info.mDestination = "AA:BB:CC:DD:EE:FF";
        BluetoothOppShareInfo info2 = mock(BluetoothOppShareInfo.class);
        info2.mTimestamp = infoTimestamp2;
        info2.mDestination = "00:11:22:33:44:55";
