...
public class BluetoothOppServiceTest {
    ...
    @Test
    public void trimDatabase_trimsRedundantRecords() {
        ContentResolver contentResolver = mock(ContentResolver.class);

        doReturn(1).when(mMethodProxy).contentResolverDelete(eq(contentResolver),
        ...
        verify(mMethodProxy, times(2)).contentResolverDelete(eq(contentResolver),
                eq(BluetoothShare.CONTENT_URI), anyString(), any());
    }
}
