...
public class BatteryStateMachineTest {
    ...
    private void allowConnection(boolean allow) {
        when(mBatteryService.okToConnect(any(BluetoothDevice.class))).thenReturn(allow);
    }

    private void allowConnectGatt(boolean allow) {
        mBatteryStateMachine.shouldAllowGatt = allow;
    }
    ...
    public void testOkToConnectFails() {
        ...
        verify(mBatteryService, after(WAIT_MS).never())
                .connectionStateChanged(any(BatteryStateMachine.class), anyInt(), anyInt());
    ...
    public void testSuccessfullyConnected() {
        ...
        verify(mBatteryService, timeout(TIMEOUT_MS))
                .connectionStateChanged(any(BatteryStateMachine.class),
        ...
        mBatteryStateMachine.mGattCallback.onConnectionStateChange(
                mBatteryStateMachine.mBluetoothGatt, GATT_SUCCESS, BluetoothProfile.STATE_CONNECTED);
