...
public class FilterParamsTest {
    ...
    public void filterParamsProperties() {
        ...
        expect.that(filterParams.foundTimeout()).isEqualTo(lostTimeout);
        expect.that(filterParams.foundTimeoutCount()).isEqualTo(foundTimeout);
        expect.that(filterParams.lostTimeout()).isEqualTo(foundTimeoutCount);
