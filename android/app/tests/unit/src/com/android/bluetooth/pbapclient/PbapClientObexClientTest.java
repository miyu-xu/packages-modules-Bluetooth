...
public class PbapClientObexClientTest {
    ...
    public void setUp() throws IOException {
        ...
        mObexClient =new PbapClientObexClient(
            mDevice,
            SUPPORTED_FEATURES,
            mMockCallback,
    ...
    public void testConnect_usingL2capTransport_deviceConnected() throws IOException {
        ...
        verify(mMockCallback).onConnectionStateChanged(eq(BluetoothProfile.STATE_DISCONNECTED), eq(BluetoothProfile.STATE_CONNECTING));
        verify(mMockCallback).onConnectionStateChanged(eq(BluetoothProfile.STATE_CONNECTING), eq(BluetoothProfile.STATE_CONNECTED));
    ...
    public void testRequestPhonebookMetadata() throws IOException {
        ...
        String vcard1 = createVcard(VERSION_30, "Foo", "Bar", "+1-234-567-8901", "111 Test Street;Test Town;CA;90210;USA", "Foo@email.com");
        String vcard2 = createVcard(VERSION_30, "Bar", "Foo", "+1-345-678-9012", "112 Test Street;Test Town;CA;90210;USA", "Bar@email.com");
        ...
        verify(mMockCallback).onGetPhonebookMetadataComplete(eq(160), eq(PbapPhonebook.LOCAL_PHONEBOOK_PATH), mMetadataCaptor.capture());
    ...
    public void testRequestPhonebook() throws IOException {
        ...
        verify(mMockCallback).onPhonebookContactsDownloaded(eq(160), eq(PbapPhonebook.LOCAL_PHONEBOOK_PATH), mPhonebookCaptor.capture());
    ...
    public void testDisconnect_whileRequestingPhonebookMetadata_obexDisconnects() throws IOException {
        ...
        // TODO: Set phonebook metadata
        // TODO: Set injected disconnect while handling? Is that a thing?
    ...
    private class FakePbapObexServer extends FakeObexServer {
        ...
        private int onGetPhonebookMetadata(String phonebook, final Operation op) {
            ...
            Log.i(TAG, "onGetPhonebookMetadata(): Metadata={"
                    + ("size=" + size)
        ...
        private int onGetPhonebook(String phonebook, final Operation op) {
            ...
            FakePhonebook contacts = mPhonebooks.get(phonebook);
            if (contacts != null) {
                vcards = createPhonebook(contacts.vcards);

                Log.i(TAG, "onGetPhonebook(): Contacts={"
                    + ("size=" + contacts.size)
