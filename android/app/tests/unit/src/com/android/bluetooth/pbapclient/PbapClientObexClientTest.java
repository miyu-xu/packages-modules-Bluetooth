...
public class PbapClientObexClientTest {
    ...
    // private static final String TEST_VCARD_1 = """
    //                                            BEGIN:VCARD
    //                                            VERSION:3.0
    //                                            FN:My name
    //                                            N:Name;My;;;
    //                                            TEL;TYPE=CALL:5551234567
    //                                            END:VCARD
    //                                            """;

    // private static final String TEST_VCARD_2 = """
    //                                            BEGIN:VCARD
    //                                            VERSION:3.0
    //                                            FN:My name
    //                                            N:Name;My;;;
    ...
    @Test
    public void testRequestPhonebookMetadata_issueDownloading_obexDisconnects() {
    ...
    @Test
    public void testRequestPhonebook_issueDownloading_obexDisconnects() {
    ...
    @Test
    public void testAbort_noOperationOngoing_nothingHappens() {

    }

    @Test
    public void testRequestPhonebookMetadata_operationAborted_obexDisconnects() {

    }

    @Test
    public void testRequestPhonebook_operationAborted_obexDisconnects() {
    ...
    @Test
    public void testDisconnect_obexNotConnected_nothingHappens() {
        assertThat(mObexClient.isConnected()).isFalse();
    ...
    @Test
    public void testDisconnect_obexConnecting_obexDisconnects() {

    }

    @Test
    public void testDisconnect_obexConnected_obexDisconnects() {

    }

    @Test
    public void testDisconnect_obexAlreadyDisconnecting_nothingHappens() {

    }

    @Test
    public void testDisconnect_obexDownloadingMetadata_obexDisconnects() {

    }

    @Test
    public void testDisconnect_obexDownloadingContacts_obexDisconnects() {
    ...
    public void verifyConnectionRequest() throws IOException {
        Log.i("FakeObexServer", "Waiting request from client");
