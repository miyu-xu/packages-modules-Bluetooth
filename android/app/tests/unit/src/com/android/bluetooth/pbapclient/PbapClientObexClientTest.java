...
public class PbapClientObexClientTest {
    ...
    public void testDisconnect_obexConnecting_obexDisconnects() throws IOException {
        ...
        // verify(mMockCallback,
        // timeout(1000)).onConnectionStateChanged(eq(BluetoothProfile.STATE_DISCONNECTED),
        // eq(BluetoothProfile.STATE_CONNECTING));
        ...
        // verify(mMockCallback,
        // timeout(1000)).onConnectionStateChanged(eq(BluetoothProfile.STATE_CONNECTING),
        // eq(BluetoothProfile.STATE_CONNECTED));
        ...
        // verify(mMockCallback,
        // timeout(1000)).onConnectionStateChanged(eq(BluetoothProfile.STATE_CONNECTED),
        // eq(BluetoothProfile.STATE_DISCONNECTING));

        // sendDisconnectResponse(ResponseCodes.OBEX_HTTP_OK);
        // verify(mMockCallback,
        // timeout(1000)).onConnectionStateChanged(eq(BluetoothProfile.STATE_DISCONNECTING),
        // eq(BluetoothProfile.STATE_DISCONNECTED));
    ...
    public void testDisconnect_whileRequestingPhonebookMetadata_obexDisconnects()
        ...
        // PbapApplicationParameters params = new PbapApplicationParameters(DEFAULT_PROPERTIES,
        // DEFAULT_VCARD_VERSION, PbapApplicationParameters.RETURN_SIZE_ONLY, 0);
        // mObexClient.requestPhonebookMetadata(PbapPhonebook.LOCAL_PHONEBOOK_PATH, params);
        ...
        // verify(mMockCallback,
        // times(1)).onConnectionStateChanged(eq(BluetoothProfile.STATE_CONNECTED),
        // eq(BluetoothProfile.STATE_DISCONNECTING));
        // verify(mMockCallback,
        // times(1)).onConnectionStateChanged(eq(BluetoothProfile.STATE_DISCONNECTING),
        // eq(BluetoothProfile.STATE_DISCONNECTED));
        // assertThat(mObexClient.getConnectionState()).isEqualTo(BluetoothProfile.STATE_DISCONNECTED);
    }
    ...
    public void testDisconnect_whileRequestingPhonebook_obexDisconnects() throws IOException {
        ...
        // PbapApplicationParameters params = new PbapApplicationParameters(DEFAULT_PROPERTIES,
        // DEFAULT_VCARD_VERSION, numToFetch, batchStart);
