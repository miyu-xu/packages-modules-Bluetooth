...
public class BluetoothOppObexClientSessionTest {
    ...
    @Test
    public void startAndStop_clientThreadStartsThenStop() throws IOException, InterruptedException {
    ...
    public void readFully() throws IOException {
        ...
        int size = 1000;
        doAnswer(invocation -> invocation.getArgument(2)).when(is).read(eq(buffer), anyInt(),
                anyInt());
        assertThat(BluetoothOppObexClientSession.readFully(is, buffer, size)).isEqualTo(size);
    }
}
