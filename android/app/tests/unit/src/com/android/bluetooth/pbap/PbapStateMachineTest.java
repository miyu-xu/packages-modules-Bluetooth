...
public class PbapStateMachineTest {
    ...
    public void initialState_isConnecting() {
        assertThat(mStateMachine.getConnectionState()).isEqualTo(BluetoothProfile.STATE_CONNECTING);
    ...
    public void testStateTransition_WaitingForAuthToConnected() {
        ...
        assertThat(mStateMachine.getConnectionState()).isEqualTo(BluetoothProfile.STATE_CONNECTED);
