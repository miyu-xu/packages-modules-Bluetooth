...
<<<<<<< PATCH SET (bdda88 [BluetoothMetrics] Refactor Hashed Name Retrieval from loggi)
...
>>>>>>> BASE      (b8b202 Merge "SystemServer: AutoOnFeature sync binder call" into ma)
    ...
    public void testDeviceNameToSha() {
        ...
        for (Map.Entry<String, String> entry : SANITIZED_DEVICE_NAME_MAP.entrySet()) {
            ...
            Assert.assertEquals(
                    sha256, mTestableMetricsLogger.logDeviceNameSha(1, deviceName, true));
    }
    }
