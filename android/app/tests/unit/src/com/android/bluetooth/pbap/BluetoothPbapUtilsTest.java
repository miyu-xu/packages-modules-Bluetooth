...
public class BluetoothPbapUtilsTest {
    ...
    public void updateSecondaryVersionCounter_whenContactsAreUpdated() {
        ...
        MatrixCursor dataCursor = new MatrixCursor(new String[] {CONTACT_ID, MIMETYPE, DATA1});
        final String updatedPhoneNum = "01234567";
        final String updatedEmail = "android@android.com";
        final String updatedPostal = "01234";
        final String updatedName = "And Roid";
        dataCursor.addRow(new Object[] {"id1", Phone.CONTENT_ITEM_TYPE, updatedPhoneNum});
        dataCursor.addRow(new Object[] {"id1", Email.CONTENT_ITEM_TYPE, updatedEmail});
        dataCursor.addRow(new Object[] {"id1", StructuredPostal.CONTENT_ITEM_TYPE, updatedPostal});
        dataCursor.addRow(new Object[] {"id1", StructuredName.CONTENT_ITEM_TYPE, updatedName});
        doReturn(dataCursor).when(mProxy).contentResolverQuery(
                any(), eq(Data.CONTENT_URI), any(), any(), any(), any());
        assertThat(BluetoothPbapUtils.sSecondaryVersionCounter).isEqualTo(0);
