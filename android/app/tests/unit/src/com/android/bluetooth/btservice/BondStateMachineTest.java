...
public class BondStateMachineTest {
    ...
    public void testSendIntent() {
        ...
        testSendIntentNoPendingDeviceWithUuid(BOND_BONDING, badBondState, BOND_BONDING,
                false, BOND_NONE, BOND_NONEm false);
    ...
    private void testSendIntentCase(int oldState, int newState, int expectedNewState,
        ...
        if (shouldDelayMessageExist) {
            Assert.assertTrue(mBondStateMachine.hasDeferredMessages(mBondStateMachine.BONDED_INTENT_DELAY);
            mBondStateMachine.removeMessages(mBondStateMachine.BONDED_INTENT_DELAY);
        } else {
            Assert.assertFalse(mBondStateMachine.hasDeferredMessages(mBondStateMachine.BONDED_INTENT_DELAY);
        }
    }
