...
public class BondStateMachineTest {
    ...
    public void testSendIntent() {
        ...
        testSendIntentPendingDeviceWithUuid(BOND_BONDING, badBondState, true, BOND_BONDING,
                false, BOND_NONE, BOND_NONE, false);
        testSendIntentPendingDeviceWithUuid(BOND_BONDED, BOND_NONE, true, BOND_NONE,
                true, BOND_BONDING, BOND_NONE, false);
        testSendIntentPendingDeviceWithUuid(BOND_BONDED, BOND_BONDING, true, BOND_BONDING,
                false, BOND_NONE, BOND_NONE, false);
    ...
    private void testSendIntentCase(int oldState, int newState, boolean isTimeout,
            int expectedNewState, boolean shouldBroadcast, int broadcastOldState,
            int broadcastNewState, boolean shouldDelayMessageExist, boolean isTimeout) {
        ...
        try {
            mBondStateMachine.sendIntent(mDevice, newState, TEST_BOND_REASON, isTimeout);
    ...
    private void testSendIntentNoPendingDeviceWithUuid(int oldState, int newState,
            boolean isTimeout, int expectedNewState, boolean shouldBroadcast, int broadcastOldState,
            int broadcastNewState, boolean shouldDelayMessageExist) {
        // Add dummy UUID for the device.
        mDeviceProperties.mUuids = TEST_UUIDS;
        testSendIntentNoPendingDevice(oldState, newState, isTimeout, expectedNewState,
                shouldBroadcast, broadcastOldState, broadcastNewState, shouldDelayMessageExist);
    }

    private void testSendIntentPendingDeviceWithUuid(int oldState, int newState, boolean isTimeout,
            int expectedNewState, boolean shouldBroadcast, int broadcastOldState,
            int broadcastNewState, boolean shouldDelayMessageExist) {
        // Add dummy UUID for the device.
        mDeviceProperties.mUuids = TEST_UUIDS;
        testSendIntentPendingDevice(oldState, newState, isTimeout, expectedNewState,
                shouldBroadcast, broadcastOldState, broadcastNewState, shouldDelayMessageExist);
    }

    private void testSendIntentPendingDevice(int oldState, int newState, boolean isTimeout,
            int expectedNewState, boolean shouldBroadcast, int broadcastOldState,
            int broadcastNewState, boolean shouldDelayMessageExist) {
        ...
        testSendIntentCase(oldState, newState, isTimeout, expectedNewState, shouldBroadcast,
                broadcastOldState, broadcastNewState, shouldDelayMessageExist);
    ...
    private void testSendIntentNoPendingDevice(int oldState, int newState, boolean isTimeout,
            int expectedNewState, boolean shouldBroadcast, int broadcastOldState,
            int broadcastNewState, boolean shouldDelayMessageExist) {
        // Test for classic remote device.
        mDeviceProperties.mDeviceType = BluetoothDevice.DEVICE_TYPE_CLASSIC;
