...
public class BluetoothOppUtilityTest {
    ...
    public void queryTransfersInBatch_returnsCorrectUrlArrayList() {
        ...
        doReturn((cnt++ < 5)).when(mCursor).isAfterLast();
        ...
        for (String url : answer) {
            assertThat(url).isEqualTo(CORRECT_FORMAT_BUT_INVALID_FILE_URI);
        }
    }
    ...
    public void fillRecord_filledAllProperties() {
        ...
        Map<String, BluetoothShareData> nameToDataMap = Map.of(
                ...
                BluetoothShare.TIMESTAMP, new BluetoothShareData(5, timestampValue),
                BluetoothShare.DESTINATION, new BluetoothShareData(6, destinationValue),
                BluetoothShare._DATA, new BluetoothShareData(7, null),
                BluetoothShare.FILENAME_HINT, new BluetoothShareData(8, null),
                BluetoothShare.MIMETYPE, new BluetoothShareData(9, fileTypeValue)
        );
