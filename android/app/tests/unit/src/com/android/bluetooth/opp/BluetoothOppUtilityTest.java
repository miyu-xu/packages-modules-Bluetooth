...
import com.android.bluetooth.opp.BluetoothOppTestUtils.BluetoothShareMockData;
...
public class BluetoothOppUtilityTest {
    ...
    public void fillRecord_filledAllProperties() {
        ...
        Map<String, BluetoothShareMockData> nameToDataMap = Map.of(
                BluetoothShare._ID, new BluetoothShareMockData(0, idValue),
                BluetoothShare.STATUS, new BluetoothShareMockData(1, statusValue),
                BluetoothShare.DIRECTION, new BluetoothShareMockData(2, directionValue),
                BluetoothShare.TOTAL_BYTES, new BluetoothShareMockData(3, totalBytesValue),
                BluetoothShare.CURRENT_BYTES, new BluetoothShareMockData(4, currentBytesValue),
                BluetoothShare.TIMESTAMP, new BluetoothShareMockData(5, timestampValue),
                BluetoothShare.DESTINATION, new BluetoothShareMockData(6, destinationValue),
                BluetoothShare._DATA, new BluetoothShareMockData(7, null),
                BluetoothShare.FILENAME_HINT, new BluetoothShareMockData(8, null),
                BluetoothShare.MIMETYPE, new BluetoothShareMockData(9, fileTypeValue)
        );
        ...
        doAnswer(invocation -> {
            int index = invocation.getArgument(0);
            for (BluetoothOppTestUtils.BluetoothShareMockData data : nameToDataMap.values()) {
                if (data.mIndex == index) {
                    return data.mValue;
                }
            }
            return -1;
        }).when(mCursor).getLong(anyInt());
