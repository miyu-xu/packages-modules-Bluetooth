...
public class BluetoothOppUtilityTest {
    ...
    public void shareUri_workNormally() {
        ...
        assertThat(BluetoothOppUtility.isBluetoothShareUri(CORRECT_FORMAT_BUT_INVALID_FILE_URI)).isTrue();
    }
    ...
    public void fileExists_returnFalse() {
        assertThat(
                BluetoothOppUtility.fileExists(mContext, CORRECT_FORMAT_BUT_INVALID_FILE_URI)).isFalse();
    }
    ...
    public void fileInfo_testFileInfoFunctions() {
        assertThat(BluetoothOppUtility.getSendFileInfo(CORRECT_FORMAT_BUT_INVALID_FILE_URI)).isEqualTo(
