...
public class BluetoothOppTestUtils {
     ...
     *     CursorMockData(BluetoothShare.DIRECTION, 2, BluetoothShare.DIRECTION_INBOUND
     *     )
     *  // This will return 2
     ...
     * @param cursorMockDataList a map representing what cursor will return
     */
    public static void setUpMockCursor(
        ...
        doAnswer(invocation -> {
            ...
            return cursorMockDataList.stream().filter(
                    mockCursorData -> Objects.equals(mockCursorData.mColumnIndex, index)
