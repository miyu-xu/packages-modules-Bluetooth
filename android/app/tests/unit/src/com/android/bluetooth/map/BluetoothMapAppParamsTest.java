...
public class BluetoothMapAppParamsTest {
    ...
    public void encodeToBuffer_thenDecode() throws Exception {
        ...
        assertThat(appParamsDecoded.getNotificationStatus()).isEqualTo(TEST_NOTIFICATION_STATUS);
        ...
        assertThat(appParamsDecoded.getPresenceAvailability()).isEqualTo(TEST_PRESENCE_AVAILABILITY);
        ...
        assertThat(appParamsDecoded.getChatState()).isEqualTo(TEST_CHAT_STATE);
        assertThat(appParamsDecoded.getConvoListingSize()).isEqualTo(TEST_CONVO_LISTING_SIZE);
        assertThat(appParamsDecoded.getFilterPresence()).isEqualTo(TEST_FILTER_PRESENCE);
        assertThat(appParamsDecoded.getFilterUidPresent()).isEqualTo(TEST_FILTER_UID_PRESENT);
