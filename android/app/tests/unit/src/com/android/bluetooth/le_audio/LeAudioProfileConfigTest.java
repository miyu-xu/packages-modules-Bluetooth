...
public class LeAudioProfileConfigTest {
     ...
     *
     * <p>Outcome:
     *   - BapUnicastClient is enabled.
     *   - BapBroadcastSource is enabled.
     *   - BapUnicastClient is enabled for TmapUnicastMediaSender, but disabled for
     *     TmapBroadcastMediaSender.
     *   - BapBroadcastSource is enabled for TmapBroadcastMediaSender, but disabled for
     *     TmapUnicastMediaSender.
     */
    @Test
    public void isFrameworkProfileEnabledForUseCase() {
        ...
        assertThat(LeAudioProfileConfig.isFrameworkProfileEnabledForUseCase(
                BAP_UNICAST_CLIENT, TMAP_UNICAST_MEDIA_SENDER)).isTrue();
        assertThat(LeAudioProfileConfig.isFrameworkProfileEnabledForUseCase(
                BAP_UNICAST_CLIENT, TMAP_BROADCAST_MEDIA_SENDER)).isFalse();

        assertThat(LeAudioProfileConfig.isFrameworkProfileEnabledForUseCase(
                BAP_BROADCAST_SOURCE, TMAP_UNICAST_MEDIA_SENDER)).isFalse();
        assertThat(LeAudioProfileConfig.isFrameworkProfileEnabledForUseCase(
                BAP_BROADCAST_SOURCE, TMAP_BROADCAST_MEDIA_SENDER)).isTrue();
    }
}
