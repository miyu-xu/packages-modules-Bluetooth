...
public class BluetoothOppLauncherActivityTest {
    ...
    public void onCreate_withActionOpen_sendBroadcast() throws Exception {
        ...
        verify(mMethodProxy).contextSendBroadcast(any(), any());
    }

    @Test
    public void launchDevicePicker_bluetoothNotEnabled_launchActivity() throws Exception {
    ...
    public void createFileForSharedContent_returnFile() throws Exception {
        ...
        scenario.onActivity(activity -> {
            ...
            Uri fileUri = activity.createFileForSharedContent(activity, shareContent);
