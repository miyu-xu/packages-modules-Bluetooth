...
public class PandoraAdvertiseManagerTest {
    ...
    private static HostGrpc.HostBlockingStub mHostStub;
    ...
    public void setUp() throws Exception {
        ...
        mHostStub = HostGrpc.newBlockingStub(mChannel);
        mHostStub.withWaitForReady().readLocalAddress(Empty.getDefaultInstance());
    }
    ...
    public void advertisingSet() {
        ...
        mHostStub.reset(Empty.getDefaultInstance());
        mHostStub.readLocalAddress(Empty.getDefaultInstance());
    }
