...
public class SapServerTest {
    ...
    public void setUp() throws Exception {
        ...
        mContext = spy(new ContextWrapper(mTargetContext));

        doReturn(Context.NOTIFICATION_SERVICE).when(mContext).getSystemServiceName(NotificationManager.class);
        doReturn(mNotificationManager).when(mContext).getSystemService(Context.NOTIFICATION_SERVICE);

        mSapServer = new SapServer(mHandler, mContext, mInputStream, mOutputStream);
    }
