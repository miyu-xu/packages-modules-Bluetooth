...
public class ScanFilterQueueTest {
    ...
    private static final String UNMATCHED_UUID_STRING = "01001805-0000-1000-8000-00805f9b34fb";
    ...
    @Test
    public void serviceDataFilterNoMask() {
        ScanFilter filter =
                new ScanFilter.Builder()
    ...
    private boolean maskedEquals(byte[] data1, byte[] data2, byte[] mask) {
