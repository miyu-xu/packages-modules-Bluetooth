...
public class RemoteDevicesTest {
    ...
    public void testFetchUuids_isBondingWithUuids() {
        ...
        ParcelUuid[] parcelUuids = new ParcelUuid[1];
        parcelUuids[0] = new ParcelUuid(uuid);
        ...
        ParcelUuid[] intent_uuids =
                mIntentArgument
                        .getValue()
                        .getParcelableArrayExtra(BluetoothDevice.EXTRA_UUID, ParcelUuid.class);
        UUID intent_uuid =
                new UUID(
                        intent_uuids[0].getUuid().getMostSignificantBits(),
                        intent_uuids[0].getUuid().getLeastSignificantBits());
    ...
    public void testFetchUuids_noBondingNoUuids_NativeReturnsCallback() {
        ...
        int[] types = new int[1];
        types[0] = AbstractionLayer.BT_PROPERTY_UUIDS;
        byte[][] values = new byte[1][Long.BYTES * 2];
        // values[0] = b;
        values[0] = uuidToBytes(uuid); // b;
        ...
        UUID intent_uuid = uuids[0].getUuid();
