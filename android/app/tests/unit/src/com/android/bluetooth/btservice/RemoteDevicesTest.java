...
public class RemoteDevicesTest {
    ...
    public void testResetBatteryLevel_testHfpBatteryIndicatorEnabled() {
        InOrder mInOrder = inOrder(mAdapterService);
        ...
        mInOrder.verify(mAdapterService)
                .sendBroadcast(any(), eq(BLUETOOTH_CONNECT), any(Bundle.class));
        ...
        // Verify that updating battery level triggers ACTION_BATTERY_LEVEL_CHANGED intent
        mRemoteDevices.updateBatteryLevel(mDevice1, newBatteryLevel, /* fromBas= */ false);
        ...
        verifyBatteryLevelChangedIntent(mDevice1, 50, mIntentArgument);
