...
public class RemoteDevicesTest {
    ...
    @Test
    public void setgetHfAudioPolicyForRemoteAg() {
        // Verify that device property is null initially
        Assert.assesetgetHfAudioPolicyForRemoteAgrtNull(mRemoteDevices.getDeviceProperties(mDevice1));
        ...
        BluetoothAudioPolicy policies = new BluetoothAudioPolicy(
