...
public class BluetoothMapAccountItemTest {
    ...
    private static final com.android.bluetooth.map.BluetoothMapUtils.TYPE TEST_TYPE = com.android.bluetooth.map.BluetoothMapUtils.TYPE.EMAIL;
    ...
    public void create_withAllParameters() {
        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItem = com.android.bluetooth.map.BluetoothMapAccountItem.create(TEST_ID, TEST_NAME,
    ...
    public void create_withoutIdAndUciData() {
        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItem = com.android.bluetooth.map.BluetoothMapAccountItem.create(/*id=*/null, TEST_NAME,
    ...
    public void getUciFull() {
        ...
        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItemWithoutUciPrefix = com.android.bluetooth.map.BluetoothMapAccountItem.create(
                TEST_ID, TEST_NAME, TEST_PACKAGE_NAME, TEST_PROVIDER_AUTHORITY, TEST_DRAWABLE,
                TEST_TYPE, TEST_UCI, null);

        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItemWithoutUci = com.android.bluetooth.map.BluetoothMapAccountItem.create(TEST_ID,
    ...
    public void compareIfTwoObjectsAreEqual_returnFalse_whenTypesAreDifferent() {
        ...
        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItemWithDifferentType = com.android.bluetooth.map.BluetoothMapAccountItem.create(
                TEST_ID, TEST_NAME, TEST_PACKAGE_NAME, TEST_PROVIDER_AUTHORITY, TEST_DRAWABLE,
                com.android.bluetooth.map.BluetoothMapUtils.TYPE.MMS);
    ...
    public void compareIfTwoObjectsAreEqual_returnTrue_evenWhenUcisAreDifferent() {
        ...
        com.android.bluetooth.map.BluetoothMapAccountItem
                accountItemWithoutUciData = com.android.bluetooth.map.BluetoothMapAccountItem.create(TEST_ID,
