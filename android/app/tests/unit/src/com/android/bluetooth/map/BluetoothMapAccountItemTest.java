...
public class BluetoothMapAccountItemTest {
    ...
    public void create_withoutIdAndUciData() {
        BluetoothMapAccountItem accountItem = BluetoothMapAccountItem.create(null, TEST_NAME,
                TEST_PACKAGE_NAME, TEST_PROVIDER_AUTHORITY, TEST_DRAWABLE, TEST_TYPE);
        // Id is set to null to test an if branch in `getAccountId()`
    ...
    @Test
    public void compareIfTwoObjectsAreEqual_returnFalse() {
        BluetoothMapAccountItem accountItem = BluetoothMapAccountItem.create(TEST_ID, TEST_NAME,
                TEST_PACKAGE_NAME, TEST_PROVIDER_AUTHORITY, TEST_DRAWABLE,
                TEST_TYPE, TEST_UCI, TEST_UCI_PREFIX);
        ...
        assertThat(accountItem.hashcode()).isNotEqualTo(accountItemWithDifferentType.hashcode());
    }
    ...
    public void compareIfTwoObjectsAreEqual_returnTrue() {
        ...
        assertThat(accountItem.hashcode()).isEqualTo(accountItemWithoutUciData.hashcode());
    }
}