...
public class AvrcpVolumeManagerTest {
    ...
    public void avrcpToSystemVolume() {
        int deviceMaxVolume = mAudioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
        ...
        assertThat(AvrcpVolumeManager.avrcpToSystemVolume(AVRCP_MAX_VOL))
                .isEqualTo(deviceMaxVolume);
        assertThat(AvrcpVolumeManager.avrcpToSystemVolume(AVRCP_MAX_VOL / 2))
                .isEqualTo(deviceMaxVolume / 2);
    }
