...
public class PublicBroadcastDataTest {
    ...
    public void parsePublicBroadcastData() {
        assertNull(PublicBroadcastData.parsePublicBroadcastData(null));

        byte[] serviceDataInvalid = new byte[] {
                (byte) 0x02, // features, non-encrypted, standard quality prsent
        };
        assertNull(PublicBroadcastData.parsePublicBroadcastData(serviceDataInvalid));
        ...
        assertNull(PublicBroadcastData.parsePublicBroadcastData(serviceDataInvalid2));
