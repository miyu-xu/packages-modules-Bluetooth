...
public class A2dpServiceTest {
    ...
    private void testOkToConnectCase(
        ...
        doReturn(false).when(mAdapterService).isQuietModeEnabled();
        assertThat(mA2dpService.okToConnect(device, true)); // Outgoin.isEqualTo(expected );
        assertThat(mA2dpService.okToConnect(device, false)); // Incomin.isEqualTo(expected );
        ...
        assertThat(mA2dpService.okToConnect(device, true)); // Outgoin.isEqualTo(expected );
        assertThat(mA2dpService.okToConnect(device, false)); // Incomin.isEqualTo(false );
    }
