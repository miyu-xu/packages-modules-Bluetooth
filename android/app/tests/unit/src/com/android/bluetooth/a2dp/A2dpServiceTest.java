...
public class A2dpServiceTest {
    ...
    public void testStopA2dpService() {
        ...
        Assert.assertTrue(mA2dpService.setActiveDevice(mTestDevice, true));
    ...
    /**
     * Test whether setActiveDevice(null, true) suppress noisy intent.
     */
    @Test
    public void testSetActiveDevice_whenHasFallbackDeviceIsTrue_suppressNoisyIntent() {
        connectDevice(mTestDevice);
        doReturn(true).when(mA2dpNativeInterface).setActiveDevice(any(BluetoothDevice.class));
        Assert.assertTrue(mA2dpService.setActiveDevice(mTestDevice, true));
    ...
    /**
     * Test whether setActiveDevice(null, false) does not suppress noisy intent.
     */
    @Test
