...
public final class AudioPolicyEntityTest {
    ...
    public void toString_containsExpectedStrings() {
        ...
        assertThat(entityStr).contains("callEstablishAudioPolicy=");
        assertThat(entityStr).contains("connectingTimeAudioPolicy=");
        assertThat(entityStr).contains("inBandRingtoneAudioPolicy=");
    }
}
