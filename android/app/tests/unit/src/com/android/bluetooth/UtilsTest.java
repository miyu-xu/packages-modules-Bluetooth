...
public class UtilsTest {
    ...
    @Test
    public void checkCallerIsSystemOrActiveOrManagedUser_withTargetContext_returnsTrue() {
        Context context = InstrumentationRegistry.getTargetContext();
        String tag = "test_tag";

        assertThat(Utils.checkCallerIsSystemOrActiveOrManagedUser(context, tag)).isTrue();
    }

    @Test
    public void checkCallerIsSystemOrActiveOrManagedUser_withNullContext_returnsFalse() {
        String tag = "test_tag";

        assertThat(Utils.checkCallerIsSystemOrActiveOrManagedUser(null, tag)).isFalse();
    }

    @Test
    public void checkCallerIsSystemOrActiveUser_returnsFalse() {
        String tag = "test_tag";

        assertThat(Utils.checkCallerIsSystemOrActiveUser(tag)).isFalse();
    }
