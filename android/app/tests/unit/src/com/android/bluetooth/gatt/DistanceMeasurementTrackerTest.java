...
public class DistanceMeasurementTrackerTest {
    ...
    private int mMethod = DistanceMeasurementParams.DISTANCE_MEASUREMENT_METHOD_RSSI;
    ...
    public void testStartTimer() {
        ...
        verify(mDistanceMeasurementManager, after(TIMEOUT_MS).times(1))
    ...
    public void testEquals() {
        DistanceMeasurementTracker tracker = new DistanceMeasurementTracker(
                mDistanceMeasurementManager, mParams, IDENTITY_ADDRESS, mUuid, 1000, mCallback);
        Assert.assertTrue(mTracker.equals(tracker));
    }
    ...
    public void testHashCode() {
        DistanceMeasurementTracker tracker = new DistanceMeasurementTracker(
                mDistanceMeasurementManager, mParams, IDENTITY_ADDRESS, mUuid, 1000, mCallback);
        Assert.assertEquals(mTracker.hashCode(), tracker.hashCode());
    }
}