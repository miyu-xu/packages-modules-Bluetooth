...
public class BluetoothMapContentObserverTest {
    ...
    public void testSendEvent_withZeroEventFilter() {
        ...
        BluetoothMapContentObserver.Event event = mObserver.new Event(eventType, TEST_HANDLE_ONE, null,
                null);
    ...
    public void setMessageStatusDeleted_withTypeEmail() {
        ...
        Assert.assertTrue(mObserver.setMessageStatusDeleted(TEST_HANDLE_ONE, TYPE.EMAIL, mCurrentFolder,
                TEST_URI_STR, BluetoothMapAppParams.STATUS_VALUE_YES));
    }

    @Test
    public void setMessageStatusDeleted_withTypeIm() {
        Assert.assertFalse(mObserver.setMessageStatusDeleted(TEST_HANDLE_ONE, TYPE.IM, mCurrentFolder,
                TEST_URI_STR, BluetoothMapAppParams.STATUS_VALUE_YES));
    }
    ...
    public void setMessageStatusDeleted_withTypeGsmOrMms_andStatusValueNo() {
        ...
        Assert.assertFalse(mObserver.setMessageStatusDeleted(TEST_HANDLE_ONE, TYPE.MMS, mCurrentFolder,
