...
public class BluetoothMapContentTest {
    ...
    public void setters_withConvoList() {
        ...
        HashMap<Long, BluetoothMapConvoListingElement> emailMap = new HashMap<Long,
                BluetoothMapConvoListingElement>();
        HashMap<Long, BluetoothMapConvoListingElement> smsMap = new HashMap<Long,
                BluetoothMapConvoListingElement>();
    ...
    public void setLastActivity_withFilterTypeSms() {
        ...
        mContent.setLastActivity(mConvoListingElement, cursor, mInfo, mParams);
