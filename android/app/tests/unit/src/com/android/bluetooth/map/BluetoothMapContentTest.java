...
public class BluetoothMapContentTest {
    ...
    public void getRecipientNameEmail() {
        ...
        assertThat(mContent.getRecipientNameEmail(mElement, cursor, mInfo)).isEqualTo(
                expected.toString());
    }
    ...
    public void getRecipientAddressingEmail() {
        ...
        assertThat(mContent.getRecipientAddressingEmail(mElement, cursor, mInfo)).isEqualTo(
                expected.toString());
    }
}