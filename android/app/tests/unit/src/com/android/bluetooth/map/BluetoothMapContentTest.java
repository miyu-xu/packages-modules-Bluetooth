...
public class BluetoothMapContentTest {
    ...
    public void convoListing_withNullFilterRecipient() {
        ...
        assertThat(listing.getList().get(0).getType()).isEqualTo(TYPE.EMAIL);
        assertThat(listing.getList().get(0).getLastActivity()).isEqualTo(TEST_DATE_EMAIL);
        assertThat(listing.getList().get(0).getName()).isEqualTo(TEST_NAME);
        assertThat(listing.getList().get(0).getReadBool()).isFalse();
        assertThat(listing.getList().get(1).getType()).isEqualTo(TYPE.SMS_GSM);
        assertThat(listing.getList().get(1).getLastActivity()).isEqualTo(TEST_DATE_SMS);
        assertThat(listing.getList().get(1).getName()).isEqualTo("");
    ...
    public void convoListing_withNonNullFilterRecipient() {
        ...
        assertThat(listing.getCount()).isEqualTo(2);
        assertThat(listing.getList().get(0).getType()).isEqualTo(TYPE.IM);
        assertThat(listing.getList().get(0).getLastActivity()).isEqualTo(TEST_DATE_EMAIL);
        assertThat(listing.getList().get(0).getName()).isEqualTo(TEST_NAME);
        assertThat(listing.getList().get(0).getReadBool()).isFalse();
        assertThat(listing.getList().get(1).getType()).isEqualTo(TYPE.SMS_GSM);
