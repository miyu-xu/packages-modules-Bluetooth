...
public class BluetoothMapContentTest {
    ...
    @Test
    public void smsSelected_withInvalidMsgType() {
    ...
    @Test
    public void smsSelected_withMsgTypeEqualToZero() {
        when(mParams.getFilterMessageType()).thenReturn(0);
    ...
    @Test
    public void smsSelected_withMsgTypeEqualToTwo_andPhoneTypeGsm() {
        when(mParams.getFilterMessageType()).thenReturn(2);
    ...
    @Test
    public void smsSelected_withMsgTypeEqualToOne_andPhoneTypeCdma() {
        when(mParams.getFilterMessageType()).thenReturn(1);
    ...
    @Test
    public void smsSelected_withMsgTypeEqualToThree() {
        when(mParams.getFilterMessageType()).thenReturn(3);

        assertThat(mContent.smsSelected(mInfo, mParams)).isFalse();
    }

    @Test
    public void mmsSelected_withInvalidMsgType() {
        when(mParams.getFilterMessageType()).thenReturn(
                BluetoothMapAppParams.INVALID_VALUE_PARAMETER);
    ...
    @Test
    public void mmsSelected_withMsgTypeEqualToZero() {
        when(mParams.getFilterMessageType()).thenReturn(0);
    ...
    @Test
    public void mmsSelected_withMsgType() {
        when(mParams.getFilterMessageType()).thenReturn(8);
