...
public class BluetoothMapContentTest {
    ...
    public void setConvoWhereFilterSmsMms() throws Exception {
        ...
        when(mParams.getFilterLastActivityBegin()).thenReturn(1L);
        when(mParams.getFilterLastActivityEnd()).thenReturn(1L);
        String convoId = "1111";
        ...
        expected.append(" AND ")
                .append(Threads.DATE)
                .append(" >= ")
                .append(mParams.getFilterLastActivityBegin());
        expected.append(" AND ")
                .append(Threads.DATE)
                .append(" <= ")
                .append(mParams.getFilterLastActivityEnd());
        expected.append(" AND ")
                .append(Threads._ID)
                .append(" = ")
                .append(Long.toString(mParams.getFilterConvoId().getLeastSignificantBits()));
    ...
    @Test
    public void smsSelected_withMsgTypeInvalid() {
    ...
    @Test
    public void smsSelected_withMsgTypeNotFilterNoSms() {
        int msgTypeNotFilterNoSms = 0;
        when(mParams.getFilterMessageType()).thenReturn(msgTypeNotFilterNoSms);

        assertThat(mContent.smsSelected(mInfo, mParams)).isTrue();
    }

    @Test
    public void smsSelected_withMsgTypeFilterNoSmsCdma_andPhoneTypeGsm() {
    ...
    @Test
    public void smsSelected_withMsgTypeFilterNoSmsGsm_andPhoneTypeCdma() {
    ...
    @Test
    public void smsSelected_withMsgTypeFilterNoSms_forBothGsmAndCdma() {
        int msgTypeFilterNoSms = 3;
        when(mParams.getFilterMessageType()).thenReturn(msgTypeFilterNoSms);

        assertThat(mContent.smsSelected(mInfo, mParams)).isFalse();
    }

    @Test
    public void mmsSelected_withMsgTypeInvalid() {
        when(mParams.getFilterMessageType()).thenReturn(
                BluetoothMapAppParams.INVALID_VALUE_PARAMETER);
    ...
    @Test
    public void mmsSelected_withMsgTypeNotFilterNoMms() {
        int msgTypeNotFilterNoMms = 0;
        when(mParams.getFilterMessageType()).thenReturn(msgTypeNotFilterNoMms);

        assertThat(mContent.mmsSelected(mParams)).isTrue();
    }

    @Test
    public void mmsSelected_withMsgTypeFilterNoMms() {
