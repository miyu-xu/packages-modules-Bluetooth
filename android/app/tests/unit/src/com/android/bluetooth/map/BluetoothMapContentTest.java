...
public class BluetoothMapContentTest {
    ...
    @Test
    public void msgListing() {
        when(mParams.getParameterMask()).thenReturn(
                (long) BluetoothMapAppParams.INVALID_VALUE_PARAMETER);
        when(mParams.getFilterMessageType()).thenReturn(TEST_NO_FILTER);
        when(mParams.getMaxListCount()).thenReturn(4);
        when(mParams.getStartOffset()).thenReturn(0);
        ...
        smsCursor.addRow(new Object[] {TEST_ID, TEST_SENT_NO, TEST_READ_TRUE, TEST_SUBJECT,
                TEST_ADDRESS, TEST_DATE_SMS, TEST_THREAD_ID});
        ...
        assertThat(listing.getCount()).isEqualTo(4);

        BluetoothMapMessageListingElement smsElement = listing.getList().get(1);
        ...
        BluetoothMapMessageListingElement emailElement = listing.getList().get(2);
        ...
        BluetoothMapMessageListingElement imElement = listing.getList().get(3);
