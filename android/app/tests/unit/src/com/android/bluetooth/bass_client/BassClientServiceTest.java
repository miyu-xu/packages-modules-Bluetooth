...
public class BassClientServiceTest {
   ...
   /**
    ...
    public void testIntentionalDisconnection() {
        ...
        mBassClientService.handleIntendedDeviceDisconnection(mCurrentDevice);
        ...
        mBassClientService.handleIntendedDeviceDisconnection(mCurrentDevice1);
    ...
    public void testNotifyBroadcastStateChangedStopped() {
        ...
        mBassClientService.notifyBroadcastStateChanged(0 /* BROADCAST_STATE_STOPPED */,
                TEST_BROADCAST_ID);
        mBassClientService.handleIntendedDeviceDisconnection(mCurrentDevice);
        mBassClientService.handleIntendedDeviceDisconnection(mCurrentDevice1);
