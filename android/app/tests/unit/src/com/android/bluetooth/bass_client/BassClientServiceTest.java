...
public class BassClientServiceTest {
    ...
    /**
     * Test whether service.addSource() does send proper mesages to all the
    ...
    public void testAddSourceForGroup() {
        ...
        doReturn(groupDevices).when(mCsipService).getGroupDevices(mCurrentDevice, BluetoothUuid.CAP);
        doReturn(groupDevices).when(mCsipService).getGroupDevices(mCurrentDevice1, BluetoothUuid.CAP);
   ...
   /**
     * Test whether service.modifySource() does send proper mesages to all the
     * state machines within the Csip coordinated group
     */
    @Test
    public void testModifySourceForGroup() {
        ...
        BluetoothLeBroadcastMetadata metaUpdate = new BluetoothLeBroadcastMetadata.Builder(meta).setBroadcastId(TEST_BROADCAST_ID + 1).build();
    ...
    /**
     * Test whether service.removeSource() does send proper mesages to all the
     * state machines within the Csip coordinated group
     */
    @Test
