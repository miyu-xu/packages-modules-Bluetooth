...
public class BassClientServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        Assume.assumeTrue("Ignore test when BassClientService is not enabled",
                mTargetContext.getResources().getBoolean(R.bool.profile_supported_bass_client));
        ...
        Assert.assertNotNull(mBassClientService);
    }

    @After
    public void tearDown() throws Exception {
        if (!mTargetContext.getResources().getBoolean(R.bool.profile_supported_bass_client)) {
            return;
        }
        TestUtils.stopService(mServiceRule, BassClientService.class);
        mBassClientService = BassClientService.getBassClientService();
        Assert.assertNull(mBassClientService);
    ...
    public void testGetBassClientService() {
        Assert.assertEquals(mBassClientService, BassClientService.getBassClientService());
        // Verify default connection and audio states
        mCurrentDevice = TestUtils.getTestDevice(mBluetoothAdapter, 0);
        Assert.assertEquals(BluetoothProfile.STATE_DISCONNECTED,
                mBassClientService.getConnectionState(mCurrentDevice));
    }
    ...
    public void testConnect() {
        ...
        Assert.assertTrue(mBassClientService.connect(mCurrentDevice));
    ...
    public void testConnect_nullDevice() {
        ...
        Assert.assertFalse(mBassClientService.connect(nullDevice));
    }
    ...
    public void testConnect_whenConnectionPolicyIsUnknown() {
        ...
        Assert.assertFalse(mBassClientService.connect(mCurrentDevice));
    }
    ...
    /**
     * Test whether service.startSearchingForSources() should not call
