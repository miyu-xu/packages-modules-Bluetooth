...
public class BassClientServiceTest {
   ...
   /**
    ...
    public void testSelectSource_withSameBroadcastId() {
        ...
        // First selectSource
        mBassClientService.addSelectSourceSyncRequest(scanResult1, false);
        verify(mMethodProxy, timeout(TIMEOUT_MS).times(1))
                .periodicAdvertisingManagerRegisterSync(
                        any(), any(), anyInt(), anyInt(), any(), any());
        // Finish select
        ...
        clearInvocations(mMethodProxy);
        mBassClientService.addSelectSourceSyncRequest(scanResult2, false);
        verify(mMethodProxy, never())
                .periodicAdvertisingManagerRegisterSync(
                        any(), any(), anyInt(), anyInt(), any(), any());
    }
    ...
    public void testSelectSource_wrongBassUUID() {
        ...
        mBassClientService.addSelectSourceSyncRequest(scanResult, false);
        verify(mMethodProxy, never())
                .periodicAdvertisingManagerRegisterSync(
                        any(), any(), anyInt(), anyInt(), any(), any());
    }
    ...
    public void testSelectSource_queueAndRemoveAfterMaxLimit() {
        ...
        // Scan and sync 5 which cause removing 1 synced element
    ...
    public void testSelectSource_orderOfSyncRegistering() {
        ...
        mBassClientService.addSelectSourceSyncRequest(scanResult2, false);
        // Added to queue
        mBassClientService.addSelectSourceSyncRequest(scanResult3, false);
        // Added to queue with priority which put it on the beginning
        mBassClientService.addSelectSourceSyncRequest(scanResult4, true);
        ...
        clearInvocations(mMethodProxy);
        onSyncEstablished(mSourceDevice, TEST_SYNC_HANDLE + 1);
        verify(mMethodProxy, timeout(TIMEOUT_MS).times(1))
                .periodicAdvertisingManagerRegisterSync(
                        any(), resultCaptor.capture(), anyInt(), anyInt(), any(), any());
        assertThat(
        ...
        clearInvocations(mMethodProxy);
        onSyncEstablished(mSourceDevice, TEST_SYNC_HANDLE + 2);
        verify(mMethodProxy, timeout(TIMEOUT_MS).times(1))
                .periodicAdvertisingManagerRegisterSync(
                        any(), resultCaptor.capture(), anyInt(), anyInt(), any(), any());
        assertThat(
