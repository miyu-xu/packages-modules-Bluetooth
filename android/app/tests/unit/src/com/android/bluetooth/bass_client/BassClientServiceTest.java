...
public class BassClientServiceTest {
   ...
   /**
    ...
    public void testActiveSyncedSource_AddRemoveGet() {
        ...
        List<BluetoothDevice> devices = mBassClientService.getConnectedDevices();
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice)).isEqualTo(null);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice1)).isEqualTo(null);
        ...
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice)).isNotEqualTo(null);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice1)).isNotEqualTo(null);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice).size()).isEqualTo(1);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice1).size()).isEqualTo(1);
    ...
    public void testSelectSource_invalidActiveSource() {
        ...
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice)).isNotEqualTo(null);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice1)).isNotEqualTo(null);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice).size()).isEqualTo(4);
        assertThat(mBassClientService.getActiveSyncedSource(mCurrentDevice1).size()).isEqualTo(4);

        BluetoothDevice testDevice1 =
                mBluetoothAdapter.getRemoteLeDevice(
                        "00:01:02:03:04:05", BluetoothDevice.ADDRESS_TYPE_RANDOM);
        ScanResult scanResult1 = new ScanResult(testDevice1, 0, 0, 0, 0, 0, 0, 0, record, 0);
