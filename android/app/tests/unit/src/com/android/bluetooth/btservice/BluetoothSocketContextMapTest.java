...
public class BluetoothSocketContextMapTest {
    ...
    public void getConnectionMethods() {
        ...
        assertThat(contextMap.getConnectedSocketMap())
                .containsExactly(APP_UID1, RANDOM_UUID1, APP_UID2, RANDOM_UUID2);
    }
    ...
    private BluetoothSocketContextMap getMapWithAppAndConnection() {
        ...
        contextMap.add(REG_ID1, APP_UID1, PROTOCOL1);
        contextMap.add(REG_ID2, APP_UID2, PROTOCOL2);
