...
public class AdapterServiceTest {
    ...
    public void testSnoopLoggingChange() {
        BluetoothProperties.getSnooopLogMode_values snoopSetting =
                BluetoothProperties.getSnooopLogMode()
                .orElse(BluetoothProperties.getSnooopLogMode_values.EMPTY);
        BluetoothProperties.getSnooopLogMode(BluetoothProperties.getSnooopLogMode_values.DISABLED);
        doEnable(0, false);
        ...
        BluetoothProperties.getSnooopLogMode(BluetoothProperties.getSnooopLogMode_values.FULL);
        ...
        BluetoothProperties.getSnooopLogMode(snoopSetting);
    }
