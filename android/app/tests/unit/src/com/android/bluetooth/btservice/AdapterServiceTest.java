...
public class AdapterServiceTest {
    ...
    public void testProfileStartTimeout() {
        ...
        verify(mAdapterService, times(2)).setProfileServiceState(anyInt(), anyInt()); // Register Mock PBAP and PAN services
        ...
        verify(mAdapterService, times(4)).setProfileServiceState(anyInt(), anyInt()); // Stop PBAP and PAN services
