...
public class AdapterServiceTest {
    ...
    private void doEnable() {
        ...
        verifyStateChange(
                BluetoothAdapter.STATE_OFF, BluetoothAdapter.STATE_BLE_TURNING_ON, mEnabledCounter);
        ...
        verifyStateChange(
                BluetoothAdapter.STATE_BLE_ON, BluetoothAdapter.STATE_TURNING_ON, mEnabledCounter);
    ...
    public void testProfileStopTimeout() {
        ...
        verifyStateChange(
                BluetoothAdapter.STATE_TURNING_OFF, BluetoothAdapter.STATE_BLE_TURNING_OFF, 1);
