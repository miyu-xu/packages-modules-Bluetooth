...
public class AdapterServiceTest {
    ...
    public void testIdentityAddressType() {
        ...
        Bundle identityAddressWithType = mAdapterService.getIdentityAddressWithType(TEST_BT_ADDR_1);
        String identityAddress =
                identityAddressWithType.getString(BluetoothDevice.IDENTITY_ADDRESS);
        int identityAddressType =
                identityAddressWithType.getInt(BluetoothDevice.IDENTITY_ADDRESS_TYPE);
        assertThat(identityAddress).isEqualTo(TEST_BT_ADDR_2);
        ...
        identityAddressWithType = mAdapterService.getIdentityAddressWithType(TEST_BT_ADDR_1);
        identityAddress = identityAddressWithType.getString(BluetoothDevice.IDENTITY_ADDRESS);
        identityAddressType = identityAddressWithType.getInt(BluetoothDevice.IDENTITY_ADDRESS_TYPE);
        assertThat(identityAddress).isEqualTo(TEST_BT_ADDR_2);
