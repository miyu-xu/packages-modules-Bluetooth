...
public class MapClientStateMachineTest {
    ...
    public void testReceiveNewMessageNotification() {
        ...
        EventReport notification = createNewEventReport("NewMessage", currentDate, mTestMessageSmsHandle,
                "telecom/msg/inbox", null, "SMS_GSM");

        Message notificationMessage =
                Message.obtain(mHandler, MceStateMachine.MSG_NOTIFICATION, (Object)notification);
        ...
        MceStateMachine.MessageMetadata messageMetadata = mMceStateMachine.mMessages.get(mTestMessageSmsHandle);
    ...
    EventReport createNewEventReport(String mType, Date mDateTime, String mHandle, String mFolder,
        ...
        attrs.put("type", mType);
        attrs.put("date", (new ObexTime(mDateTime)).toString());
        attrs.put("handle", mHandle);
