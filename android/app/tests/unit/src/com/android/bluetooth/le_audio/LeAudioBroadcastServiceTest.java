...
public class LeAudioBroadcastServiceTest {
    ...
    private boolean onLeAudioPrimaryGroupChangedCallbackCalled = false;
    ...
    public void testOnLeAudioPrimaryGroupChanged() {
        int groupId1 = 1;
        int groupId2 = 2;
        int broadcastId = 243;
        byte[] code = {0x00, 0x01, 0x00, 0x02};

        onLeAudioPrimaryGroupChangedCallbackCalled = false;
        ...
        IBluetoothLeAudioCallback leAudioCallbacks =
                new IBluetoothLeAudioCallback.Stub() {
                    ...
                    public void onLeAudioPrimaryGroupChanged(int groupId) {
                        onLeAudioPrimaryGroupChangedCallbackCalled = true;
        ...
        Assert.assertTrue(onLeAudioPrimaryGroupChangedCallbackCalled);
