    ...
    public void testBroadcastResumeUnicastGroupChangeRequestDriven() {
        ...
        verify(mLeAudioBroadcasterNativeInterface, times(1))
                .createBroadcast(
                        ...
                        eq(expectedQualityArray),
                        eq(expectedDataArray));
        verify(mLeAudioNativeInterface, times(1)).setSinkListeningMode(eq(true));
        ...
        create_event = new LeAudioStackEvent(LeAudioStackEvent.EVENT_TYPE_SINK_MONITORING_STATUS);
        create_event.valueInt1 = LeAudioStackEvent.STATUS_STREAMING_REQUESTED;
        mService.messageFromNative(create_event);
        ...
        create_event = new LeAudioStackEvent(LeAudioStackEvent.EVENT_TYPE_SINK_MONITORING_STATUS);
        create_event.valueInt1 = LeAudioStackEvent.STATUS_STREAM_SUSPENDED;
        mService.messageFromNative(create_event);
