...
public class LeAudioBroadcastServiceTest {
    ...
    private void verifyConnectionStateIntent(
        ...
        Assert.assertEquals(
                intent.getAction(), BluetoothLeAudio.ACTION_LE_AUDIO_CONNECTION_STATE_CHANGED);
        Assert.assertEquals(
    ...
    public void testCreatePendingBroadcast() {
        ...
        Assert.assertEquals(
                mService.getConnectionState(mDevice), BluetoothProfile.STATE_CONNECTING);
        ...
        verifyConnectionStateIntent(
                ...
                BluetoothProfile.STATE_CONNECTING);
        Assert.assertEquals(mService.getConnectionState(mDevice), BluetoothProfile.STATE_CONNECTED);
        ...
        /* Check if broadcast is queued, active group should not change */
        ...
        Assert.assertEquals(activeGroup, -1);
    }
