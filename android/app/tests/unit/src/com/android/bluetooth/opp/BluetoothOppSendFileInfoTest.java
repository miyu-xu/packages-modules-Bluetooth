...
public class BluetoothOppSendFileInfoTest {
    ...
    @Test
    public void generateFileInfo_fileLengthMismatch_cannotCorrectMismatch_returnsSendFileInfoError()
            throws IOException {
        String type = "text/plain";
        Uri uri = Uri.parse("content:///hello/world");
    ...
    @Test
    public void generateFileInfo_fileLengthMismatch_canCorrectMismatch_returnInfoWithCorrectLength()
            throws IOException {
        String type = "text/plain";
        Uri uri = Uri.parse("content:///hello/world");
