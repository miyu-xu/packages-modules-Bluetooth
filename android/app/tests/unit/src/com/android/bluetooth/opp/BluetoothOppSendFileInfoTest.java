...
public class BluetoothOppSendFileInfoTest {
    ...
    @Test
    public void createInstance_withFileInputStream_createCorrectly() {
    ...
    @Test
    public void createInstance_withoutFileInputStream_createCorrectly() {
        String type = "text/plain";
        long length = 10000;
        int status = BluetoothShare.STATUS_SUCCESS;
    ...
    @Test
    public void generateFileInfo_withUnsupportedScheme_fileError() {
        String type = "text/plain";
    ...
    @Test
    public void generateFileInfo_withContentUri_withForbiddenExternalUri_fileError() {
        String type = "text/plain";
        Uri uri = Uri.parse("content://com.android.bluetooth.map.MmsFileProvider:8080");
        Log.d("TestRunner", "hieu " + uri.getScheme() + " " + uri.getHost() + " "
                + BluetoothOppUtility.isForbiddenContent(uri));
    ...
    @Test
    public void generateFileInfo_withContentUri_throwSecurityException_fileError() {
        String type = "text/plain";
    ...
    @Test
    public void generateFileInfo_fileLengthMismatch_cannotFindLength_returnErrorFileInfo()
            throws IOException {
        String type = "text/plain";
        Uri uri = Uri.parse("content:///hello/world");
    ...
    @Test
    public void generateFileInfo_withContentUri_fileLengthMismatch_returnCorrectedInfo()
            throws IOException {
        String type = "text/plain";
        Uri uri = Uri.parse("content:///hello/world");
    ...
    @Test
    public void generateFileInfo_withFileUri_notInExternalStorageDir_returnFileErrorInfo() {
        String type = "text/plain";
