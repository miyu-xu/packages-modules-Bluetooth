...
public class A2dpStateMachineTest {
    ...
    public void testIncomingPriorityReject() {
        ...
        assertThat(mA2dpStateMachine.getCurrentState())
                .isEqualTo(IsInstanceOf.instanceOf(A2dpStateMachine.Disconnected.class));
    }
    ...
    public void testIncomingPriorityAccept() {
        ...
        assertThat(mA2dpStateMachine.getCurrentState())
                .isEqualTo(IsInstanceOf.instanceOf(A2dpStateMachine.Connecting.class));
        ...
        assertThat(mA2dpStateMachine.getCurrentState())
                .isEqualTo(IsInstanceOf.instanceOf(A2dpStateMachine.Connected.class));
    }
