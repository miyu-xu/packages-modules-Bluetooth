...
**If your DUT is an AVD**, then proceed with the following steps:

* Connect to your [Chrome Remote Desktop](
  https://remotedesktop.corp.google.com/access/).
* Create a local AVD instance using your locally built image with the command
...
communications. It is used by default within an AVD (and thus this step is not
...
* **DUT**: physical
  ...
  * On your remote instance: execute your tests.
  TODO: ROOTCANAL PORT 7300 for AVD
