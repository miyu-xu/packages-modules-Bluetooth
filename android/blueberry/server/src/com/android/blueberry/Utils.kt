...
open class ServiceListener : BluetoothProfile.ServiceListener {
...
/**
 * Get the profile proxy object associated with the profile and wait for it to be connected.
 *
 * @param T The desired profile proxy (e.g BluetoothA2dp)
 * @param context Context of the application
 * @param bluetoothAdapter BluetoothAdapter: The local device Bluetooth adapter
 * @param profile Int: The Bluetooth profile (e.g BluetoothProfile#A2DP)
 * @return T The desired profile proxy (e.g BluetoothA2dp)
 *
 */
@Suppress("UNCHECKED_CAST")
@kotlinx.coroutines.ExperimentalCoroutinesApi
fun <T> getProfileProxy(context: Context, bluetoothAdapter: BluetoothAdapter, profile: Int): T {
  var proxy: T
  runBlocking {
