...
class BluetoothServiceBinder extends IBluetoothManager.Stub {
    ...
    public boolean enable(@NonNull AttributionSource source) {
        ...
        final String errorMsg = BtPermissionUtils.callerCanToggle(mContext, source, mUserManager,
                mAppOpsManager, mPermissionManager, "enable", true);
        if (!errorMsg.isEmpty()) {
    ...
    public boolean enableNoAutoConnect(AttributionSource source) {
        ...
        final String errorMsg = BtPermissionUtils.callerCanToggle(mContext, source, mUserManager,
                mAppOpsManager, mPermissionManager, "enableNoAutoConnect", false);
        if (!errorMsg.isEmpty()) {
    ...
    public boolean disable(AttributionSource source, boolean persist) {
        ...
        final String errorMsg = BtPermissionUtils.callerCanToggle(mContext, source, mUserManager,
                mAppOpsManager, mPermissionManager, "disable", true);
        if (!errorMsg.isEmpty()) {
    ...
    public boolean enableBle(AttributionSource source, IBinder token) {
        ...
        final String errorMsg = BtPermissionUtils.callerCanToggle(mContext, source, mUserManager,
                mAppOpsManager, mPermissionManager, "enableBle", false);
        if (!errorMsg.isEmpty()) {
    ...
    public boolean disableBle(AttributionSource source, IBinder token) {
        ...
        final String errorMsg = BtPermissionUtils.callerCanToggle(mContext, source, mUserManager,
                mAppOpsManager, mPermissionManager, "disableBle", false);
        if (!errorMsg.isEmpty()) {
