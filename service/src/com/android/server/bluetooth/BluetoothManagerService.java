...
class BluetoothManagerService {
    ...
    private void disableBluetoothComponents(String packageName) {
        ...
        disableComponents(pm, packageInfo.services, packageName, null); // No filtering for services
        disableComponents(pm, packageInfo.receivers, packageName, null); // No filtering for receivers
        disableComponents(pm, packageInfo.providers, packageName, null); // No filtering for providers
    }
