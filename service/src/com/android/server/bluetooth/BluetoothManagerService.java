...
class BluetoothManagerService {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothAdapter.ACTION_LOCAL_NAME_CHANGED.equals(action)) {
                ...
                try {
                    mEnable = false;
                    mEnableExternal = false;
                    if (mBluetooth != null && mState.equals(STATE_BLE_ON)) {
                        synchronousOnBrEdrDown(mContext.getAttributionSource());
                    } else if (mBluetooth != null && mState.equals(STATE_ON)) {
    ...
    class BluetoothHandler extends Handler {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_BLUETOOTH_STATE_CHANGE: {
                    ...
                    if ((prevState == STATE_BLE_TURNING_ON) && (newState
                            == STATE_OFF) && (mBluetooth != null) && mEnable) {
                        recoverBluetoothServiceFromError(false);
                    }
                    if ((prevState == STATE_TURNING_ON) && (newState
                            == STATE_BLE_ON) && (mBluetooth != null) && mEnable) {
        ...
        private void restartForReason(int reason) {
            ...
            bluetoothStateChangeHandler(STATE_ON,
                    STATE_TURNING_OFF);
    ...
    private void bluetoothStateChangeHandler(int prevState, int newState) {
        ...
        if (newState == STATE_BLE_ON || newState == STATE_OFF) {
            boolean intermediate_off = (prevState == STATE_TURNING_OFF
                    && newState == STATE_BLE_ON);
        ...
        } else if (newState == STATE_TURNING_ON
                || newState == STATE_TURNING_OFF) {
            sendBleStateChanged(prevState, newState);
        }
