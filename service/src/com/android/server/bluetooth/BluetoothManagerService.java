...
class BluetoothManagerService {
    ...
    private boolean performKill(boolean postOnMainHandler) {
        ...
        try {
            ...
            // Reduce exception to info: Bluetooth is already dead
            Log.i(TAG, "Bluetooth already dead while calling linkToDeath 💀");
            return true;
        }
        ...
        try {
            ...
            // Reduce exception to info: Bluetooth is already dead
            Log.i(TAG, "Bluetooth already dead while calling killBluetoothProcess 💀");
        } catch (RemoteException e) {
