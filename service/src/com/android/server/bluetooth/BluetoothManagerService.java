                    ...
                    if (!Flags.getNameAndAddressAsCallback()
                        ...
                        if (Settings.Global.BLUETOOTH_ON.equals(name)) {
                            ...
                            if (newValue.equals("0")) {
                                mHandler.sendEmptyMessage(MESSAGE_RESTORE_USER_SETTING_OFF);
                            } else {
                                mHandler.sendEmptyMessage(MESSAGE_RESTORE_USER_SETTING_ON);
                            }
                        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_RESTORE_USER_SETTING_OFF:
                    if (!mEnable) {
                        Log.w(TAG, "RESTORE_USER_SETTING_OFF: Unhandled. mEnable=" + mEnable);
                        break;
                    }
                ...
                case MESSAGE_RESTORE_USER_SETTING_ON:
                    if (mEnable) {
                        Log.w(TAG, "RESTORE_USER_SETTING_ON: Unhandled. mEnable=" + mEnable);
                        break;
                    }
