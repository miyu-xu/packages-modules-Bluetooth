...
class BluetoothManagerService {
    ...
    private static final boolean useNewSatelliteMode = DeviceConfig.getBoolean(DeviceConfig.NAMESPACE_BLUETOOTH,
                "com.android.bluetooth.use_new_satellite_mode", false);
