...
public class TemporaryOffListener private constructor() {
    companion object {
         ...
         *
         * Known limitation:
         * * If the phone is off during the time the alarm would expire, it will skip a day
         * * If changing the time / timezone skip the alarm, it will skip a day
         *
 ...
 * automatically later
 *
 * TODO: b/317212112 - Migrate to official API in Android V.
 */
 ...
 * *Do not use outside of this file to avoid async issues*
 *
 * @return whether the bluetooth is currently in temporary off state
 */
