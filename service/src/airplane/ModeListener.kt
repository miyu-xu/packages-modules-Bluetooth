...
public fun initialize(
    ...
    // This is done only if the APM_ENHANCEMENT settings is not already set.
    if (Settings.Global.getString(systemResolver, APM_ENHANCEMENT) == null) {
...
private class AirplaneMetricSession(
    ...
    fun notifyUserToggledBluetooth(
        ...
        if (!isApmEnhancementEnabled(resolver)) {
            // Set "Airplane Enhancement Mode" for a specific user
