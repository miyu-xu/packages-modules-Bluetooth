...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    public void onUserRestrictionsChanged(UserHandle userHandle) {
        ...
        if (userHandle == UserHandle.SYSTEM && newBluetoothDisallowed != mBluetoothDisallowed) {
     ...
     */
    private void updateOppLauncherComponentState(UserHandle userHandle, boolean bluetoothSharingDisallowed) {
        ...
        try {
            final IPackageManager imp = AppGlobals.getPackageManager();//mContext.getSystemService(PackageManager.class);
