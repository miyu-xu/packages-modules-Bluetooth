...
public class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    public void onAirplaneModeChanged() {
        if (mHandler != null) {
            ...
            // If only LE mode with airplane on, should disable le and turn off airplane, shuld not turn on le
            if (state == BluetoothAdapter.STATE_BLE_ON && isBluetoothPersistedStateOn()) {
                ...
                // If Bluetooth is truning state, should handle airplane event after delay
    ...
    private void handleAirplaneModeChanged() {
        synchronized (this) {
            ...
            } else if (mEnableExternal || isBluetoothPersistedStateOnBluetooth()) {
