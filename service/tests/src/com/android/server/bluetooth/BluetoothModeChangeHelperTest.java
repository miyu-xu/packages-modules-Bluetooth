...
public class BluetoothModeChangeHelperTest {
    ...
    public void isBluetoothOn_doesNotCrash() {
        // TODO: Strangely, isBluetoothOn does not call BluetoothAdapter.isLeEnabled() rather than
        // BluetoothAdapter.isEnabled(). This can be true even when adapter is disabled.
