...
public class BluetoothManagerServiceTest {
    ...
    void transition_onToBleOn(IBluetoothCallback btCallback) throws Exception {
    ...
    public void disableAirplane_whenNothing_startBluetooth() throws Exception {
        ...
        discardMessage(MESSAGE_ENABLE); // link to enable

        mManagerService.onAirplaneModeChanged(false);

        discardMessage(MESSAGE_ENABLE); // trigger by airplane change
    }
