...
public class BluetoothManagerServiceTest {
    ...
    public void offToBleOn() throws Exception {
        ...
        // moveForward to make MESSAGE_TIMEOUT_BIND available to nextMessage and check it there
        // Checking timeout behavior need to be done in another test. This is needed to not failed
        // during teardown
        mLooper.moveTimeForward(1000000);
        assertThat(mLooper.nextMessage().what).isEqualTo(MESSAGE_TIMEOUT_BIND);
    ...
    public void offToOn() throws Exception {
        ...
        // moveForward to make MESSAGE_TIMEOUT_BIND available to nextMessage
        mLooper.moveTimeForward(1000000);
        assertThat(mLooper.nextMessage().what).isEqualTo(MESSAGE_TIMEOUT_BIND);
