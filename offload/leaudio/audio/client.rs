...
use crate::ffi::{CCallbacks, CCodec, CIsoStream};
use crate::streamer::{Callbacks, Streamer};
use aidl::android::hardware::bluetooth::offload::leaudio::{
    IHciProxy::{BpHciProxy, IHciProxy},
    IHciProxyCallbacks::{BnHciProxyCallbacks, IHciProxyCallbacks},
...
impl Stream {
    pub fn new(
        ...
        let streamer = Arc::new(Streamer::new(bitdepth, iso_streams, codec, callbacks)?);
