 ...
 * - LC3 High-Resoltion mode supports 48000 and 96000 Hz
 ...
 * - LC3 High-Resoltion mode supports 2500, 5000 and 10000 us.
 * - Opus supports 20000 us.
 */
struct swoff_audio_config {
  int bitdepth;
  int sample_rate;
  int frame_duration_us;

  enum swoff_codec_type codec_type;
  union {
...
swoff_lea_stream_t swoff_leaudio_setup(const struct swoff_iso_stream iso_streams[],
                                       size_t num_iso_streams,
                                       const struct swoff_audio_config *audio,
